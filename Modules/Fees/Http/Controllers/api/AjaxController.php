...
class AjaxController extends Controller
{
    ...
    {
        $feesinvoice = FmFeesInvoice::withoutGlobalScope(AcademicSchoolScope::class)->where('id', $request->invoiceId)->first();
        $feesTranscations = FmFeesTransaction::withoutGlobalScope(AcademicSchoolScope::class)
            ->where('fees_invoice_id', $feesinvoice->id)
