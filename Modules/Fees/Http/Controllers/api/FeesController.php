...
class FeesController extends Controller
{
    public function feesGroup()
    {
        ...
        $feesGroups = FmFeesGroup::withoutGlobalScope(AcademicSchoolScope::class)->where('school_id', auth()->user()->school_id)
            ->where('academic_id', getAcademicId())
            ->get();

        return response()->json(['data' => $feesGroups]);
    }
    ...
    public function feesGroupUpdate(Request $request)
    {
        ...
        try {
            if (checkAdmin() === true) {
                $feesGroup = FmFeesGroup::find($request->get('id'));
            } else {

                $feesGroup = FmFeesGroup::withoutGlobalScope(AcademicSchoolScope::class)->where('id', $request->get('id'))
                    ->where('school_id', auth()->user()->school_id)
                    ->first();
            }

            $feesGroup->name = $request->get('name');
            $feesGroup->description = $request->get('description');
    ...
    public function feesGroupDelete(Request $request)
    {
        try {
            if (checkAdmin() === true) {
                ...
                FmFeesGroup::withoutGlobalScope(AcademicSchoolScope::class)->where('id', $request->id)
                    ->where('school_id', auth()->user()->school_id)
                    ->delete();
            }
    ...
    public function feesType()
    {
        ...
        $feesTypes = FmFeesType::withoutGlobalScope(AcademicSchoolScope::class)->where('type', 'fees')
            ->where('school_id', auth()->user()->school_id)
            ->where('academic_id', getAcademicId())
            ->get();
    ...
    public function feesTypeUpdate(FeesTypeRequest $feesTypeRequest)
    {
        try {
            if (checkAdmin() === true) {
                ...
                $feesType = FmFeesType::withoutGlobalScope(AcademicSchoolScope::class)->where('type', 'fees')
    ...
    {
        try {
            $feesGroupId = FmFeesType::withoutGlobalScope(AcademicSchoolScope::class)->where('id', $request->id)->first();

            $checkExistsData = FmFeesType::where('id', $feesGroupId->fees_group_id)->first();

            if (! $checkExistsData) {
                FmFeesType::withoutGlobalScope(AcademicSchoolScope::class)->where('id', $request->id)->delete();
    ...
    {
        $studentInvoices = FmFeesInvoice::withoutGlobalScope(AcademicSchoolScope::class)->where('type', 'fees')
            ->where('school_id', auth()->user()->school_id)
             // ->where('academic_id', getAcademicId())
    ...
    {
        $invoiceInfo = FmFeesInvoice::withoutGlobalScope(AcademicSchoolScope::class)->where('id', $id)->first();
    ...
    {
        $classes = SmClass::withoutGlobalScope(AcademicSchoolScope::class)->where('active_status', 1)
            ->where('academic_id', getAcademicId())
            ->where('school_id', auth()->user()->school_id)
            ->get();

        $feesPayments = FmFeesTransaction::withoutGlobalScope(AcademicSchoolScope::class)->with('feeStudentInfo', 'transcationDetails', 'transcationDetails.transcationFeesType')
            ->where('paid_status', 0)
    ...
    public function approveBankPayment(Request $request)
    {
        try {
            ...
            $transcationInfo = FmFeesTransaction::withoutGlobalScope(AcademicSchoolScope::class)->where('id', $transcation)->first();
