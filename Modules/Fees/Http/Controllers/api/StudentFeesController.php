...
class StudentFeesController extends Controller
{
    ...
    public function studentFeesPaymentStore(StudentAddFeesPaymentRequest $studentAddFeesPaymentRequest)
    {
        ...
        if (!$record) {
            throw ValidationException::withMessages(['student_id' => 'Student record not found']);
        }
        ...
        // Remove the file from the request bag so that exception trackers (like Ignition)
        // do not attempt to read the moved temporary file if an exception is thrown.
        if ($studentAddFeesPaymentRequest->hasFile('file')) {
            $studentAddFeesPaymentRequest->files->remove('file');
        }
