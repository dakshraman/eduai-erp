@push('css')
    <link rel="stylesheet" href="{{ assetPath('modules/fees/css/feesStyle.css')}}" />
    <style>
            ...
            <div class="col-lg-3">
                ...
                <div class="student-meta-box">
                    ...
                    <img class="student-meta-img img-100"
                        src="{{ $invoiceInfo->studentInfo->student_photo ? $invoiceInfo->studentInfo->student_photo : assetPath('public/uploads/staff/demo/staff.jpg') }}"
                        alt="">
                    <div class="white-box radius-t-y-0">
                        ...
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                <div class="name"> @lang('common.shift')</div>
                        ...
                        <div class="single-meta">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="value">
                                    <span class="add_wallet">{{ currency_format(0.0) }}</span>
                        ...
                        <div class="row mt-25">
                            <div class="col-lg-12">
                                <select
                                    ...
                                    <option data-display="@lang('accounts.payment_method')*" value="">@lang('accounts.payment_method')*
                                    </option>
                                    @foreach ($paymentMethods as $paymentMethod)
                                        <option value="{{ $paymentMethod->method }}"
                                            {{ old('payment_method') == $paymentMethod->method ? 'selected' : '' }}>
                        ...
                        <div class="row mt-25 chequeBank d-none">
                            <div class="col-lg-12">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('common.note') <span></span>
                                    </label>
                                    <textarea class="primary_input_field form-control" cols="0" rows="3" name="payment_note" id="note">{{ old('payment_note') }}</textarea>
                                    ...
                                    <div class="primary_input">
                                        ...
                                        @if ($errors->has('name_on_card'))
                                            <span class="text-danger" role="alert">
                                                {{ $errors->first('name_on_card') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input">
                                        <label class="primary_input_label" for="">@lang('accounts.card_number') <span
                                                class="text-danger"> *</span> </label>
                                        <input
                                            class="primary_input_field form-control{{ $errors->has('card-number') ? ' is-invalid' : '' }} card-number"
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input">
                                        ...
                                        <input class="primary_input_field form-control card-cvc" type="text"
                                            name="card-cvc" autocomplete="off" value="{{ old('card-cvc') }}">

                                        @if ($errors->has('card-cvc'))
                                            <span class="text-danger" role="alert">
                                                {{ $errors->first('card-cvc') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input">
                                        ...
                                        @if ($errors->has('card-expiry-month'))
                                            <span class="text-danger" role="alert">
                                                {{ $errors->first('card-expiry-month') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input">
                                        ...
                                        @if ($errors->has('card-expiry-year'))
                                            <span class="text-danger" role="alert">
                                                {{ $errors->first('card-expiry-year') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        @if (moduleStatusCheck('MercadoPago') == true)
                            @include('mercadopago::form.userForm', [
                                            ...
                                            @foreach ($invoiceDetails as $key => $invoiceDetail)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="primary_input">
                                                            <input
                                                                class="primary_input_field border-0 form-control addFeesAmount{{ $errors->has('amount') ? ' is-invalid' : '' }}"
                                                                type="number" name="amount[]" autocomplete="off" step="{{inputStep()}}"
                                                                value="{{ isset($invoiceDetail) ? decimal_only($invoiceDetail->amount) : old('amount') }}"
                                                                readonly>
                                                    ...
                                                    <td>
                                                        <div class="primary_input">
                                                            <input
                                                                class="primary_input_field border-0 form-control showTotalValue" step="{{inputStep()}}"
                                                                type="number" name="due[]"
                                                                value="{{ isset($invoiceDetail) ? decimal_only($invoiceDetail->due_amount) : '' }}"
                                                                autocomplete="off" readonly>
                                                            <input class="dueAmount" type="hidden" step="{{inputStep()}}"
                                                                value="{{ isset($invoiceDetail) ? decimal_only($invoiceDetail->due_amount) : decimal_only(0) }}">
                                                            <input class="extraAmount" type="hidden" step="{{inputStep()}}"
                                                    ...
                                                    <td>
                                                        <input
                                                            ...
                                                            type="number" name="paid_amount[]" step="{{inputStep()}}" autocomplete="off">
                                                    </td>
                                                    <td>
                                                        @if (isset($role) && $role == 'admin')
                                                            <div class="primary_input">
                                                                <input
                                                                    ...
                                                                    type="number" name="weaver[]" autocomplete="off" step="{{inputStep()}}"
                                                                    value="{{ isset($invoiceDetail) ? decimal_only($invoiceDetail->weaver) : old('weaver') }}">
                                                                <input class="previousWeaver" type="hidden" step="{{inputStep()}}"
                                                                    value="{{ isset($invoiceDetail) ? decimal_only($invoiceDetail->weaver) : '' }}">

                                                            </div>
                                                        @else
                                                            <input class="primary_input_field border-0 form-control" step="{{inputStep()}}"
                                                                value="{{ isset($invoiceDetail) ? decimal_only($invoiceDetail->weaver) : decimal_only(0) }}"
                                                                autocomplete="off" readonly>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (isset($role) && $role == 'admin')
                                                            <input class="primary_input_field form-control addFeesFine"
                                                                type="number" name="fine[]" autocomplete="off" step="{{inputStep()}}"
                                                                value="{{decimal_only(0)}}">
                                                        @else
                                                            <input class="primary_input_field border-0 form-control" step="{{inputStep()}}"
                                                                value="{{ isset($invoiceDetail) ? decimal_only($invoiceDetail->fine) : decimal_only(0) }}"
                                                                autocomplete="off" readonly>
                                                        @endif
                                                    </td>
                                                    <td>
