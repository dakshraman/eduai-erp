                ...
                @if (userPermission('fees_group_store'))
                    <div class="row">
                        <div class="offset-lg-10 col-lg-2 text-right col-md-12 mb-20">
                            <a href="{{ route('fees.fees-group') }}" class="primary-btn small fix-gr-bg"><span
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($feesGroup))
                                {{ html()->form('POST', route('fees.fees-group-update'))->attributes(['class' => 'form-horizontal'])->open() }}
                                <input type="hidden" name="id" value="{{ isset($feesGroup) ? $feesGroup->id : '' }}">
                            @else
                                {{ html()->form('POST', route('fees.fees-group-store'))->attributes(['class' => 'form-horizontal'])->open() }}
                            @endif
                            <div class="white-box">
                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($feesGroup) ? $feesGroup->branch_id : '',
                                            ])
                                        </div>        
                                    @endif
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($feesGroup) ? $feesGroup->name : old('name') }}">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <textarea class="primary_input_field form-control" cols="0" rows="4" name="description">{{ isset($feesGroup) ? $feesGroup->description : old('description') }}</textarea>
                                    ...
                                    <table id="table_id" class="table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            @foreach ($feesGroups as $feesGroup)
                                                <tr>
                                                    @if (moduleStatusCheck('Branch'))
                                                    <td>{{ $feesGroup->branch?->branch_name }}</td>
                                                    @endif
                                                        ...
                                                        <x-drop-down>
                                                            @if (userPermission('fees.fees-group-edit'))
                                                                <a class="dropdown-item"
                                                                    href="{{ route('fees.fees-group-edit', [$feesGroup->id]) }}">
                                                                    @lang('common.edit')</a>
                                                            @endif
                                                            ...
                                                            @if (userPermission('fees.fees-group-delete'))
                                                                <a class="dropdown-item deleteFeesGroupModal"
                                                                    data-toggle="modal"
                                                                    data-target="#deleteFeesGroupModal{{ $feesGroup->id }}"
                                                ...
                                                <div class="modal fade admin-query"
                                                    id="deleteFeesGroupModal{{ $feesGroup->id }}">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('POST', route('fees.fees-group-delete'))->open() }}
