            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('fees.search-bank-payment'))->attributes(['class' => 'form-horizontal', 'files' => true, 'enctype' => 'multipart/form-data'])->open() }}
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 mt-30-md">
                                <div class="primary_input">
                                    ...
                                    <input class="primary_input_field primary_input_field form-control" type="text"
                                        name="payment_date" value="{{ old('payment_date', $payment_date ?? '') }}" placeholder="">
                                        ...
                                        <tbody>
                                            @if (isset($feesPayments))
                                                @foreach ($feesPayments as $bank_payment)
                                                    ...
                                                    @endphp
                                                    <tr>
                                                        <td>{{ @$bank_payment->feeStudentInfo ? @$bank_payment->feeStudentInfo->full_name : ''}}</td>
                                                                                ...
                                                                                <div class="row justify-content-center">
                                                                                    <div class="col-lg-12 text-center">
                                                                                        <table
                                                                                            ...
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    <th>@lang('fees::feesModule.fees_type')
                                                                                                    </th>
                                                                                                    <th>@lang('fees::feesModule.paid_amount')
                                                                                                    </th>
                                                                                                </tr>
                                                                                            </thead>
                                                                                            <tbody>
                                                        ...
                                                        <td>{{ currency_format($bank_payment->paid_amount + $bank_payment->add_wallet_money) }}</td>
                                                        <td>
                                                    ...
                                                    <div class="modal fade admin-query"
                                                        id="bankPaymentFile{{ $bank_payment->id }}">
                                                        <div class="modal-dialog modal-dialog-centered large-modal">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <div class="container student-certificate">
                                                                        <div class="row justify-content-center">
                                                                            <div class="col-lg-12 text-center">
                                                                                ...
                                                                                @if (@$for_pdf == 'pdf')
                                                                                    <div class="mb-5">
                                                                                        <a href="{{ assetPath($bank_payment->file) }}"
                                                                                            download>@lang('common.download')
                                                                                            <span
                                                                                ...
                                                                                @else
                                                                                    <div class="mb-5">
                                                                                        <img class="img-fluid"
                                                                                            src="{{ assetPath($bank_payment->file) }}">
                                                                                        </br>
                                                                                        <a href="{{ assetPath($bank_payment->file) }}"
                                                                                            download>@lang('common.download')
                                                                                            <span
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ html()->form('POST', route('fees.approve-bank-payment'))->open() }}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{ html()->form('POST', route('fees.reject-bank-payment'))->open() }}
...
@push('script')
    <script>
        const selectedPaymentDate = @json(old('payment_date', $payment_date ?? ''));
        const paymentDateRange = selectedPaymentDate ? selectedPaymentDate.split(' - ') : [];
        const paymentDateStart = paymentDateRange.length === 2 ? moment(paymentDateRange[0], 'MM/DD/YYYY') : moment().subtract(7, 'days');
        const paymentDateEnd = paymentDateRange.length === 2 ? moment(paymentDateRange[1], 'MM/DD/YYYY') : moment();
