            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('fees.waiver-search'))->attributes(['class' => 'form-horizontal'])->open() }}
...
@include('backEnd.partials.server_side_datatable')
@include('backEnd.partials.currency_formate')
@push('script')
    <script type="text/javascript" src="{{ assetPath('modules/fees/js/app.js') }}"></script>
    <script>
        $(document).ready(function() {
            $('.data-table').DataTable({
                ...
                footerCallback: function(row, data, start, end, display) {
                    ...
                    // Apply your currency formatter here
                    $(api.column(5).footer()).html(currency_format_js(total, format=window.currencyFormat));
                },
