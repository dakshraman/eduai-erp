                    ...
                    <table class="table border_table mb_30 description_table" >
                        ...
                        @foreach ($invoiceDetails as $key=>$invoiceDetail)
                            ...
                            <tr>
                                ...
                                <td>{{currency_format($invoiceDetail->amount)}}</td>
                                <td>{{currency_format($invoiceDetail->weaver)}}</td>
                                <td>{{currency_format($invoiceDetail->fine)}}</td>
                                <td>{{currency_format($invoiceDetail->paid_amount)}}</td>
