                ...
                <div class="container">
                    <div class="invoice_part_iner">
                        <table class="table">
                            ...
                            <td>
                                <div class="logo_img">
                                    <img  src="{{assetPath($generalSetting->logo)}}" alt="{{$generalSetting->school_name}}">
                                </div>
                            </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="addressleft_text">
                                                        ...
                                                        <p><span><strong>@lang('common.branch') </span> <span class="nowrap">: {{@$invoiceInfo->branch?->branch_name}}</span> </strong></p>
                                                        @endif
                                                        <p><span>@if(shiftEnable()) @lang('admin.class_Sec_shift') @else @lang('admin.class_Sec') @endif</span> <span>: {{@$invoiceInfo->recordDetail->class->class_name}} ({{@$invoiceInfo->recordDetail->section->section_name}}) @if(shiftEnable() && @$invoiceInfo->recordDetail->shift) [{{@$invoiceInfo->recordDetail->shift->name}}] @endif</span> </p>
            ...
            <table class="table border_table mb_30 description_table" >
                ...
                @foreach ($invoiceDetails as $key=>$invoiceDetail)
                    ...
                    <tr>
                        ...
                        <td>{{currency_format(($invoiceDetail)? $invoiceDetail->amount : 0.00)}}</td>
                        <td>{{currency_format(($invoiceDetail->weaver)? $invoiceDetail->weaver : 0)}}</td>
                        <td>{{currency_format(($invoiceDetail->fine)? $invoiceDetail->fine : 0)}}</td>
                        <td>{{currency_format(($invoiceDetail->paid_amount)? $invoiceDetail->paid_amount : 0)}}</td>
