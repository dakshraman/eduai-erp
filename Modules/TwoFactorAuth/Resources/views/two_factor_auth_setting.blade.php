                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row mb-40 mt-40">
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="col-lg-5 d-flex">
                                                    <p class="text-uppercase fw-500 mb-10">@lang('auth.two_factor_otp') <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Enable or disable two-factor authentication for added security when logging in."></i></p>
                                                </div>
                                                <div class="col-lg-7">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="col-lg-5 d-flex">
                                                    <p class="text-uppercase fw-500 mb-10">@lang('auth.send_code_via') <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Code send via email, if email selected. Otherwise SMS."></i></p>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="d-flex radio-btn-flex applicable-for-radio-option flex-wrap"> 
                                        ...
                                        <div class="col-lg-6">
                                             <div class="row">
                                                 <div class="col-lg-3 d-flex">
                                                     <p class="text-uppercase fw-500 mb-10">@lang('auth.applicable_for') <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Working Two-Factor Authentication (2FA) selection panel,."></i></p>
                                                 </div>
                                                 <div class="col-lg-9">
                                                     <div class="d-flex radio-btn-flex applicable-for-radio-option flex-wrap"> 
                                                        <div class="mr-30">
