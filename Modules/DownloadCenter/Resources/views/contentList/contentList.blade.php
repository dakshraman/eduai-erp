...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            @if(userPermission('download-center.content-list-search'))
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box filter_card">
                        ...
                        {{ html()->form('GET', route('download-center.content-list-search'))->attributes([
            ...
            @endif
            <div class="row mt-40">
                @if(userPermission('download-center.content-list-save') || isset($editContent))
                <div class="col-lg-4 col-xl-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($editContent))
                                {{ html()->form('POST', route('download-center.content-list-update'))->attributes([
                                        'class' => 'form-horizontal',
                                        'enctype' => 'multipart/form-data',
                                        'files' => true,
                                    ])->open() }}
                            ...
                            @else
                                {{ html()->form('POST', route('download-center.content-list-save'))->attributes([
                                        'class' => 'form-horizontal',
                                        'enctype' => 'multipart/form-data',
                                        'files' => true,
                                    ])->open() }}
                                ...
                                <div class="add-visitor">
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($editContent) ? $editContent->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                    @if (isset($editContent))
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    ...
                                                    <input
                                                        ...
                                                        type="text" name="file_name" autocomplete="off"
                                                        value="{{ isset($editContent) ? @$editContent->file_name : old('file_name') }}">
                                                </div>
                                            ...
                                            <select
                                                ...
                                                @foreach (@$contentTpyes as $contentTpye)
                                                    <option value="{{ $contentTpye->id }}"
                                                        {{ old('content_type_id', isset($editContent) ? $editContent->content_type_id : '') == $contentTpye->id ? 'selected' : '' }}>
                                                        {{ $contentTpye->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    @if ($editContent == null)
                                        <div class="row no-gutters input-right-icon mb-20">
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label>@lang('downloadCenter.youtube_link') <span class="text-danger"> *</span></label>
                                                    <input
                                                        class="primary_input_field form-control{{ $errors->has('youtube_link') ? ' is-invalid' : '' }}"
                                                        type="text" name="youtube_link" autocomplete="off"
                                                        value="{{ isset($editContent) ? @$editContent->youtube_link : old('youtube_link') }}">
                                                </div>
                ...
                @endif
                <div class="@if(userPermission('download-center.content-list-save') || isset($editContent)) col-lg-8 col-xl-9 @else col-lg-12 @endif">
                    <div class="white-box">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="mt-3 pt-4">
                                    <x-table>
                                        <table id="table_id" class="table Crm_table_active3 content-table"
    ...
    <div class="modal fade admin-query" id="shareContent">
        <div class="modal-dialog modal-dialog-centered large-modal">
            <div class="modal-content">
                ...
                {{ html()->form('POST', route('download-center.content-share-list-save'))->attributes([
                        'class' => 'form-horizontal',
                        'enctype' => 'multipart/form-data',
                        'id' => 'share-content-form',
                        'files' => true,
                    ])->open() }}
                <div class="modal-body">
                    <div class="container-fluid">
                                ...
                                <div class="row student-details mt_0_sm">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade show active mt-2" id="group_video">
                                                <div class="white-box">
                                                    <div class="col-lg-12">
                                                    ...
                                                    <div class="row mb-15">
                                                        ...
                                                        <div class="col-lg-12 mt-15" id="selectStaffsDiv">
                                                            ...
                                                            <select multiple="multiple"
                                                                ...
                                                                name="individual_content_user[]" style="width:300px">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row mb-35">
                                                        ...
                                                        @else
                                                            ...
                                                            <div class="col-lg-12 mt-30" id="selectSectionsDiv">
                                                                <label for="checkbox" class="mb-2">@lang('common.section')
    ...
    <div class="modal fade admin-query" id="generateUrl">
        <div class="modal-dialog modal-dialog-centered large-modal">
            <div class="modal-content">
                ...
                {{ html()->form('POST', route('download-center.content-generate-url-save'))->attributes([
                        'class' => 'form-horizontal',
                        'id' => 'generate-url-form',
                        'enctype' => 'multipart/form-data',
                        'files' => true,
                    ])->open() }}
                <div class="modal-body">
