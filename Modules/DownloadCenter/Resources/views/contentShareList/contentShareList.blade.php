                                        ...
                                        <tbody>
                                            @foreach ($sharedContents as $key => $sharedContent)
                                                ...
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    @if(moduleStatusCheck('Branch'))
                                                    <td>{{ $sharedContent->branch?->branch_name }}</td>
                                                    @endif
                                                    ...
                                                    <td>
                                                        <x-drop-down>
                                                            ...
                                                            @if(userPermission('download-center.content-generate-url-view'))
                                                            <a class="modalLink dropdown-item"
                                                            ...
                                                            @if (auth()->user()->role_id != 2)
                                                                @if(userPermission('download-center.content-generate-url-delete'))
