...
class ContentTypeController extends Controller
{
    ...
    {
        try {
            $types = branchWise(ContentType::get());
    ...
    public function contentTypeSave(Request $request)
    {
        ...
        try {
            ...
            $contentType->academic_id = getAcademicId();
            $contentType->school_id = Auth::user()->school_id;
            if (moduleStatusCheck('Branch') && Schema::hasColumn('content_types', 'branch_id')) {
                $contentType->branch_id = $request->branch_id;
            }
            $contentType->save();
