...
<div class="">
    @push('css')
        <link href="{{ assetPath('modules/menumanage/css/jquery.nestable.min.css') }}" rel="stylesheet">
        <link href="{{ assetPath('modules/menumanage/css/sidebar.css') }}" rel="stylesheet">
    @endpush
    @php
                                    ...
                                    <div class="setting_icons">
                                        <span class="edit-btn">
                                            <a class=" btn-modal" data-container="#commonModal" type="button"
                                                href="{{ route('sidebar-manager.section-edit-form', [$sidebar_menu->id, 'role_name' => $role_name]) }}">
                                                                ...
                                                                @if(moduleStatusCheck($menu->module))
                                                                    ...
                                                                    <li class="dd-item" data-id="{{ $menu->id }}" 
                                                                        ...
                                                                        <div class="card accordion_card"
                                                                            ...
                                                                            <ol class="dd-list">
                                                                                @include('menumanage::components.menu_childs', ['items' => $menu->childs])
                                                                            </ol>
                                                                    </li>  
    ...
    @push('scripts')
        <script src="{{ assetPath('public/backEnd/js/jquery.nestable.min.js') }}"></script>
        <script src="{{ assetPath('modules/menumanage/js/sidebar.js') }}"></script>
    @endpush
