                                    ...
                                    <div class="permission_header d-flex align-items-center justify-content-between">
                                        <div>
                                            <input type="checkbox" name="module_id[]"
                                                value="{{ $student_parent_module->infix_module_id }}"
                                                id="Main_Module_{{ $key }}"
                                                class="common-radio permission-checkAll main_module_id_{{ $student_parent_module->infix_module_id }}"
                                                {{ $check_sidebar != '' ? (in_array($student_parent_module->infix_module_id, $already_assigned) ? 'checked' : '') : 'checked' }}>
                                            <input type="hidden" value="{{ $student_parent_module->infix_module_id }}"
                                                name="all_modules_id[]">
                                            <label
                                        ...
                                        <div class="permission_body">
                                            <ul class="submenuSort">
                                                @foreach ($subModule as $key => $row2)
                                                    <li>
                                                        <div class="submodule">
                                                            <input type="hidden" value="{{ $row2->infix_module_id }}"
                                                                name="all_modules_id[]">
                                                            <input id="Sub_Module_{{ $row2->infix_module_id }}"
                                                                name="module_id[]" value="{{ $row2->infix_module_id }}"
                                                                class="infix_csk common-radio  module_id_{{ $student_parent_module->infix_module_id }} module_link"
                                                                type="checkbox"
                                                    ...
                                                    <li>
                                                        <div class="submodule">
                                                            ...
                                                            <input id="Sub_Module_{{ $row2->id }}"
                                                                ...
                                                                class="infix_csk common-radio  module_id_{{ $student_parent_module->id }} module_link"
                                                                type="checkbox"
