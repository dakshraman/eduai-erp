                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($sidebar))
                                {{ html()->form('POST', route('menumanage.update'))->attributes([
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="erp_role_permission_area ">
                                ...
                                @else
                                    {{ html()->form('POST', route('menumanage.store.sidebar'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                        ...
                                        @foreach ($all_modules as $key => $row)
                                            @php
                                                ...
                                                if (moduleStatusCheck('SaasRolePermission') == true) {
                                                    $module_info = Modules\RolePermission\Entities\InfixModuleInfo::where(
                                                        'module_id',
                                                        $key,
                                                    )->first();
                                                    $all_group_modules = Modules\RolePermission\Entities\InfixModuleInfo::where(
                                                        'module_id',
                                                        $key,
                                                    )
                                                        ->where('id', '!=', $key)
