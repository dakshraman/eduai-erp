...
@section('mainContent')
    @php
        $setting = App\Models\SmGeneralSettings::where('school_id', Auth::user()->school_id)->first();
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        {{ html()->form('POST', route('fees-bulk-print-search'))->attributes([
                        ...
                        <div class="row">
                            ...
                            @if (moduleStatusCheck('University'))
                                @includeIf(
                                    ...
                                    ['ac_mt' => 'mt-25', 'div' => 'col-lg-4', 'hide' => ['USUB']]
                                )
                            @else
                                ...
                                <div class="col-lg-6 mt-30-md" id="select_section_div">
                                    <select class="primary_select {{ $errors->has('section') ? ' is-invalid' : '' }}"
                                    ...
                                    @foreach ($fees_payments as $students)
                                        @foreach ($students as $fees_payment)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $fees_payment->studentInfo != '' ? $fees_payment->studentInfo->full_name : '' }}
                                                </td>
                                                <td>
