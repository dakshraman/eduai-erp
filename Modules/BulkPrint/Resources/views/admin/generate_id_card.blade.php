...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            {{ html()->form('POST', route('student-id-card-bulk-print-search'))->attributes([
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <label class="primary_input_label" for="">@lang('common.select_role') <span
                                        class="text-danger"> *</span></label>
                                <select class="primary_select form-control{{ $errors->has('role') ? ' is-invalid' : '' }}"
                                    name="role" id="role_id">
                            ...
                            <div class="col-lg-4 mt-30-md" id="id-card-div">
                                <label class="primary_input_label" for="">@lang('common.select_id_card') <span
                                        class="text-danger"> *</span></label>
                                <select
                                    class="primary_select  form-control{{ $errors->has('id_card') ? ' is-invalid' : '' }}"
                                    id="id_card_list" name="id_card">

                                    <option data-display=" @lang('common.select_id_card') *" value=""> @lang('common.select_id_card') *
                                    </option>
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('bulkprint::bulk.grid_gap') (px) <span
                                            class="text-danger"> *</span></label>
                                    <input
                                            ...
                                            <tr>
                                                <th width="10%">
                                                    <input type="checkbox" id="checkAll"
                                                        class="common-checkbox generate-id-card-print-all" name="checkAll"
                                                        value="">
