...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            {{ html()->form('POST', route('certificate-bulk-print-seacrh'))->attributes(['class' => 'form-horizontal'])->open() }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            @if (moduleStatusCheck('University'))
                                <input type="hidden" id="moduleStatus" value="University">
                                <div class="col-lg-12 mt-25 classSection">
                                    <div class="row">
                                        @includeIf(
                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="col-lg-1">
                                    ...
                                    <input type="hidden" value="{{ $gridGap }}" id="certificate_grid_gap">
                                    <input type="hidden"
                                        value="{{ route('bulk-s-certificate-print', ['__USER_IDS__', '__CERTIFICATE_ID__']) }}"
                                        id="bulk_certificate_print_url">
