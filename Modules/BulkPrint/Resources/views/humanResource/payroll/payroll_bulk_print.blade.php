                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3 mb-lg-0">
                                    <select
                                        ...
                                        <option data-display="@lang('common.role') "
                                                value="">@lang('common.select_role') </option>
                                ...
                                <div class="col-lg-4 mb-3 mb-lg-0">
                                    <select
                                        ...
                                        <option data-display="@lang('common.select_year') "
                                                value="">@lang('common.select_year')
                                        </option>
                                        @php
                                            $year = date('Y');
                                            $ini = date('y');
                                    ...
                                    <table id="table_id" class="table" cellspacing="0" width="100%">
                                        ...
                                        @foreach ($staffs as $value)
                                            <tr>
                                                ...
                                                <td>{{ $value->departments != '' ? $value->departments->name : '' }}
                                                </td>
                                                ...
                                                <td>
                                                    @php
                                                        $getPayrollDetails = App\Models\SmHrPayrollGenerate::getPayrollDetails(
                                                            $value->id,
                                                            $payroll_month,
                                                            $payroll_year,
                                                        );
