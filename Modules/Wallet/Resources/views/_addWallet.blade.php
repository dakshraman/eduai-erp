        ...
        <div class="d-flex mb-25 align-items-center flex-wrap justify-content-between" style="gap: 10px">
            @if (Auth::user()->role_id == 2 || Auth::user()->role_id == 3)
                <button class="primary-btn small fix-gr-bg">
                    ...
                    {{ currency_format(Auth::user()->wallet_balance ?? 0.0) }}
                </button>
                                                    ...
                                                    <div class="col-lg-12 text-center">
                                                        ...
                                                        @else
                                                            @if (file_exists($walletAmount->file))
                                                                <div class="mb-5">
                                                                    <img class="img-fluid"
                                                                        src="{{ assetPath($walletAmount->file) }}">
                                                                </div>
                                                                <br>
                                                                <div class="mb-5">
                                                                    <a href="{{ url(@$walletAmount->file) }}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ html()->form('POST', route('wallet.add-wallet-amount'))->attributes([
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="primary_input">
                                ...
                                <input class="primary_input_field form-control" type="number" step="{{inputStep()}}" name="amount"
                                    id="walletAmount">
                            ...
                            <select class="primary_select  form-control" name="payment_method"
                                ...
                                @foreach ($paymentMethods as $paymentMethod)
                                    <option value="{{ $paymentMethod->method }}">{{ $paymentMethod->method }}
                                        {{-- {{ (@$paymentMethod->gatewayDetail->charge_type, @$paymentMethod->gatewayDetail->charge) ? '+ ' . __('common.service_charge') . '(' . (@$paymentMethod->gatewayDetail->charge_type, @$paymentMethod->gatewayDetail->charge) . ')' : null }} --}}
                                        {{ 
                                            @$paymentMethod->gatewayDetail->charge_type && @$paymentMethod->gatewayDetail->charge
                                                ? '+ ' . __('common.service_charge') . ' (' . @$paymentMethod->gatewayDetail->charge_type . ', ' . @$paymentMethod->gatewayDetail->charge . ')'
                                                : null 
                                        }}
                        ...
                        <div class="col-lg-12">
                            <select
                                ...
                                @if ($bankAccounts->isEmpty())
                                    <option value="" disabled>@lang('reports.no_data_found')</option>
                                @endif
                            </select>
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input">
                                    ...
                                    @if ($errors->has('card_number'))
                                        <span class="text-danger"> {{ $erroFrs->first('card_number') }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade admin-query" id="refundRequest">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                {{ html()->form('POST', route('wallet.wallet-refund-request-store'))->attributes([
                        'class' => 'form-horizontal',
                        'files' => true,
                        'enctype' => 'multipart/form-data',
                        'id' => 'refundAmount',
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input">
                                ...
                                <input class="primary_input_field" type="number" step="{{inputStep()}}"
                                    value="{{ Auth::user()->wallet_balance != null ? decimal_only(Auth::user()->wallet_balance) : decimal_only(0.0) }}"
