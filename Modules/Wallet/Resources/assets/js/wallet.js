// Add Wallet Student Panel
    $(document).ready(function () {
        function toggleWalletPaymentFields(paymentValue) {
        ...
        $(document).on("change", "#addWalletPaymentMethod", function() {
            toggleWalletPaymentFields($(this).val());
        });

        toggleWalletPaymentFields($("#addWalletPaymentMethod").val());
    });
