...
<head>
    ...
    <style>
        ...
        .admit_card_wrapper_header.d-flex,
        .student_info{
            page-break-inside: avoid;
        }
    ...
    <div class="admit_card_wrapper">
        ...
        <div class="admit_card_wrapper_header d-flex">
            ...
            @if($setting->student_photo)
                ...
                @if($admitcard->studentRecord->studentDetail->gender->base_setup_name == 'Male')
                    <img class="student-meta-img img-80" style="width: 100px"
                         src="{{ file_exists(@$admitcard->studentRecord->studentDetail->student_photo) ? asset(@$admitcard->studentRecord->studentDetail->student_photo) : asset('Modules/ExamPlan/Public/images/profile.jpg') }}"
                         alt="">
                @else
                    <img class="student-meta-img img-80" style="width: 100px"
        ...
        <div class="admid_card_wrapper_body">
            <div class="student_info">
                <div class="single_student_information d-flex align-items-center">
                    ...
                    <p class="m-0">
                        <span class="sep_name">@lang('student.date')</span>
                        <span>:</span>
                        <span class="f_w_500 theme_text text-uppercase">{{@dateConvert($admitcard->created_at)}}</span>
                    </p>
                    ...
                    @if($setting->class_section || $setting->academic_year)
                        <p class="m-0">
                            ...
                            @if($setting->class_section)
                                ...
                                @if(shiftEnable()) {{isset($admitcard->studentRecord->shift) ? ' ['. $admitcard->studentRecord->shift->name.']' : ''}} @endif
                            @endif
                ...
                <div class="single_student_information d-flex align-items-center">
                    ...
                    <p class="m-0">
                        <span class="sep_name">@lang('student.roll')</span>
                        <span>:</span>
                        <span class="f_w_500 theme_text text-uppercase">{{@$admitcard->studentRecord->studentDetail->roll_no}}</span>
                    </p>
            ...
            <table class="table">
                ...
                @foreach($exam_routines as $exam_routine)
                    <tr>
                        ...
                        <td>{{ $exam_routine->subject ? $exam_routine->subject->subject_name : '' }}
