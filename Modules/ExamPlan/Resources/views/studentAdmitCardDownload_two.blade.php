...
<head>
    ...
    <!-- Main css -->
    <link rel="stylesheet" href="{{assetPath('modules/ExamPlan/Public/assets/css/style.min.css')}}">
        ...
        <div class="card-item border border-3 p-10">
                ...
                <tr>
                    <td class="flex flex-wrap gap-2 items-center">
                        <div class="logo w-110">
                            <img src="{{ assetPath(generalSetting()->logo)}}" class="w-full" alt="{{ assetPath(generalSetting()->school_name)}}">
                        </div>
                        <div class="content">
            ...
            <div class="user border p-10 flex">
                ...
                <div class="profile flex items-center justify-center border">
                    ...
                    <img src="{{assetPath(@$admit->studentRecord->studentDetail->student_photo ?? 'public/uploads/staff/demo/staff.jpg')}}" alt="{{assetPath(@$admit->studentRecord->studentDetail->full_name)}}">
                    @endif 
                </div>
            </div>
            <div class="h-10"></div>
