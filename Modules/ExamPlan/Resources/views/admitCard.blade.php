...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            {{ html()->form('POST', route('examplan.admitcard.search'))->attributes(['class' => 'form-horizontal', 'files' => true, 'enctype' => 'multipart/form-data'])->open() }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            @if (moduleStatusCheck('University'))
                                @includeIf(
                                    ...
                                    ['required' => ['USN', 'UD', 'UA', 'US', 'USL', 'USEC'], 'hide' => ['USUB']]
                                )
                ...
                <div class="row mt-40">
                    <div class="col-lg-12">
                        <div class="white-box">
                            ...
                            {{ html()->form('POST', route('examplan.admitcard.generate'))->attributes(['class' => 'form-horizontal', 'files' => true, 'target' => '_blank', 'enctype' => 'multipart/form-data'])->open() }}
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <table class="table school-table-style" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    @if(shiftEnable())
                                                    <th width="15%">@lang('common.shift')</th>
                                                    @endif
