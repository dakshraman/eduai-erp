...
class LessonPlanner extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\SmClass::class, 'class_id')->withDefault();
    }

    public function sectionName()
    {
        return $this->belongsTo(\App\Models\SmSection::class, 'section_id')->withDefault();
    }

    public function subject()
    {
        return $this->belongsTo(\App\Models\SmSubject::class, 'subject_id')->withDefault();
    }
    ...
    {
        return $this->belongsTo(\App\Models\SmStaff::class, 'teacher_id')->withDefault();
    }
