...
@endpush
@section('mainContent')
    <link rel="stylesheet" href="{{ assetPath('modules/lesson/css/lesson_plan.css') }}">
            ...
            <div class="row"> 
                <div class="col-lg-12">
                    ...
                    @if (Auth::user()->role_id == 1)
                        <div class="white-box">
                            {{ html()->form('POST', route('lesson-planner'))->attributes([
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-30-md">
                                    <select
                                        ...
                                        <option value="{{ $teacher_id }}" selected="">{{ @$teacher->full_name }}
                                        </option>
                ...
                <div class="row mt-20">
                    <div class="col-lg-12 col-md-12">
                        <div class="main-title">
                            ...
                            <h3 class="text-center "><a href="{{ url('/lesson/teacher/dicrease-week/' . $dates[0]) }}">
                                    << /a> week {{ $week_number }} <a
                                            href="{{ url('/lesson/teacher/change-week/' . $dates[6]) }}">></a></h3>
                                            ...
                                            @php
                                                if (!in_array($routine->id, $used)) {
                                                    $tr[$i][$sm_weekend->name][$loop->index][
                                                        'subject'
                                                    ] = $routine->subject ? $routine->subject->subject_name : '';
                                                    $tr[$i][$sm_weekend->name][$loop->index][
                                                        'subject_code'
                                                    ] = $routine->subject ? $routine->subject->subject_code : '';
                                                    $tr[$i][$sm_weekend->name][$loop->index][
                                                        'class_room'
