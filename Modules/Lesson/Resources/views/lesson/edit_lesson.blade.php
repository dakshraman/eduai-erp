    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            @if (isset($lesson))
                ...
                @endif
            @endif
            {{ html()->form('POST', route('lesson-update'))->attributes(['class' => 'form-horizontal', 'files' => true, 'enctype' => 'multipart/form-data'])->open() }}
            <div class="row">
                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => '',
                                                'branch_id' => isset($lesson) ? $lesson->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                        ...
                                        <div class="row mt-15" id="">
                                            <div class="col-lg-12" id="select_subject_div">
                                                ...
                                                <div class="pull-right loader" id="select_subject_loader"
                                                    ...
                                                    <img src="{{ assetPath('public/backEnd/image/pre-loader.gif') }}"
                                                        alt="" style="width: 28px;height:28px;">
                                                </div>
                                                @if ($errors->has('subject'))
                                                    <span class="text-danger invalid-select" role="alert">{{ $errors->first('subject') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ html()->form('POST', route('lesson-destroy'))->attribute('enctype', 'multipart/form-data')->open() }}
