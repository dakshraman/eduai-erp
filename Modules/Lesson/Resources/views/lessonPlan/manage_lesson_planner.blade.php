    ...
    <section>
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="white-box">
                    {{ html()->form('POST', route('search-lesson-plan'))->class('form-horizontal')->attributes(['enctype' => 'multipart/form-data', 'files' => true])->id('search_lesson_Plan')->open() }}
                    <div class="row">
                        ...
                        @if (moduleStatusCheck('University'))
                            @includeIf('university::common.session_faculty_depart_academic_semester_level', [
                                'ac_mt' => 'mt-25',
                                'required' => ['USN', 'UF', 'UD', 'UA', 'US', 'USL', 'USUB'],
                            ])
                        @else
                                ...
                                <table id="table_id" class="table" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        @foreach ($lessonPlanner as $data)
                                            <tr>
                                                @if(moduleStatusCheck('Branch'))
                                                <td>{{ @$data->branch != '' ? @$data->branch->branch_name : '' }}
                                                </td>
                                                @endif
