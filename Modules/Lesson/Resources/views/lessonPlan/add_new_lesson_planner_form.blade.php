...
<div class="container-fluid">
    {{ html()->form('POST', route('add-new-lesson-plan'))->attributes([
            'class' => 'form-horizontal',
            'files' => true,
            'enctype' => 'multipart/form-data',
            'name' => 'myForm',
            'onsubmit' => 'return validateLssonPlan()',
        ])->open() }}
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="white-box dloader" id=select_lesson_topic_loader>
                <div class="dloader_style mt-2 text-center">
                    <img class="dloader_img_style" src="{{ assetPath('public/backEnd/img/demo_wait.gif') }}"
                         alt="loader">
                </div>
            </div>
