                                                            ...
                                                            <tr>
                                                                ...
                                                                @foreach ($sm_weekends as $key => $sm_weekend)
                                                                    @php
                                                                        if(moduleStatusCheck('University'))
                                                                        {
                                                                            $parentRoutine = \App\Models\SmWeekend::studentClassRoutineFromRecordUniversity($record->un_academic_id, $record->un_semester_label_id, $sm_weekend->id);
                                                                        } else {

                                                                            $parentRoutine = \App\Models\SmWeekend::studentClassRoutineFromRecord($record->class_id, $record->section_id, $sm_weekend->id, $record->shift_id);
                                                                        }
                                                                    @endphp
                                                                                    ...
                                                                                    @else
                                                                                        ...
                                                                                        $lessonPlan    =  DB::table('lesson_planners')
                                                                                            ...
                                                                                            $lessonPlan = DB::table('lesson_planners')
                                                                                                            ...
                                                                                                            ->when(shiftEnable() && !empty($record->shift_id), function ($query) use ($record) {
                                                                                                                $query->where('shift_id', $record->shift_id);
                                                                                                            })
