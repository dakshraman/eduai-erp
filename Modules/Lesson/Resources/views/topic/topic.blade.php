        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xl-3">
                    @if (userPermission('lesson.topic.store'))
                        {{ html()->form('POST', route('lesson.topic.store'))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
                    @endif
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box">
                                    ...
                                    <div class="row mt-15">
                                        ...
                                        <div class="col-lg-12" id="select_section_div">
                                            ...
                                            <div class="pull-right loader" id="select_section_loader"
                                                ...
                                                <img src="{{ assetPath('modules/lesson/images/pre-loader.gif') }}"
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12" id="select_subject_div">
                                            ...
                                            <select
                                                ...
                                                <option data-display="@lang('lesson::lesson.select_subject') *"
                                                        value="">
                                                    @lang('lesson::lesson.select_subject')*
                                                </option>
                                            </select>

                                            <div class="pull-right loader" id="select_subject_loader"
                                                 style="margin-top: -30px;padding-right: 21px;">
                                                <img src="{{ assetPath('modules/lesson/images/images/pre-loader.gif') }}"
                                                     alt="" style="width: 28px;height:28px;">
                                            </div>
                                ...
                                <div class="row align-items-center mb-3">
                                    <div class="col-xl-9 col-lg-8 col-md-10 col-9">
                                        <div class="main-title my-0 md:mt-auto">
                                            <h5 class="mb-0">@lang('lesson::lesson.add_topic')  <small class="text-danger">*</small></h5>
                                        </div>
                                    </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="primary_input">
                                                <input
                                                        ...
                                                        id="topic" name="topic[]" autocomplete="off"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ html()->form('post', route('topic-delete'))->open() }}
