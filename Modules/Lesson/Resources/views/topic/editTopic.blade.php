...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            {{ html()->form('POST', route('lesson.topic.update'))->attributes([
                                ...
                                <div class="add-visitor">
                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => '',
                                                'branch_id' => isset($topic) ? $topic->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                    <div class="row" >
                                            ...
                                            <select
                                                ...
                                                @foreach ($subjects as $subject)
                                                    <option value="{{ @$subject->id }}"
                                                        {{ @$subject->id == @$topic->subject_id ? 'selected' : '' }}>
                                    ...
                                    <div class="row mt-25">
                                        ...
                                        <div class="col-lg-12" id="select_lesson_div">
                                            ...
                                            <select
                                                class="primary_select form-control{{ $errors->has('section') ? ' is-invalid' : '' }} select_lesson"
                                                id="select_lesson" name="lesson" disabled="">
                                                <option data-display="@lang('common.select_section') *" value="">
                                                    @lang('common.select_section') *</option>
                                                @foreach ($lessons as $lesson)
                                                    <option value="{{ @$lesson->id }}"
                                                        {{ @$lesson->id == @$topic->lesson_id ? 'selected' : '' }}>
                                            ...
                                            <tr id="row1">
                                                <td class="pt-2">
                                                    ...
                                                    <div class="primary_input">
                                                        ...
                                                        <input
                                                            ...
                                                            value="{{ isset($topicData) ? $topicData->topic_title : '' }}"
                                                            required="">
                                                    </div>
                                                </td>
                                                ...
                                                <td class="">
                                                    <a href="" data-toggle="modal"
                                                        data-target="#deleteTopicTitle{{ $topicData->id }}">
                                                        <button style="position: relative; top: 18px; left: 5px;"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            <a href="{{ route('topicTitle-delete', [$topicData->id]) }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ html()->form('POST', route('topic-delete'))->attribute('enctype', 'multipart/form-data')->open() }}
...
@endsection
@push('script')
    <script type="text/javascript" src="{{ assetPath('modules\lesson\js\app.js') }}"></script>
    <script src="{{ assetPath('public/backEnd/js/lesson_plan.js') }}"></script>
@endpush
