...
class Permission extends Model
{
    ...
    public static function boot()
    {
        ...
        self::created(function ($model) {
            self::clearPermissionCaches($model);
        });
    ...
    protected static function clearPermissionCaches($model): void
    {
        ...
        if (function_exists('clearPermissionMenuCache')) {
            clearPermissionMenuCache($model->school_id ?? null);
        }
    }
    ...
    public function childs()
    {
        ...
        return $this->hasMany(self::class, 'parent_route', 'route')
    ...
    {
        return $this->belongsTo(self::class, 'parent_route', 'route');
    }
