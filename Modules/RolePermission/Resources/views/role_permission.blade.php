...
@section('mainContent')
    ...
    <link rel="stylesheet" href="{{ assetPath('modules/rolepermission/css/custom.css') }}">
...
@php
    $paid_modules = ['Branch', 'CbseExam','Zoom','University','Gmeet','QRCodeAttendance','BBB','ParentRegistration','InAppLiveClass','AiContent','Lms','Certificate','Jitsi','WhatsappSupport','InfixBiometrics'];
@endphp
        <!-- single_permission  -->
        ...
        {{ Form::open([
            ...
            'method' => 'POST',
            'onsubmit' => 'return gatherPermissions(this)'
        ]) }}

        <input type="hidden" name="role_id" value="{{ @$role->id }}">
        <input type="hidden" name="permissions_string" id="permissions_string">
...
@section('script')
    <script type="text/javascript">
        ...
        function gatherPermissions(form) {
            ...
            $('#permissions_string').val(checked.join(','));
            return true;
        }
    </script>
{{-- <script>
