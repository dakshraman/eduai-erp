@php
    ...
    $onlineExam = ['parent_online_examination_result','parent_online_examination','parent_answer_script','question-group', 'question-bank', 'online-exam','student_online_exam','student_view_result'];
@endphp
                ...
                @foreach ($row2->subModule as $row3)
                    <li>
                        <div class="module_link_option_div" id="{{ $row2->id }}">
                            ...
                            <label
                                for="Option_{{ $row3->id }}">{{ __('rolepermission::permissions.' . $row3->name) }}  sfads df  </label>
                            <br>
                        </div>
                    </li>
                @endforeach
...
@else  
    ...
    @if(in_array($row2->route, $onlineExam))
                        ...
                        @if(moduleStatusCheck($row3->module))
                            <li>
                                <div class="module_link_option_div" id="{{ $row2->id }}">
                                    ...
                                    <label for="Option_{{ $row3->id }}">{{ __('rolepermission::permissions.' . $row3->name) }} {{ $row3->route }}  </label>
                                    <br>
                                </div>
                            </li>
                        @endif
