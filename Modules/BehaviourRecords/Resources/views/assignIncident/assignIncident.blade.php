...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            {{ html()->form('POST', route('behaviour_records.assign_incident_search'))->attributes([
                        ...
                        <div class="row">
                            ...
                            @if (moduleStatusCheck('Branch'))
                                @include('branch::components.branch_select', [
                                    'grid_class' => 'col-lg-4',
                                    'mb' => '',
                                    'branch_id' => @$data['branch_id'] ? @$data['branch_id'] : old('branch_id'),
                                ])
                            @endif
            ...
            @if (moduleStatusCheck('Branch'))
            <input type="hidden" id="main_branch_id" value="{{ @$branch_id }}">
            @endif
