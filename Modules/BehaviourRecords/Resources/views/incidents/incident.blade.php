    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            <div class="row mt-40">
                <div class="col-lg-12">
                    <div class="white-box">
                        @if(userPermission('behaviour_records.incident_create'))
                                    ...
                                    <table id="table_id" class="table data-table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            @foreach ($incidents as $data)
                                                <tr>
                                                    @if (moduleStatusCheck('Branch'))
                                                    <td class="col-lg-2">{{ $data->branch?->branch_name }}</td>
                                                    @endif
                                                    <td class="col-lg-2">{{ $data->title }}</td>
                                                    <td class="col-lg-2">{{ $data->point }}</td>
                                                    <td class="col-lg-6">{{ $data->description }}</td>
                                                    <td class="col-lg-2">
                                                        @if(userPermission('behaviour_records.incident_update') || userPermission('behaviour_records.incident_delete'))
                                                            <x-drop-down>
                                                                @if(userPermission('behaviour_records.incident_update'))
                                                                ...
                                                                @endif 
                                                                @if(userPermission('behaviour_records.incident_delete'))
                                                                    <a class="dropdown-item" data-toggle="modal"
                                                ...
                                                <div class="modal fade admin-query" id="editIncident{{ @$data->id }}">
                                                    <div class="modal-dialog modal-dialog-centered large-modal">
                                                        <div class="modal-content">
                                                            ...
                                                            {{ html()->form('POST', route('behaviour_records.incident_update'))->attributes([
                                                                        ...
                                                                        @if (moduleStatusCheck('Branch'))
                                                                            <div class="row">
                                                                                @include('branch::components.branch_select', [
                                                                                    ...
                                                                                    'mb' => 'mb-4',
                                                                                    'branch_id' => isset($data) ? $data->branch_id : old('branch_id'),
                                                                                ])
                                                                            </div>
                                                                        @endif
                                                                        <div class="row">
    ...
    <div class="modal fade admin-query" id="addIncident">
        <div class="modal-dialog modal-dialog-centered large-modal">
            <div class="modal-content">
                ...
                {{ html()->form('POST', route('behaviour_records.incident_create'))->attributes([
                        'class' => 'form-horizontal',
                        'enctype' => 'multipart/form-data',
                        'files' => true,
                    ])->open() }}
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('behaviourRecords.point')<span
                                                        class="text-danger"> *</span></label>
                                                <input class="primary_input_field read-only-input form-control"
                                                    type="number" min="0" name="point" step="{{inputStep()}}"
                                                    id="point element_point" value="{{old('point')}}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="primary_input sm_mb_20 mt-30"
                                                ...
                                                <input type="checkbox" name="negativePoint" id="negativePoint"
                                                    class="common-checkbox permission-checkAll" value="1" {{ old('negativePoint') ? 'checked' : '' }}>
