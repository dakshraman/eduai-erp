...
class CreateBehaviourRecordSettingsTable extends Migration
{
    ...
    {
        Schema::create('behaviour_record_settings', function (Blueprint $blueprint): void {
            $blueprint->id();
            $blueprint->integer('student_comment')->nullable();
            $blueprint->integer('parent_comment')->nullable();
            $blueprint->integer('student_view')->nullable();
            $blueprint->integer('parent_view')->nullable();
                                                ...
                                                <div class="txtTinyMce-wrapper"
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size:14px;color:rgb(255,255,255);font-family:Arial;">
                                                            © 2026 Infix Education software|&nbsp;
                                                        </span>
                                                        <span style="background-color:transparent;text-align:left;">
                                                            <font color="#ffffff">
                                                                Copyright © 2026 All rights reserved | This application is made
                                                                by Codethemes
                                                            </font>
                                                        </span>
                                                        <br>
