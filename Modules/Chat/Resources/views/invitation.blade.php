                                            ...
                                            <div class="single_list d-flex align-items-center">
                                                <div class="thumb">
                                                    @if($myRequest->requestTo->avatar)
                                                        <a><img src="{{assetPath($myRequest->requestTo->avatar)}}" alt=""></a>
                                                    @elseif($myRequest->requestTo->avatar_url)
                                                        <a><img src="{{ assetPath($myRequest->requestTo->avatar_url) }}" alt=""></a>
                                                    @else
                                                        <a><img src="{{assetPath('public/chat/images/spondon-icon.png')}}" alt=""></a>
                                                    @endif
                                                </div>
                                                <div class="list_name">
                                                    <a>
                                            ...
                                            <div class="single_list d-flex align-items-center">
                                                <div class="thumb">
                                                    @if($request->requestFrom->avatar)
                                                        <a><img src="{{assetPath($request->requestFrom->avatar)}}" alt=""></a>
                                                    @elseif($request->requestFrom->avatar_url)
                                                        <a><img src="{{ assetPath($request->requestFrom->avatar_url) }}" alt=""></a>
                                                    @else
                                                        <a><img src="{{assetPath('public/chat/images/spondon-icon.png')}}" alt=""></a>
                                                    @endif
                                                </div>
                                    ...
                                    @forelse($connectedPeoples as $request)
                                        <li class="list-unstyled">
                                            <div class="single_list d-flex align-items-center">
                                                <div class="thumb">
                                                    @if($request->avatar)
                                                        <a><img src="{{assetPath($request->avatar)}}" alt=""></a>
                                                    @elseif($request->avatar_url)
                                                        <a><img src="{{ assetPath($request->avatar_url) }}" alt=""></a>
                                                    @else
                                                        <a><img src="{{assetPath('public/chat/images/spondon-icon.png')}}" alt=""></a>
                                                    @endif
                                                </div>
