                                ...
                                @forelse($messages as $message)
                                    <div class="single-entry">
                                        @if($message->message_type == 1)
                                            <img style="max-height: 120px;width: 100%;" class="img-fluid" src="{{ assetPath($message->file_name) }}" alt="">
                                        ...
                                        @else
                                            <div>
                                                <audio class="w-100" src="{{ assetPath($message->file_name) }}" controls></audio>
                                            </div>
                                        @endif
                                    </div>
                                @empty
