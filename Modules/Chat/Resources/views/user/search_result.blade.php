                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <div class="single_list d-flex align-items-center">
                                                <div class="thumb">
                                                    @if($user->avatar)
                                                        <img src="{{assetPath($user->avatar)}}" alt="">
                                                    @elseif($user->avatar_url)
                                                        <img src="{{assetPath($user->avatar_url)}}" alt="">
                                                    @else
                                                        <img src="{{assetPath('public/chat/images/spondon-icon.png')}}" alt="">
                                                    @endif
                                                </div>
                                                <div class="list_name">
                                                        ...
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">
                                                                <div class="thumb" style="display: inline">
                                                                    <a href="#"><img src="{{ assetPath($user->avatar) }}" height="50" width="50" alt=""></a>
                                                                </div>
