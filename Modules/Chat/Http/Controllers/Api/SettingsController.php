...
class SettingsController extends Controller
{
    ...
    public function chatPermission()
    {
        ...
        return response()->json(['permission_settings' => $permission_settings, 'invitation_settings' => $invitation_settings, 'chat_settings' => $chat_settings]);
    }
    ...
    public function generate($type)
    {
        try {
            ...
            foreach ($subject_teachers as $subject_teacher) {
                $assign_class_teacher_collection = SmAssignClassTeacher::find($subject_teacher->assign_class_teacher_id);
                event(new ClassTeacherGetAllStudent($assign_class_teacher_collection, $subject_teacher));
            }
