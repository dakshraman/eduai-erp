...
if (! function_exists('userStatusChange')) {
    function userStatusChange($userId, $status): void
    {
...
if (! function_exists('createGroupPermission')) {
    function createGroupPermission()
    {
        ...
        if ($role_id === 2) {
            return app('general_settings')->get('chat_can_make_group') === 'yes';
        }

        return app('general_settings')->get('chat_teacher_staff_can_make_group') === 'yes';

    }
}

if (! function_exists('createGroupUser')) {
    function createGroupUser($group, $user_id, $role = 1, $invited_by = null): void
    {
...
if (! function_exists('removeGroupUser')) {
    function removeGroupUser($group, $user_id): void
    {
