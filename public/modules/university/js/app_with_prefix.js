...
$(document).ready(function() {
    // get department data
    $("#select_faculty"+prefix).on("change", function() {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                $('#select_dept_loader'+prefix).addClass('pre_loader').removeClass('loader');
            ...
            success: function(data) {
                ...
                $.each(data, function(i, item) {
                    if (item.length) {
                        $("#select_dept"+prefix).find("option").not(":first").remove();
                        $("#select_dept_div"+prefix+" ul").find("li").not(":first").remove();

                        $.each(item, function(i, dept) {
                            $("#select_dept"+prefix).append(
                                $("<option>", {
                                    value: dept.id,
                                    text: dept.name,
                                })
                            ...
                            $("#select_dept_div"+prefix+" ul").append(
                                "<li data-value='" +
                                dept.id +
                                "' class='option'>" +
                                dept.name +
                        ...
                        $("#select_dept_div"+prefix+" .current").html("SELECT Department ");
                        $("#select_dept"+prefix).find("option").not(":first").remove();
                        $("#select_dept_div"+prefix+" ul").find("li").not(":first").remove();
                    }
                });
            ...
            complete: function() {
                i--;
                if (i <= 0) {
                    $('#select_dept_loader'+prefix).removeClass('pre_loader').addClass('loader');
                }
            }
        });
    });
    ...
    $("#select_dept"+prefix).on("change", function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(i, item) {
                    if (item.length) {
                        $("#select_semester_label_subject"+prefix).find("option").not(":first").remove();
                        $("#select_semester_label_subject_div"+prefix+" ul").find("li").not(":first").remove();

                        $.each(item, function(i, subject) {
                            $("#select_semester_label_subject"+prefix).append(
                                $("<option>", {
                                    value: subject.id,
                            ...
                            $("#select_semester_label_subject_div"+prefix+" ul").append(
                                "<li data-value='" +
                                subject.id +
                                "' class='option'>" +
                        ...
                        $("#select_semester_label_subject_div"+prefix+" .current").html("SELECT SEMESTER LEVEL *");
                        $("#select_semester_label_subject"+prefix).find("option").not(":first").remove();
                        $("#select_semester_label_subject_div"+prefix+" ul").find("li").not(":first").remove();
                    }
                });
            ...
            complete: function() {
                i--;
                if (i <= 0) {
                    $('#select_semester_label_subject_loader'+prefix).removeClass('pre_loader').addClass('loader');
                }
            }
        });
...
// get semester level 
$(document).ready(function() {
    $("#select_semester"+prefix).on("change", function() {
        
        var url = $("#url").val();
        var i = 0;
        let semester_id = $(this).val();
        let academic_id = $('#select_academic'+prefix).val();  
        let session_id = $('#select_session'+prefix).val();
        let faculty_id = $('#select_faculty'+prefix).val();
        let department_id = $('#select_dept'+prefix).val();
        let subject_id = $('#select_semester_label_subject'+prefix).val();
        ...
        if (session_id =='') {
            ...
            $("#select_semester"+prefix).val('').niceSelect('update');          
            return ;
        }
        if (department_id =='') {
            setTimeout(function() {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                $('#select_semester_label_loader'+prefix).addClass('pre_loader').removeClass('loader');
            ...
            success: function(data) {
                ...
                $.each(data, function(i, item) {
                    if (item.length) {
                        $("#select_semester_label"+prefix).find("option").not(":first").remove();
                        $("#select_semester_label_div"+prefix+" ul").find("li").not(":first").remove();

                        $.each(item, function(i, dept) {
                            $("#select_semester_label"+prefix).append(
                                $("<option>", {
                                    value: dept.id,
                                    text: dept.name,
                                })
                            ...
                            $("#select_semester_label_div"+prefix+" ul").append(
                                "<li data-value='" +
                                dept.id +
                                "' class='option'>" +
                                dept.name +
                        ...
                        $("#select_semester_label_div"+prefix+" .current").html("SELECT SEMESTER LEVEL *");
                        $("#select_semester_label"+prefix).find("option").not(":first").remove();
                        $("#select_semester_label_div"+prefix+" ul").find("li").not(":first").remove();
                    }
                });
            ...
            complete: function() {
                i--;
                if (i <= 0) {
                    $('#select_semester_label_loader'+prefix).removeClass('pre_loader').addClass('loader');
                }
            }
        });
    });
...
//get semester label subject
$(document).ready(function() {
    $("#select_semester_label"+prefix).on("change", function() {

        var url = $("#url").val();
        var i = 0;
        let un_semester_id = $(this).val();
        let un_academic_id = $('#select_academic'+prefix).val();  
        let un_session_id = $('#select_session'+prefix).val();
        let un_faculty_id = $('#select_faculty'+prefix).val();
        let un_department_id = $('#select_dept'+prefix).val();
        let un_semester_label_id = $('#select_semester_label'+prefix).val();
        ...
        if (un_department_id =='') {
            ...
            $("#select_semester"+prefix+" option:selected").prop("selected", false)
        ...
        $.ajax({
            ...
            beforeSend: function() {
                $('#unSubjectLoader'+prefix).addClass('pre_loader').removeClass('loader');
            },
            
            success: function(data) {
                $.each(data, function(i, item) {
                    $("#universityExamSubejct"+prefix).empty();
                    var appendRow = "";
                    ...
                    $("#universityExamSubejct"+prefix).append(appendRow);
                });
            },
            complete: function() {
                i--;
                if (i <= 0) {
                    $('#unSubjectLoader'+prefix).removeClass('pre_loader').addClass('loader');
                }
            }
        });
        //get section 
        $.ajax({
            ...
            beforeSend: function() {
                $('#select_section_loader'+prefix).addClass('pre_loader').removeClass('loader');
            },
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i, item) {
                        if (is_multiple ==1) {
                            if (item.length) {
                                $("#selectSectionss"+prefix).find("option").remove();
                                $("#selectSectionsDiv"+prefix+" ul").find("li").not(":first").remove();
                                $.each(item, function (i, section) {
                                    $("#selectSectionss"+prefix).append(
                                        $("<option>", {
                                            value: section.id,
                                ...
                                $("#selectSectionsDiv"+prefix+" .current").html("SELECT SECTION *");
                                $("#selectSectionss"+prefix).find("option").not(":first").remove();
                                $("#selectSectionsDiv"+prefix+" ul").find("li").not(":first").remove();
                            }
                        } else {
                            if (item.length) {
                                $("#select_section"+prefix).find("option").not(":first").remove();
                                $("#select_section_div"+prefix+" ul").find("li").not(":first").remove();

                                $.each(item, function(i, section) {
                                    $("#select_section"+prefix).append(
                                        $("<option>", {
                                            value: section.id,
                                            text: section.section_name,
                                        })
                                    ...
                                    $("#select_section_div"+prefix+" ul").append(
                                        "<li data-value='" +
                                        section.id +
                                        "' class='option'>" +
                                ...
                                $("#select_section_div"+prefix+" .current").html("SELECT SECTION *");
                                $("#select_section"+prefix).find("option").not(":first").remove();
                                $("#select_section_div"+prefix+" ul").find("li").not(":first").remove();
                            }
                         }
                         try {
                            $('#selectSectionss'+prefix).multiselect('reset');
                         } catch (error) {
                            
                         }
                         console.log($('#selectSectionss'+prefix).val());
                    });
                },
            ...
            complete: function() {
                i--;
                if (i <= 0) {
                    $('#select_section_loader'+prefix).removeClass('pre_loader').addClass('loader');
                }
            }
        });
...
$(document).ready(function() {
    $("#select_semester_label"+prefix).on("change", function() {
        ...
        let faculty_id = $('#select_faculty'+prefix).val();
        let department_id = $('#select_dept'+prefix).val();
        let semester_label_id = $('#select_semester_label'+prefix).val();
        ...
        $.ajax({
            ...
            beforeSend: function() {
                $('#select_exam_type_loader'+prefix).addClass('pre_loader').removeClass('loader');
            },
            success: function(data) {
                var a = "";
                $.each(data, function(i, item) {
                    if (item.length) {
                        $("#select_exam_typ_subject"+prefix).find("option").not(":first").remove();
                        $("#select_exam_typ_subject_div"+prefix+" ul").find("li").not(":first").remove();

                        $.each(item, function(i, examTitle) {
                            $("#select_exam_typ_subject"+prefix).append(
                                $("<option>", {
                            ...
                            $("#select_exam_typ_subject_div"+prefix+" ul").append(
                                "<li data-value='" +
                        ...
                        $("#select_exam_typ_subject_div"+prefix+" .current").html("SELECT EXAM *");
                        $("#select_exam_typ_subject"+prefix).find("option").not(":first").remove();
                        $("#select_exam_typ_subject_div"+prefix+" ul").find("li").not(":first").remove();
                    }
                });
            ...
            complete: function() {
                i--;
                if (i <= 0) {
                    $('#select_exam_type_loader'+prefix).removeClass('pre_loader').addClass('loader');
                }
            }
        });
    }
