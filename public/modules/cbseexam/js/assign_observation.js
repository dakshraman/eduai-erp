    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".edit", function (event) {
            ...
            $.ajax({
                ...
                if (response.status == 1) {
                    ...
                    $("#edit_assign_observation").modal("show");
                    $("#observation_id_edit").niceSelect();
                    $("#term_id_edit").niceSelect();
                } else {
        ...
        $(document).on('click','.assign-marks',function(){
            ...
            $.ajax({
                ...
                if (response.status == 1) {
                    $("#append").html(response.view);
                    $("#assing_marks").modal('show');
                    $("#class_id").niceSelect();
                    $("#add_section_id").niceSelect();
                }else {
                    toastr.error(response.msg);
                }
            });
        ...
        $(document).on('change', '#class_id', function () {
            ...
            $.ajax({
                ...
                if (response.status == 'success') {
                    ...
                    $('#add_section_id').niceSelect();
                    $('#add_section_id').niceSelect('update');
                }
            });
        });
