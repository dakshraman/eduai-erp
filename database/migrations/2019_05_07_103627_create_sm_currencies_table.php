...
class CreateSmCurrenciesTable extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('sm_currencies', function (Blueprint $blueprint): void {
            ...
            $blueprint->string('currency_type', 2)->nullable()->default(2)->comments('C=code, S= symbol');
            $blueprint->string('currency_position', 2)->nullable()->default(2)->comments('S=suffix, P= prefix');
            $blueprint->boolean('space')->nullable()->default(true);
            $blueprint->integer('decimal_digit')->nullable();
            $blueprint->string('decimal_separator', 1)->nullable();
            $blueprint->string('thousand_separator')->nullable();
