...
class CreateSmsTemplatesTable extends Migration
{
    ...
    {
        Schema::create('sms_templates', function (Blueprint $blueprint): void {
            $blueprint->id();
            $blueprint->string('type')->comment('email, sms');
            $blueprint->text('purpose')->nullable();
            $blueprint->text('subject');
            $blueprint->longText('body');
            $blueprint->string('module')->nullable();
            $blueprint->text('variable')->nullable();
            $blueprint->integer('status')->default(1)->comment('Enable & Disable');
