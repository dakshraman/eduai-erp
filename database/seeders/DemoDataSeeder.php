...
class DemoDataSeeder extends Seeder
{
    public function run($count = 5): void
    {
        ...
        $notices = [
            [
                'notice_title' => 'Midterm Exams 2026: Important Announcement',
                'notice_message' => 'Dear Students, this is to inform you that the test exams for the 2026 academic year are scheduled to begin on Dec 10, 2024, and will end on March 20, 2024. The detailed timetable for the exams will be provided shortly. We advise all students to prepare thoroughly and approach their studies with focus and dedication. Please ensure to bring all necessary materials on exam days and follow the school’s examination guidelines. Let’s aim for excellent results in the upcoming exams!',
