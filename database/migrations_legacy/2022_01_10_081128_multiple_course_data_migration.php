...
class MultipleCourseDataMigration extends Migration
{
    ...
    {
        // Promoted data
        $promotes = App\Models\SmStudentPromotion::all();
        foreach ($promotes as $promote) {
            $class = App\Models\SmClass::withOutGlobalScope(StatusAcademicSchoolScope::class)->where(['id' => $promote->class_id, 'school_id' => $promote->school_id])->first();
        ...
        $students = App\Models\SmStudent::all();
