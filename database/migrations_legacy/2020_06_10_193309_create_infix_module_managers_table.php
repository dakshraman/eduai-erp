...
class CreateInfixModuleManagersTable extends Migration
{
    ...
    {
        Schema::create('infix_module_managers', function (Blueprint $blueprint): void {
            $blueprint->bigIncrements('id');
            $blueprint->string('name', 200)->nullable();
            $blueprint->string('email', 200)->nullable();
            $blueprint->string('notes', 255)->nullable();
            $blueprint->string('version', 200)->nullable();
            $blueprint->string('update_url', 200)->nullable();
            $blueprint->string('purchase_code', 200)->nullable();
            $blueprint->string('checksum', 200)->nullable();
            $blueprint->string('installed_domain', 200)->nullable();
            $blueprint->boolean('is_default')->default(0);
            $blueprint->string('addon_url')->nullable();
            $blueprint->date('activated_date')->nullable();
