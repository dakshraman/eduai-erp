...
Route::group(['middleware' => ['XSS', 'subdomain']], function () {
    ...
    Route::group(['middleware' => ['StudentMiddleware']], function () {
        ...
        Route::get('student-dashboard', 'Student\SmStudentPanelController@studentDashboard')->name('student-dashboardstudent-dashboard')->middleware('userRolePermission:student-dashboard');
