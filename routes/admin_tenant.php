...
Route::group(['middleware' => ['XSS', 'subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::get('role-delete', ['uses' => 'Admin\RolePermission\RoleController@delete']);
        ...
        Route::get('subject-wise-attendance-import', 'Admin\StudentInfo\SmSubjectAttendanceController@subjectWiseAttendanceImport')->name('subject-wise-attendance-import');
        Route::post('subject-wise-attendance-bulk-store', 'Admin\StudentInfo\SmSubjectAttendanceController@subjectWiseAttendanceBulkStore')->name('subject-wise-attendance-bulk-store');
        ...
        Route::get('subject-attendance/print/{class_id}/{section_id}/{month}/{year}/{shift_id?}/{branch_id??}', 'Admin\StudentInfo\SmSubjectAttendanceController@subjectAttendanceReportPrint')->name('subject-attendance/print')->middleware('userRolePermission:subject-attendance/print');
        ...
        Route::get('student-attendance/print/{class_id}/{section_id}/{month}/{year}/{shift?}/{branch_id?}', 'Admin\StudentInfo\SmStudentAttendanceReportController@print')->name('student-attendance-print');

        // for university module
        Route::get('un-student-attendance/print/{semester_id}/{month}/{year}/{branch_id?}', 'Admin\StudentInfo\SmStudentAttendanceReportController@unPrint')->name('un-student-attendance-print');
        ...
        Route::post('add-income-store', ['as' => 'add_income_store', 'uses' => 'Admin\Accounts\SmAddIncomeController@store'])->middleware('userRolePermission:add_income');
        ...
        Route::post('student-transport-report-filter', ['as' => 'student_transport_report_store', 'uses' => 'Admin\Transport\SmTransportController@studentTransportReportSearch']);
        ...
        Route::get('exam-routine-view/{class_id}/{section_id}/{exam_period_id}/{shift_id?}/{branch_id?}', 'Admin\Examination\SmExamRoutineController@examRoutineView');
        Route::get('exam-routine-print/{class_id}/{section_id}/{exam_period_id}/{shift_id?}/{branch_id?}', 'Admin\Examination\SmExamRoutineController@examRoutinePrint')->name('exam-routine-print');
        ...
        Route::post('add-expense', 'Admin\Accounts\SmAddExpenseController@store')->name('add-expense-store')->middleware('userRolePermission:add-expense');
        ...
        // Ajax get branch-wise data
        Route::get('/branch-get-shifts', 'BranchDataController@getBranchShifts');
        Route::get('/branch-get-classes', 'BranchDataController@getBranchClasses');
        ...
        Route::post('student-view-toggle', ['as' => 'student_view_toggle', 'uses' => 'Admin\StudentInfo\SmStudentAdmissionController@toggleView']);
        Route::get('student-grid-search', ['as' => 'studentGrid', 'uses' => 'Admin\StudentInfo\SmStudentAdmissionController@studentGrid']);
        // parent list
        ...
        Route::get('student-list-search-data', 'DatatableQueryController@studentDetailsData')->name('student-list-search-data');
        ...
        Route::post('staff-view-toggle', ['as' => 'staff_view_toggle', 'uses' => 'Admin\Hr\SmStaffController@toggleView']);
        Route::get('staff-grid-search', ['as' => 'staffGrid', 'uses' => 'Admin\Hr\SmStaffController@staffGrid']);

        Route::get('search-staff', ['as' => 'searchStaff', 'uses' => 'Admin\Hr\SmStaffController@searchStaff']);
        Route::post('search-staff', ['uses' => 'Admin\Hr\SmStaffController@searchStaff']);
        ...
        Route::get('staff-attendance/print/{role_id}/{month}/{year}/{branch_id?}', 'Admin\Hr\SmStaffAttendanceController@staffAttendancePrint')->name('staff-attendance/print');
        ...
        Route::get('delete-book/{id}', 'Admin\Library\SmBookController@deleteBook')->name('delete-book')->middleware('userRolePermission:delete-book-view');
        ...
        Route::post('update-twilio-data', 'Admin\SystemSettings\SmSystemSettingController@updateTwilioData')->name('update-twilio-data');
        ...
        Route::post('exam_step_skip', 'Admin\Examination\CustomResultSettingController@stepSkipUpdate')->name('exam.step.skip.update');
    ...
    Route::post('/news_store', 'Admin\FrontSettings\SmNewsController@store')->name('store_news')->middleware('userRolePermission:store_news');
    ...
    // for front-result
    Route::get('/front_result', 'Admin\FrontSettings\SmFrontResultController@index')->name('front-result')->middleware('userRolePermission:front-result');
