...
if (moduleStatusCheck('Lms')) {
    Route::get('online-course', 'OnlineCourseController@onlineCourse');
    Route::get('online-course-details/{slug}', 'OnlineCourseController@onlineCourseDetails')->name('frontend.online-course-details');
    Route::get('watch-course/{id}', 'OnlineCourseController@onlineCourseWatch')->name('frontend.watch-course');
    Route::get('watch-course-lesson/{id}/{lesson_id}', 'OnlineCourseController@onlineCourseLessonWatch')->name('frontend.watch-course-lesson');
}
...
Route::group(['middleware' => []], function () {
    ...
    Route::group(['middleware' => ['XSS']], function () {
        ...
        Route::get('class-routine/print/{class_id}/{section_id}/{shift_id?}/{branch_id?}', 'Admin\Academics\SmClassRoutineNewController@classRoutinePrint')->name('classRoutinePrint');
    });
