...
@push(config('optionbuilder.style_var'))
    @if( config('optionbuilder.add_bootstrap') === 'yes' )
        <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/bootstrap.min.css') }}">
    @endif
    @if( config('optionbuilder.add_select2') === 'yes' )  
        <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/select2.min.css') }}">
    @endif
    <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/jquery.mCustomScrollbar.min.css') }}">
    <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/feather-icons.css') }}">
    <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/jquery-confirm.min.css')}}">
    <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/flatpickr.min.css')}}">
    <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/jquery.colorpicker.bygiro.css')}}">
    <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/summernote-lite.min.css')}}">
    <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/nouislider.min.css')}}">
    <link rel="stylesheet" href="{{ assetPath('public/vendor/optionbuilder/css/main.css') }}">
@endpush
@push(config('optionbuilder.script_var'))
    
    @if( config('optionbuilder.add_jquery') === 'yes' )
        <script src="{{ assetPath('public/vendor/optionbuilder/js/jquery.min.js') }}"></script>
    @endif

    @if( config('optionbuilder.add_bootstrap') === 'yes' )
        <script defer src="{{ assetPath('public/vendor/optionbuilder/js/bootstrap.min.js') }}"></script>
    @endif

    @if( config('optionbuilder.add_select2') === 'yes' )
        <script defer src="{{ assetPath('public/vendor/optionbuilder/js/select2.min.js') }}"></script>
    @endif
    <script defer src="{{ assetPath('public/vendor/optionbuilder/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
    <script defer src="{{ assetPath('public/vendor/optionbuilder/js/jquery-confirm.min.js')}}"></script>
    <script defer src="{{ assetPath('public/vendor/optionbuilder/js/popper-core.js') }}"></script>
    <script defer src="{{ assetPath('public/vendor/optionbuilder/js/tippy.js') }}"></script>
    <script defer src="{{ assetPath('public/vendor/optionbuilder/js/flatpickr.js') }}"></script>
    <script defer src="{{ assetPath('public/vendor/optionbuilder/js/jquery.colorpicker.bygiro.js') }}"></script>
    <script defer src="{{ assetPath('public/vendor/optionbuilder/js/summernote-lite.min.js') }}"></script>
    <script defer src="{{ assetPath('public/vendor/optionbuilder/js/nouislider.min.js') }}"></script>
    <script defer src="{{ assetPath('public/vendor/optionbuilder/js/optionbuilder.js') }}"></script>
