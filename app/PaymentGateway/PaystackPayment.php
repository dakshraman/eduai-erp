    ...
    public function successCallBack()
    {
        ...
        try {
            ...
            if (Session::get('payment_type') === 'Wallet') {
                ...
                $walletTransaction->amount = session('amount') - session('service_charge', 0);
                $walletTransaction->payment_method = 'Paystack';
                $walletTransaction->user_id = $user->id;
                $walletTransaction->type = $walletType;
            ...
            if (Session::get('payment_type') === 'Fees') {
                ...
                $feesExtendedController->addFeesAmount(Session::get('transcation_id'), null);
            ...
            } elseif (Session::get('payment_type') === 'Saas') {
