...
trait Filepond
{
    ...
    {
        if (trim($serverId)== '' || trim($serverId) === '0') {
    ...
    public function getPublicPathWithFileNameFromServerId($serverId, $driver = 'local'): ?array
    {
        ...
        try {
            ...
            if (isset($file[2])) {
                ...
                $link = $finalLocation.'/'.$file_name;
                $new_file = $finalLocation.'/'.$file_name;
