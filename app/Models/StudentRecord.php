...
class StudentRecord extends Model
{
    ...
    public function section()
    {
        if (moduleStatusCheck('University')) {
            return $this->belongsTo(SmSection::class, 'un_section_id', 'id')->withDefault()->withoutGlobalScope(StatusAcademicSchoolScope::class);
        }

        return $this->belongsTo(SmSection::class, 'section_id', 'id')->withDefault()->withoutGlobalScope(StatusAcademicSchoolScope::class);
    ...
    {
        return $this->hasOne(SmStudent::class, 'id', 'student_id')->withoutGlobalScopes();
    }

    public function saasstudent()
    {
        return $this->hasOne(SmStudent::class, 'id', 'student_id')->withOutGlobalScope(SchoolScope::class);
    }
    ...
    {
        return $this->belongsTo(SmStudent::class, 'student_id', 'id')->withDefault();
    }
    ...
    public function getOnlineExamAttribute()
    {
        ...
        if (moduleStatusCheck('OnlineExam') === true) {
            ...
            return InfixOnlineExam::with('studentSubmitExamWithStatus')
                ->where('active_status', 1)
                ->where('academic_id', getAcademicId())
                ->where('status', 1)
    ...
    {
        return $this->belongsTo(SmMarkStore::class, 'student_record_id', 'id')->withDefault();
    }
