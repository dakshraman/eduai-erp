...
class SmGeneralSettings extends Model
{
    ...
    {
        static::updating(function (SmGeneralSettings $settings) {
            Cache::forget('general_settings_'.$settings->school_id);
        });
    }
    ...
    // OPTIMIZED: Removed eager-loading of currencyDetail from $with.
    // Use ->load('currencyDetail') explicitly only where currency data is required.
    ...
    {
        return $this->belongsTo(\Modules\University\Entities\UnAcademicYear::class, 'un_academic_id', 'id');
    }
