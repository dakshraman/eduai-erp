...
/**
 * SendEmailJob — Sends emails via SMTP using Laravel's Mailer contract.
 * Uses the `backEnd.emails.mail` view template.
 * Dispatched from: Helper.php (sendSystemMail / API email notifications)
 *
 * Note: EmailJob is a separate job using backEnd.email.emailBody template.
