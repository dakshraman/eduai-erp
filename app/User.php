...
class User extends Authenticatable implements OAuthenticatable
{
    ...
    {
        return $this->hasMany(\Modules\Lms\Entities\Course::class, 'instructor_id', 'id');
    }

    public function enrolledCourses()
    {
        return $this->hasMany(\Modules\Lms\Entities\CoursePurchaseLog::class, 'student_id', 'id')->where('active_status', '=', 'approve');
    }
    ...
    {
        return $this->hasMany(\Modules\Lms\Entities\CoursePurchaseLog::class, 'instructor_id', 'id')->where('active_status', '=', 1);
    }
    ...
    protected static function booted(): void
    {
        ...
        static::updating(function (User $user) {
            if ($user->role_id === 1) {
                Cache::forget('school_lang_'.$user->school_id);
            }
        });
