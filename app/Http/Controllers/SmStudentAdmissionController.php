...
use App\Models\StudentBulkTemporary;
...
class SmStudentAdmissionController extends Controller
{
    ...
    public function studentStore(Request $request)
    {
        ...
        if ($request->file('document_file_1') ) {
            ...
            $file = $request->file('document_file_1');
            $document_file_1 = fileUpload($file, 'public/uploads/student/document/');
        }
        ...
        if ($request->file('document_file_2') ) {
            ...
            $file = $request->file('document_file_2');
            $document_file_2 = fileUpload($file, 'public/uploads/student/document/');
        }
        ...
        if ($request->file('document_file_3') ) {
            ...
            $file = $request->file('document_file_3');
            $document_file_3 = fileUpload($file, 'public/uploads/student/document/');
        }
        ...
        if ($request->file('document_file_4') ) {
            ...
            $file = $request->file('document_file_4');
            $document_file_4 = fileUpload($file, 'public/uploads/student/document/');
        }
                        ...
                        if ($request->customF) {
                            ...
                            foreach ($dataImage as $label => $field) {
                                if (is_object($field)) {
                                    ...
                                    $file = $field;
                                    $dataImage[$label] = fileUpload($file, 'public/uploads/customFields/');
                                }
                            }
    ...
    public function studentDetails(Request $request)
    {
        try {
            ...
            return view('backEnd.studentInformation.student_details', ['classes' => $classes, 'sessions' => $sessions, 'students' => $students, 'all_students' => $students]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function studentDetailsSearch(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.student_details', ['students' => $students, 'all_students' => $students, 'sections' => $sections, 'academic' => $academic, 'section_id' => $section_id, 'classes' => $classes, 'class_id' => $class_id, 'name' => $name, 'roll_no' => $roll_no, 'sessions' => $sessions]);
        } catch (Exception $exception) {
        ...
        try {
            if ($request->file('photo')  && $request->title ) {
                ...
                if ($request->file('photo') ) {
                    ...
                    $file = $request->file('photo');
                    $document_photo = fileUpload($file, 'public/uploads/student/document/');
                }
        ...
        try {
            if ($request->title ) {
                ...
                if ($request->file('document_file_4') ) {
                    ...
                    $file = $request->file('document_file_4');
                    $document_photo = fileUpload($file, 'public/uploads/student/timeline/');
                }
...
//                    ->where('academic_id', getAcademicId())->where('school_id', Auth::user()->school_id)->get();
    ...
    public function disabledStudent(Request $request)
    {
        try {
            ...
            $students = branchWIse(SmStudent::where('active_status', 0)->where('school_id', Auth::user()->school_id)->get());
    ...
    public function disabledStudentSearch(Request $request)
    {
        ...
        try {
            ...
            $student_ids = StudentRecord::when($request->class_id, function ($query) use ($request): void {
                ...
                ->when($request->branch_id, function ($query) use ($request): void {
            ...
            $students = branchWise(SmStudent::query()->withOutGlobalScope(StatusAcademicSchoolScope::class));
    ...
    public function disabledStudentDelete(Request $request)
    {
        ...
        try {
            ...
            try {
                ...
                $table_list = \App\Support\tableList::ONLY_TABLE_LIST('student_id');
    ...
    public function previousRecordSearch(Request $request)
    {
        ...
        try {
            ...
            $students = branchWise(SmStudentPromotion::where('created_at', 'LIKE', '%'.$yearCh->year.'%'));
    ...
    public function unassignedStudent(Request $request)
    {
        try {
            ...
            $students = branchWise(SmStudent::wheredoesnthave('studentRecords')->where('school_id', Auth::user()->school_id)->where('academic_id', getAcademicId())->get());
            $classes = branchWise(SmClass::where('active_status', 1)->where('academic_id', getAcademicId())->where('school_id', Auth::user()->school_id)->get());
