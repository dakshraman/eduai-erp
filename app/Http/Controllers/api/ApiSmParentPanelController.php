    ...
    public function childInfo(Request $request, $user_id)
    {
        ...
        try {
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                ...
                $user = SmStudent::withoutGlobalScope(SchoolScope::class)->with('parents', 'studentRecords', 'studentDocument')->where('user_id', $user_id)->first();
                $data = [];
                ...
                $data['userDetails'] = [
                    ...
                    'document_file_1' => $user->document_file_1,
                    'document_file_2' => $user->document_file_2,
                    'document_file_3' => $user->document_file_3,
                    'document_file_4' => $user->document_file_4,
                    'student_photo' => $user->student_photo,
                ];
    ...
    public function saas_childInfo(Request $request, $school_id, $user_id)
    {
        ...
        try {
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                ...
                $user = SmStudent::with('parents', 'studentRecords', 'studentDocument')->where('user_id', $user_id)->where('school_id', $school_id)->first();
                $data = [];
