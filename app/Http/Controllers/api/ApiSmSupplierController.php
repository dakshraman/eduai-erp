...
class ApiSmSupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $smSupplier->company_name = $request->company_name;
            $smSupplier->company_address = $request->company_address;
            $smSupplier->contact_person_name = $request->contact_person_name;
            $smSupplier->contact_person_mobile = $request->contact_person_mobile;
            $smSupplier->contact_person_email = $request->contact_person_email;
            $smSupplier->description = $request->description;
            // $suppliers->created_by = Auth()->user()->id;
            $results = $smSupplier->save();
