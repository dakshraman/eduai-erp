...
class ApiSmPhoneCallLogController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.admin.phone_call', ['phone_call_logs' => $phone_call_logs]);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $smPhoneCallLog->name = $request->name;
            $smPhoneCallLog->phone = $request->phone;
            $smPhoneCallLog->date = date('Y-m-d', strtotime($request->date));
            $smPhoneCallLog->description = $request->description;
            $smPhoneCallLog->next_follow_up_date = date('Y-m-d', strtotime($request->follow_up_date));
            $smPhoneCallLog->call_duration = $request->call_duration;
            $smPhoneCallLog->call_type = $request->call_type;
            $result = $smPhoneCallLog->save();
