...
class ShiftController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['shifts'] = branchWise(Shift::where('school_id', auth()->user()->school_id)->get());
    ...
    {
        try {
            $classes = branchWise(SmClassSection::with('className')->where('shift_id', $request->shift_id)->get());
    ...
    {
        $class_section = branchWise(SmClassSection::with('shift')->where('class_id', $request->class_id)
