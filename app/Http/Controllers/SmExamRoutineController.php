...
class SmExamRoutineController extends Controller
{
    ...
    public function examScheduleReportSearch(Request $request)
    {
        ...
        try {
            ...
            $section_id = empty($request->section) ? 0 : $request->section;
            ...
            return view('backEnd.examination.exam_schedule_new', ['classes' => $classes, 'exams' => $exams, 'exam_schedules' => $exam_schedules, 'assign_subjects' => $assign_subjects, 'class_id' => $class_id, 'section_id' => $section_id, 'exam_id' => $exam_id, 'exam_types' => $exam_types, 'exam_periods' => $exam_periods, 'exam_dates' => $exam_dates]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function examScheduleReportSearchOld(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.examination.exam_schedule', ['classes' => $classes, 'exams' => $exams, 'assign_subjects' => $assign_subjects, 'class_id' => $class_id, 'section_id' => $section_id, 'exam_id' => $exam_id, 'exam_types' => $exam_types, 'exam_periods' => $exam_periods]);
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function examRoutineView($class_id, $section_id, $exam_term_id)
    {
        ...
        try {
            ...
            return view('backEnd.examination.exam_schedule_new_update', ['classes' => $classes, 'subjects' => $subjects, 'exam_schedule' => $exam_schedule, 'exams' => $exams, 'class_id' => $class_id, 'section_id' => $section_id, 'exam_type_id' => $exam_type_id, 'exam_types' => $exam_types, 'teachers' => $teachers, 'rooms' => $rooms, 'examName' => $examName, 'search_current_class' => $search_current_class, 'search_current_section' => $search_current_section]);
        } catch (Exception $exception) {
