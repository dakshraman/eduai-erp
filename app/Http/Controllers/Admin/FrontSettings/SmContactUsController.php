...
class SmContactUsController extends Controller
{
    public function index()
    {
        ...
        */
        ...
        return view('backEnd.frontSettings.contact_us', ['contact_us' => $contact_us, 'module_links' => $module_links]);
        /*
    ...
    public function edit()
    {
        ...
        */
        ...
        return view('backEnd.frontSettings.contact_us', ['contact_us' => $contact_us, 'update' => $update]);
        /*
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
