...
class SmFrontExamRoutineController extends Controller
{
    public function index()
    {
        ...
        */
        ...
        return view('backEnd.frontSettings.front_exam_routine.front_exam_routine', ['frontExamRoutines' => $frontExamRoutines]);
        /*
    ...
    public function edit($id)
    {
        ...
        */
        $frontExamRoutines = FrontExamRoutine::where('school_id', app('school')->id)->get();
        $add_front_exam_routine = FrontExamRoutine::findOrFail($id);

        return view('backEnd.frontSettings.front_exam_routine.front_exam_routine', ['frontExamRoutines' => $frontExamRoutines, 'add_front_exam_routine' => $add_front_exam_routine]);
        /*
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
    ...
    public function update(Request $request)
    {
        ...
        */
        $destination = 'public/uploads/front_exam_routine/';
        $frontExamRoutine = FrontExamRoutine::findOrFail($request->id);
        $frontExamRoutine->title = $request->title;
        $frontExamRoutine->publish_date = date('Y-m-d', strtotime($request->publish_date));
    ...
    public function deleteModal($id)
    {
        ...
        try {
        */
        $frontExamRoutine = FrontExamRoutine::findOrFail($id);

        return view('backEnd.frontSettings.front_exam_routine.front_exam_routine_delete_modal', ['frontExamRoutine' => $frontExamRoutine]);
        /*
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
