...
class SmStudentCategoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        try {
        */
        $student_types = branchWise(SmStudentCategory::get());
    ...
    public function store(SmStudentCategoryRequest $smStudentCategoryRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch') && Schema::hasColumn('sm_student_categories', 'branch_id')) {
            $smStudentCategory->branch_id = $smStudentCategoryRequest->branch_id;
        }
    ...
    public function update(SmStudentCategoryRequest $smStudentCategoryRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch') && Schema::hasColumn('sm_student_categories', 'branch_id')) {
            $student_type->branch_id = $smStudentCategoryRequest->branch_id;
        }
        $student_type->save();
        Toastr::success('Operation successful', 'Success');
    ...
    public function delete(Request $request, $id)
    {
        ...
        try {
        */
        $tables = \App\Support\tableList::getTableList('student_category_id', $id);
        /*
            try {
            */
        if (! $tables) {
