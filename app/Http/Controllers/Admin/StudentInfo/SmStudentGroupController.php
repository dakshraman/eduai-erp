...
class SmStudentGroupController extends Controller
{
    public function index(Request $request)
    {
        ...
        try {
        */
        $student_groups = branchWise(SmStudentGroup::withCount('students')->where('school_id', Auth::user()->school_id)->get());
    ...
    public function store(StudentGroupRequest $studentGroupRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch') && Schema::hasColumn('sm_student_groups', 'branch_id')) {
            $smStudentGroup->branch_id = $studentGroupRequest->branch_id;
        }
    ...
    public function update(StudentGroupRequest $studentGroupRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch') && Schema::hasColumn('sm_student_groups', 'branch_id')) {
            $student_group->branch_id = $studentGroupRequest->branch_id;
        }
        $student_group->save();
        Toastr::success('Operation successful', 'Success');
    ...
    public function delete(Request $request, $id)
    {
        ...
        try {
        */
        $tables = \App\Support\tableList::getTableList('student_group_id', $id);
        /*
        try {
        */
        if (! $tables) {
