...
class SmAddIncomeController extends Controller
{
    ...
    public function store(SmAddIncomeRequest $smAddIncomeRequest)
    {
        ...
        */
        ...
        $smAddIncome->amount = (float) round($smAddIncomeRequest->amount, getDecimalDigit());
        ...
        if (paymentMethodName($smAddIncomeRequest->payment_method)) {
            ...
            $after_balance = $bank->current_balance + (float) round($smAddIncomeRequest->amount, getDecimalDigit());

            $smBankStatement = new SmBankStatement();
            $smBankStatement->amount = (float) round($smAddIncomeRequest->amount, getDecimalDigit());
    ...
    public function update(SmAddIncomeRequest $smAddIncomeRequest)
    {
        ...
        */
        ...
        $add_income->amount = (float) round($smAddIncomeRequest->amount, getDecimalDigit());
