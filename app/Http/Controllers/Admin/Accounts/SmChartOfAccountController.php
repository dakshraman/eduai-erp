...
class SmChartOfAccountController extends Controller
{
    public function index()
    {
        ...
        try {
        */
        $chart_of_accounts = branchWise(SmChartOfAccount::get());
    ...
    public function store(SmChartOfAccountRequest $smChartOfAccountRequest)
    {
        try {
            ...
            if (moduleStatusCheck('Branch')) {
                $smChartOfAccount->branch_id = $smChartOfAccountRequest->branch_id;
            }
    ...
    public function update(SmChartOfAccountRequest $smChartOfAccountRequest, $id)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $chart_of_account->branch_id = $smChartOfAccountRequest->branch_id;
        }
        if (moduleStatusCheck('University')) {
    ...
    public function destroy(Request $request, $id)
    {
        ...
        */
        ...
        try {
        */
        if (in_array($tables1, [null, ''], true) && in_array($tables2, [null, ''], true)) {
