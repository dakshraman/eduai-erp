...
class SmItemReceiveController extends Controller
{
    ...
    public function saveItemReceiveData(SmItemReceiveRequest $smItemReceiveRequest)
    {
        ...
        */
        ...
        $subTotalValue = (float) round($smItemReceiveRequest->subTotalValue, getDecimalDigit());
        $totalDueValue = (float) round($smItemReceiveRequest->totalDueValue, getDecimalDigit());
        $paid_status = '';
        if ($totalDueValue == 0) {
            $paid_status = 'P';
        ...
        $smItemReceive->grand_total = $subTotalValue;
        ...
        $smItemReceive->total_due = $totalDueValue;
        ...
        if ($results) {
            ...
            for ($i = 0; $i < $item_ids; $i++) {
                if (! empty($smItemReceiveRequest->item_id[$i])) {
                    ...
                    $itemReceivedChild->unit_price = (float) round($smItemReceiveRequest->unit_price[$i], getDecimalDigit());
                    $itemReceivedChild->quantity = $smItemReceiveRequest->quantity[$i];
                    $itemReceivedChild->sub_total = (float) round($smItemReceiveRequest->totalValue[$i], getDecimalDigit());
        ...
        $data['grand_total'] = $subTotalValue;
        $data['total_paid'] = $total_paid;
        $data['total_due'] = $totalDueValue;
        $data['quantity'] = (float) round($smItemReceiveRequest->subTotalQuantityValue, getDecimalDigit());
    ...
    public function saveItemReceivePayment(Request $request)
    {
        ...
        */
        ...
        if (isset($itemPaymentDue)) {
            ...
            $smAddExpense->amount = (float) round($request->amount, getDecimalDigit());
    ...
    public function deleteItemSale($id)
    {
        ...
        try {
        */
        $tables = \App\Support\tableList::getTableList('item_sell_id', $id);
        /*
        try {
        */
