...
class SmSupplierController extends Controller
{
    public function index(Request $request)
    {
        ...
        */
        if (moduleStatusCheck('Branch')) {
            $suppliers = branchWise(SmSupplier::where('school_id', Auth::user()->school_id)->select([
                'id', 'company_name', 'company_address', 'contact_person_name', 'contact_person_mobile', 'contact_person_email', 'cotact_person_address', 'description', 'active_status', 'branch_id',
            ])->get());
        } else {
    ...
    public function store(SmSupplierRequest $smSupplierRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $smSupplier->branch_id = $smSupplierRequest->branch_id;
        }
    ...
    public function update(SmSupplierRequest $smSupplierRequest, $id)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $suppliers->branch_id = $smSupplierRequest->branch_id;
        }
