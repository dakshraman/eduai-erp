...
class SmSubjectController extends Controller
{
    ...
    public function store(SmSubjectRequest $smSubjectRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $smSubject->branch_id = $smSubjectRequest->branch_id;
        }
    ...
    public function edit($id)
    {
        ...
        try {
        */
        $subject = $this->subjectQuery()->where('id', $id)->first();
        $subjects = $this->subjectList();
    ...
    public function update(SmSubjectRequest $smSubjectRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $subject->branch_id = $smSubjectRequest->branch_id;
        }
    ...
    private function subjectQuery(): Builder
    {
        $columns = [
            'id',
            'subject_name',
