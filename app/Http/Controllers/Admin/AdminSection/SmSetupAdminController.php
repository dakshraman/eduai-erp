...
class SmSetupAdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        */
        if (moduleStatusCheck('Branch')) {
            $admin_setups = branchWise(SmSetupAdmin::select(['id', 'type', 'name', 'description', 'active_status', 'updated_by', 'created_by', 'branch_id'])->get());
        } else {
    ...
    public function store(SmAdminSetupRequest $smAdminSetupRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $smSetupAdmin->branch_id = $smAdminSetupRequest->branch_id;
        }
    ...
    public function update(SmAdminSetupRequest $smAdminSetupRequest, $id)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $setup->branch_id = $smAdminSetupRequest->branch_id;
        }
