...
class SmBackGroundSettingController extends Controller
{
    ...
    public function store(SmBackGroundSettingRequest $smBackGroundSettingRequest)
    {
        ...
        */
        ...
        $fileName = $smBackGroundSettingRequest->background_type === 'image'
            ? fileUpload($smBackGroundSettingRequest->image, $destination)
            : '';
        $title = match ((int) $smBackGroundSettingRequest->style) {
            1 => 'Dashboard Background',
            2 => 'Login Background',
            3 => 'Lead Form Background',
        };
    ...
    public function update(SmBackGroundSettingRequest $smBackGroundSettingRequest)
    {
        ...
        */
        ...
        $background_setting = (SmBackgroundSetting::where("school_id", app("school")->id ?? 1)->first() ?: new SmBackgroundSetting());
