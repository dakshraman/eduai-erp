...
use App\Models\SmQuestionLevel;
...
class SmQuestionLevelController extends Controller
{
    ...
    public function index()
    {
        ...
        */
        ...
        return view('backEnd.examination.question_level', ['levels' => $levels]);
        /*
    ...
    public function show($id)
    {
        ...
        */
        ...
        return view('backEnd.examination.question_level', ['levels' => $levels, 'level' => $level]);
        /*
        } catch (Exception $exception) {
            Toastr::error('Operation Failed', 'Failed');
