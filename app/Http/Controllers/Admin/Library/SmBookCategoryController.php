...
class SmBookCategoryController extends Controller
{
    public function index()
    {
        ...
        try {
        */
        $bookCategories = branchWise(SmBookCategory::status()->get());
    ...
    public function store(BooksCategoryRequest $booksCategoryRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch') && Schema::hasColumn('sm_book_categories', 'branch_id')) {
            $smBookCategory->branch_id = $booksCategoryRequest->branch_id;
        }
    ...
    public function edit($id)
    {
        ...
        */
        ...
        $bookCategories = branchWise(SmBookCategory::where('school_id', Auth::user()->school_id)->get());
    ...
    public function update(BooksCategoryRequest $booksCategoryRequest, $id)
    {
        ...
        if (moduleStatusCheck('Branch') && Schema::hasColumn('sm_book_categories', 'branch_id')) {
            $categories->branch_id = $booksCategoryRequest->branch_id;
        }
        $categories->update();
        Toastr::success('Operation successful', 'Success');
    ...
    public function destroy($id)
    {
        ...
        $tables = \App\Support\tableList::getTableList('book_category_id', $id);
        $tables1 = \App\Support\tableList::getTableList('sb_category_id', $id);
        /*
        try {
        */
        if (in_array($tables, [null, ''], true) && in_array($tables1, [null, ''], true)) {
