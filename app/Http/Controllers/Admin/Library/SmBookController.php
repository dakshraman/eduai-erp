...
class SmBookController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
        */
        $books = branchWise(SmBook::leftjoin('library_subjects', 'sm_books.book_subject_id', '=', 'library_subjects.id')
    ...
    public function addBook(Request $request)
    {
        ...
        try {
        */
        $categories = branchWise(SmBookCategory::get());
        $subjects = branchWise(LibrarySubject::get());
    ...
    public function saveBookData(SmBookRequest $smBookRequest)
    {
        ...
        */
        ...
        if (@$smBookRequest->book_price ) {
            $smBook->book_price = (float) round($smBookRequest->book_price, getDecimalDigit());
        }
        ...
        if (moduleStatusCheck('Branch')) {
            $smBook->branch_id = $smBookRequest->branch_id;
        }
    ...
    public function updateBookData(SmBookRequest $smBookRequest, $id)
    {
        ...
        */
        ...
        $books->book_price = (float) round($smBookRequest->book_price, getDecimalDigit());
        $books->details = $smBookRequest->details;
        $books->post_date = date('Y-m-d');
        $books->updated_by = auth()->user()->id;
        if (moduleStatusCheck('Branch')) {
            $books->branch_id = $smBookRequest->branch_id;
        }
        $books->update();
    ...
    public function memberList(Request $request)
    {
        ...
        try {
        */
        $activeMembers = branchWise(SmLibraryMember::with('roles', 'studentDetails', 'staffDetails', 'parentsDetails', 'memberTypes')->where('school_id', Auth::user()->school_id)->where('active_status', '=', 1)->get());
    ...
    public function issueBooks(Request $request, $member_type, $student_staff_id)
    {
        ...
        */
        ...
        $books = branchWise(SmBook::where('school_id', Auth::user()->school_id)->get());
        $totalIssuedBooks = branchWise(SmBookIssue::where('school_id', Auth::user()->school_id)->where('member_id', '=', $student_staff_id)->get());
    ...
    public function saveIssueBookData(SaveIssueBookRequest $saveIssueBookRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $smBookIssue->branch_id = $saveIssueBookRequest->branch_id;
        }
    ...
    public function searchIssuedBook(Request $request)
    {
        ...
        */
        ...
        $now = Carbon::now();
        $issueBooks = branchWise(SmBookIssue::whereHas('books', function ($query) use ($request): void {
        ...
        if ($request->branch_id) {
            $issueBooks = branchWise(SmBookIssue::whereHas('books', function ($query) use ($request): void {
                $query->where('id', $request->book_id)->where('branch_id', $request->branch_id);
            })->get());
        }
        ...
        $books = branchWise(SmBook::where('active_status', 1)->get());
        $subjects = branchWise(LibrarySubject::where('active_status', 1)->get());

        return view('backEnd.library.allIssuedBook', ['issueBooks' => $issueBooks, 'books' => $books, 'subjects' => $subjects, 'book_id' => $book_id, 'book_number' => $book_number, 'subject_id' => $subject_id, 'now' => $now, 'branch_id' => $branch_id]);
        /*
        } catch (\Exception $e) {
    ...
    public function subjectList(Request $request)
    {
        ...
        try {
        */
        $subjects = branchWise(LibrarySubject::where('school_id', auth()->user()->school_id)->with('category')->get());
        $bookCategories = branchWise(SmBookCategory::get());
    ...
    public function store(LibrarySubjectRequest $librarySubjectRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $librarySubject->branch_id = $librarySubjectRequest->branch_id;
        }
    ...
    public function update(LibrarySubjectRequest $librarySubjectRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $subject->branch_id = $librarySubjectRequest->branch_id;
        }
        $subject->save();
