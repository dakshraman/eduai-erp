...
class SmFeesCollectController extends Controller
{
        ...
        */
        ...
        if (moduleStatusCheck('University')) {
            ...
            if (moduleStatusCheck('Branch')) {
                $students->where('branch_id', $smFeesCollectSearchRequest->branch_id);
            }
            ...
            if ($smFeesCollectSearchRequest->shift ) {
                $students->where('shift_id', $smFeesCollectSearchRequest->shift);
            } else {
                $students->whereNotNull('shift_id');
            }
        ...
        if (moduleStatusCheck('Branch')) {
            $branch_info = \Modules\Branch\Entities\Branch::find($smFeesCollectSearchRequest->branch);
            $search_info['branch_name'] = @$branch_info->branch_name;
        }
        ...
        $data['class_id'] = $smFeesCollectSearchRequest->class;
        $data['section_id'] = $smFeesCollectSearchRequest->section;
        $data['shift_id'] = $smFeesCollectSearchRequest->shift;
        $data['keyword'] = $smFeesCollectSearchRequest->keyword;

        $un_session_id = $smFeesCollectSearchRequest->un_session_id;
        $un_faculty_id = $smFeesCollectSearchRequest->un_faculty_id;
        $un_department_id = $smFeesCollectSearchRequest->un_department_id;
        $un_academic_id = $smFeesCollectSearchRequest->un_academic_id;
        $un_semester_id = $smFeesCollectSearchRequest->un_semester_id;
        $un_semester_label_id = $smFeesCollectSearchRequest->un_semester_label_id;
        $un_section_id = $smFeesCollectSearchRequest->un_section_id;

        $branch_id = $smFeesCollectSearchRequest->branch_id ?? null;
        ...
        return view('backEnd.feesCollection.collect_fees', array_merge($data, [
    ...
    public function collectFeesStudent(Request $request, $id)
    {
        ...
        */
        ...
        $fees_assigneds = branchWise(SmFeesAssign::with('feesGroupMaster')
