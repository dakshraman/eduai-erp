...
*/
        ...
        $data['shift_id'] = $smFeesBankPaymentRequest->shift;
        $data['classes'] = SmClass::get();
        $data['sections'] = SmSection::get();

        $un_session_id = $smFeesBankPaymentRequest->un_session_id;
        $un_faculty_id = $smFeesBankPaymentRequest->un_faculty_id;
        $un_department_id = $smFeesBankPaymentRequest->un_department_id;
        $un_academic_id = $smFeesBankPaymentRequest->un_academic_id;
        $un_semester_id = $smFeesBankPaymentRequest->un_semester_id;
        $un_semester_label_id = $smFeesBankPaymentRequest->un_semester_label_id;
        $un_section_id = $smFeesBankPaymentRequest->un_section_id;
        $branch_id = $smFeesBankPaymentRequest->branch_id ?? null;
