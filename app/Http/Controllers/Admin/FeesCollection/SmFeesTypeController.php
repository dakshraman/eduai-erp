...
class SmFeesTypeController extends Controller
{
    public function index(Request $request)
    {
        ...
        try {
        */
        $fees_types = branchWise(SmFeesType::with('fessGroup')->where('school_id', Auth::user()->school_id)->get());
        $fees_groups = branchWise(SmFeesGroup::where('school_id', Auth::user()->school_id)->get());
    ...
    public function store(SmFeesTypeRequest $smFeesTypeRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $smFeesType->branch_id = $smFeesTypeRequest->branch_id;
        }
    ...
    public function edit(Request $request, $id)
    {
        ...
        */
        ...
        $fees_types = branchWise(SmFeesType::where('school_id', Auth::user()->school_id)->get());
        $fees_groups = branchWise(SmFeesGroup::where('school_id', Auth::user()->school_id)->get());
    ...
    public function update(Request $request)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $fees_type->branch_id = $request->branch_id;
        }
