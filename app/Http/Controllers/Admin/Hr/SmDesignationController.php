...
class SmDesignationController extends Controller
{
    public function index(Request $request)
    {
        ...
        */
        if (moduleStatusCheck('Branch')) {
            $designations = SmDesignation::select(['title', 'id', 'active_status', 'is_saas', 'branch_id'])->get();
        } else {
    ...
    public function store(SmDesignationRequest $smDesignationRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $smDesignation->branch_id = $smDesignationRequest->branch_id;
        }
    ...
    public function update(SmDesignationRequest $smDesignationRequest, $id)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $designation->branch_id = $smDesignationRequest->branch_id;
        }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try {
        */
        $tables = \App\Support\tableList::getTableList('designation_id', $id);
        // return $tables;
        /*
        try {
        */
