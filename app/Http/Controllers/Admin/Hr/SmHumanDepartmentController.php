...
class SmHumanDepartmentController extends Controller
{
    public function index(Request $request)
    {
        ...
        */
        if (moduleStatusCheck('Branch')) {
            $departments = SmHumanDepartment::select(['id', 'name', 'branch_id'])->get();
        } else {
    ...
    public function store(SmDepartmentRequest $smDepartmentRequest)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $smHumanDepartment->branch_id = $smDepartmentRequest->branch_id;
        }
    ...
    public function update(SmDepartmentRequest $smDepartmentRequest, $id)
    {
        ...
        */
        ...
        if (moduleStatusCheck('Branch')) {
            $department->branch_id = $smDepartmentRequest->branch_id;
        }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try {
        */
        $tables = \App\Support\tableList::getTableList('department_id', $id);
        /*
        try {
        */
