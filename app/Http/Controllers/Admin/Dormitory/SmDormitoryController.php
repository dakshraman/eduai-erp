...
class SmDormitoryController extends Controller
{
    public function studentDormitoryReport(Request $request)
    {
        ...
        */
        ...
        $dormitories = branchWiseBook(SmDormitoryList::get());
        $students = branchWise(SmStudent::with('class', 'section', 'parents', 'dormitory', 'room')
    ...
    public function studentDormitoryReportSearch(Request $request)
    {
        ...
        */
        $data = [];
        $stdent_ids = [];
        $students = branchWise(SmStudent::query());
