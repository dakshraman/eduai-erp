...
use App\Models\SmCourseCategory;
...
class FrontendController extends Controller
{
    ...
    {
        $data['news'] = SmNews::where('school_id', app('school')->id)->where('mark_as_archive', 0)->latest()->paginate(8);
    ...
    public function loadMoreBlogs(Request $request)
    {
        ...
        $data['news'] = SmNews::skip($data['skip'])->where('school_id', app('school')->id)->where('mark_as_archive', 0)->latest()->take(4)->get();
    ...
    {
        $data['blogs'] = SmNews::with('category')->where('mark_as_archive', 0)->where('school_id', app('school')->id)->latest()->paginate(5);
        $data['recent_blog'] = SmNews::with('category')->where('mark_as_archive', 0)->where('school_id', app('school')->id)->orderBy('id', 'desc')->take(3)->latest()->get();
