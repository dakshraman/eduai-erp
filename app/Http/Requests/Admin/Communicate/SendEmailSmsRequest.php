...
class SendEmailSmsRequest extends FormRequest
{
    ...
    /**
     * @return 'required_if:selectTab,C'[]|'required_with:class_id|array'[]|'sometimes|nullable'[]|'required'[]|'required_if:selectTab,G|array'[]|'required_if:selectTab,I'[]|'required_with:role_id|array'[]|'nullable'[]
     */
