...
class SmHomeworkRequest extends FormRequest
{
    ...
    /**
     * @return array{0: 'required', 1?: ('after:homework_date' | 'date')}[]|non-falsy-string[]
     */
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'homework_file' => 'sometimes|nullable',
            'homework_file.*' => 'mimes:pdf,doc,docx,txt,jpg,jpeg,png,mp4,ogx,oga,ogv,ogg,webm,mp3|max:'.$maxFileSize,
        ];
    ...
    public function messages(): array
    {
        $messages = [
            ...
            'homework_file.*.mimes' => 'Each file must be of type: pdf, doc, docx, txt, jpg, jpeg, png, mp4, ogx, oga, ogv, ogg, webm, or mp3.',
            'homework_file.*.max' => 'Each file must be less than '.generalSetting()->file_size.' MB.',
