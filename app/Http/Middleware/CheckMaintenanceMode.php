...
class CheckMaintenanceMode
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        SaasSchool();
        // OPTIMIZED: Cache maintenance setting for 5 minutes instead of querying DB every request.
        $setting = \Illuminate\Support\Facades\Cache::remember('maintenance_setting', 300, fn () => MaintenanceSetting::first());
