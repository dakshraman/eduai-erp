...
class ProfileParnetResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'mothers_photo' => ! empty($this->mothers_photo) ? assetPath($this->mothers_photo) : null,
            ...
            'guardians_photo' => ! empty($this->guardians_photo) ? assetPath($this->guardians_photo) : null,
        ];
    }
}
