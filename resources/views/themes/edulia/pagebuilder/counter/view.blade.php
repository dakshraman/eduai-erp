...
<section class="section_padding_off cta_area"
    @if (!empty(pagesetting('counter_image'))) style="background-image: url('{{ assetPath(pagesetting('counter_image')[0]['thumbnail']) }}')" @endif>
    <div class="container">
        <div class="row">
...
@pushonce(config('pagebuilder.site_script_var'))
    <script src="{{ assetPath('public/theme/edulia/packages/animate-number/multi-animated-counter.min.js') }}"></script>
@endpushonce
