@pushonce(config('pagebuilder.site_style_var'))
    <link rel="stylesheet" href="{{ assetPath('public/theme/edulia/packages/nice-select/nice-select.css') }}">
    <link rel="stylesheet" href="{{ assetPath('public/theme/edulia/css/themify-icons.min.css') }}">
    <style>
...
@pushonce(config('pagebuilder.site_script_var'))
    <script src="{{ assetPath('public/theme/edulia/packages/nice-select/jquery.nice-select.min.js') }}"></script>
    <script>
