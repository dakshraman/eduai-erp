...
<head>
    ...
    <link rel="stylesheet" href="{{assetPath('public/backEnd/login2')}}/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{assetPath('public/backEnd/login2')}}/themify-icons.css">
    ...
    <link rel="stylesheet" href="{{assetPath('public/backEnd/login2')}}/css/style.css">
...
<body >
            ...
            <div class="row justify-content-center">
                <div class="col-sm-8 col-lg-5 col-xl-4 col-md-7">
                    ...
                    <div class="in_login_content">
                        @if(!empty($setting->logo))<img src="{{assetPath($setting->logo)}}" alt="Login Panel">@endif
    ...
    <!--================ End Footer Area =================-->
    <script src="{{assetPath('public/backEnd/login2')}}/js/jquery-3.4.1.min.js"></script>
    <script src="{{assetPath('public/backEnd/login2')}}/js/popper.min.js"></script>
	<script src="{{assetPath('public/backEnd/login2')}}/js/bootstrap.min.js"></script>
