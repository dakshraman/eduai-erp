            ...
            <div class="col-lg-5 col-md-8">
                <div class="form-wrap text-center">
                    <div class="logo-container">
                        ...
                        @endphp
                        <a href="#">
                            {{-- <img src="{{assetPath('public/backEnd/img/logo.png')}}" alt=""> --}}
                            <img src="{{assetPath($setting->logo)}}" alt="" width="170px" height="68px">
                        </a>
                    </div>
                    ...
                    <form method="POST" class="" action="{{ route('storeNewPassword') }}">
                        ...
                        <div class="form-group input-group mb-4 mx-3">
                            ...
                            <input class="form-control{{ $errors->has('new_password') ? ' is-invalid' : '' }}"
                                   type="password" name='new_password' placeholder="@lang('auth.enter_new_password')"/>
