...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        @else
            <link rel="icon" href="{{assetPathPath('uploads/settings/favicon.png')}}" type="image/png"/>
        @endif
        @if( !empty($page->title) )
        ...
        @if( config('pagebuilder.add_bootstrap') === 'yes' )
            <link rel="stylesheet" href="{{ assetPath('vendor/optionbuilder/css/bootstrap.min.css') }}">
        @endif

        {{-- <link rel="stylesheet" href="{{ assetPath('public/demo/css/demo.css') }}"> --}}
        
        <!-- Main css -->
        <link rel="stylesheet" href="{{ assetPath('public/theme/'.activeTheme().'/css/fontawesome.all.min.css') }}">
        <link rel="stylesheet" href="{{ assetPath('public/theme/'.activeTheme().'/css/dataTables.jqueryui.min.css') }}">
        <link rel="stylesheet" href="{{ assetPath('public/theme/'.activeTheme().'/css/responsive.jqueryui.min.css') }}">
        <link rel="stylesheet" href="{{assetPath('public/theme/'.activeTheme().'/css/style.css')}}">
    ...
    <body>
        ...
        <script src="{{assetPath('public/theme/'.activeTheme().'/js/jquery.dataTables.min.js')}}"></script>
        <script src="{{assetPath('public/theme/'.activeTheme().'/js/dataTables.responsive.min.js')}}"></script>
        <script>
