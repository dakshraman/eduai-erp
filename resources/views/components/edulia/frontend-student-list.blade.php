                            ...
                            <tbody>
                                @foreach ($students as $key => $student)
                                    <tr>
                                        ...
                                        <td><img src="{{ file_exists($student->student_photo) ? assetPath($student->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
                        ...
                        <div class="user_item">
                            <div class="d-flex single-student-info">
                                <div><a href="{{ route('frontend.frontend-single-student-details', $student->id) }}"
                                        ...
                                        <img src="{{ file_exists($student->student_photo) ? assetPath($student->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
