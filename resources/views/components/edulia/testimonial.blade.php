<div class="tesimonials_slider owl-carousel">
    @foreach ($testimonials as $testimonial)
        <div class="tesimonials_slider_item"
            data-dot="<button role='button' class='owl-dot'><img src='{{ file_exists(@$testimonial->image) ? assetPath($testimonial->image) : assetPath('public/uploads/staff/demo/staff.jpg') }}'/></button>">
