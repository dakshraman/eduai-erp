<nav class="heading_main_menu">
    <ul>
        @foreach ($menus as $menu)
            ...
            @else
            @if($menu->title == "Online Course")
                
            
            @endif
                @php
                    $isOnlineCourse = $menu->title == 'Online Course' && $menu->type == 'customLink';
                @endphp

                @if (!$isOnlineCourse || ($isOnlineCourse && moduleStatusCheck('Lms')))
                    <li class="heading_main_menu_list">
                        <a class="heading_main_menu_list_link"
                            {{ $menu->is_newtab ? 'target="_blank"' : '' }}
