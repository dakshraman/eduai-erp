            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($editData))
                                {{ html()->form('POST', route('update-course-category'))->attributes([
                            ...
                            @else
                                @if (userPermission('store-course-category'))
                                    {{ html()->form('POST', route('store-course-category'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                        ...
                                        <div class="col-lg-12 mb-20">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($editData) ? $editData->category_name : old('category_name') }}">
                                        ...
                                        <div class="col-lg-12 mt-15">
                                            <div class="primary_input">
                                                ...
                                                <div class="primary_file_uploader">
                                                    <input
                                                        class="primary_input_field form-control{{ $errors->has('category_image') ? ' is-invalid' : '' }}"
                                                        name="category_image" readonly="true" type="text"
                                                    ...
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg"
                                                            for="addCategoryImage">{{ __('common.browse') }}</label>
                                                        <input type="file" class="d-none" name="category_image"
                                                            id="addCategoryImage">
                                                    </button>
                                    ...
                                    <div class="row ">
                                        <div class="col-lg-12 mt-15">
                                            <img class="previewImageSize {{ @$editData->category_image ? '' : 'd-none' }}"
                                                src="{{ @$editData->category_image ? assetPath($editData->category_image) : '' }}"
                                                alt="" id="categoryImageShow" height="100%" width="100%">
                                        </div>
                                    </div>
                                    @php
                                        $tooltip = '';
                                            ...
                                            @if (isset($course_categories))
                                                @foreach ($course_categories as $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="{{ assetPath($value->category_image) }}" height="100"
                                                                width="200">
                                                        </td>
                                                        <td>
                                                            <x-drop-down>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mt-40 d-flex justify-content-between">
                                                                        ...
                                                                        {{ html()->form('POST', route('delete-course-category', $value->id))->open() }}
