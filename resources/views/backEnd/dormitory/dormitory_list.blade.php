            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($dormitory_list))
                                {{ html()->form('PUT', route('dormitory-list-update', $dormitory_list->id))->attributes([
                            ...
                            @else
                             @if(userPermission('dormitory-list-store'))
                                {{ html()->form('POST', route('dormitory-list-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($dormitory_list) ? $dormitory_list->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                    <div class="row">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            ...
                                            <select
                                                ...
                                                @else
                                                    <option value="B" {{ old('type') == 'B' ? 'selected' : '' }}>
                                                        @lang('dormitory.boys')
                                                    </option>
                                                    <option value="G" {{ old('type') == 'G' ? 'selected' : '' }}>
                                                        @lang('dormitory.girls')
                                                    </option>
                                                @endif
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input oninput="numberCheck(this)"
                                                    ...
                                                    type="number" name="intake" min="0" step="1"
                                        ...
                                        <tbody>
                                            @foreach ($dormitory_lists as $key => $dormitory_list)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    @if (moduleStatusCheck('Branch'))
                                                    <td>{{ @$dormitory_list->branch?->branch_name }}</td>
                                                    @endif
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('DELETE', route('dormitory-list-delete', $dormitory_list->id))->attribute('enctype', 'multipart/form-data')->open() }}
