...
@section('mainContent')
    ...
    <section class="admin-visitor-area">
        ...
        <div class="row">
            <div class="col-lg-12"> 
                <div class="white-box">
                {{ html()->form('POST', route('previous-class-results-view'))->attributes([
                                ...
                                <div class="col-lg-12">
                                    <div class="single-report-admit">
                                        <div class="card">
                                            ...
                                            <div> 
                                                <img class="report-admit-img" src="{{assetPath($studentDetails->student_photo)}}" width="100" height="100" alt="">
                                            </div>
                                        </div> 
                                        <div class="card-body">
