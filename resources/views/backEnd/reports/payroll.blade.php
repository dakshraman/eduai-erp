            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('searchPayrollReport'))->attributes([
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mt-30-lg">
                                <select
                                    ...
                                    <option data-display="@lang('student.select_month') *"
                                            value="">@lang('student.select_month') *
                                    </option>
                                    ...
                                    <x-table>
                                        <table id="table_id" class="table" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <th>@lang('hr.basic_salary')({{ generalSetting()->currency_symbol }})
                                                </th>
                                                <th>@lang('hr.earnings')({{ generalSetting()->currency_symbol }})</th>
                                                <th>@lang('hr.deductions')({{ generalSetting()->currency_symbol }})</th>
                                                <th>@lang('leave.leave_deductions')
                                                    ({{ generalSetting()->currency_symbol }})
                                                </th>
                                                <th>@lang('hr.gross_salary')({{ generalSetting()->currency_symbol }})
                                                </th>
                                            ...
                                            @foreach ($staffsPayroll as $value)
                                                <tr>
                                                    ...
                                                    <td>{{ $value->id }}</td>
                                                    <td>{{ currency_format($value->basic_salary) }}</td>
                                                    <td>
                                                        @php
                                                            $totalEarnings = App\Models\SmHrPayrollEarnDeduc::getTotalEarnings($value->id);
                                                        @endphp
                                                        @if ($totalEarnings > 0)
                                                            {{ currency_format($totalEarnings) }}
                                                    ...
                                                    <td>
                                                        @php
                                                            $totalDeductions = App\Models\SmHrPayrollEarnDeduc::getTotalDeductions($value->id);
                                                        @endphp
                                                        @if ($totalDeductions > 0)
                                                            {{ currency_format($totalDeductions) }}
                                                    ...
                                                    <td>
                                                        @php
                                                            $leaveDeductions = App\Models\SmLeaveDeductionInfo::select('salary_deduct')
                                                                ->where('payroll_id', $value->id)
                                                                ->first();
                                                        @endphp
                                                        @if (@$leaveDeductions->salary_deduct > 0)
                                                            {{ currency_format(@$leaveDeductions->salary_deduct) }}
                                                        @else
                                                            {{ currency_format(0) }}
                                                        @endif
                                                    </td>
                                                    <td>{{ currency_format($value->gross_salary) }}</td>
                                                    <td>{{ currency_format($value->tax) }}</td>
                                                    <td>{{ currency_format($value->net_salary) }}</td>
                                                    @php
