@if (!empty($promotes))
    <div class="row">
        <div class="offset-lg-10 col-lg-2 pull-right text-right mt-20 ">
            <a target="_blank" href="{{ route('session_student', $admission_number) }}"
               class="primary-btn small fix-gr-bg "><span class="ti-printer pr-2"></span> @lang('common.print') </a>
        </div>
    </div>
    <div class="row mt-20">
        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div>
                                    <img class="report-admit-img"
                                         src="{{ $studentDetails->student_photo ? assetPath($studentDetails->student_photo) : assetPath('public/backEnd/assets/img/avatar.png') }}"
                                ...
                                <div class="white-box p-5">
                                    ...
                                    <div class="row  mt-40 ">
                                        ...
                                        <div class="row mt-20 transcript-heading">
                                            ...
                                            <div class="col-lg-4">
                                                <strong>@lang('reports.transcript_no')
                                    ...
                                    @foreach ($promotes as $studentDetails)
                                        @php
                                            ...
                                            @$current_class = App\Models\SmStudent::where('sm_students.id', $student_id)
                                                ->join('sm_classes', 'sm_classes.id', '=', 'sm_students.class_id')
                                                ->first();
                                            @$current_section = App\Models\SmStudent::where('sm_students.id', $student_id)
                                                ->join('sm_sections', 'sm_sections.id', '=', 'sm_students.section_id')
                                                ->first();
                                            $current_session = App\Models\SmStudent::where('sm_students.id', $student_id)
                                                ->join(
                                                    'sm_academic_years',
                                            ...
                                            $exams = App\Models\SmExam::where('active_status', 1)
                                                ->where('class_id', $class_id)
                                                ->where('section_id', $section_id)
                                                ->get();
                                            $exam_types = App\Models\SmExamType::where('active_status', 1)
                                                ->where('academic_id', getAcademicId())
                                                ->get();
                                            $classes = App\Models\SmClass::where('active_status', 1)
                                                ->where('academic_id', getAcademicId())
                                                ->get();
                                            $exam_setup = App\Models\SmExamSetup::where([
                                                ['class_id', $class_id],
                                                ['section_id', $section_id],
                                            ])->get();

                                            $subjects = App\Models\SmAssignSubject::where([
                                                ['class_id', $class_id],
                                                ['section_id', $section_id],
                                            ])->get();
                                            ...
                                            foreach ($assinged_exam_types as $assinged_exam_type) {
                                                foreach ($subjects as $subject) {
                                                    $is_mark_available = App\Models\SmResultStore::where([
                                                        ['class_id', $class_id],
                                                        ['section_id', $section_id],
                                            ...
                                            $is_result_available = App\Models\SmResultStore::where([
                                                ['class_id', $class_id],
                                                ['section_id', $section_id],
                                                ['student_id', $student_id],
                                            ])->get();
                                        ...
                                        @if ($is_result_available->count() > 0)
                                            <div class="row  mt-40 ">
                                                <div class="col-lg-3">
                                                    ...
                                                    @php
                                                        $exam = App\Models\SmExamType::where(
                                                            'id',
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    @php
                                                        $class = App\Models\SmClass::where(
                                                            'id',
                                                ...
                                                <table class="w-100  mt-10 mb-20 table table-bordered">
                                                    ...
                                                    <tr style="text-align: center;">
                                                        ...
                                                        @foreach ($assinged_exam_types as $assinged_exam_type)
                                                            @php
                                                                $exam_type = App\Models\SmExamType::examType(
                                                                    $assinged_exam_type,
                                                                );
                                                            @endphp
                                                            ...
                                                            <td>
                                                                @php
                                                                    if ($totalSubjectFail > 0) {
                                                                        ...
                                                                        $mark_grade = \App\Models\SmMarksGrade::where([
                                                            ...
                                                            @php
                                                                ...
                                                                if ($total_fail != 0) {
                                                                    ...
                                                                    if ($grade_point_final != '0.00') {
                                                                        $average_grade = \App\Models\SmMarksGrade::where([
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="{{ $colspan / 2 + 1 }}" class="text-center">
                                                            {{ number_format($grade_point_final, 2, ',', '') }}
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
