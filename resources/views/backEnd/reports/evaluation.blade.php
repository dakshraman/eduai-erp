                                                ...
                                                @foreach ($homeworkLists as $value)
                                                    <tr>
                                                        ...
                                                        @php
                                                            ...
                                                            $totalStudents = (int) ($homeworkPercentage['totalStudents'] ?? 0);
                                                            $completedHomeworks = (int) ($homeworkPercentage['totalHomeworkCompleted'] ?? 0);
                                                            $pendingHomeworks = max($totalStudents - $completedHomeworks, 0);
                                                        @endphp
                                                        <td>
                                                            @if (isset($homeworkPercentage))
                                                                {{ $completedHomeworks . '/' . $pendingHomeworks }}
                                                            @endif
                                                        </td>
                                                        <td>
                                                            @if (isset($homeworkPercentage))
                                                                {{ $totalStudents > 0 ? number_format(($completedHomeworks * 100) / $totalStudents, 2) : number_format(0, 2) }}
                                                            @endif
                                                        </td>
                                                        <td>
                                                            <x-drop-down>
