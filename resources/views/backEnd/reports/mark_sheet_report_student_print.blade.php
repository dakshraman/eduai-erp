...
<div class="invoice_wrapper">
                            ...
                            @if(resultPrintStatus('image'))
                                <div class="profile_thumb profile_100">
                                    <img class="report-admit-img"
                                         src="{{ file_exists(@$studentDetails->studentDetail->student_photo) ? assetPath($studentDetails->studentDetail->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
    ...
    <div class="{{(resultPrintStatus('body'))? "meritTableBody": "meritTableBodyCustomReport"}}">
        ...
        <div class="student_name_highlight" style="text-align: center; margin-bottom: 20px;">
            ...
            <h4 style="text-align: center !important;"><span style="border-bottom: 3px double; font-size: 20px">@lang('reports.mark_sheet')</span></h4>
        </div>
        ...
        <table class="table border_table gray_header_table mb_30 max-width-500 ml_auto margin-auto report_table @if(resultPrintStatus('vertical_boarder')) mt_40 @endif">
            ...
            @if ($average_passing_mark)
                <tr>
                    ...
                    <td class="nowrap">
                        ...
                        @endphp
                        <p>
                            <strong>{{$average_passing_mark <= $average_mark ? __('exam.pass') : __('exam.fail')}}</strong>
                        </p>
                    </td>
                </tr>
            @endif
            ...
            @if(@$generalsettingsResultType != 'mark')
                ...
                <tr>
                    ...
                    <td colspan="2"
                        style="text-align: center">{{getStudentMeritPosition($class_id, $section_id, $exam_details->id, $student_detail->id)}}</td>
                </tr>
            @endif
            </tbody>
        </table>
                        ...
                        <div class="text-right d-flex flex-column justify-content-end">
                            <div class="thumb text-right">
                                @if (@$exam_content->file)
                                    <img src="{{assetPath(@$exam_content->file)}}" width="100px">
                                @endif
                            </div>
