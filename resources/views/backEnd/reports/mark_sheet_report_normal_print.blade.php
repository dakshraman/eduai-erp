            ...
            <table class="align-center table border_table gray_header_table mb-0 ">
                ...
                @if(count($remainSubjects) > 0)
                    @foreach($remainSubjects as $reaminSubject)
                        @php
                            $subject = App\Models\SmSubject::find($reaminSubject);
                        @endphp
                        <tr>
            ...
            <table class="table border_table gray_header_table mb_30 max-width-400 ml_auto margin-auto report_table @if(resultPrintStatus('vertical_boarder')) mt_40 @endif">
                ...
                <tr>
                    <td class="nowrap {{generalSetting()->result_type == 'mark' ? 'text-center' : ''}}"
                        colspan="{{generalSetting()->result_type == 'mark' ? '2' : ''}}">@lang('reports.average_mark')</td>
                        ...
                        <td>
                            @php
                                if(in_array($failgpaname->grade_name,$temp_grade)){
                                    ...
                                    $grade_details= App\Models\SmResultStore::remarks($total_gpa);
                                }
                            @endphp
                        ...
                        <td>
                            @php
                                if(in_array($failgpaname->grade_name,$temp_grade)){
                                    ...
                                    $grade= App\Models\SmResultStore::remarks($total_gpa);
                                }
                            @endphp
                            {{@$grade->description}}
                        </td>
