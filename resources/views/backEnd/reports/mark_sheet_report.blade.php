    ...
    <section class="admin-visitor-area">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                @endif
                <div class="white-box">
                    {{ html()->form('POST', route('mark_sheet_reports'))->attributes([
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="d-flex">
                                                    <div>
                                                        <img class="logo-img"
                                                             src="http://localhost/naim/schoolmanagementsystem/public/backEnd/img/logo.png"
                                                             alt="">
                                                    </div>
                                                    <div class="ml-30">
                                                        <h3 class="text-white">School Management System</h3>
                                                        <p class="text-white mb-0">House 25, Road 27, Block B, 54th
                                                            Floor, New York, United States of America</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body">
