                            ...
                            <div class="{{(resultPrintStatus('header'))? "logo_img": "logo_img custom_result_print"}}">
                                ...
                                <div class="company_info">
                                    ...
                                    <h5>@lang('common.email')
                                        ...
                                        , @lang('common.phone')
                                        : {{isset(generalSetting()->phone)?generalSetting()->phone:'+96897002784'}}</h5>
                                </div>
                            </div>
                        </td>
                        </thead>
                ...
                <tr>
                    @foreach($subjects as $subject)
                        @php
                            ...
                            $subject_ID     = $subject->subject_id;
                            $subject_Name   = $subject->subject->subject_name;
                            $mark_parts      = \App\Models\SmAssignSubject::getMarksOfPart($student->id, $subject_ID, $class_id, $section_id, $exam_term_id, shiftEnable() ? $shift_id : '');
                            $subject_count= 0;
                        ...
                        @if($examReportSignature->count() == 1)
                            <div class="text-right d-flex flex-column justify-content-end">
                                <div class="thumb text-right">
                                    <img src="{{assetPath(@$examReportSignature->first()->signature)}}" width="100px">
                                </div>
                        ...
                        <td>
                            <div class="{{(resultPrintStatus('header'))? "logo_img": "logo_img custom_result_print"}}">
                                <div class="logo_thumb_upper">
                                    ...
                                    <h2 class="text-nowrap" style="text-wrap: nowrap; margin-left: 20px;">
            ...
            <tr>
                ...
                @foreach($subjects as $subject)
                    @php
                        $subject_ID    = $subject->subject_id;
                        $subject_Name   = $subject->subject->subject_name;
                        $mark_parts      = App\Models\SmAssignSubject::getNumberOfPart($subject_ID, $class_id, $section_id, $exam_term_id, shiftEnable() ? $shift_id : '');
                    @endphp
            ...
            @foreach($students->where('active_status' , 1) as $student)
                ...
                <tr>
                    ...
                    @foreach($subjects as $subject)
                        ...
                        <td>
                            @php
                                $tola_mark_by_subject = App\Models\SmAssignSubject::getSumMark($student->id, $subject_ID, $class_id, $section_id, $exam_term_id, shiftEnable() ? $shift_id : '');
                                $marks_by_students  = $marks_by_students + $tola_mark_by_subject;
                            @endphp
                            {{$tola_mark_by_subject}}
                        </td>
