...
@endsection
@section('mainContent')
    <link rel="stylesheet" href="{{ assetPath('public/backEnd/css/custom_result/style.css') }}">
    <style>
        tr {
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="col-lg-6 ml-30">
                                                            ...
                                                            <p class="text-white mb-0">
                                                                ...
                                                                @lang('common.phone')
                                                                : {{isset(generalSetting()->phone)?generalSetting()->phone:'hello@aorasoft.com'}}
                                                            </p>
                                                        </div>
                                                        <div class="offset-2"></div>
                                                        <div>
                                                            <img class="report-admit-img"
                                                                 src="{{ file_exists(@$studentDetails->student_photo) ? assetPath($studentDetails->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
                                                                 width="100" height="100"
                                                                 alt="{{assetPath($studentDetails->student_photo)}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                                ...
                                                                <table class="custom_table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @foreach ($assigned_exam as $key => $item)
                                                                            ...
                                                                            @if ($key==2)
                                                                                ...
                                                                                @endphp
                                                                            @endif
                                                                            <th colspan={{ $assign_subjects->count()*2+1 }}width">{{$item->title}} {{ $percentage }}
                                                                                %
                                                                            </th>
                                                                        @endforeach
                                                                    ...
                                                                    <tr>
                                                                        @foreach ($assigned_exam as $key => $exam)
                                                                            ...
                                                                            <td rowspan="2">
                                                                                ...
                                                                                @endif
                                                                                @php
                                                                                    $term_gpa=App\Models\CustomResultSetting::termResult($exam->exam_type_id,$input_class,$input_section,$input_student,$assign_subjects->count());
                                                                                    echo number_format((float)$term_gpa, 2, '.', '');
                                                                                    $term_final_gpa=\App\Models\CustomResultSetting::getFinalResult($exam->exam_type_id,$input_class,$input_section,$input_student,$percentage);
                                                                    ...
                                                                    @foreach ($assigned_exam as $exam)
                                                                        @foreach ($assign_subjects as $subject)
                                                                            <td>
                                                                                @php
                                                                                    $gpa=App\Models\CustomResultSetting::getSubjectGpa($exam->exam_type_id,$input_class,$input_section,$input_student,$subject->subject_id);
