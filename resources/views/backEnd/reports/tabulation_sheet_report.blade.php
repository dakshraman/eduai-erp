    ...
    <section class="admin-visitor-area">
        <div class="white-box">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div>
                        {{ html()->form('POST', route('tabulation_sheet_report_search'))->attributes([
                                ...
                                <div class="col-lg-3 mt-30-md md_mb_20">
                                    ...
                                    <select class="primary_select form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach($exam_types as $exam)
                                            <option value="{{$exam->id}}" @if( old('exam') )
                                                {{ old('exam') == $exam->id ? 'selected' : '' }}
                                                    @elseif( isset($exam_term_id) )
                                                {{ $exam_term_id == $exam->id ? 'selected' : '' }}
                                                    @endif
                                            >{{$exam->title}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 pull-right mt-0">
                                    <div class="print_button pull-right">
                                        ...
                                        {{ html()->form('POST', route('tabulation-sheet.print'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                            'id' => 'search_student',
                                        ...
                                        @else
                                            <input type="hidden" value="allSection" name="allStallSection">
                                        @endif
                                        <button type="submit" class="primary-btn small fix-gr-bg"><i
                                                    class="ti-printer"> </i> @lang('common.print')</button>
                                        {{ html()->form()->close() }}
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-lg-8 text-left text-lg-right mt-30-md">
                                                    ...
                                                    <p class="text-white mb-0"> @lang('common.email')
                                                        ...
                                                        , @lang('common.phone')
                                                        : {{isset(generalSetting()->phone)?generalSetting()->phone:'+96897002784'}}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <ul class="student_info">
                                                            ...
                                                            @if(shiftEnable() && $shift_id)
                                                                <li>
                                                                    <p>@lang('common.shift')</p>
                                                                    <p class="bold_text">
                                                                        : {{$tabulation_details['shift']}}</p>
                                                                </li>
                                                            @endif
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <table class="mt-0 mb-20 table table-striped table-bordered scrolled_table"
                                                        ...
                                                        <tr>
                                                            @foreach($subjects as $subject)
                                                                @php
                                                                    ...
                                                                    if(shiftEnable() && $shift_id){
                                                                        $mark_parts      = App\Models\SmAssignSubject::getNumberOfPart($subject_ID, $class_id, $section_id, $exam_term_id, $shift_id);
                                                                    }else{
                                                                        $mark_parts      = App\Models\SmAssignSubject::getNumberOfPart($subject_ID, $class_id, $section_id, $exam_term_id);
                                                                    }
                                                                @endphp
                                                                <th colspan="{{count($mark_parts)+1}}"
                                                                    class="subject-list large_spanTh">{{$subject_Name}}</th>
                                                            @endforeach
                                                            <th rowspan="2"
                                                                class="large_spanTh">@lang('exam.total_mark')</th>
                                                            @if ($optional_subject_setup!='')
                                                                @if (@generalSetting()->result_type != 'mark')
                                                                    <th class="large_spanTh">@lang('exam.gpa')</th>
                                                                    <th rowspan="2"
                                                                        class="large_spanTh">@lang('exam.gpa')</th>
                                                                    <th rowspan="2"
                                                                        class="large_spanTh">@lang('reports.result')</th>
                                                                @endif
                                                            @else
                                                                @if (@generalSetting()->result_type != 'mark')
                                                                    <th rowspan="2"
                                                            ...
                                                            @endif
                                                            <th rowspan="2"
                                                                class="large_spanTh">@lang('exam.position')</th>
                                                        </tr>
                                                        <tr>
                                                            @foreach($subjects as $subject)
                                                                @php
                                                                ...
                                                                @foreach($mark_parts as $sigle_part)
                                                                    <th class="large_padding">{{$sigle_part->exam_title}}
                                                                        ({{$sigle_part->exam_mark}})
                                                                    </th>
                                                                @endforeach
                                                        ...
                                                        @foreach($students as $student)
                                                            @php
                                                                ...
                                                                $opt_sub_gpa=0;
                                                                $optional_subject=App\Models\SmOptionalSubjectAssign::where('student_id','=',$student->id)
                                                            ...
                                                            <tr>
                                                                @foreach($subjects as $subject)
                                                                    @php
                                                                        $tola_mark_by_subject = 0;
                                                                        $subject_ID     = $subject->subject_id;
                                                                        $subject_Name   = $subject->subject->subject_name;
                                                                        if(shiftEnable() && $shift_id){
                                                                            $mark_parts      = App\Models\SmAssignSubject::getMarksOfPart($student->id, $subject_ID, $class_id, $section_id, $exam_term_id, $shift_id);
                                                                        }else{
                                                                            $mark_parts      = App\Models\SmAssignSubject::getMarksOfPart($student->id, $subject_ID, $class_id, $section_id, $exam_term_id);
                                                                        }
                                                                        $subject_count= 0;
                                                                ...
                                                                @else
                                                                    @if (@generalSetting()->result_type != 'mark')
                                                                        ...
                                                                        <td>
                                                                            @if(shiftEnable() && $shift_id)
                                                                                {{getStudentMeritPosition($class_id, $section_id, $exam_term_id, $tabulation_details['record_id'], $shift_id)}}
                                                                            @else
                                                    ...
                                                    <div style="margin-top:auto; margin-bottom:20px; display: flex; justify-content: {{$examReportSignature->count() == 1 ? 'flex-end' : 'space-between'}}; flex-wrap: wrap; align-items: center;">
                                                        @foreach ($examReportSignature as $signature)
                                                            <div style="text-align: right; display: flex; align-items: center; justify-content: center; margin-right: 24px; flex-direction: column">
                                                                <div>
                                                                    <img src="{{assetPath($signature->signature)}}"
                                                                ...
                                                                @if($examReportSignature->count() == 1)
                                                                    <div class="text-right d-flex flex-column justify-content-end">
                                                                        <div class="thumb text-right">
                                                                            <img src="{{assetPath(@$examReportSignature->first()->signature)}}"
                                                                                 width="100px">
                                                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 pull-right">
                                    <div class="print_button pull-right">
                                        ...
                                        <button type="submit" class="primary-btn small fix-gr-bg"><i
                                                    class="ti-printer"> </i> @lang('common.print')
                                        </button>
                                        {{ html()->form()->close() }}
                                    </div>
                                </div>
                                                    ...
                                                    <div class="student_marks_table pt-0">
                                                        <div class="table-responsive">
                                                            <table class="mt-30 mb-20 table table-bordered w-100 scrolled_table">
                                                                ...
                                                                <tr>
                                                                    <th class="name_field"
                                                                        rowspan="2">@lang('common.name')</th>
                                                                    <th class="roll_field"
                                                                        rowspan="2">@lang('student.roll_no')</th>
                                                                    @foreach($subjects as $subject)
                                                                        @php
                                                                            $subject_ID    = $subject->subject_id;
                                                                            $subject_Name   = $subject->subject->subject_name;
                                                                        ...
                                                                        <th class="large_spanTh"
                                                                            colspan="{{count($mark_parts)+1}}">{{$subject_Name}}</th>
                                                                    @endforeach
                                                                ...
                                                                @foreach($students->where('active_status' , 1) as $student)
                                                                    @php
                                                                        ...
                                                                        $optional_subject=App\Models\SmOptionalSubjectAssign::where('student_id','=',$student->id)
                                                                                        ->where('session_id','=',$student->session_id)
                                                                                        ->first();
                                                                        $query = App\Models\StudentRecord::where('class_id', $class_id)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @foreach($subjects as $subject)
                                                                            ...
                                                                            <td>
                                                                                @php
                                                                                    if(shiftEnable() && $shift_id){
                                                                                        $tola_mark_by_subject = \App\Models\SmAssignSubject::getSumMark($student->id, $subject_ID, $class_id, $section_id, $exam_term_id, $shift_id);
                                                                                    }else{
                                                                                        $tola_mark_by_subject = \App\Models\SmAssignSubject::getSumMark($student->id, $subject_ID, $class_id, $section_id, $exam_term_id);
                                                                                    }
                                                                                    $marks_by_students  = $marks_by_students + $tola_mark_by_subject;
                                                                                @endphp
                                                                                {{$tola_mark_by_subject}}
                                                                        ...
                                                                        @if (@generalSetting()->result_type != 'mark')
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                @else
                                                                                    {{getStudentMeritPosition($class_id, $section_id, $exam_term_id, $studentRecord->id, shiftEnable() ? $shift_id : '')}}
                                                                                @endif
