                                            ...
                                            <div class="row">
                                                ...
                                                <table style="max-width: 400px; margin-bottom: 20px;"
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                            <td colspan="{{$colspan / $col_for_result + 7}}"
                                                                style="padding:10px; font-weight:bold">{{$total_marks}} @lang('reports.out_of') {{$all_exam_type_full_mark}}</td>
                                                        @else
                                                    ...
                                                    @if (@generalSetting()->result_type != 'mark')
                                                        ...
                                                        {{-- Total Gpa Start --}}
                                                        <tr>
                                                            <td colspan="{{$colspan / $col_for_result - 1}}">@lang('exam.total_grade')
                                                                ss
                                                            </td>
                                                            @if($has_failed)
                                                                <td colspan="{{$colspan / $col_for_result + 9}}"
