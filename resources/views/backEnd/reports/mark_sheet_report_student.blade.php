                ...
                @else
                    ...
                    <div class="col-lg-3 mt-30-md md_mb_20">
                        ...
                        <select class="primary_select form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}"
                                name="exam">
                            <option data-display="@lang('reports.select_exam') *"
                                    value="">@lang('reports.select_exam')
                                *
                            </option>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        @php
                                                                            if(@$generalsettingsResultType == 'mark'){
                                                                                $total_mark+=subjectPercentageMark(round(@singleSubjectMark($data->student_record_id,$data->subject_id,$data->exam_type_id)[0]), @subjectFullMark($exam_details->id, $data->subject->id, $class_id, $section_id, $shift_id));
                                                                            }else{
    ...
    $optional_countable_gpa=0;
                                                        ...
                                                        <table class="table @if(resultPrintStatus('vertical_boarder')) mt-5 @endif">
                                                            ...
                                                            @if ($average_passing_mark)
                                                                <tr>
                                                                    ...
                                                                    <td class="nowrap">
                                                                        ...
                                                                        <p>
                                                                            <strong>
                                                                                @if(isset($failgpaname) && in_array($failgpaname->grade_name, $temp_grade))
                                                                                    {{__('exam.fail')}}
                                                                                @else
                                                            ...
                                                            <tr>
                                                                <td class="nowrap {{$generalsettingsResultType == 'mark' ? 'text-center' : ''}}"
                                                                    colspan="{{$generalsettingsResultType == 'mark' ? '2' : ''}}">@lang('reports.average_mark')</td>
                                                            ...
                                                            @if(@$generalsettingsResultType != 'mark')
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2"
                                                                        style="text-align: center !important;">{{getStudentMeritPosition($class_id, $section_id, $exam_type_id, $student_detail->id)}}</td>
                                                ...
                                                @if(isset($exam_content))
                                                    <table style="width:100%"
                                                           class="border-0 mark_sheet_footer">
                                                        <tbody>
                                                        <tr>
