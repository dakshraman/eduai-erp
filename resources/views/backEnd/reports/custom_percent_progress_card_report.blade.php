...
@section('mainContent')
    ...
    @if(resultPrintStatus('vertical_boarder'))
        <style>
            ...
            .single-report-admit table tbody tr th {
                border: 1px solid rgba(92, 105, 165, 0.15) !important;
            }
                ...
                <div class="white-box">
                    ...
                    <div class="row">
                        ...
                        @include('backEnd.common.search_criteria', [
                            ...
                            'visiable' => ['academic', 'student', 'shift', 'class', 'section'],
                            'academic_name' => 'academic_year',
                            'shift_name' => 'shift',
                            'class_name' => 'class',
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <div class="report-admit-img profile_100"
                                                         style="background-image: url({{ file_exists(@$studentDetails->studentDetail->student_photo) ? assetPath($studentDetails->studentDetail->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }})"></div>
                                                    ...
                                                    <div class="student_marks_table">
                                                        <div class="row">
                                                            <div class="col-lg-7 text-black">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        @if(shiftEnable())
                                                                            <p class="mb-0">
                                                                                @lang('common.shift') :<span
                                                                                        class="primary-color fw-500">{{ $studentDetails->shift->name }}</span>
                                                                            </p>
                                                                        @endif
                                                            ...
                                                            <div class="col-12 text-center mb-3">
                                                                <h3>
                                                                    <span style="border-bottom: 3px double;">@lang('reports.progress_report')</span>
                                                                </h3>
                                                            </div>
                                                                ...
                                                                @foreach($subjects as $data)
                                                                    <tr class="text-center">
                                                                        ...
                                                                        foreach ($assinged_exam_types as $assinged_exam_type){
                                                                            ...
                                                                            $result = App\Models\SmResultStore::GetResultBySubjectId($class_id, $section_id, $data->subject_id, $assinged_exam_type, $studentDetails->id);

                                                                            if (!empty($result)) {
                                                                                $final_results = App\Models\SmResultStore::GetFinalResultBySubjectId($class_id, $section_id, $data->subject_id, $assinged_exam_type, $studentDetails->id);

                                                                                $term_base = App\Models\SmResultStore::termBaseMark($class_id, $section_id, $data->subject_id, $assinged_exam_type, $studentDetails->id);
                                                                            }
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                                        <td colspan="{{$colspan / $col_for_result + 7}}"
                                                                            style="padding:10px; font-weight:bold">{{number_format($totalavgMarkAddition,2)}} @lang('reports.out_of') {{ number_format($all_exam_type_full_mark / $total_semesters,2) }}</td>
                                                                    @else
                                                                ...
                                                                @if (@generalSetting()->result_type != 'mark')
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                                            ...
                                                                            <td colspan="3"
                                                                                style="padding:10px;">@lang('reports.without_additional_gpa')</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @if ($optional_subject_setup!='' && $student_optional_subject!='')
                                                                            ...
                                                                            <td colspan="3"
                                                                                style="padding:10px;">@lang('reports.without_additional_grade')</td>
                                                                            <td colspan="2" style="padding:10px;">
                                                                    ...
                                                                    <tr>
                                                                        @if($optional_subject_setup!='' && $student_optional_subject!='')
                                                                            ...
                                                                            <td colspan="{{$colspan / $col_for_result + 4}}"
                                                                                style="padding:10px; font-weight:bold">
                                                                                {{remarks(number_format($total_with_optional_percentage,2,'.',''))}}
                                                                            </td>
                                                                        @else
                                                                            <td colspan="{{$colspan / $col_for_result - 1}}">@lang('reports.position')</td>
                                                                            <td colspan="{{$colspan / $col_for_result + 6}}"
                                                                                style="padding:10px; font-weight:bold">
