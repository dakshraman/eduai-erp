            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('student_transport_report_store'))->attributes([
...
<input type="hidden" id="search_class_id" value="{{ isset($class_id) ? $class_id:null }}">
<input type="hidden" id="search_section_id" value="{{ isset($section_id) ? $section_id:null }}">
<input type="hidden" id="search_route_id" value="{{ isset($route_id) ? $route_id:null }}">
<input type="hidden" id="search_vechile_id" value="{{ isset($vechile_id) ? $vechile_id:null }}">
@if(moduleStatusCheck('Branch'))
<input type="hidden" id="branch_id" value="{{ isset($branch_id) ? $branch_id:null }}">
@endif
@endsection
       ...
       $('.data-table').DataTable({
                     ...
                     "ajax": $.fn.dataTable.pipeline( {
                           ...
                           data: { 
                                ...
                                'route_id' : $("#search_route_id").val(),
                                'vechile_id' : $("#search_vechile_id").val(),
                                @if(moduleStatusCheck('Branch'))
