        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        @if(isset($assign_vehicle))
                            {{ html()->form('PUT', route('vehicle-update', @$assign_vehicle->id))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}
                        @else
                        @if(userPermission('vehicle-add'))
                            {{ html()->form('POST', route('vehicle-store'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}
                        ...
                        <div class="white-box">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <input type="hidden" name="id" value="{{isset($assign_vehicle)? @$assign_vehicle->id: old('assign_vehicle')}}">
                            ...
                            <div class="row mt-15">
                                <div class="col-lg-12">
                                    ...
                                    <select class="primary_select form-control {{ $errors->has('driver_id') ? ' is-invalid' : '' }}" 
                                            id="select_class" 
                                            name="driver_id">
                                        <option data-display="@lang('transport.select_driver') *" value="">
                                            @lang('transport.select_driver') *
                                        </option>
                                        @foreach($drivers as $driver)
                                            <option value="{{ $driver->id }}"
                                                {{ old('driver_id', @$assign_vehicle->driver_id ?? '') == $driver->id ? 'selected' : '' }}>
                                                {{ @$driver->full_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        ...
                                                        {{ html()->form('DELETE', route('vehicle-delete', @$assign_vehicle->id))->attribute('enctype', 'multipart/form-data')->open() }}
