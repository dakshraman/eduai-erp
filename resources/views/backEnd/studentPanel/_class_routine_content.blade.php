                                                        ...
                                                        @foreach ($sm_weekends as $sm_weekend)
                                                            @php
                                                                if (moduleStatusCheck('University')) {
                                                                    ...
                                                                    $studentClassRoutine = \App\Models\SmWeekend::studentClassRoutineFromRecord($record->class_id, $record->section_id, $sm_weekend->id);
                                                                }
                                                            @endphp
                            ...
                            <div role="tabpanel" class="tab-pane fade  @if ($key == 0) active show @endif"
                                ...
                                <div class="container-fluid p-0">
                                    <div class="row {{ $routineDashboard ? '' : 'mt-15' }}">
                                        ...
                                        @if (!$routineDashboard)
                                            <div class="col-lg-6 col-md-6 col-sm-6 pull-right">
                                                <a href="{{ route('classRoutinePrint', [@$record->class_id, @$record->section_id, shiftEnable() ?? $record->shift_id]) }}"
                                                   class="primary-btn small fix-gr-bg pull-right" target="_blank"><i
                                                            class="ti-printer"> </i> Print</a>
                                            </div>
                                        @endif
                                                ...
                                                <div class="table-responsive">
                                                    <table id="default_table"
                                                        ...
                                                        <tr>
                                                            ...
                                                            @foreach ($sm_weekends as $sm_weekend)
                                                                @php
                                                                    $studentClassRoutine = App\Models\SmWeekend::studentClassRoutineFromRecord($record->class_id, $record->section_id, $sm_weekend->id, shiftEnable() ?? $record->shift_id);
                                                                @endphp
                                                                @if ($studentClassRoutine->count() > $height)
                                                                    @php
                                                                        $height = $studentClassRoutine->count();
