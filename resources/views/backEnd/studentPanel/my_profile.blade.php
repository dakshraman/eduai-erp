...
@section('mainContent')
    ...
    @endpush
    @php
        $setting = app('school_general_settings');
                        ...
                        <ul class="nav nav-tabs tabs_scroll_nav mb-10" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Session::get('studentAttendance') == 'active' ? 'active' : '' }} "
                                   ...
                                   data-toggle="tab">@lang('student.my_attendance')</a>
                            </li>
                            <li class="nav-item">
                                                    ...
                                                    @foreach ($fees_assigneds as $fees_assigned)
                                                        @if ($fees_assigned->record_id == $record->id)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @php
                                                                        echo currency_format($fees_assigned->feesGroupMaster->amount);
                                                                    @endphp
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                            ...
                                                            @php
                                                                @$payments = App\Models\SmFeesAssign::feesPayment(@$fees_assigned->feesGroupMaster->feesTypes->id, @$fees_assigned->student_id, $fees_assigned->recordDetail->id);
                                                                $i = 0;
                                                            @endphp
                                                    ...
                                                    <x-table>
                                                        <table id="" class="table mb-5" cellspacing="0"
                                                            ...
                                                            @foreach ($get_results as $mark)
                                                                @php
                                                                    $get_subject_marks = subjectFullMark($mark->exam_type_id, $mark->subject_id, $mark->studentRecord->class_id, $mark->studentRecord->section_id, $mark->studentRecord->shift_id);
                                                                    ...
                                                                    $schedule_by_subject = App\Models\SmStudent::scheduleBySubject($exam->id, $mark->subject_id, @$record);
                                                                    $result_subject = 0;
                                                                    if(@generalSetting()->result_type == 'mark'){
                                                                    ...
                                                                    if (@$mark->is_absent == 0) {
                                                                        if(@generalSetting()->result_type == 'mark'){
                                                                            $grand_total += @subjectPercentageMark(@$mark->total_marks, @subjectFullMark($mark->exam_type_id, $mark->subject_id, $mark->studentRecord->class_id, $mark->studentRecord->section_id, $mark->studentRecord->shift_id));
                                                                        }else{
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @else
                                                                            ({{ @subjectFullMark($mark->exam_type_id, $mark->subject_id, $mark->studentRecord->class_id, $mark->studentRecord->section_id, $mark->studentRecord->shift_id) }})
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if (@generalSetting()->result_type == 'mark')
                                                                            {{@subjectPercentageMark(@$mark->total_marks, @subjectFullMark($mark->exam_type_id, $mark->subject_id, $mark->studentRecord->class_id, $mark->studentRecord->section_id, $mark->studentRecord->shift_id))}}
                                                                        @else
                                                                            {{@$mark->total_marks}}
                                                                        @endif
                                                                    </td>
                                                                    @if(@generalSetting()->result_type == 'mark')
                                                                        <td>
                                                                            @php
                                                                                $totalMark = subjectPercentageMark(@$mark->total_marks, @subjectFullMark($mark->exam_type_id, $mark->subject_id, $mark->studentRecord->class_id, $mark->studentRecord->section_id, $mark->studentRecord->shift_id));
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>@lang('exam.position')
                                                                    : {{getStudentMeritPosition($record->class_id, $record->section_id, $exam->id, $record->id, $record->shift_id)}}</th>
                                                                <th>
                                        ...
                                        @foreach ($result_views as $result_view)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endphp
                                                    @if ($now >= $endTime)
                                                        <a class="linkopenmodal btn btn-success modalLink"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 text-center mt-40">
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            ...
                                                            <button class="primary-btn fix-gr-bg" type="submit">save
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
