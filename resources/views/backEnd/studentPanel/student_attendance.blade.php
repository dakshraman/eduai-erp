            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('student_my_attendance_search'))->attributes([
                ...
                <div class="white-box">
                    <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
                        @foreach($records as $key => $record)
                            <li class="nav-item">
                                <a class="nav-link @if($key== 0) active @endif " href="#tab{{$key}}" role="tab" data-toggle="tab">{{$record->class->class_name}} ({{$record->section->section_name}}) @if(shiftEnable() && @$record->shift) [{{$record->shift->name}}] @endif</a>
                            </li>
                        @endforeach
                    </ul>
                    <!-- Tab panes -->
                                ...
                                <div class="row">
                                    <div class="col-lg-12 d-flex justify-content-between">
                                        <div class="lateday d-flex">
                                            ...
                                            <div class="mr-3">@lang('student.leave'): <span class="text-muted">Le</span></div>
                                        </div>
                                        ...
                                        <div>
                                            <div class="table-responsive" style="padding:20px">
                                                ...
                                                <table id="table_id1" style="margin-bottom:25px" class="table table-responsive" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        @php
                                                            $studentAttendance = $record->studentAttendanceByMonth($month, $year);
                                                                ...
                                                                @endphp <td
                                                                    ...
                                                                    @foreach($studentAttendance as $value)
                                                                        @if(strtotime($value->attendance_date) == strtotime($date))
                                                                            @php
                                                                                $studentAttendanceType = $value->attendance_type;
                                                                                $notes = $value->notes;
                                                                            @endphp
                                                                    ...
                                                                    @if(is_null($studentAttendanceType) && in_array($dayName, $weekendDayNames))
                                                                        W
                                                                    @endif
                                                                </td>
                                                            @endfor
