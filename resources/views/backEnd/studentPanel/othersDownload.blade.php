                        ...
                        <ul class="nav nav-tabs tabs_scroll_nav ml-0" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if($key== 0) active @endif " href="#tab{{$key}}" role="tab" data-toggle="tab">
                                    ...
                                    @else
                                    {{$record->class->class_name}} ({{$record->section->section_name}}) @if(shiftEnable()) @if($record->shift) [{{@$record->shift->shift_name}}] @endif @endif
                                    @endif
                                </a>
                            </li>
                            @endforeach
                                        ...
                                        <tbody>
                                            ...
                                            @php
                                                if(moduleStatusCheck('University')){
                                                    ...
                                                    $contents =  $record->getUploadContent('ot');
                                                }
                                            @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if(@$value->classes != "" && $value->sections != "")
                                                            @lang('study.all_students_of') ({{@$value->classes->class_name.'->'.@$value->sections->section_name}}) @if($record->shift) [{{@$record->shift->shift_name}}] @endif
                                                        @endif
