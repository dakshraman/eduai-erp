        ...
        <div class="container-fluid p-0">
            <div class="white-box">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="main-title">
                            <h3 class="mb-15">@lang('student.welcome_to')
                                <strong> {{ @$student_detail->full_name }}</strong></h3>
                        </div>
                    </div>
                </div>
                <div class="row row-gap-30">
                    ...
                    @endphp
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route(generalSetting()->fees_status == 0 ? 'student_fees' : 'fees.student-fees-list') }}"
                           class="d-block">
                            <div class="white-box single-summery fuchsia">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            @foreach ($records as $key => $record)
                                                @if ($record->Exam)
                                                    @foreach ($record->Exam as $key => $exam)
                                                        @php
                                                            $exam_routines = App\Models\SmExamSchedule::getAllExams($exam->class_id, $exam->section_id, $exam->exam_type_id);
                                                        @endphp
                                                        <div role="tabpanel"
                                                                                ...
                                                                                @foreach ($exam_routines as $date => $exam_routine)
                                                                                    <tr
                                                                                        ...
                                                                                        <td>{{ $exam_routine->class ? $exam_routine->class->class_name : '' }}
                                                                                            ...
                                                                                            @if(shiftEnable())
                                                                                                {{ $exam_routine->shift ? '[]' . $exam_routine->shift->name . ']' : '' }}
                                                                                            @endif
                                                                                        </td>
