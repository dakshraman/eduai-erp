                                ...
                                <a class="nav-link @if($key== 0) active @endif " href="#tab{{$key}}" role="tab"
                                   data-toggle="tab">
                                    @if(moduleStatusCheck('University'))
                                        {{@$record->unSemesterLabel->name}} ({{@$record->unDepartment->name}}
                                        ...
                                        <x-table>
                                            <table id="" class="table school-table-style-parent-fees" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="nowrap">@lang('fees.fine')
                                                        ({{@generalSetting()->currency_symbol}})
                                                    </th>
                                                ...
                                                @foreach($record->fees as $fees_assigned)
                                                    ...
                                                    @php
                                                        ...
                                                        $paid = \App\Models\SmFeesAssign::feesPayment($fees_assigned->feesGroupMaster->feesTypes->id,$fees_assigned->student_id,$fees_assigned->record_id)->sum('amount');

                                                        @$total_grand_paid += @$paid
                                                    @endphp
                                                    @php
                                                        //Sum of total fine for single fees type
                                                        $fine = \App\Models\SmFeesAssign::feesPayment($fees_assigned->feesGroupMaster->feesTypes->id,$fees_assigned->student_id,$fees_assigned->record_id)->sum('fine');
                                                                ...
                                                                <div class="dropdown CRM_dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        ...
                                                                        @if( (moduleStatusCheck('XenditPayment') == TRUE) && ($balance_amount != 0) )
                                                                            <form action="{!!route('xenditpayment.feesPayment')!!}"
                                                                                ...
                                                                                <input type="hidden" name="record_id"
                                                                                       value="{{@$fees_assigned->recordDetail->id}}">
                                                                                <div class="pay">
                                                                                    <button class="dropdown-item razorpay-payment-button btn filled small"
                                                                                            @if(serviceCharge('XenditPayment'))
                                                                                                data-toggle="tooltip"
                                                                                            data-title="{{ __('common.service charge for per transaction ') }} {{ serviceCharge('XenditPayment')}}"
                                                                                            @endif
                                                                                            type="submit">
                                                                            ...
                                                                            <div class="pay">
                                                                                <button class="dropdown-item btn filled small khalti-payment-button"
                                                                                        ...
                                                                                        @if(serviceCharge('KhaltiPayment'))
                                                                                            data-toggle="tooltip"
                                                                                        data-title="{{ __('common.service charge for per transaction ')}} {{ serviceCharge('KhaltiPayment') }}"
                                                                                        @endif
                                                                                >
                                                                        ...
                                                                        @if($already_add=="" && $balance_amount !=0)
                                                                            @php
                                                                                $KhaltiPayment = $balance_amount * 100;
                                                                            @endphp
                                                                            @if(@$data['bank_info']->active_status == 1 || @$data['cheque_info']->active_status == 1 )
                                                                                <a class="dropdown-item modalLink"
                                                                                   ...
                                                                                   href="{{route('fees-generate-modal-child', [@$KhaltiPayment, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id,$fees_assigned->id,$fees_assigned->record_id])}}">
                                                                                    @lang('fees.add_bank_payment')
                                                                                </a>
                                                                            @endif
                                                                        @else
                                                                            @if($balance_amount !=0)
                                                                                @php $KhaltiPayment = $balance_amount*100;@endphp
                                                                                <a class="dropdown-item modalLink"
                                                                                   data-modal-size="modal-lg"
                                                                                   title="{{$fees_assigned->feesGroupMaster->feesGroups->name.': '. $fees_assigned->feesGroupMaster->feesTypes->name}}"
                                                                                   href="{{route('fees-generate-modal-child', [@$KhaltiPayment, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id,$fees_assigned->id, $fees_assigned->record_id])}}">
                                                                        ...
                                                                        @if(!empty($is_paypal) && $balance_amount !=0)
                                                                            <form method="POST"
                                                                                  action="{{ route('studentPayByPaypal') }}"
                                                                                ...
                                                                                <button type="submit"
                                                                                        ...
                                                                                        @if(serviceCharge('PayPal'))
                                                                                            data-toggle="tooltip"
                                                                                        data-title="{{ __('common.service charge for per transaction ') }} {{ serviceCharge('PayPal') }}"
                                                                                        @endif
                                                                                >
                                                                        ...
                                                                        @if(!empty($is_paystack) && $balance_amount !=0)
                                                                            <form method="POST"
                                                                                ...
                                                                                <input type="hidden" name="key"
                                                                                       value="{{ @$paystack_info->gateway_secret_key }}">
                                                                                <input type="hidden" name="record_id"
                                                                                       value="{{@$fees_assigned->recordDetail->id}}">
                                                                                <button type="submit"
                                                                                        class=" dropdown-item"
                                                                                        @if(serviceCharge('Paystack'))
                                                                                            data-toggle="tooltip"
                                                                                        data-title="{{ __('common.service charge for per transaction ') }} {{ serviceCharge('Paystack') }}"
                                                                                        @endif
                                                                                >
                                                                        ...
                                                                        @if(!empty($is_stripe) && $balance_amount !=0)
                                                                            <a class="dropdown-item modalLink"
                                                                               ...
                                                                               @if(serviceCharge('Stripe'))
                                                                                   data-toggle="tooltip"
                                                                               data-title="{{ __('common.service charge for per transaction ') }} {{ serviceCharge('Stripe') }}"
                                                                               @endif
                                                                        ...
                                                                        @if(moduleStatusCheck('CcAveune') && $balance_amount !=0)
                                                                            ...
                                                                            <a type="submit"
                                                                               ...
                                                                               @if(serviceCharge('CcAveune'))
                                                                                   data-toggle="tooltip"
                                                                               data-title="{{ __('common.service charge for per transaction ') }} {{ serviceCharge('CcAveune') }}"
                                                                               @endif
                                                                        ...
                                                                        @if(moduleStatusCheck('PhonePay') && $balance_amount !=0)
                                                                            ...
                                                                            <form method="POST"
                                                                                  action="{{ route('studentFeesPay-PhonePe') }}"
                                                                                  accept-charset="UTF-8"
                                                                                  class="form-horizontal" role="form">
                                                                                @csrf
                                                                                <input type="hidden" name="assign_id"
                                                                                ...
                                                                                <button type="submit"
                                                                                        ...
                                                                                        @if(serviceCharge('PhonePe'))
                                                                                            data-toggle="tooltip"
                                                                                        data-title="{{ __('common.service charge for per transaction ') }} {{ serviceCharge('PhonePe') }}"
                                                                                        @endif
                                                                                >
                                                                                    @lang('fees.PhonePe')
                                                                        ...
                                                                        @if(moduleStatusCheck('SslCommerz') && $balance_amount !=0)
                                                                            <!-- start PhonePay Gateway  -->
                                                                            @php
                                                                                $is_CcAveune = DB::table('sm_payment_methhods')
                                                                                            ->where('method','PhonePe')
                                                                            ...
                                                                            <form method="POST"
                                                                                  action="{{ route('ssl.studentFeesPay') }}"
                                                                                  accept-charset="UTF-8"
                                                                                  class="form-horizontal" role="form">
                                                                                @csrf
                                                                                <input type="hidden" name="assign_id"
                                                                        ...
                                                                        @if(moduleStatusCheck('RazorPay') == TRUE and !empty($is_active))
                                                                            ...
                                                                            <form id="rzp-footer-form_{{$count}}"
                                                                                ...
                                                                                <input type="hidden" name="amount"
                                                                                       id="amount"
                                                                                       value="{{ ($balance_amount + chargeAmount('RazorPay', $balance_amount))  * 100}}"/>
                                                                                <input type="hidden" name="fees_type_id"
                                                                                       id="fees_type_id"
                                                                                       value="{{$fees_assigned->feesGroupMaster->fees_type_id}}">
                                                                                <input type="hidden" name="student_id"
                                                                                ...
                                                                                <div class="pay">
                                                                                    <button class="dropdown-item razorpay-payment-button btn filled small"
                                                                                            ...
                                                                                            @if(serviceCharge('RazorPay'))
                                                                                                data-toggle="tooltip"
                                                                                            data-title="{{ __('common.service charge for per transaction ')}}
                                                                        ...
                                                                        @if((moduleStatusCheck('Raudhahpay') == TRUE)  && ($balance_amount > 0))
                                                                            ...
                                                                            <form id="xend-footer-form_{{$count}}"
                                                                                  action="{!!route('raudhahpay.feesPayment')!!}"
                                                                                  method="POST"
                                                                                  style="width: 100%; text-align: center">
                                                                                @csrf
                                                                                <input type="hidden" name="amount"
                                                                                ...
                                                                                <div class="pay">
                                                                                    <button class="dropdown-item razorpay-payment-button btn filled small"
                                                                                            ...
                                                                                            @if(serviceCharge('Raudhahpay'))
                                                                                                data-toggle="tooltip"
                                                                                            data-title="{{ __('common.service charge for per transaction ')}} {{ serviceCharge('Raudhahpay') }}"
                                                                                            @endif
                                                                                            type="submit">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ html()->form('POST', route('fees-payment-delete'))->attribute('enctype', 'multipart/form-data')->open() }}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        <button type="button" class="primary-btn tr-bg"
                                data-dismiss="modal">@lang('common.cancel')</button>
                        {{ html()->form('POST', url('child-bank-slip-delete'))->attribute('enctype', 'multipart/form-data')->open() }}
...
@if(moduleStatusCheck('KhaltiPayment')==true)
    @push('script')
        ...
        <script>
            $(documet).on('click', '.khalti-payment-button', function () {
