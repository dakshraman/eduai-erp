                                           ...
                                           <h4>{{++$j.'.'}} {{@$question->questionBank->question}}</h4> 
                                            ...
                                            @elseif($question->questionBank->type == "MI")
                                                ...
                                                <div class="quiestion_group">
                                                    @foreach($multiple_options as $multiple_option)
                                                        <div class="single_question " style="background-image: url({{assetPath($multiple_option->title)}})">
                                            ...
                                            <div class="mt-20">
                                                ...
                                                @elseif(@$question->questionBank->type == "MI")
                                                    ...
                                                    <div class="quiestion_group">
                                                        ...
                                                        <div class="single_question "style="background-image: url({{assetPath($ques_bank_multiple->title)}})">
                                                            <div class="img_ovelay">
                                                                <div class="icon">
                                                                    <i class="fa fa-check"></i>
                                                                </div>
