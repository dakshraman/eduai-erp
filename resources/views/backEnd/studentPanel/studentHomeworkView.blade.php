                        ...
                        <div class="homework_info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="name">
                                            ...
                                            @else
                                                {{@$homeworkDetails->sections->section_name}} @if($homeworkDetails?->shift)
                                                    [{{@$homeworkDetails?->shift?->shift_name}}]
                                                @endif
                                            @endif
                                        </div>
                                    </div>
                            ...
                            @php
                                if (Auth::user()->role_id == 2) {
                                   $student_detail = \App\Models\SmStudent::where('user_id', Auth::user()->id)->first();
                                } else {
                                    $parent = Auth::user()?->parent;
                                    $student_detail = \App\Models\SmStudent::where('parent_id', $parent?->id)->first();
                                }
                                            ...
                                            @if (!empty($files))
                                                ...
                                                @else
                                                    @foreach ($files as $file)
                                                        <a href="{{ assetPath($file) }}" download>
                        ...
                        <div class="file-preview" style="display: none">
                            ...
                            @foreach ($files as $file)
                                ...
                                <div class="mt-3">
                                    ...
                                    @else
                                        <div class="alert alert-warning">{{ strtoupper($ext) }} file not previewable.
                                        </div>
                                    @endif
                                    ...
                                    <div class="mt-4 d-flex justify-content-between">
                                        ...
                                        @endphp
                                        <a class="primary-btn tr-bg" download="{{ $downloadName }}"
                                           href="{{ $fileUrl }}">
