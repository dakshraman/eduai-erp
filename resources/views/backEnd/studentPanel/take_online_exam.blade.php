        ...
        <div class="container-fluid p-0">
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    {{ html()->form('POST', route('student_online_exam_submit'))->attributes([
                                ...
                                <table class="" cellspacing="0" width="100%">
                                    ...
                                    <tr align="center" class="exam-bg">
                                        <td colspan="2" class="pt-4 pb-3 px-sm-5">
                                            ...
                                            <h2><strong>@lang('common.subject')
                                                    : </strong>{{@$online_exam->subject !=""?@$online_exam->subject->subject_name:""}}
                                            </h2>
                                            <h6><strong>@lang('common.class_Sec')
                                                    : </strong>{{@$online_exam->class !=""?@$online_exam->class->class_name:""}}
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p><strong>@lang('exam.instruction')
                                                            : </strong>{{@$online_exam->instruction}}</p>
                                                </div>
                                                <div class="col-md-6">
                                                    <p class="mb-2">
                                                        <strong>@lang('exam.exam_has_to_be_submitted_within')
                                                            : </strong> {{ dateTimeConvert(@$online_exam->end_time)}}
                                                    </p>
                                    ...
                                    @foreach($assigned_questions as $question)
                                        @php
                                            $student_id=Auth::user()->student->id;
                                                $submited_answer=\App\Models\OnlineExamStudentAnswerMarking::StudentGivenAnswer($question->online_exam_id,$question->question_bank_id,$student_id);
                                                if ($question->questionBank->type=='MI') {
                                                    $submited_answer=\App\Models\OnlineExamStudentAnswerMarking::StudentImageAnswer($question->online_exam_id,$question->question_bank_id,$student_id);

                                                }
                                        @endphp
                                        <input type="hidden" name="online_exam_id"
                                               value="{{@$question->online_exam_id}}">
                                        <input type="hidden" name="question_ids[]"
                                               value="{{@$question->question_bank_id}}">
                                            ...
                                            <td width="80%" class="pt-5">
                                                ...
                                                @if(@$question->questionBank->type == "MI")
                                                    ...
                                                    <img class="mb-20" width="100%" height="auto"
                                                         src="{{assetPath($question->questionBank->question_image)}}"
                                                         alt="">
                                                @endif
                                                    ...
                                                    @foreach($multiple_options as $multiple_option)
                                                        <div class="mt-20">
                                                            <input data-question="{{@$question->question_bank_id}}"
                                                                   type="radio" data-option="{{@$multiple_option->id}}"
                                                                   id="answer{{@$multiple_option->id}}"
                                                                   class="common-checkbox answer_question_mu"
                                                                   name="options_{{@$question->question_bank_id}}"
                                                                   value="{{$multiple_option->id}}" {{isset($submited_answer)? $submited_answer->user_answer==$multiple_option->id? 'checked' :'' : '' }}>
                                                    ...
                                                    <div class="upload_grid_wrapper">
                                                        @foreach($multiple_options as $multiple_option)
                                                            ...
                                                            <div class="single_upload_img">
                                                                ...
                                                                <img src="{{assetPath($multiple_option->title)}}" alt="">
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                    ...
                                                    <div class="d-flex radio-btn-flex mt-20">
                                                        <div class="mr-30">
                                                            <input data-question="{{@$question->question_bank_id}}"
                                                                   ...
                                                                   {{isset($submited_answer)? $submited_answer->user_answer=='T'? 'checked' :'' : '' }} class="common-radio relationButton answer_question_mu">
                                                        ...
                                                        <div class="mr-30">
                                                            <input data-question="{{@$question->question_bank_id}}"
                                                                   ...
                                                                   {{isset($submited_answer)? $submited_answer->user_answer=='F'? 'checked' :'' : '' }} class="common-radio relationButton answer_question_mu">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-10">
                                                            <div class="primary_input mt-20">
                                                                ...
                                                                <textarea
                                                                        class="primary_input_field form-control mt-10 form_filler_{{@$question->question_bank_id}}"
                                                                        name="answer_word_{{@$question->question_bank_id}}"
                                                                        id="answer_word_{{@$question->question_bank_id}}">{{isset($submited_answer)? $submited_answer->user_answer : '' }} </textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-2 pt-60">
                                                            <p class="primary-btn fix-gr-bg"
                                                               data-question="{{@$question->question_bank_id}}"
                                                               onclick="fillBlanks({{@$question->question_bank_id }})">{{ __('common.Fill') }}</p>
                                                        </div>
                                                    </div>
