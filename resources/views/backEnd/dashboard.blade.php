...
@endsection
@push('css')
    <link rel="stylesheet" href="{{ assetPath('public/backEnd/assets/vendors/css/fullcalendar.min.css') }}" />
    <link rel="stylesheet" href="{{ assetPath('public/backEnd/assets/vendors/calender_js/core/main.css') }}" />
    <link rel="stylesheet" href="{{ assetPath('public/backEnd/assets/vendors/calender_js/daygrid/main.css') }}" />
    <link rel="stylesheet" href="{{ assetPath('public/backEnd/assets/vendors/calender_js/timegrid/main.css') }}" />
    <link rel="stylesheet" href="{{ assetPath('public/backEnd/assets/vendors/calender_js/list/main.css') }}" />
    <style>
        .ti-calendar:before {
            position: absolute;
...
@section('mainContent')
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div class="col-span-12">
                        <div class="main-title">
                            ...
                            @else
                                <h3 class="mb-15">@lang('dashboard.welcome') - 
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        @if (userPermission('number-of-student'))
                            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                                <a href="{{ route('student_list') }}" class="block">
                        ...
                        @if (userPermission('number-of-teacher'))
                            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                                <a href="{{ route('staff_directory') }}" class="block">
            ...
            <div class="w-full p-0">
                <div class="white-box">
                    <div class="grid grid-cols-12 gap-4 justify-between">
                        <div class="col-span-12 lg:col-span-8 md:col-span-9 col-span-8">
                            <div class="main-title">
                                <h3 class="mb-0"> @lang('dashboard.income_and_expenses_for') {{ date('M') }} {{ $year }} </h3>
                            </div>
                        </div>
                        <div class="col-span-12 lg:col-span-4 text-right md:col-span-3 col-span-4 nowrap">
                        ...
                        <div class="col-span-12">
                            <div id="barChartDiv" class="mt-15">
                                <div class="grid grid-cols-12 gap-4 padding4 row-gap-24">
                                    <div class="col-span-12 lg:col-span-2 md:col-span-6 col-span-6">
                                        <div class="text-center">

                                            <h1>
                                                {{-- ({{ generalSetting()->currency_symbol }}) --}}
                                                {{ currency_format($m_total_income) }}
                                            </h1>
                                    ...
                                    <div class="col-span-12 lg:col-span-2 md:col-span-6 col-span-6">
                                        <div class="text-center">
                                            <h1>
                                                {{-- ({{ generalSetting()->currency_symbol }}) --}}
                                                {{ currency_format($m_total_expense) }}</h1>
                                            <p>@lang('dashboard.total_expenses')</p>
                                        </div>
                                    </div>
                                    <div class="col-span-12 lg:col-span-3 md:col-span-6 col-span-6">
                                        <div class="text-center">
                                            <h1>
                                                {{-- ({{ generalSetting()->currency_symbol }}) --}}
                                                {{ currency_format($m_total_income - $m_total_expense) }}</h1>
                                ...
                                <div class="grid grid-cols-12 gap-4 padding4 row-gap-24">
                                    <div class="col-span-12 lg:col-span-3 md:col-span-6 col-span-6">
                                        <div class="text-center">
                                            <h1>
                                                {{-- ({{ generalSetting()->currency_symbol }}) --}}
                                                {{ currency_format($y_total_income) }}
                                            </h1>
                                            <p>@lang('dashboard.total_income')</p>
                                        </div>
                                    </div>
                                    <div class="col-span-12 lg:col-span-3 md:col-span-6 col-span-6">
                                        <div class="text-center">
                                            ...
                                            <h1>
                                                {{-- ({{ generalSetting()->currency_symbol }}) --}}
                                                {{ currency_format($y_total_expense) }}</h1>
                                            <p>@lang('dashboard.total_expenses')</p>
                                        </div>
                                    </div>
                                    <div class="col-span-12 lg:col-span-2 md:col-span-6 col-span-6">
                                        <div class="text-center">
                                            <h1>
                                                {{-- ({{ generalSetting()->currency_symbol }}) --}}
                                                {{ currency_format($y_total_income - $y_total_expense) }}</h1>
                                            <p>@lang('dashboard.total_profit')</p>
                                        </div>
                                    </div>
                                    <div class="col-span-12 lg:col-span-2 md:col-span-6 col-span-6">
    ...
    <div class="grid grid-cols-12 gap-4 mt-40">
            ...
            @if (userPermission('notice-board'))
                <section>
                    <div class="w-full p-0">
                        <div class="white-box">
                            <div class="grid grid-cols-12 gap-4">
                                <div class="col-span-12 lg:col-span-6 col-span-7">
                                    <div class="main-title">
                                        <h3 class="mb-15">@lang('communicate.notice_board')</h3>
                                    </div>
                                </div>
                                @if (userPermission('add-notice'))
                                    <div class="col-span-12 lg:col-span-6 col-span-5 ml-auto pull-right text-right text-nowrap">
                                    ...
                                    <table class="school-table-style w-100">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="flex justify-around">@lang('common.actions')</th>
                                            </tr>
                                        </thead>
        ...
        <div class="col-span-12 md:col-span-6 mt-50-md md_infix_50">
            ...
            <div class="grid grid-cols-12 gap-4 h-full">
                <div class="col-span-12">
                    <div class="white-box school-table h-full">
                        @if (userPermission('to-do-list'))
                            <div class="grid grid-cols-12 gap-4">
                                <div class="col-span-12 lg:col-span-6 md:col-span-6 col-span-6">
                                    <div class="main-title">
                                        <h3 class="mb-15">@lang('dashboard.to_do_list')</h3>
                                    </div>
                                </div>
                                <div class="col-span-12 lg:col-span-6 text-right md:col-span-6 col-span-6">
                            ...
                            <div class="grid grid-cols-12 gap-4 to-do-list mb-20">
                            ...
                            <div class="toDoList">
                                @if (count(@$toDos->where('complete_status', 'P')) > 0)
                                    @foreach ($toDos->where('complete_status', 'P') as $toDoList)
                                        <div class="single-to-do flex justify-between toDoList"
                                            ...
                                            <div>
                                                ...
                                                <label for="midterm{{ @$toDoList->id }}">
                                                    ...
                                                    <input type="hidden" id="url"
                                                        value="{{ url('/') }}">
                                                    <h5 class="inline">{{ @$toDoList->todo_title }}</h5>
                                                    <p>
                                    ...
                                    @endforeach
                                @else
                                    <div class="single-to-do flex justify-between">
                                ...
                                @if (count(@$toDos->where('complete_status', 'C')) > 0)
                                    @foreach ($toDos->where('complete_status', 'C') as $toDoListsCompleted)
                                        <div class="single-to-do flex justify-between"
                                            ...
                                            <div>
                                                <h5 class="inline">{{ @$toDoListsCompleted->todo_title }}</h5>
                                                <p class="">
    ...
    for($i = 1; $i <= date('d'); $i++){
        ...
        $i = $i < 10? '0'.$i:$i;
        @$income = App\Models\SmAddIncome::monthlyIncome($i);
        @$expense = App\Models\SmAddIncome::monthlyExpense($i);
    ...
    for($i = 1; $i <= date('m'); $i++){
        ...
        @$yearlyIncome = App\Models\SmAddIncome::yearlyIncome($i);

        @$yearlyExpense = App\Models\SmAddIncome::yearlyExpense($i);
...
@section('script')
    <script type="text/javascript" src="{{ assetPath('public/backEnd/') }}/vendors/js/fullcalendar.min.js"></script>
    <script src="{{ assetPath('public/backEnd/vendors/js/fullcalendar-locale-all.js') }}"></script>
