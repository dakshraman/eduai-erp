...
<div class="row mt-25 mb-25">
    <div class="col-lg-12">
        ...
        <select class="primary_select form-control {{ $errors->has('exams_type') ? ' is-invalid' : '' }}"
            id="exam_class" name="exams_type">
            <option data-display="@lang('common.select_exam_type') *" value="">@lang('common.select_exam_type') *
            </option>
...
<div class="row mt-25">
    <div class="col-lg-12">
        ...
        <select class="primary_select form-control {{ $errors->has('class_id') ? ' is-invalid' : '' }}"
            id="classSelectStudentHomeWork" name="class_id">
...
<div class="row mt-25">
    <div class="col-lg-12 " id="selectSectionsDiv" style="margin-top: -25px;">
        ...
        <select multiple="multiple" id="selectSectionss" name="section_ids[]" style="width:300px"
