                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="white-box">
                                ...
                                @if (isset($bank))
                                    {{ html()->form('PUT', route('question-bank-update', $bank->id))->attributes([
                                ...
                                @else
                                    @if (userPermission('question-bank-store'))
                                        {{ html()->form('POST', route('question-bank-store'))->attributes([
                                                'class' => 'form-horizontal',
                                                'files' => true,
                                                'enctype' => 'multipart/form-data',
                                                'id' => 'question_bank',
                                ...
                                <div class="add-visitor">
                                    ...
                                    <div class="row">
                                        @include('branch::components.branch_select', [
                                            ...
                                            'mb' => 'mb-15',
                                            'branch_id' => isset($bank) ? $bank->branch_id : old('branch_id'),
                                        ])
                                    </div>
                                    @endif
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('exam.question') <span
                                                        class="text-danger"> *</span></label>
                                                <textarea
                                                    class="primary_input_field verticle-scroll-question form-control{{ $errors->has('question') ? ' is-invalid' : '' }}"
                                                    cols="0" rows="4" name="question">{{ isset($bank) ? $bank->question : (old('question') != '' ? old('question') : '') }}</textarea>
                                    ...
                                    <table id="table_id" class="table" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                @else
                                                    <th>@lang('common.class_Sec') @if(shiftEnable()) - @lang('common.shift') @endif</th>
                                                @endif
                                        ...
                                        <tbody>
                                            @foreach ($banks as $bank)
                                                <tr>
                                                    @if (moduleStatusCheck('Branch'))
                                                    <td>{{ $bank->branch != '' ? $bank->branch->branch_name : '' }}
                                                    @endif
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('DELETE', route('question-bank-delete', $bank->id))->attribute('enctype', 'multipart/form-data')->open() }}
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            $(document).on("change", "#common_select_shifts", function() {
                var url = $("#url").val();
                var shift_id = $(this).val();
                var academic_id = $('#common_academic_years').val();

                if (!shift_id) {
                    $("#class_id_email_sms").empty().append(
                        $("<option>", {
                            value: '',
                            text: "@lang('common.select_class') *",
                        })
                    );
                    $('#class_id_email_sms').niceSelect('update');
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#class_id_email_sms').niceSelect('update');
                        $('#class_id_email_sms').trigger('change');
                    },
                    error: function(data) {
