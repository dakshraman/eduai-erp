                ...
                <div class="white-box mt-40">
                    <div class="row">
                        ...
                        <div class="col-lg-3  col-md-3 mb-4 mb-md-0">
                            <a href="{{ route('exam-routine-print', [$class_id, $section_id, $exam_type_id, shiftEnable() ? $shift_id : null, moduleStatusCheck('Branch') ? isset($branch_id) : null]) }}"
                    ...
                    {{ html()->form('POST', route('add-exam-routine-store'))->attributes([
                            'class' => 'form-horizontal',
                            'files' => true,
                            'enctype' => 'multipart/form-data',
                            'name' => 'myForm',
                    ...
                    @if(moduleStatusCheck('Branch'))
                    <input type="hidden" name="branch_id" id="branch_id" value="{{ isset($branch_id) }}">
                    @endif
                                            ...
                                            <tr class="0" id="row_{{ $row }}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <select class="primary_select  promote_class" readonly disabled
                                                                id="promote_class"
                                                                name="routine[{{ $row }}][class]" required>
                                                            ...
                                                            <select class="primary_select"
                                                                ...
                                                                @foreach ($sections as $section)
                                                                    <option value="{{ $section->id }}"
                                                                        {{ $routine->section_id == $section->id ? 'selected' : '' }}>
                                                ...
                                                <td class="border-top-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12" id="">
                                                            ...
                                                            <select class="primary_select"
                                                                name="routine[{{ $row }}][shift]" required>
    
                                                                <option data-display="@lang('common.select_shift') *" value="">
                                                                    @lang('common.select_shift') *
                                                                </option>
    
                                                                @foreach (shifts() as $shift)
                                                                    <option value="{{ $shift->id }}"
                                                                        {{ $routine->shift_id == $shift->id ? 'selected' : '' }}>
                                                                        {{ $shift->name }}</option>
                                                                @endforeach
                                                ...
                                                <td class="border-top-0">
                                                    ...
                                                    @if (userPermission('delete-class-routine'))
                                                        <button
                                                            class="primary-btn icon-only fix-gr-bg removeExamRoutineRowBtn"
                                                            data-row_id="{{ $row }}"
                    ...
                    var tr = `<tr class="0" id="row_${row_count}">
                                                ...
                                                <td class="border-top-0">
                                                        <div class="row">
                                                            ...
                                                            <select class="primary_select  promote_class" readonly disabled  id="promote_class" name="routine[${row_count}][class]" required>
                                                                <option data-display="@lang('exam.exam_schedule_create') *" value="">@lang('common.dashboard') *</option>
                                                                    @foreach ($classes as $class)
                                                ...
                                                <td class="border-top-0">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <select class="primary_select" name="routine[${row_count}][shift]" required>
