            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('exam_schedule_report_search_new'))->attributes([
                        ...
                        <div class="row">
                            ...
                            <div class=" @if(shiftEnable()) col-lg-3 @else col-lg-4 @endif mt-30-md">
                                <select class="primary_select form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}"
                                    name="exam_type">
                                    <option data-display="Select Exam *" value="">@lang('common.select_exam') *
                                    </option>
                            ...
                            <div class="main-title">
                                <h3 class="mb-15">@lang('exam.exam_routine')|
                                    <small>
                                        ...
                                        @if (moduleStatusCheck('Branch'))
                                        @lang('common.branch'):
                                        {{ @$search_current_branch != '' ?? $search_current_branch->branch_name }},
                                        @endif
                                        @lang('common.class'):
                                        ...
                                        @if(shiftEnable())
                                        @lang('common.shift'):
                                        {{ @$search_current_shift != '' ?? $search_current_shift->name }},
                                        @endif
                        ...
                        <div class="col-lg-6 pull-right">
                            <div class="main-title">
                                <div class="print_button pull-right pb-2">
                                    <a href="{{ route('exam-routine-print', [$class_id, $section_id, $exam_type_id, shiftEnable() ? $shift_id : null, moduleStatusCheck('Branch') ? $branch_id : null]) }}"
                                                ...
                                                @foreach ($exam_schedules as $date => $exam_routine)
                                                    <tr>
                                                        ...
                                                        <td>{{ $exam_routine->class ? $exam_routine->class->class_name : '' }}
                                                            ...
                                                            @if(shiftEnable()) {{ $exam_routine->shift ? '[' . $exam_routine->shift->name . ']' : '' }} @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            @php
                                                                $duration =
                                                                    strtotime($exam_routine->end_time) -
                                                                    strtotime($exam_routine->start_time);
                                                            @endphp
