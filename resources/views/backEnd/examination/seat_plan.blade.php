        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <div class="white-box">
                        {{ html()->form('POST', route('seat_plan_report_search_new'))->attributes([
                            ...
                            <div class="col-lg-2 mt-30-md">
                                <select class="primary_select form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}"
                                    ...
                                    <option data-display="@lang('exam.select_exam')"
                                            value="">@lang('exam.select_exam')</option>
                                ...
                                <select
                                    ...
                                    @foreach ($classes as $class)
                                        <option value="{{ $class->id }}"
                                                {{ old('class') == $class->id ? 'selected' : '' }}>{{ $class->class_name }}
                                        </option>
                                    @endforeach
                                </select>
                                @if ($errors->has('class'))
                            ...
                            <div class="col-lg-2 mt-30-md" id="select_subject_div">
                                <select
                                    ...
                                    <option data-display="@lang('common.select_subjects')"
                                            value="">@lang('common.select_subjects')</option>
                                </select>
                                    ...
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field  primary_input_field date form-control"
                                                   id="startDate" type="text" name="date" autocomplete="off">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                if ($i == 1) {
                                                    echo date('h:i a', strtotime($seat_plan_child->start_time)) .
                                                        '-' .
                                                        date('h:i a', strtotime($seat_plan_child->end_time));
                                                }
                                            @endphp
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @php
                                                if ($i == 1) {
                                                    echo \App\Models\SmSeatPlan::total_student(
                                                        $seat_plan->class_id,
                                                        $seat_plan->section_id,
                                                    );
                                                }
                                            @endphp
                                        </td>
                                        <td>@php
                                                $class_room = $seat_plan_child->class_room;
                                                echo $class_room->room_no;
                                            @endphp</td>
