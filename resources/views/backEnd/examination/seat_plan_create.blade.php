        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <div class="white-box">
                        {{ html()->form('POST', route('seat_plan_create_search'))->attributes([
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 mt-30-md" id="select_section_div">
                                <select
                                    ...
                                    @if (isset($section_id))
                                        <option value="" selected>@php$section = App\Models\SmSection::select('section_name')
                                                ->where('id', $section_id)
                                                ->first();
                                ...
                                <select
                                    ...
                                    @if (isset($subject_id))
                                        <option value="" selected>@php
                                                $subject = App\Models\SmSubject::select('subject_name')->where('id', $subject_id)->first();
                                    ...
                                    <div class="col">
                                        <div class="primary_input">
                                            <input class="primary_input_field  primary_input_field date form-control"
                                                   ...
                                                   value="{{ isset($date) ? date('m/d/Y', strtotime($date)) : date('m/d/Y') }}"
                                                   readonly="true">
    ...
    @if (isset($students))
        <section class="mt-40">
            <div class="container-fluid p-0">
                ...
                {{ html()->form('POST', route('seat_plan_store_create'))->attributes([
                        'class' => 'form-horizontal',
                        'files' => true,
                        'enctype' => 'multipart/form-data',
                        'id' => 'seat_plan_store',
                        ...
                        <table class="table school-table-style" cellspacing="0" width="100%" id="assign_exam_room">
                            ...
                            @if (count($seat_plan_assign_childs) == 0)
                                <tr id="1">
                                    ...
                                    <td>{{ $students->count() }} <input type="hidden" name="total_student"
                                                                        id="total_student"
                                                                        value="{{ $students->count() }}"></td>
                                            ...
                                            <div class="col">
                                                <div class="primary_input">
                                                    ...
                                                    <label class="primary_input_label"
                                                           for="">@lang('exam.start_time')</label>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <div class="primary_input">
                                                    <select class="primary_select class_room room_select"
                                                            name="room[]" id="room_1">
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <div class="primary_input">
                                                    <input class="primary_input_field capacity"
                                                           placeholder="Room Capacity" type="text" name="capacity[]"
                                                           id="capacity-1" readonly>
                                                    <input type="hidden" name="already_assigned"
                                                           id="already_assigned-{{ 1 }}">
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <div class="primary_input">
                                                    <input
                                                            class="primary_input_field assign_student assign_student_input"
                                                            type="text" name="assign_student[]" id="assign_student-1">
                                                    <label class="primary_input_label"
                                                           for="">@lang('exam.enter_student_no')<span></span> </label>
                            ...
                            @else
                                ...
                                @foreach ($seat_plan_assign_childs as $seat_plan_assign_child)
                                    ...
                                    <tr id="{{ $i }}">
                                        ...
                                        <td>{{ $i == 1 ? $students->count() : '' }} <input type="hidden"
                                                                                           name="total_student"
                                                                                           id="total_student"
                                                    ...
                                                    <div class="col">
                                                        <div class="primary_input">
                                                            <input
                                                                    class="primary_input_field primary_input_field time form-control{{ $errors->has('start_time') ? ' is-invalid' : '' }}"
                                                                    type="text" name="start_time" id="start_time"
                                                                    value="{{ date('h:i a', strtotime($seat_plan_assign_child->start_time)) }}">
                                                            <label class="primary_input_label"
                                                                   for="">@lang('exam.start_time')</label>
                                                    ...
                                                    <div class="col">
                                                        <div class="primary_input">
                                                            <input
                                                                    class="primary_input_field primary_input_field time  form-control{{ $errors->has('end_time') ? ' is-invalid' : '' }}"
                                                                    type="text" name="end_time" id="end_time"
                                                                    value="{{ date('h:i a', strtotime($seat_plan_assign_child->end_time)) }}">
                                                            <label class="primary_input_label"
                                                                   for="">@lang('exam.end_time')</label>
                                                        ...
                                                        <select class="primary_select class_room room_select"
                                                            ...
                                                            @foreach ($class_rooms as $class_room)
                                                                @if (!in_array($class_room->id, $fill_uped) || $seat_plan_assign_child->room_id == $class_room->id)
                                                                    <option value="{{ $class_room->id }}"
                                                                            {{ $seat_plan_assign_child->room_id == $class_room->id ? 'selected' : '' }}>
                                                                        {{ $class_room->room_no }}</option>
                                                                @endif
                                                            @endforeach
                                                        </select>
                                                        <span id="room_error-{{ $i }}"
                                        ...
                                        @php
                                            $used_room = App\Models\SmSeatPlanChild::usedRoomCapacity(
                                                $seat_plan_assign_child->room_id,
                                            );
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="primary_input">
                                                        <input class="primary_input_field capacity" type="text"
                                                               name="capacity[]" id="capacity-{{ $i }}"
                                                               value="Assigned {{ $used_room . ' of ' . $class_room->capacity }}"
                                                               readonly>
                                                        <input type="hidden" name="already_assigned"
                                                               id="already_assigned-{{ $i }}"
                                                               value="{{ $used_room }}">
                                                        <input type="hidden" name="room_capacity"
                                                               id="room_capacity-{{ $i }}"
                                                               value="{{ $class_room->capacity }}">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="primary_input">
                                                        <input
                                                                class="primary_input_field assign_student assign_student_input"
                                                                type="text" placeholder="Enter Student No"
                                                                name="assign_student[]"
                                                                id="assign_student-{{ $i }}"
                                                                value="{{ $seat_plan_assign_child->assign_students }}">

                                                        <span id="assign_student_error-{{ $i }}"
                                                              class="text-danger"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td class="text-right">
                                            <button class="primary-btn icon-only fix-gr-bg" type="button">
                                                    <span class="ti-trash text-white"
                                                          @if ($i != 1) onclick="deleteExamRow({{ $i }})" @endif
                                                "></span>
                                            </button>
                                        </td>
                                    </tr>
