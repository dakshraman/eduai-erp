            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($group))
                                {{ html()->form('PUT', route('question-group-update', @$group->id))->attributes([
                            ...
                            @else
                                @if (userPermission('question-group-store'))
                                    {{ html()->form('POST', route('question-group-store'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                ...
                                <div class="add-visitor">
                                    ...
                                    <div class="row">
                                        @include('branch::components.branch_select', [
                                            ...
                                            'mb' => 'mb-15',
                                            'branch_id' => isset($group) ? $group->branch_id : old('branch_id'),
                                        ])
                                    </div>
                                    @endif
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('exam.title') <span
                                                        class="text-danger"> *</span></label>
                                                <input class="primary_input_field " type="text" name="title"
                                                    autocomplete="off" value="{{ isset($group) ? $group->title : '' }}">
                                                        ...
                                                        <x-drop-down>
                                                            @if (userPermission('question-group-edit'))
                                                                <a class="dropdown-item"
                                                                    href="{{ route('question-group-edit', [$group->id]) }}">@lang('common.edit')</a>
                                                            @endif
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('DELETE', route('question-group-delete', $group->id))->attribute('enctype', 'multipart/form-data')->open() }}
