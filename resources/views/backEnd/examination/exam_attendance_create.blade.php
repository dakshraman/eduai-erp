...
@section('mainContent')
    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('exam_attendance_create_search'))->attributes([
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 mt-30" id="select_exam_typ_subject_div">
                                            {{ html()->select('exam_type', ['' => __('exam.select_exam') . '*'])->value(null)->attributes([
                                        ...
                                        <div class="col-lg-3 mt-30" id="select_un_exam_type_subject_div">
                                            {{ html()->select('subject_id', ['' => __('exam.select_subject') . '*'])->value(null)->attributes([
            ...
            @if (isset($students))
                {{ html()->form('POST', route('exam-attendance-store'))->attribute('class', 'form-horizontal')->open() }}
                @if (moduleStatusCheck('University'))
                                    ...
                                    <div class="white-box">
                                        <div class="row">
                                            <div class="col-lg-12 no-gutters mb-15">
                                                <div class="main-title">
                                                    <h3>@lang('exam.exam_attendance') | <strong>
                                                        @if(moduleStatusCheck('Branch'))
                                                        @lang('common.branch'):
                                                        {{ $search_info['branch_name'] }},
                                                        @endif
                                                        @lang('exam.subject')</strong>:
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex radio-btn-flex">
                                                                        <div class="mr-20">
                                                                            <input type="hidden"
                                                                                name="attendance[{{ @$record->id }}]"  value="{{ @$record->id }}">
                                                                            <input type="hidden"
                ...
                @else
                    <div class="row mt-40">
                        <div class="col-lg-12">
                            ...
                            <input class="shiftId" type="hidden" name="shift_id" value="{{ @$shift_id }}">
                            @if(moduleStatusCheck('Branch'))
                            <input type="hidden" name="branch_id" value="{{ @$branch_id }}">
                            @endif
                            <div class="row">
                                    ...
                                    <div class="white-box">
                                        <div class="row">
                                            <div class="col-lg-12 no-gutters">
                                                <div class="main-title">
                                                    <h3 class="mb-15">@lang('exam.exam_attendance') | <small>
                                                            @if(moduleStatusCheck('Branch'))
                                                            @lang('common.branch'):
                                                            {{ $search_info['branch_name'] }},
                                                            @endif
                                                            ...
                                                            {{ $search_info['subject_name'] }}
                                                            @if(shiftEnable()) @lang('common.shift'): {{ $search_info['shift_name'] }} @endif</small></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table school-table-style shadow-none p-0" cellspacing="0"
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <th width="25%">@lang('student.admission_no')</th>
                                                        <th width="25%">@lang('student.student_name')</th>
                                                        <th width="25%"> @if(shiftEnable()) @lang('admin.class_Sec_shift') @else @lang('admin.class_Sec') @endif</th>
                                                        <th width="25%">@lang('student.roll_number')</th>
                                                        <th width="25%">@lang('exam.attendance')</th>
                                                    </tr>
                                                </thead>
                                                        ...
                                                        @foreach ($students as $record)
                                                            <tr>
                                                                ...
                                                                <td>{{ @$record->class->class_name }}
                                                                    ({{ @$record->section->section_name }}) @if(shiftEnable()) [{{ @$record->shift->shift_name }}] @endif
                                                                </td>
                                                                <td>{{ @$record->roll_no ? $record->roll_no : '' }}</td>
                                                                <td>
                                                                    <div class="d-flex radio-btn-flex">
                            ...
                            <td>
                                <div class="d-flex radio-btn-flex">
                                    <div class="mr-20">
                                        ...
                                        <input type="radio" name="attendance[{{ @$student_record->id }}][attendance_type]"
                                    ...
                                    <div class="mr-20">
                                        <input type="radio" name="attendance[{{ @$student_record->id }}][attendance_type]"
                                            id="attendanceL{{ @$student_record->id }}" value="A" class="common-radio">
