...
@section('mainContent')
    @php
        $showBranch = moduleStatusCheck('Branch') && \Illuminate\Support\Facades\Schema::hasTable('branches');
    @endphp
    <style>
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-xl-4">
                    @if (isset($exam))
                        {{ html()->form('PUT', route('exam-update', $exam->id))->class('form-horizontal')->open() }}
                    @else
                        @if (userPermission('exam-setup-store'))
                            {{ html()->form('POST', route('exam-store'))->class('form-horizontal')->open() }}
                        @endif
                    @endif
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="add-visitor">
                                    ...
                                    <div class="row">
                                        @include('branch::components.branch_select', [
                                            ...
                                            'mb' => 'mb-15',
                                            'branch_id' => isset($exam) ? $exam->branch_id : old('branch_id'),
                                        ])
                                    </div>
                                    @endif
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input oninput="numberMinCheck(this)"
                                                    ...
                                                    value="{{ isset($exam) ? $exam->exam_mark : old('exam_marks') }}" required="">
                                                ...
                                                <tr id="row1" class="mt-40">
                                                    <td class="border-top-0">
                                                        ...
                                                        <input type="hidden" name="url" id="url"
                                                            value="{{ URL::to('/') }}">
                                                        <div class="primary_input">
                                                            <input type="hidden" value="@lang('exam.title')"
                                                                id="lang">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($exams as $exam)
                                                <tr>
                                                    <td>{{ $count++ }}</td>
                                                    @if ($showBranch)
                                                    <td>{{ $exam->branch != '' ? $exam->branch->branch_name : '' }}
                                                    </td>
                                                    @endif
                                                    <td>{{ $exam->GetExamTitle != '' ? $exam->GetExamTitle->title : '' }}
                                                    </td>
                                                    @if (moduleStatusCheck('University'))
                                                    ...
                                                    @else
                                                        ...
                                                        @if(shiftEnable())
                                                        <td>{{ $exam->shift != '' ? $exam->shift->name : '' }}</td>
                                                        @endif
                                                    @endif
                                                    ...
                                                    <td>
                                                        @foreach ($exam->markDistributions as $row)
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-4"><strong> {{ $row->exam_mark }}
                                                                    </strong>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('DELETE', route('exam-delete', $exam->id))->attribute('enctype', 'multipart/form-data')->open() }}
