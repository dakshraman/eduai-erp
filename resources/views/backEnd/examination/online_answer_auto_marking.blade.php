                                ...
                                <div class="">
                                    <div class="row  pl-10">
                                        <div class="col-lg-7 mt-20">
                                            ...
                                            <h4><strong>@lang('exam.total_marks')
                                                    : {{@$take_online_exam->total_marks}} </strong></h4>

                                            <p><strong>@lang('exam.instruction')
                                                    : </strong>{{@$take_online_exam->onlineExam->instruction}}</p>
                                        </div>
                                        <div class="col-lg-5 mt-20">
                                            <p class="mb-2"><strong>@lang('common.date') & @lang('common.time')
                                                    : </strong>{{@$take_online_exam->onlineExam !=""?
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center radio-btn-flex mt-20">
                                                        <div class="mr-30">
                                                            <input type="radio" disabled
                                                                   ...
                                                                   class="common-radio relationButton" {{@$student_answer->user_answer == "T"? 'checked': ''}}>
                                                            <label for="true_{{@$question->question_bank_id}}">@lang('exam.true')</label>
                                                        </div>
                                                        <div class="mr-30">
                                                            <input type="radio" disabled
                                                                   id="false_{{@$question->question_bank_id}}" value="F"
                                                                   class="common-radio relationButton" {{@$student_answer->user_answer == "F"? 'checked': ''}}>
                                                ...
                                                @else
                                                    <div class="row align-items-center">
                                                        <div class="primary_input mt-20 ml-30">
                                                            <textarea readonly
                                                                      class="primary_input_field form-control read-only-input has-content mt-10 "
                                                                      cols="0" rows="5"
                                                ...
                                                <td width="10%" class="text-right">
                                                    <div class="mt-20 float-right">
                                                        <input type="radio" disabled
                                                               ...
                                                               name="marks[]{{@$question->questionBank->id}}" {{@$student_answer->answer_status==0? 'checked': ''}}>
                                                ...
                                                <td width="10%" class="text-right">
                                                    <div class="mt-20">
                                                        <input type="radio" disabled
                                                               ...
                                                               value="{{@$question->questionBank!=""?@$question->questionBank->id:""}}" {{@$student_answer->answer_status==1? 'checked': ''}}>
