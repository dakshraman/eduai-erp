                ...
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        @if (userPermission('send_marks_by_sms'))
                            {{ html()->form('POST', route('send_marks_by_sms_store'))->attributes([
                        ...
                        <div class="row">
                            ...
                            @if (moduleStatusCheck('University'))
                                ...
                                <div class="col-lg-3 mt-15">
                                    ...
                                    <select
                                        class="primary_select form-control {{ $errors->has('receiver') ? ' is-invalid' : '' }}"
                                        name="receiver">
                                        <option data-display="@lang('exam.select_receiver') *" value="">@lang('exam.select_receiver') *
                                        </option>

                                        <option value="students" {{ old('receiver') == 'students' ? 'selected' : '' }}>
                                            @lang('student.students')</option>
                                        @if (generalSetting()->with_guardian)
                                            <option value="parents" {{ old('receiver') == 'parents' ? 'selected' : '' }}>
                                                @lang('student.parents')</option>
                                        @endif
                                    </select>
                                ...
                                <div class="@if(shiftEnable()) col-lg-3 @else col-lg-4 @endif mt-30-md">
                                    <select
                                        ...
                                        @foreach ($exams as $exam)
                                            <option value="{{ $exams != '' ? $exam->id : '' }}">{{ $exams != '' ? $exam->title : '' }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('exam'))
