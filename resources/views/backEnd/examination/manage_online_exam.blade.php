                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="single-meta mt-20">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="name">
                                                        {{$online_exam->branch?->branch_name}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="single-meta">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="name">
                                                        {{@$online_exam->shift !=""?@$online_exam->shift->name:""}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <table id="table_id" class="table pb-120" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr class="abc">
                                        ...
                                        @if(moduleStatusCheck('Branch'))
                                        <td>{{@$question_bank->questionGroup !=""?@$question_bank->questionGroup->branch?->branch_name:""}}</td>
                                        @endif
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-40 d-flex justify-content-between">
                    ...
                    {{ html()->form('POST', route('online-exam-question-delete'))->attribute('enctype', 'multipart/form-data')->open() }}
