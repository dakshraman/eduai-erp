    ...
    <section class="admin-visitor-area mb-40">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                @endif
                <div class="white-box">
                    {{ html()->form('POST',route('studentFinalMarkSheetSearch'))->attributes(['class' => 'form-horizontal', 'files' => true, 'enctype' => 'multipart/form-data'])->open() }}
                    <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    {{ html()->select('exam_type', [""=>__('exam.select_exam').'*'], null)->attributes([
                                        'class' => 'niceSelect w-100 bb form-control' . ($errors->has('exam_type') ? ' is-invalid' : ''),
                                    ...
                                    {{ html()->select('student_id', ["" => __('common.select_student') . '*'], null)->attributes([
                                        'class' => 'niceSelect w-100 bb form-control' . ($errors->has('student_id') ? ' is-invalid' : ''),
                                            ...
                                            <div class="card-header">
                                                    <div class="d-flex">
                                                            ...
                                                            <div class="col-lg-6 ml-30">
                                                                <h3 class="text-white"> 
                                                                    {{isset(generalSetting()->school_name)?generalSetting()->school_name:'EduAI School Management ERP'}} 
                                                                </h3> 
                                                                <p class="text-white mb-0">
                                                                    {{isset(generalSetting()->address)?generalSetting()->address:'EduAI School Address'}} 
                                                                </p>
                                                                <p class="text-white mb-0">
                                                ...
                                                <div class="report-admit-img profile_100" style="background-image: url({{ file_exists(@$studentDetails->studentDetail->student_photo) ? assetPath($studentDetails->studentDetail->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }})"></div>
                                                            ...
                                                            <tr class="text-center">
                                                                ...
                                                                foreach ($assinged_exam_types as $assinged_exam_type) {
                                                                    ...
                                                                    if (! empty($result)) {
                                                                        ...
                                                                        $term_base = App\Models\SmResultStore::termBaseMark($class_id, $section_id, $data->subject_id, $assinged_exam_type, $student_id);
                                                                    }
