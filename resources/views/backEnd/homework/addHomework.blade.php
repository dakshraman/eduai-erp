    ...
    <section class="admin-visitor-area">
        <div class="w-full p-0">
            @if (userPermission('saveHomeworkData'))
                {{ html()->form('POST', route('saveHomeworkData'))->attributes([
                ...
                <div class="col-span-12">
                    <div class="white-box">
                        ...
                        <div class="">
                            ...
                            @if (moduleStatusCheck('University'))
                                <div class="grid grid-cols-12 gap-4">
                                    ...
                                    @include('branch::components.branch_select', [
                                        'grid_class' => 'col-lg-3',
                                        'mb' => 'mb-15',
                                        'branch_id' => old('branch_id', userBranch()),
                                    ])
                                    @endif
                                    @includeIf(
                            ...
                            @else
                                <div class="grid grid-cols-12 gap-4 mb-15">
                                    @if (moduleStatusCheck('Branch'))
                                    @include('branch::components.branch_select', [
                                        'grid_class' => 'col-lg-3',
                                        'mb' => 'mb-15',
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="">
                                                            <input
                                                                class="primary_input_field primary_input_field date w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                                    ...
                                    <div class="col-span-12 lg:col-span-3">
                                        <div class="grid grid-cols-12 gap-4 no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="primary_input ">
                                                    <label class="primary_input_label" for="">@lang('homework.marks') <span
                                                            class="text-danger"> *</span></label>
                                                    <input oninput="numberCheckWithDot(this)"
                                                        class="primary_input_field w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500{{ $errors->has('marks') ? ' is-invalid' : '' }}"
                            ...
                            @endif
                            <div class="grid grid-cols-12 gap-4 md-20">
                                <div class="col-span-12">
                                    <div class="primary_input ">
                                        <label class="primary_input_label" for="">@lang('common.description') <span
                                                class="text-danger"> *</span> </label>
                                        <textarea class="primary_input_field w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500{{ $errors->has('description') ? ' is-invalid' : '' }}"
                                            cols="0" rows="4" name="description" id="description *">{{ old('description') }}</textarea>
                                ...
                                <div class="col-span-12">
                                    <label class="primary_input_label" for="">@lang('homework.attach_file')</label>
                                        ...
                                        <div class="dropzone-uploads">
                                            ...
                                            <div class="dropzone-uploads__inner grid grid-cols-12 gap-6" id="previews">
                                                <div class="upload-item col-span-12 xl:col-span-3 md:col-span-6 lg:col-span-4 hidden" id="uploadItemTemplate">
...
@push('script')
    <script src="{{ assetPath('public/backEnd/dropzone/dropzone.min.js') }}"></script>
