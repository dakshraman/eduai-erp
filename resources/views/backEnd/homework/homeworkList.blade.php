        ...
        <div class="w-full p-0">
                ...
                <div class="col-span-12">
                    <div class="white-box">
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-12 lg:col-span-4 text-md-right text-left md:col-span-6 mb-30-lg">
                        ...
                        @endif
                        <div class="grid grid-cols-12 gap-4">
                            <div class="col-span-12 mt-20 text-right">
            ...
            <div class="grid grid-cols-12 gap-4 mt-40">
                <div class="col-span-12">
                    <div class="white-box">
                        <div class="grid grid-cols-12 gap-4">
                            <div class="col-span-12 lg:col-span-4 no-gutters">
                                <div class="main-title">
