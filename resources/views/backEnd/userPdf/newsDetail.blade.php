                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 course__details">
                                <div class="text-center">
                                    <img class="img-fluid" src="{{assetPath($news->image)}}" alt="">
                                </div>
                                            ...
                                            @foreach ($news->newsComments as $comment)
                                                <div class="single_reviews">
                                                    <div class="thumb">
                                                        ...
                                                        @else
                                                            <img class="img-fluid rounded-circle"
                                                                src="{{ !is_null($comment->user->staff->staff_photo) ? assetPath($comment->user->staff->staff_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
                                                    ...
                                                    @foreach ($comment->replies as $reply)
                                                        <div class="single_reviews">
                                                            <div class="thumb">
                                                                ...
                                                                @else
                                                                    <img class="img-fluid rounded-circle" src=" {{ !is_null($reply->user->staff->staff_photo) ? assetPath($reply->user->staff->staff_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}" alt="{{ @$reply->user->staff->first_name }}">
                                                                @endif
                                                            </div>
