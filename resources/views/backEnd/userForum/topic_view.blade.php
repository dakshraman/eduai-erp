...
@push('css')
    <link rel="stylesheet" href="{{ assetPath('/') }}/Modules/Forum/public/assets/css/style.css" />
                                                            ...
                                                            <div class="d-flex align-items-center gap-10">
                                                                <div class="thumb">
                                                                    @if ($reply->user)
                                                                        ...
                                                                        @else --}}
                                                                        {{-- @endif --}}
                                                                            <img class="img-fluid rounded-circle" src=" {{ @profile() && file_exists(@profile()) ? asset(profile()) : assetPath('public/backEnd/assets/img/avatar.png') }}" alt="">
                                                                    @endif
                                                                ...
                                                                <div class="modal-dialog modal-lg" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            {{ html()->form('POST', route('user-topic-comment-reply.update'))->attributes([
                                                ...
                                                <div class="modal fade" id="editCommentModal{{$comment->id}}" tabindex="-1" role="dialog" aria-labelledby="editModalCommentLabel{{$comment->id}}" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                {{ html()->form('POST', route('user-topic-comment.update'))->attributes([
                                                                    'class' => 'form-horizontal',
                                                                    'files' => true,
                                                                    'enctype' => 'multipart/form-data',
                                                                ])->open() }}
