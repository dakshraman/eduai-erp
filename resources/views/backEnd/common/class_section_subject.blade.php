...
<script>
    $(document).ready(function() {
        // Handle Branch Change - Load Classes by Branch
        $(document).on('change', '.for-data-get-shift-class', function() {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $('#select_class_loader').addClass('pre_loader').removeClass('loader');
                },
                success: function (data) {
                    $("#select_class").empty().append(
                        $("<option>", {
                            value: '',
                            text: "{{ __('common.select_class') }}",
                        })
                    );
                    if (data.length) {
                    ...
                    if ($('#select_class').hasClass('niceSelect')) {
                        $('#select_class').niceSelect('update');
                    }
                ...
                complete: function () {
                    $('#select_class_loader').removeClass('pre_loader').addClass('loader');
                }
            });
        });
    });
