...
<section class="admin-visitor-area up_admin_visitor full_wide_table">
    <div class="container-fluid p-0">
            @if (userPermission('disabled_student_search'))
            {{ html()->form('POST', route('disabled_student_search'))->attributes([
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-40 d-flex justify-content-between">
                    ...
                    {{ html()->form('POST', route('disable_student_delete'))->attribute('enctype', 'multipart/form-data')->open() }}
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mt-40 d-flex justify-content-between">
                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('common.cancel')</button>
                    {{ html()->form('POST', route('enable_student'))->attribute('enctype', 'multipart/form-data')->open() }}
