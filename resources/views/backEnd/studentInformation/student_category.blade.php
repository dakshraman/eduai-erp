...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            ...
            @endif
            <div class="row">
                @if (userPermission('student_category_store') || isset($student_type))
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">

                            @if (isset($student_type))
                                {{ html()->form('POST', route('student_category_update'))->attributes(['class' => 'form-horizontal'])->open() }}
                            @else
                                @if (userPermission('student_category_store'))
                                    {{ html()->form('POST', route('student_category_store'))->attributes(['class' => 'form-horizontal'])->open() }}
                                @endif
                            @endif
                            <div class="white-box">
                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-20',
                                                'branch_id' => isset($student_type) ? $student_type->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('common.category') <span
                                                        class="text-danger"> *</span></label>
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('category') ? ' is-invalid' : '' }}"
                                                    type="text" name="category" autocomplete="off"
                                                    value="{{ old('category', isset($student_type) ? $student_type->category_name : '') }}">
                                                <input type="hidden" name="id"
                                                    value="{{ isset($student_type) ? $student_type->id : '' }}">
                ...
                @endif
                <div class="@if (userPermission('student_category_store') || isset($student_type)) col-lg-9 @else col-lg-12 @endif">
                    <div class="white-box">
                        <div class="row">
                                        ...
                                        <tbody>
                                            @foreach ($student_types as $key => $student_type)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    @if (moduleStatusCheck('Branch'))
                                                    <td>{{ $student_type->branch?->branch_name }}</td>
                                                    @endif
                                                ...
                                                <div class="modal fade admin-query"
                                                    id="deleteStudentTypeModal{{ $student_type->id }}">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    <a
                                                                        href="{{ route('student_category_delete', [$student_type->id]) }}"><button
