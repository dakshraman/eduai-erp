{{ html()->form('POST', route('student.record.update'))->attributes([
...
@if (moduleStatusCheck('Branch'))
    <div class="row">
        @include('branch::components.branch_select', [
            ...
            'mb' => 'mb-15',
            'branch_id' => isset($record) ? $record->branch_id : old('branch_id'),
            'title' => 0,
        ])
    </div>
@endif
<div class="row">
    @php  $setting = app('school_general_settings');   @endphp
