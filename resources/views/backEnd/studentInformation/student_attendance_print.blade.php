        ...
        <table  cellspacing="0" width="100%">
            <tr>
                ...
                <td style="padding-left: 10px"> 
                    <h3 style="font-size:22px !important" class="text-white"> {{isset(generalSetting()->school_name)?generalSetting()->school_name:'EduAI'}} </h3> 
                    <p style="font-size:18px !important" class="text-white mb-0"> {{isset(generalSetting()->address)?generalSetting()->address:'School Address'}} </p>  
                </td>
                <td style="text-aligh:center"> 
                @if(moduleStatusCheck('Branch'))
                    <p style="font-size:14px !important; border-bottom:1px solid gray" align="left" class="text-white">{{__('common.branch')}}: {{ $branch->branch_name}} </p>
                @endif
