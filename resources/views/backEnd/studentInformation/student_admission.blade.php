...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ assetPath('public/backEnd/') }}/css/croppie.css">
@endsection
@section('mainContent')
                                    ...
                                    <div class="tab-content">
                                                    ...
                                                    <div class="form-section">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 mt-4">
                                                                <div class="primary_input" id="common_academic_years_div">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-section">
                                                        <div class="row">
                                                                    ...
                                                                    <div class="image-upload-wrapper">
                                                                        <div class="primary_input">
                                                                            <div class="primary_file_uploader">
                                                                                {{-- Display file name --}}
                                                                                <input class="primary_input_field image-placeholder form-control{{ $errors->has('photo') ? ' is-invalid' : '' }}"
                                                                                    type="text"
                                                                                    placeholder="@lang('common.student_photo') @if (is_required('photo') == true) * @endif"
                                                                                    value="@lang('common.student_photo') @if (is_required('photo') == true) * @endif"
                                                                                    disabled>

                                                                                {{-- Browse button and actual file input --}}
                                                                                <button type="button">
                                                                                    <label class="primary-btn small fix-gr-bg">
                                                                                        {{ __('common.browse') }}
                                                                                        <input type="file" class="d-none image-input" name="photo">
                                                                                    </label>
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12 mt-15">
                                                                            <img class="d-none previewImageSize image-preview" src="" alt="" height="100%" width="100%">
                                                                            <button type="button" class="btn btn-sm btn-danger mt-2 d-none remove-image">Remove Image</button>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-12 mt-15">
                                                                <img class="d-none previewImageSize image-preview" src="" alt="" id="studentImageShow" height="100%" width="100%">
                                                                <button type="button" class="btn btn-sm btn-danger mt-2 d-none remove-image">Remove Image</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                        ...
                                                                        @if (is_show('fathers_photo'))
                                                                            <div class="col-lg-6 mt-4">
                                                                                <div class="image-upload-wrapper">
                                                                                    <div class="primary_input">
                                                                                        <label class="primary_input_label" for="">
                                                                                            @lang('student.fathers_photo')
                                                                                            @if (is_required('fathers_photo') == true)
                                                                                                <span class="text-danger">*</span>
                                                                                            @endif
                                                                                        </label>
                                                                                        <div class="primary_file_uploader">
                                                                                            <input class="primary_input_field image-placeholder form-control"
                                                                                                type="text"
                                                                                                placeholder="@lang('student.photo')"
                                                                                                value="@lang('student.photo')"
                                                                                                disabled>
                                                                                            <button type="button">
                                                                                                <label class="primary-btn small fix-gr-bg">
                                                                                                    {{ __('common.browse') }}
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="document_info">
                                            <div class="row pt-4 row-gap-24">
                                                ...
                                                @if (is_show('document_file_1') || is_show('document_file_2') || is_show('document_file_3') || is_show('document_file_4'))
                                                <div class="col-lg-12">
                                                    <div class="form-section">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="row">
                                                                        <div class="col-lg-12">
                                                                            <div class="primary_input ">
                                                                                ...
                                                                                <input class="primary_input_field form-control{{ $errors->has('document_title_1') ? ' is-invalid' : '' }}"
                                                                    ...
                                                                    <div class="col-lg-12 mt-2 mb-3 mb-lg-0">
                                                                        <div class="primary_input">
                                                                            <div class="primary_file_uploader">
                                                                                <input class="primary_input_field file-placeholder"
                                                                                    type="text"
                                                                        ...
                                                                        <button type="button" class="btn btn-sm btn-danger mt-2 d-none remove-file-btn" data-id="1">Remove</button>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                        <div class="col-lg-12">
                                                                            <div class="primary_input ">
                                                                                ...
                                                                                <input class="primary_input_field form-control{{ $errors->has('document_title_2') ? ' is-invalid' : '' }}"
                                                                    ...
                                                                    <div class="col-lg-12 mt-2 mb-3 mb-lg-0">
                                                                        <div class="primary_input">
                                                                            <div class="primary_file_uploader">
                                                                                <input class="primary_input_field file-placeholder" type="text"
                                                                                ...
                                                                                <button class="" type="button">
                                                                                    ...
                                                                                    <input type="file" class="d-none file-input"
                                                                                        name="document_file_2" id="document_file_2" data-id="2">
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                        <button type="button" class="btn btn-sm btn-danger mt-2 d-none remove-file-btn" data-id="2">Remove</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @endif
                                                                ...
                                                                <div class="row">
                                                                        <div class="col-lg-12">
                                                                            <div class="primary_input ">
                                                                                ...
                                                                                <input class="primary_input_field form-control{{ $errors->has('document_title_3') ? ' is-invalid' : '' }}"
                                                                        ...
                                                                        <div class="primary_input">
                                                                            <div class="primary_file_uploader">
                                                                                ...
                                                                                <button class="" type="button">
                                                                                    ...
                                                                                    <input type="file" class="d-none file-input"
                                                                                        name="document_file_3" id="document_file_3" data-id="3">
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                        <button type="button" class="btn btn-sm btn-danger mt-2 d-none remove-file-btn" data-id="3">Remove</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @endif
                                                                ...
                                                                <div class="row">
                                                                        <div class="col-lg-12">
                                                                            <div class="primary_input ">
                                                                                ...
                                                                                <input class="primary_input_field form-control{{ $errors->has('document_title_4') ? ' is-invalid' : '' }}"
                                                                        ...
                                                                        <div class="primary_input">
                                                                            <div class="primary_file_uploader">
                                                                                ...
                                                                                <button class="" type="button">
                                                                                    ...
                                                                                    <input type="file" class="d-none file-input"
                                                                                        name="document_file_4" id="document_file_4" data-id="4">
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                        <button type="button" class="btn btn-sm btn-danger mt-2 d-none remove-file-btn" data-id="4">Remove</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @endif
...
@section('script')
    <script src="{{ assetPath('public/backEnd/js/croppie.js') }}"></script>
    <script src="{{ assetPath('public/backEnd/js/st_addmision.js') }}"></script>
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('.file-input').forEach(function (input) {
                input.addEventListener('change', function () {
                    ...
                    const placeholder = document.querySelector(`.file-placeholder[data-id="${id}"]`);
                    const removeBtn = document.querySelector(`.remove-file-btn[data-id="${id}"]`);

                    if (placeholder) placeholder.value = fileName;
                    if (fileName && removeBtn) removeBtn.classList.remove('d-none');
                });
            });
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            uploadWrappers.forEach(wrapper => {
                ...
                const placeholderInput = wrapper.querySelector('.image-placeholder');
                const imagePreview = wrapper.querySelector('.image-preview');
                const removeButton = wrapper.querySelector('.remove-image');
                const defaultPlaceholder = placeholderInput?.getAttribute('placeholder') || 'Choose Image';

                if (!fileInput || !placeholderInput || !imagePreview || !removeButton) return;

                // Browse and Preview
                fileInput.addEventListener('change', function () {
                    const file = this.files[0];
                    if (file) {
                        placeholderInput.value = file.name;
