...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        ...
        @endif
        <div class="row">
            @if(userPermission('student_group_store') || isset($student_group))
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        @if(isset($student_group))
                        {{ html()->form('POST', route('student_group_update'))->attributes([
                        ...
                        @else
                        @if(userPermission('student_group_store'))
                        {{ html()->form('POST', route('student_group_store'))->attributes([
                            'class' => 'form-horizontal',
                            'files' => true,
                            'enctype' => 'multipart/form-data',
                        ])->open() }}
                                ...
                                @if (moduleStatusCheck('Branch'))
                                    <div class="row">
                                        @include('branch::components.branch_select', [
                                            ...
                                            'mb' => 'mb-20',
                                            'branch_id' => old('branch_id', isset($student_group) ? $student_group->branch_id : ''),
                                        ])
                                    </div>
                                @endif
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('group', isset($student_group) ? $student_group->group : '') }}">
            ...
            <div class="@if(userPermission('student_group_store') || isset($student_group)) col-lg-9 @else col-lg-12 @endif">
                <div class="white-box">
                    <div class="row">
                            ...
                            <x-table>
                                <table id="table_id" class="table Crm_table_active3" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            @if (moduleStatusCheck('Branch'))
                                            <td>{{$student_group->branch?->branch_name}}</td>
                                            @endif
