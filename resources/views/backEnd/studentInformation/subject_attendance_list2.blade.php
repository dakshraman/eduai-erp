...
@endsection
<link rel="stylesheet" href="{{assetPath('public/backEnd/css/login_access_control.css')}}"/>
...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">  
                    <div class="white-box">
                        ...
                        @else
                            ...
                            <div class="col-lg-3 mt-30-md mt-30">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <label for="startDate">@lang('student.attendance_date')<span class="text-danger"> *</span></label>
                                        <div class="primary_input">
                ...
                {{-- {{ html()->form('POST', route('subject-attendance-store-second'))->attributes([
                        'class' => 'form-horizontal',
                        'files' => true,
                        'enctype' => 'multipart/form-data',
                    ])->open() }} --}}
                    ...
                    @if(moduleStatusCheck('University'))
                    <input class="subject_branch_id" type="hidden" name="branch_id" value="{{$input['branch_id']}}">
                    @endif
                    <div class="row mt-40">
                        <div class="col-lg-12 ">
                            <div class=" white-box mb-40">
                                <div class="row"> 
                                    ...
                                    @else
                                        ...
                                        <div class="col-lg-3">
                                            <b> @lang('common.section'): </b> {{$search_info['section_name']}} @if(shiftEnable()) [{{$search_info['shift_name']}}] @endif
                                        </div>
                                        <div class="col-lg-3">
