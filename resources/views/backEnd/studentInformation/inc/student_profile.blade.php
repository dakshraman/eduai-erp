...
@if (is_show('photo'))
    <img class="student-meta-img img-100"
        src="{{ file_exists(@$student_detail->student_photo) ? assetPath($student_detail->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
        alt="">
@endif
...
<div class="white-box radius-t-y-0">
    ...
    <div class="single-meta">
        <div class="d-flex justify-content-between">
            ...
            <div class="value">
                {{ @$student_detail->defaultClass->branch?->branch_name }}
            </div>
        </div>
    </div>
    @endif
    ...
    <div class="single-meta">
        <div class="d-flex justify-content-between">
            ...
            <div class="value">
               ...
               {{ @$student_detail->studentRecord->shift->name ?? ''  }}
            </div>
        </div>
    </div>
    @endif
        ...
        @if(moduleStatusCheck('QRCodeAttendance') && file_exists(public_path('qr_codes/student-'.$student_detail->id.'-qrcode.png')))
            <div class="single-meta">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="value">
                        <img src="{{ assetPath('public/qr_codes/student-'.$student_detail->id.'-qrcode.png') }}" height="100" width="100" alt="">
                    </div>
                </div>
            </div>
        @endif
...
@if (count($siblings) > 0)
    ...
    @foreach ($siblings as $sibling)
        <div class="student-meta-box mb-20">
            ...
            <img class="student-meta-img img-100"
                src="{{ file_exists(@$sibling->student_photo) ? asset(@$sibling->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
                alt="">
            <div class="white-box radius-t-y-0">
                <div class="single-meta mt-50">
                    <div class="d-flex justify-content-between">
