                    ...
                    @if ($get_results)
                        <div class=@if ($key != 0) mt-40 @endif>
                            ...
                            @php
                                ...
                                $optional_subject = (!is_null($student_detail->optionalSubjectSetup) && !is_null($student_detail->optionalSubject)) ? 1 : 0;
                                $optional_gpa = 0;
                            @endphp


                            <div class="table-responsive">
                                <table id="table_id" class="table student-exam-data-table mt-5" cellspacing="0"
                                       width="100%">
                                    <thead>
                                    <tr>
                                    ...
                                    @foreach ($get_results as $mark)
                                        @php
                                            ...
                                            if (!is_null(@$student_detail->optionalSubject)) {
                                                if (@$student_detail->optionalSubject->subject_id == $mark->subject->id && $mark_gpa_point < @$student_detail->optionalSubjectSetup->gpa_above) {
