            ...
            @foreach ($teacherEvaluations as $teacherEvaluation)
                @if ($teacherEvaluation->status == 1 && $approved_evaluation_button_enable == false)
                    <tr>
                        ...
                        <td>{{ $teacherEvaluation->studentRecord->class->class_name }}({{ $teacherEvaluation->studentRecord->section->section_name }}) @if(shiftEnable()) [{{ $teacherEvaluation->studentRecord->shift->name }}] @endif
                        </td>
                        <td>
