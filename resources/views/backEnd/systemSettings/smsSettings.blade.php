                ...
                <div class="col-lg-12">
                    <div class="student-details">
                        <ul class="nav nav-tabs tab_column" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if (Session::get('twilio_settings') == 'active') active @endif "
                                href="#twilio_settings"
                                role="tab" data-toggle="tab">@lang('system_settings.twilio') </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if (Session::get('msg91_settings') == 'active') active @endif "
                                href="#msg91_settings"
                                role="tab" data-toggle="tab">@lang('system_settings.msg91') </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if (Session::get('textlocal_settings') == 'active') active @endif "
                                href="#textlocal_settings"
                            ...
                            <li class="nav-item">
                                ...
                                href="#africatalking_settings" role="tab"
                                data-toggle="tab">@lang('system_settings.africatalking') </a>
                            </li>

                            @if (moduleStatusCheck('HimalayaSms'))
                                <li class="nav-item">
                                    <a class="nav-link @if (Session::get('HimalayaSms') == 'active') active @endif "
                                    href="#HimalayaSms"
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if (Session::get('Mobile_SMS') == 'active') active @endif "
                                href="#Mobile_SMS"
                                role="tab" data-toggle="tab">@lang('system_settings.mobile_sms')</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link @if (Session::get('Custom_sms') == 'active') active @endif "
                                href="#Custom_sms"
                    ...
                    <div class="tab-content">
                            ...
                            <div class="white-box">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 select_sms_services">
                                        {{ html()->form(route('update-clickatell-data'))->attributes([
                                        ...
                                        <div class="primary_input">
                                            <label class="primary_input_label"
                                                   for="">@lang('system_settings.select_a_SMS_service')<span
                                            ...
                                            <select
                                                ...
                                                <option data-display="@lang('system_settings.select_a_SMS_service')"
                                                        value="">@lang('system_settings.select_a_SMS_service')
                                                </option>
                                    ...
                                    <div class="col-lg-8">
                                        {{ html()->form('post', route('send-test-sms'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                            'id' => 'send-test-sms',
                        ...
                        <!-- Start Exam Tab -->
                        <div role="tabpanel"
                             class="tab-pane fade @if (Session::get('twilio_settings') == 'active') show active @endif "
                             id="twilio_settings">
                            @if (userPermission('update-twilio-data'))
                                {{ html()->form(route('update-twilio-data'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                    'id' => 'twilio_form',
                                        ...
                                        <div class="col-md-5">
                                            <div class="row">
                                                <div class="col-lg-12 mb-30">
                                                    <div class="primary_input">
                                                        <label class="primary_input_label"
                                                               for="">@lang('system_settings.twilio_account_sid') <span
                                                                    class="text-danger"> *</span> </label>
                                                        <input
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 mb-30">
                                                    <div class="primary_input">
                                                        <label class="primary_input_label"
                                                               for="">@lang('system_settings.authentication_token')
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="primary_input">
                                                        <label class="primary_input_label"
                                                               for="">@lang('system_settings.registered_phone_number')
                                                            <span class="text-danger"> *</span> </label>
                                                        <input
                                                                class="primary_input_field form-control{{ $errors->has('twilio_registered_no') ? ' is-invalid' : '' }}"
                                                                type="text" name="twilio_registered_no"
                                                                autocomplete="off"
                                        ...
                                        <div class="col-md-7">
                                            <div class="row justify-content-center">
                                                <img class="logo" width="250" height="90"
                                                     src="{{ assetPath('public/backEnd/img/twilio.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel"
                             class="tab-pane fade @if (Session::get('msg91_settings') == 'active') show active @endif "
                             id="msg91_settings">
                            @if (userPermission('update-msg91-data'))
                                {{ html()->form('POST', route('update-msg91-data'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                ])->open() }}
                                    ...
                                    <div class="col-md-5">
                                        <div class="row">
                                            <div class="col-lg-12 mb-30">
                                                ...
                                                <div class="primary_input">
                                                    <label class="primary_input_label"
                                                           for="">@lang('system_settings.authentication_key_sid')
                                                        <span class="text-danger"> *</span> </label>
                                                    <input
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mb-30">
                                                <div class="primary_input">
                                                    <label class="primary_input_label"
                                                           for="">@lang('system_settings.sender_id')
                                                        <span class="text-danger"> *</span> </label>
                                                    <input
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label class="primary_input_label"
                                                           for="">@lang('system_settings.country_code')
                                                        <span class="text-danger"> *</span> </label>
                                                    <input
                                    ...
                                    <div class="col-md-7">
                                        <div class="row justify-content-center">
                                            <img class="logo" width="" height=""
                                                 src="{{ assetPath('public/backEnd/img/MSG91-logo.png') }}">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- Start Exam Tab -->
                        <div role="tabpanel"
                             class="tab-pane fade @if (Session::get('textlocal_settings') == 'active') show active @endif "
                             id="textlocal_settings">
                            @if (userPermission('update-textlocal-data'))
                                {{ html()->form('POST', route('update-textlocal-data'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                    'id' => 'textlocal_form',
                            ...
                            <div class="white-box">
                                <div class="">
                                    ...
                                    <div class="row mb-30">
                                        ...
                                        <div class="col-md-5">
                                            <div class="row">
                                                <div class="col-lg-12 mb-30">
                                                    <div class="primary_input">
                                                        <label class="primary_input_label"
                                                               for="">@lang('system_settings.textlocal_username')<span
                                                                    class="text-danger"> *</span> </label>
                                                        <input
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 mb-30">
                                                    <div class="primary_input">
                                                        <label class="primary_input_label"
                                                               for="">@lang('system_settings.textlocal_hash') <span
                                                                    class="text-danger"> *</span> </label>
                                                        <input
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 mb-30">
                                                    <div class="primary_input">
                                                        <label class="primary_input_label"
                                                               for="">@lang('system_settings.textlocal_sender')<span
                                                                    class="text-danger"> *</span> </label>
                                                        <input
                                        ...
                                        <!-- <div class="col-md-7">
                                        <div class="row justify-content-center">
                                             <img class="logo" width="250" height="90" src="{{ assetPath('public/backEnd/img/twilio.png') }}">
                                        </div>
                                    </div> -->
                                    </div>
                                </div>
                        ...
                        <!-- Mobile_SMS Tab -->
                        <div role="tabpanel"
                             class="tab-pane fade @if (Session::get('Mobile_SMS') == 'active') show active @endif "
                             id="Mobile_SMS">
                            <div class="white-box">
                                <div class="row mb-30">
                                    <div class="col-lg-12">
                            ...
                            @php
                                ...
                                $mobile_sms = App\Models\SmSmsGateway::where('gateway_name', 'Mobile SMS')->first('device_info');
                            ...
                            @if(!$data && @$device_info)
                                <div class="mt-20">
                                    <div class="white-box">
                                        <form class="form-horizontal" action="{{route('set_fcm_sms_key')}}"
                        ...
                        <!-- Start Himalaya Sms  -->
                        <div role="tabpanel"
                             class="tab-pane fade @if (Session::get('HimalayaSms') == 'active') show active @endif "
                             id="HimalayaSms">
                            @if (userPermission('himalayasms.update-setting') && moduleStatusCheck('HimalayaSms'))
                                {{ html()->form('POST', route('himalayasms.update-setting'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                    'id' => 'textlocal_form',
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-30">
                                                    <div class="primary_input">
                                                        <label class="primary_input_label"
                                                               for="">@lang('system_settings.api_key') <span
                                                                    class="text-danger"> *</span> </label>
                                                        <input
                        ...
                        <div role="tabpanel"
                             class="tab-pane fade @if (Session::get('africatalking_settings') == 'active') show active @endif"
                             id="africatalking_settings">
                            @if (userPermission('update-africatalking-data'))
                                {{ html()->form('POST', route('update-africatalking-data'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                    'id' => 'textlocal_form',
                                        ...
                                        <div class="col-md-5">
                                            <div class="row">
                                                <div class="col-lg-12 mb-30">
                                                    <div class="primary_input">
                                                        <label class="primary_input_label"
                                                               for="">@lang('system_settings.africatalking_username')
                                                            <span class="text-danger"> *</span> </label>
                                                        <input
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 mb-30">
                                                    <div class="primary_input">
                                                        <label class="primary_input_label"
                                                               for="">@lang('system_settings.africatalking_api_key')
                                                            <span class="text-danger"> *</span> </label>
                                                        <input
