            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($academic_year))
                                {{ html()->form('PUT', route('academic-year-update', @$academic_year->id))->attributes([
                            ...
                            @else
                                @if (userPermission('academic-year-store'))
                                    {{ html()->form('POST', route('academic-years'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                ...
                                                <input
                                                        ...
                                                        value="{{ isset($academic_year) ? @$academic_year->year : old('year') }}">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label> @lang('system_settings.year_title')<span
                                                            class="text-danger"> *</span></label>
                                                <input
                                                        class="primary_input_field form-control{{ $errors->has('title') ? ' is-invalid' : '' }}"
                                                        type="text" name="title" autocomplete="off"
                                                        value="{{ isset($academic_year) ? @$academic_year->title : old('title') }}">
                                                <input type="hidden" name="id"
                                                       value="{{ isset($academic_year) ? @$academic_year->id : '' }}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"
                                                       for="date_of_birth">@lang('system_settings.starting_date')
                                                    <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row mt-15">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"
                                                       for="date_of_birth">@lang('system_settings.ending_date')
                                                    <span class="text-danger">*</span></label>
                                                <div class="primary_datepicker_input">
                                                    <div class="no-gutters input-right-icon">
                                                        <div class="col">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <select multiple name="copy_with_academic_year[]"
                                                        {{ isset($academic_year) ? 'disabled':'' }}  class="multypol_check_select active position-relative">
                                                    <option value="App\Models\SmClass"
                                                            @if (isset($academic_year)) @if (in_array('App\Models\SmClass', @$copy_with_academic_year)) selected @endif
                                                            @endif >@lang('common.class') </option>
                                                    <option value="App\Models\SmSection"
                                                            @if (isset($academic_year)) @if (in_array('App\Models\SmSection', @$copy_with_academic_year)) selected @endif
                                                            @endif >@lang('common.section')</option>
                                                    @if(shiftEnable())
                                                        <option value="App\Models\Shift"
                                                                @if (isset($academic_year)) @if (in_array('App\Models\Shift', @$copy_with_academic_year)) selected @endif
                                                                @endif >@lang('common.shift')</option>
                                                    @endif
                                                    <option value="App\Models\SmSubject"
                                                            @if (isset($academic_year)) @if (in_array('App\Models\SmSubject', @$copy_with_academic_year)) selected @endif
                                                            @endif >@lang('common.subject')</option>
                                                    <option value="App\Models\SmExamType"
                                                            @if (isset($academic_year)) @if (in_array('App\Models\SmExamType', @$copy_with_academic_year)) selected @endif
                                                            @endif >@lang('exam.exam_type') </option>
                                                    <option value="App\Models\SmStudentCategory"
                                                            @if (isset($academic_year)) @if (in_array('App\Models\SmStudentCategory', @$copy_with_academic_year)) selected @endif
                                                            @endif >@lang('student.student_category')</option>
                                                    <option value="App\Models\SmFeesGroup"
                                                            @if (isset($academic_year)) @if (in_array('App\Models\SmFeesGroup', @$copy_with_academic_year)) selected @endif
                                                            @endif >@lang('fees.fees_group')</option>
                                                    <option value="App\Models\SmLeaveType"
                                                            @if (isset($academic_year)) @if (in_array('App\Models\SmLeaveType', @$copy_with_academic_year)) selected @endif
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-40 d-flex justify-content-between">
                                                                ...
                                                                {{ html()->form('DELETE', route('academic-year-delete', @$academic_year->id))->attribute('enctype', 'multipart/form-data')->open() }}
