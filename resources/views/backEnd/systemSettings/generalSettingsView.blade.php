                    ...
                    <div class="col-sm-6 col-lg-12">
                        ...
                        <div class="white-box">
                            ...
                            @if(isset($editData->logo))
                                ...
                                <img id="upload_logo_preview" class="img-fluid Img-100" src="{{assetPath($editData->logo)}}" alt="" >
                            @else
                                <img id="upload_logo_preview" class="img-fluid" src="{{assetPath('public/uploads/settings/logo.png')}}" alt="">
                            @endif
                            </div>
                    ...
                    <div class="col-sm-6 col-lg-12">
                        ...
                        <div class="white-box">
                            ...
                            @if(isset($editData->favicon) && !empty(@$editData->favicon))                            
                                <img  id="upload_favicon_preview" class="img-fluid Img-50" src="{{assetPath($editData->favicon)}}" alt="" >
                            @else
                                <img  id="upload_favicon_preview" class="img-fluid" src="{{assetPath('public/uploads/settings/favicon.png')}}" alt="">
                            @endif
                            </div>
                            ...
                            <div class="student-meta-box">
                                ...
                                <div class="single-meta">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="name">
                                                @lang('common.carry_forword_due_day')
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="value text-left">
                                                {{ @$editData->carry_forword_due_day }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
