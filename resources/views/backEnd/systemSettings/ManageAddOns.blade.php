...
@push('script')
    <script type="text/javascript" src="{{ assetPath('public/vendor/spondonit/js/parsley.min.js') }}"></script>
    <script type="text/javascript" src="{{ assetPath('public/vendor/spondonit/js/function.js') }}"></script>
    <script type="text/javascript" src="{{ assetPath('public/vendor/spondonit/js/common.js') }}"></script>
@endpush

@section('mainContent')
    <link rel="stylesheet" href="{{ assetPath('public/vendor/spondonit/css/parsley.css') }}">
    <style type="text/css">
        #selectStaffsDiv,
        .forStudentWrapper {
            display: none;
                            ...
                            <div class="col-lg-12">
                                <div class="table-responsive">
                                    <table class="table school-table-style" cellspacing="0" width="100%">
                                        ...
                                        @php
                                            $modules = App\Models\InfixModuleManager::where('is_default', 0)->get();
                                            $count = 1;
                                            $module_array = [];
                                        @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-success text-bold"> (
                                                        Version: {{ file_exists($is_module_available) ? @moduleVersion($module->name) : 'N/A'}}</small> )
                                                    <p>{{ $module->notes }}</p>
                                                ...
                                                <td>
                                                    @if (moduleStatusCheck($module->name) == false)
                                                        <span class="  {{ $module->name }} badge badge-warning text-white  "
                                                           >@lang('common.disable')</span>
                                                    @elseif(moduleStatusCheck($module->name) == true)
                                                        <span class=" {{ $module->name }} badge badge-success text-white "
                                                           >@lang('common.active') </span>
                                                    @else
                                                        <span class="{{ $module->name }} badge badge-success text-white "
                                                           >Purchased</span>
                                                    @endif
                                                ...
                                                <td>
                                                                            ...
                                                                            <div class="modal-dialog modal-dialog-centered">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body text-left">
                                                                                        {!! html()->form('POST', route('service.install.module'))->attributes([
                                                                                        ...
                                                                                        <div class="row mt-40">
                                                                                            <div
                                                                                                ...
                                                                                                <button style="display: none;"
                                                                                                        class="primary-btn fix-bg submitting"
                                                                                                        disabled>
                                                                                                        <span
                                                                                                                class="ti-reload"></span>
                                                                                                    @lang('common.verifying')
                                                                                                </button>
                                                                                            </div>
                                                                                        </div>
                                                                                        {{ html()->form()->close() }}
                                                    ...
                                                    @else
                                                        <div id="waiting_loader"
                                                            ...
                                                            <img src="{{ assetPath('public/backEnd/img/demo_wait.gif') }}"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            {{ html()->form('POST', route('moduleFileUpload'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
