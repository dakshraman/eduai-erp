        ...
        <div class="row">
            <div class="col-lg-12"> 
                <div class="white-box">
                    ...
                    {{ html()->form('POST', route('optional_subject_setup_post'))->attributes([
                    ...
                    <div class="row">
                            <input type="hidden" name="url" id="url" value="{{URL::to('/')}}">
                                ...
                                @endif
                                <div @if (moduleStatusCheck('Branch')) class="col-lg-3" @else class="col-lg-4" @endif>
                            ...
                            @endif
                               ...
                               @php 
                                ...
                                @endphp
                                <div @if (moduleStatusCheck('Branch')) class="col-lg-3 mt-30-md mt-35" @else class="col-lg-4 mt-30-md mt-35" @endif id="select_subject_div">
                            ...
                            <table id="table_id" class="table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{++$i}}</td>
                                        @if (moduleStatusCheck('Branch'))
                                        <td>{{@$class_optional->branch?->branch_name}}</td>
                                        @endif
