...
@section('mainContent')
    ...
    <section class="admin-visitor-area white-box">
        <div class="container-fluid p-0">
                    ...
                    <div class="student-details">
                        <ul class="nav nav-tabs tab_column" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" href="#local-drive" role="tab" data-toggle="tab"
                                    aria-selected="true">
                                    <span class="ti-desktop"></span> @lang('system_settings.local_drive')
                                </a>
                            </li>
                            @if(moduleStatusCheck('GoogleDrive'))
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="#google-drive" role="tab" data-toggle="tab" aria-selected="false">
                                        <span class="ti-google"></span> @lang('system_settings.google_drive')
                                    </a>
                                </li>
                            @endif
                        </ul>
            ...
            <div class="tab-content p-15">
                <!-- Local Drive Tab -->
                <div role="tabpanel" class="tab-pane fade show active" id="local-drive">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="row">
                                <div class="col-lg-12">
                                    @if (userPermission('backup-store'))
                                                                    {{ html()->form('POST', route('backup-store'))->attributes([
                                    ...
                                    <div class="col-lg-8 col-xl-9 text-right col-md-12 title_custom_margin">
                                        ...
                                        @if (Illuminate\Support\Facades\Config::get('app.app_sync'))
                                            <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip"
                                                ...
                                                <button class="primary-btn small fix-gr-bg  demo_view"
                                                    ...
                                                    @lang('system_settings.upload_file_backup')</button>
                                            </span>
                                        ...
                                        @else
                                            ...
                                            @if (userPermission('get-backup-db'))
                                                <a href="{{ route('get-backup-db') }}"
                                                    class="primary-btn small fix-gr-bg demo_view">
                                                    <span class="ti-arrow-circle-down pr-2"></span>
                                                    @lang('system_settings.database_backup') </a>
                                            @endif
                                        @endif
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title"> @lang('common.delete_item')
                                                                            </h4>
                ...
                @if(moduleStatusCheck('GoogleDrive'))
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="google-drive">
                        <div class="main-title">
                            <h3 class="mb-15">@lang('system_settings.google_drive') @lang('system_settings.backup_settings')
                            </h3>
                        </div>

                        @include('GoogleDrive::index')
                    </div>
...
@push('script')
    <script>
        // Proper Bootstrap 4 tab switching
        $(document).ready(function () {
            // Use Bootstrap's native tab functionality
            $('.nav-tabs a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
                // Target tab pane that should be shown
