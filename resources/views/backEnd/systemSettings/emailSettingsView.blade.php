            ...
            <div class="col-lg-12">
                ...
                <div class="tab-content p-15">
                    ...
                    <div role="tabpanel" class="tab-pane fade @if ($active_mail_driver == 'smtp') show active @endif" id="smtp">
                        ...
                        {{ html()->form('POST', url('update-email-settings-data'))->attributes([
                                    ...
                                    <div class="row justify-content-center mb-15">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                                ...
                                                type="text" name="from_email" id="from_email" autocomplete="off" value="{{isset($editData)? $editData->from_email : old('from_email')}}">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-6 mb-15">
                                            <div class="primary_input">
                                                ...
                                                type="text" name="mail_driver" id="mail_driver" autocomplete="off" value="{{isset($editData)? $editData->mail_driver : old('mail_driver')}}">
                                        ...
                                        <div class="col-lg-6 mb-15">
                                            <div class="primary_input">
                                                ...
                                                type="text" name="mail_host" id="mail_host" autocomplete="off" value="{{isset($editData)? $editData->mail_host : old('mail_host')}}">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-6 mb-15">
                                            <div class="primary_input">
                                                ...
                                                type="text" name="mail_port" id="mail_port" autocomplete="off" value="{{isset($editData)? $editData->mail_port : old('mail_port')}}">
                                        ...
                                        <div class="col-lg-6 mb-15">
                                            <div class="primary_input">
                                                ...
                                                type="text" name="mail_username" id="mail_username" autocomplete="off" value="{{isset($editData)? $editData->mail_username : old('mail_username')}}">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-6 mb-15">
                                            <div class="primary_input">
                                                ...
                                                type="password" name="mail_password" id="mail_password" autocomplete="off" value="{{isset($editData)? $editData->mail_password : old('mail_password')}}">
                                        ...
                                        <div class="col-lg-3 mb-15">
                                            <div class="primary_input">
                                                ...
                                                type="text" name="mail_encryption" id="mail_encryption" autocomplete="off" value="{{isset($editData)? $editData->mail_encryption : old('mail_encryption')}}">
                                        ...
                                        <div class="row justify-content-center mb-15">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="primary_input">
                                                    <label class="primary_input_label" for="">@lang('system_settings.from_mail')<span class="text-danger"> *</span> </label>
                                                    <input class="primary_input_field form-control{{ $errors->has('from_email') ? ' is-invalid' : '' }}"
                                                    type="text" name="from_email" id="from_email" autocomplete="off" value="{{isset($editDataPhp)? $editDataPhp->from_email : old('from_email')}}">
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-12">
                <div class="white-box">
                    <div class="main-title">
                        <h3 class="mb-30">Test Mail</h3>
                    </div>
                    {{ html()->form('POST', url('send-test-mail'))->attributes([
                        'class' => 'form-horizontal',
                        'id' => 'test_mail_form',
                    ])->open() }}
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="primary_input">
                                <label class="primary_input_label" for="test_email">Email Address <span class="text-danger">*</span></label>
