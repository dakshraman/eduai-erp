                ...
                <div class="white-box">
                    ...
                    <div class="">
                        ...
                        <div class="row mb-30">
                            <div class="col-lg-6 d-flex relation-button flex-wrap gap-20 mb-15">
                                <p class="text-uppercase mb-0">
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="Allow students to have different roll numbers in different classes.">
                                    </i>
                                </p>
                            ...
                            <div class="col-lg-6 d-flex relation-button flex-wrap gap-20 mb-15">
                                <p class="text-uppercase mb-0">
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="Allow students to be promoted to the next class without taking an exam.">
                                    </i>
                                </p>
                                <div class="d-flex radio-btn-flex">
                                    <div class="mr-20">
                        ...
                        <div class="row mb-30">
                            <div class="col-lg-6 d-flex relation-button flex-wrap gap-20 mb-15">
                                <p class="text-uppercase mb-0">
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="Enable or disable checkout functionality for purchasing LMS courses.">
                                    </i>
                                </p>
                        ...
                        <div class="row mb-30 ">
                                    ...
                                    <div class="mr-20">
                                        {{-- <label for=""> --}}
                                            ...
                                            <label for="first_layout">
                                                <img src="{{assetPath('public/backEnd/img/first_layout.png')}}" width="200px" height="auto" class="layout_image" for="first_layout" alt="">
                                            </label>
                                            {{-- </label> --}}
                                    </div>
                                    <div class="mr-20">
                                        ...
                                        <label for="second_layout">
                                            <img src="{{assetPath('public/backEnd/img/second_layout.png')}}" width="200px" height="auto" class="layout_image" for="second_layout" alt="">
                                        </label>
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <p class="text-uppercase mb-2">
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="Enable the updated fees module to manage fee types, collections, and reports more efficiently.">
                                    </i>
                                </p>
                                <div class="d-flex radio-btn-flex">
                                    <div class="mr-20">
                                    ...
                                    <div class="mr-20">
                                        <input type="radio" name="fees_status" id="fees_disable" value="0"
                                            class="common-radio relationButton"
                        ...
                        @if(!moduleStatusCheck('University'))
                            <div class="row mb-30 mt-30">
                                <div class="col-lg-12 d-flex relation-button flex-wrap gap-20 mb-15">
                                    <p class="text-uppercase mb-0">@lang('fees.school_fees_payment_installment_enable') <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Enable this to allow school fees to be paid in multiple installments."></i></p>
                                    <div class="d-flex radio-btn-flex">
                                        <div class="mr-20">
                        ...
                        <div class="row mb-30">
                            <div class="col-lg-6 d-flex relation-button flex-wrap gap-20 mb-15">
                                <p class="text-uppercase mb-0">
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="Choose how student results are displayed: as GPA or as full marks.">
                                    </i>
                                </p>
                                <div class="d-flex radio-btn-flex">
                                    <div class="mr-20">
                            ...
                            <div class="col-lg-6 d-flex relation-button flex-wrap gap-20 mb-15">
                                <p class="text-uppercase mb-0">
                                    ...
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    title="Select whether student admission requires guardian information.">
                                    </i>
                                </p>
                                <div class="d-flex radio-btn-flex">
                                    <div class="mr-20">
                                    ...
                                    <div class="mr-20">
                                        <input type="radio" name="with_guardian" id="without_guardian" value="0"
                                            class="common-radio relationButton"
                        ...
                        <div class="row md-30 mt-30">
                            ...
                            <div class="col-lg-5">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">{{ __("common.carry_forword_due_day") }}<span class="text-danger"> *</span></label>
                                    <input class="primary_input_field form-control" type="text"  name="carry_forword_due_day" autocomplete="off" value="{{!empty($editData) && !empty($editData->carry_forword_due_day) ? $editData->carry_forword_due_day:60}}" id="carry_forword_due_day">
                                </div>
                            </div>
                        </div>
