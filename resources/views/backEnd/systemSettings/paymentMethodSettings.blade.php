    ...
    <div class="container-fluid p-0">
        <div class="row pt-20">
            <div class="col-lg-3">
                ...
                {{ html()->form('POST', route('is-active-payment'))->attributes([
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row mb-15">
                                            <div class="col-md-12">
                                                ...
                                                @if (!in_array($input_field, $forServiceCharge) && $input_field != 'ssl_environment')
                                                    <div class="row">
                                                        <div class="col-lg-12 mb-15">
                                                            <div class="primary_input">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ old($input_field, isset($value) ? $value : '') }}"
                                                ...
                                                @if ($input_field == 'service_charge')
                                                    ...
                                                    <div class="row {{ $d_none }}" id="charge_type_{{ $row->gateway_name }}">
                                                        <div class="col-lg-6 ">
                                                            ...
                                                            <div class="d-flex radio-btn-flex mt-10">
                                                                ...
                                                                <div class="mr-30">
                                                                    ...
                                                                    <label   for="f_{{ $row->gateway_name }}">@lang('common.Flat')</label>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="primary_input">
                                                                <input class="primary_input_field form-control chargeValue {{ $errors->has('charge') ? ' is-invalid' : '' }}"     type="text" name="charge" data-gateway_name="{{ $row->gateway_name }}"    id="charge_{{ $row->gateway_name }}" autocomplete="off" value="{{ old('charge', $row->charge) }}">
                                                ...
                                                @if($input_field == 'ssl_environment')
                                                    <div class="row">
                                                        <div class="col-lg-6 ">
                                                            <label for=""> </label>
                                                            <div class="d-flex radio-btn-flex mt-10">
                                                                <div class="mr-30">
                                                                    <input type="radio" name="{{ $input_field }}" id="ssl_sendbox" value="sendbox" class="common-radio relationButton type_SslCommerz" checked="">
                                                                    <label for="ssl_sendbox">SENDBOX</label>
                                                                </div>
                                                                <div class="mr-30">
                                                                    <input type="radio" name="{{ $input_field }}" id="ssl_live" value="live" class="common-radio relationButton type_SslCommerz">
                                                        ...
                                                        <div class="col-lg-12 mb-15">
                                                            <div class="primary_input">
                                                                ...
                                                                <input
                                                                    ...
                                                                    type="text"
                                                                    name="{{ $input_field }}"
                                                                    id="gateway_{{ $input_field }}"
                                                                    autocomplete="off"
                                                                    value="{{ old($input_field, $value ?? '') }}"
                                                                    @if (!empty($count) && $count == 0) readonly @endif>
