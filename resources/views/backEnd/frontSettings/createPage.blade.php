            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($editData))
                                {{ html()->form('POST', route('update-page-data'))->attributes([
                            ...
                            @else
                                {{ html()->form('POST', route('save-page-data'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    type="text" name="title" onkeyup="processSlug(this.value, '#slug')"
                                                    autocomplete="off"
                                    ...
                                    <div class="row  mt-20">
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('front_settings.slug') <span
                                                        class="text-danger"> *</span></label>
                                                <input
                                                    class="primary_input_field form-control{{ @$errors->has('slug') ? ' is-invalid' : '' }}"
                                                    type="text" name="slug" id="slug" autocomplete="off"
                                                    value="{{ isset($editData) ? $editData->slug : old('slug') }}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input">
                                                        <label
                                                            class="primary_input_label">{{ __('front_settings.image_header_min') }}</label>
                                                        <div class="primary_file_uploader">
                                                            ...
                                                            <button class="" type="button">
                                                                <label class="primary-btn small fix-gr-bg"
                                                                    for="addPageImage">{{ __('common.browse') }}</label>
                                            ...
                                            @isset($editData)
                                                <a class="btn btn-primary cust-class pull-right"
                                                    href="{{ route('view-page', ['slug' => @$editData->slug]) }}"
                                                    target="blank">@lang('front_settings.preview')</a>
                                            @endisset
                                        </div>
                                    </div>
                                    <div class="row  mt-20">
                                        <div class="col-lg-12">
                                            <img class="previewImageSize {{ @$editData->header_image ? '' : 'd-none' }}"
                                                src="{{ @$editData->header_image ? assetPath($editData->header_image) : '' }}"
                                                alt="" id="pageImageShow" height="100%" width="100%">
                                        </div>
                                    </div>
                                    <div class="row  mt-20">
                                        <div class="col-lg-12">
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('common.details')<span
                                                        class="text-danger"> *</span></label>
                                                <textarea class="primary_input_field summer_note form-control{{ $errors->has('details') ? ' is-invalid' : '' }}"
                                                    cols="0" rows="4" name="details">{{ isset($editData) ? $editData->details : old('details') }}</textarea>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex">
                            <img src="{{ assetPath(@$editData->header_image) }}" width="100%" style="float: left">
                        </div>
                    </div>
                </div>
            </div>
