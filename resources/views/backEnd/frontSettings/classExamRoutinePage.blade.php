                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if (userPermission('news-heading-update'))
                                {{ html()->form('POST', route('class-exam-routine-page-update'))->attributes([
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input class="primary_input_field " type="text" name="title"
                                                    autocomplete="off"
                                                    value="{{ isset($update) ? ($routine_page != '' ? $routine_page->title : '') : old('title') }}">
                                                @if ($errors->has('title'))
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    ...
                                                    <textarea class="primary_input_field form-control" cols="0" rows="5" name="description" id="description">{{ isset($update) ? ($routine_page != '' ? $routine_page->description : '') : old('description') }}</textarea>
                                            ...
                                            <div class="primary_input mt-15">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($update) ? ($routine_page != '' ? $routine_page->main_title : '') : old('main_title') }}">
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    ...
                                                    <textarea class="primary_input_field form-control" cols="0" rows="5" name="main_description"
                                                        id="main_description">{{ isset($update) ? ($routine_page != '' ? $routine_page->main_description : '') : old('main_description') }}</textarea>
                                            ...
                                            <div class="primary_input mt-15">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($update) ? ($routine_page != '' ? $routine_page->button_text : '') : old('button_text') }}">
                                            ...
                                            <div class="primary_input mt-15">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($update) ? ($routine_page != '' ? $routine_page->button_url : '') : old('button_url') }}">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-6 d-flex">
                                            ...
                                            <div class="col-lg-6 d-flex radio-btn-flex">
                                                <div class="col-lg-6 primary_input sm_mb_20">
                                                    <input type="radio" name="class_routine" id="classRoutineShow"
                                                ...
                                                <div class="col-lg-6 primary_input sm_mb_20">
                                                    <input type="radio" name="class_routine" id="classRoutineHide"
                                                        class="common-radio" value="hide"
                                                        {{ @$routine_page->class_routine == 'hide' ? 'checked' : '' }}>
                                                    <label for="classRoutineHide">@lang('front_settings.hide')</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 d-flex">
                                            ...
                                            <div class="col-lg-6 d-flex radio-btn-flex">
                                                <div class="col-lg-6 primary_input sm_mb_20">
                                                    <input type="radio" name="exam_routine" id="examRoutineShow"
                                                        class="common-radio" value="show"
                                                        {{ @$routine_page->exam_routine == 'show' ? 'checked' : '' }}>
                                                    <label for="examRoutineShow">@lang('front_settings.show')</label>
                                                </div>
                                                <div class="col-lg-6 primary_input sm_mb_20">
                                                    <input type="radio" name="exam_routine" id="examRoutineHide"
                                                        class="common-radio" value="hide"
                                                        {{ @$routine_page->exam_routine == 'hide' ? 'checked' : '' }}>
                                                    <label for="examRoutineHide">@lang('front_settings.hide')</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
