        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        @if (isset($add_course))
                            {{ html()->form('POST', route('update_course'))->attributes([
                        ...
                        @else
                            @if (userPermission('store_course'))
                                {{ html()->form('POST', route('store_course'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                        ...
                        <div class="white-box">
                            ...
                            <div class="add-visitor">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('front_settings.course_category') <span
                                                    class="text-danger"> *</span></label>
                                            <select
                                                class="primary_select form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }}"
                                                name="category_id">
                                                <option data-display="@lang('front_settings.course') @lang('student.category')*"
                                                    value="">@lang('common.select') *</option>
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ @$add_course->category_id == $category->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('common.image') <span
                                                    class="text-danger">{{ !isset($add_course) || empty($add_course->image) ? '*' : '' }}</span></label>
                                            <div class="primary_file_uploader">
                                                ...
                                                <button class="" type="button">
                                                    <label class="primary-btn small fix-gr-bg"
                                                        for="addCourseImage">{{ __('common.browse') }}</label>
                                ...
                                <div class="row mt-15">
                                    <div class="col-md-12 mt-15">
                                        <img class="previewImageSize {{ @$add_course->image ? '' : 'd-none' }}"
                                            src="{{ @$add_course->image ? assetPath($add_course->image) : '' }}" alt=""
                                            id="courseImageShow" height="100%" width="100%">
                                    </div>
                                </div>
                                ...
                                <div class="row mt-15">
                                    <div class="col-md-12 mt-15">
                                        <div class="primary_input">
                                            ...
                                            <textarea class="generated-text primary_input_field form-control{{ $errors->has('overview') ? ' is-invalid' : '' }}"
                                                cols="0" rows="4" name="overview" maxlength="500">{{ isset($add_course) ? $add_course->overview : old('overview') }}</textarea>
                                ...
                                <div class="row mt-15">
                                    <div class="col-md-12">
                                        <div class="primary_input">
                                            ...
                                            <textarea class="generated-text primary_input_field form-control{{ $errors->has('outline') ? ' is-invalid' : '' }}"
                                                cols="0" rows="4" name="outline" maxlength="500">{{ isset($add_course) ? $add_course->outline : old('outline') }}</textarea>
                                ...
                                <div class="row mt-15">
                                    <div class="col-md-12">
                                        <div class="primary_input">
                                            ...
                                            <textarea
                                                class="generated-text primary_input_field form-control{{ $errors->has('prerequisites') ? ' is-invalid' : '' }}"
                                            ...
                                            @if ($errors->has('prerequisites'))
                                                <span
                                                    class="error text-danger">{{ $errors->first('prerequisites') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-15">
                                    <div class="col-md-12">
                                        <div class="primary_input">
                                            ...
                                            <textarea class="generated-text primary_input_field form-control{{ $errors->has('resources') ? ' is-invalid' : '' }}"
                                                cols="0" rows="4" name="resources" maxlength="500">{{ isset($add_course) ? $add_course->resources : old('resources') }}</textarea>
                                ...
                                <div class="row mt-15">
                                    <div class="col-md-12">
                                        <div class="primary_input">
                                            ...
                                            <textarea class="generated-text primary_input_field form-control{{ $errors->has('stats') ? ' is-invalid' : '' }}"
                                                cols="0" rows="4" name="stats" maxlength="500">{{ isset($add_course) ? $add_course->stats : old('stats') }}</textarea>
                                            @if ($errors->has('stats'))
                                ...
                                <script>
                                    $(document).ready(function() {
                                        function uploadGeneratedTextImage(files, editor) {
                                        ...
                                        $('textarea.generated-text').summernote({
                                            ...
                                            callbacks: {
                                                onImageUpload: function(files) {
                                                    uploadGeneratedTextImage(files, $(this));
                                                }
                                            },
                                        });
                                    });
                                ...
                                <div class="col-lg-12 text-center">
                                    @if (Illuminate\Support\Facades\Config::get('app.app_sync'))
                                        <span class="d-inline-block" tabindex="0" data-toggle="tooltip"
                                            title="Disabled For Demo "> <button class="primary-btn fix-gr-bg  demo_view"
                                                style="pointer-events: none;"
                                                type="button">@lang('front_settings.update_course')</button></span>
                                    @else
