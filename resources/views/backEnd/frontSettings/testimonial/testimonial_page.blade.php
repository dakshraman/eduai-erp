        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        @if (isset($add_testimonial))
                            {{ html()->form('POST', route('update_testimonial'))->attributes([
                        ...
                        @else
                            @if (userPermission('store_testimonial'))
                                {{ html()->form('POST', route('store_testimonial'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                        'id' => 'add-income',
                        ...
                        <div class="white-box">
                            ...
                            <div class="add-visitor">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <img class="previewImageSize {{ @$add_testimonial->image ? '' : 'd-none' }}"
                                            src="{{ @$add_testimonial->image ? assetPath($add_testimonial->image) : '' }}"
                                            alt="" id="testimonialImageShow" height="100%" width="100%">
                                    </div>
                                </div>
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <textarea class="primary_input_field form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" cols="0"
                                                rows="4" name="description">{{ isset($add_testimonial) ? @$add_testimonial->description : old('description') }}</textarea>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="star-rating">
                                                        <input type="radio" id="5-stars{{ $value->id }}"
                                                            name="rating{{ $value->id }}" value="5"
                                                            {{ $value->star_rating == 5 ? 'checked' : '' }} disabled />
                                                        <label for="5-stars{{ $value->id }}"
                                                            class="star">&#9733;</label>

                                                        <input type="radio" id="4-stars{{ $value->id }}"
                                                            name="rating{{ $value->id }}" value="4"
                                                            {{ $value->star_rating == 4 ? 'checked' : '' }} disabled />
                                                        <label for="4-stars{{ $value->id }}"
                                                            class="star">&#9733;</label>

                                                        <input type="radio" id="3-stars{{ $value->id }}"
                                                            name="rating{{ $value->id }}" value="3"
                                                            {{ $value->star_rating == 3 ? 'checked' : '' }} disabled />
                                                        <label for="3-stars{{ $value->id }}"
                                                            class="star">&#9733;</label>

                                                        <input type="radio" id="2-stars{{ $value->id }}"
                                                            name="rating{{ $value->id }}" value="2"
                                                            {{ $value->star_rating == 2 ? 'checked' : '' }} disabled />
                                                        <label for="2-stars{{ $value->id }}"
                                                            class="star">&#9733;</label>

                                                        <input type="radio" id="1-star{{ $value->id }}"
                                                            name="rating{{ $value->id }}" value="1"
                                                            {{ $value->star_rating == 1 ? 'checked' : '' }} disabled />
