...
@endsection
@push('css')
    <link rel="stylesheet" href="{{ assetPath('modules/AiContent/Resources/assets/css/ai_content.css') }}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        @if (isset($add_news))
                            {{ html()->form('POST', route('update_news'))->attributes([
                        ...
                        @else
                            @if (userPermission('store_news'))
                                {{ html()->form('POST', route('store_news'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                        'id' => 'add-income',
                            ...
                            <div class="add-visitor">
                                <div class="row">
                                        ...
                                        <div class="row mt-15">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="primary_input">
                                                            <label class="primary_field_label"
                                                                for="">@lang('common.image')<span class="text-danger">
                                                                    *</span></label>
                                                            <div class="primary_file_uploader">
                                                                ...
                                                                <button class="" type="button">
                                                                    <label class="primary-btn small fix-gr-bg"
                                                                        for="addNewsImage">{{ __('common.browse') }}</label>
                                    ...
                                    <div class="col-lg-12 mt-15">
                                        <img class="previewImageSize {{ @$add_news->image ? '' : 'd-none' }}"
                                            src="{{ @$add_news->image ? assetPath($add_news->image) : '' }}" alt=""
                                            id="newsImageShow" height="100%" width="100%">
                                    </div>
                                    <div class="col-md-12 mt-15">
                                        <div class="primary_input">
                                            ...
                                            <textarea
                                                class="generated-text primary_input_field form-control{{ $errors->has('description') ? ' is-invalid' : '' }} newsSummerNote"
                                    ...
                                    <div class="col-md-12 mt-15">
                                        ...
                                        <div class="">
                                            <input type="checkbox" id="newsStatus" class="common-checkbox form-control"
                                                name="status" value=1
                                                {{ isset($add_news) ? ($add_news->status == 1 ? 'checked' : '') : 'checked' }}>
                                    ...
                                    <div class="col-md-12 mt-15">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label class="primary_input_label"
                                                    for="">@lang('common.use_global_settings_for_can_comment_and_comment_auto_approval')</label>
                                                <div class="">
                                                    <input type="checkbox" id="newsSettings"
                                                        class="common-checkbox form-control" name="is_global"
                                                        value="1"
                                                        {{ isset($add_news) ? ($add_news->is_global == 1 ? 'checked' : '') : 'checked' }}>
                                            ...
                                            <div class="col-md-3 newsSettingsDiv d-none">
                                                <label class="primary_input_label"
                                                    for="">@lang('common.can_comment_only_for_this_news')</label>
                                                <div class="">
                                                    <input type="checkbox" id="isComment"
                                                        class="common-checkbox form-control" name="is_comment"
                                                        value="1"
                                                        {{ isset($add_news) ? ($add_news->is_comment == 1 ? 'checked' : '') : '' }}>
                                            ...
                                            <div class="col-md-3 newsSettingsDiv d-none">
                                                <label class="primary_input_label"
                                                    for="">@lang('common.auto_approval_comment_only_for_this_news')</label>
                                                <div class="">
                                                    <input type="checkbox" id="autoApproval"
                                                        class="common-checkbox form-control" name="auto_approve"
                                                        value="1"
                                                        {{ isset($add_news) ? ($add_news->auto_approve == 1 ? 'checked' : '') : '' }}>
                                                    <label for="autoApproval">{{ __('common.yes') }}</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="primary_input_label"
                                                    for="">@lang('common.mark_as_archive')</label>
                                                <div class="">
                                                    <input type="checkbox" id="mark_archive"
                                                        class="common-checkbox form-control" name="mark_as_archive"
                                                        value="1"
                                                        {{ isset($add_news) ? ($add_news->mark_as_archive == 1 ? 'checked' : '') : '' }}>
                                    ...
                                    <tbody>
                                        @foreach ($news as $value)
                                            <tr>
                                                    ...
                                                    @if ($value->mark_as_archive == 1)
                                                        <span>
                                                            <button class="btn btn-outline-danger btn-sm px-1 py-0"
                                                                style="font-size: 9px;">Archived</button>
                                                        </span>
                                                    @endif
                                                </td>
                                                ...
                                                <td><img src="{{ assetPath($value->image) }}" width="60px" height="50px">
                                                </td>
                                                <td>
                                                    <x-drop-down>
