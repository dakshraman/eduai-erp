            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($editData))
                                {{ html()->form('POST', route('update_news_category'))->attributes([
                            ...
                            @else
                                @if (userPermission('store_news_category'))
                                    {{ html()->form('POST', route('store_news_category'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                            'id' => 'add-income',
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                        <div class="col-lg-12 mb-15">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('student.category_name') <span
                                    ...
                                    @php
                                        $tooltip = '';
                                        if (
                                            userPermission('store_news_category') ||
                                            userPermission('edit-news-category')
                                        ) {
                                            $tooltip = '';
                                        } else {
                                                            ...
                                                            <x-drop-down>
                                                                @if (userPermission('edit-news-category'))
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('edit-news-category', $value->id) }}">
                                                                        @lang('common.edit')</a>
                                                                @endif
                                                                ...
                                                                @else
                                                                    @if (userPermission('for-delete-news-category'))
                                                                        <a class="deleteUrl dropdown-item"
                                                                            ...
                                                                            title="@lang('front_settings.delete_news_category')"
                                                                            href="{{ route('for-delete-news-category', $value->id) }}">
