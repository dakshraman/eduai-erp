                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if (userPermission('news-heading-update'))
                                {{ html()->form('POST', route('news-heading-update-new'))->attributes([
                                            ...
                                            <div class="primary_input mt-15">
                                                <div class="primary_input">
                                                    ...
                                                    <textarea class="primary_input_field form-control" cols="0" rows="5" name="main_description"
                                                        id="main_description">{{ isset($update) ? ($SmNewsPage != '' ? $SmNewsPage->main_description : '') : '' }}</textarea>
                                    ...
                                    <div class="mt-20">
                                        <section class="container box-1420">
                                            <div class="banner-area"
                                                style="background: linear-gradient(0deg, rgba(124, 50, 255, 0.6), rgba(199, 56, 216, 0.6)), url({{ $SmNewsPage->image != '' ? $SmNewsPage->image : '../img/client/common-banner1.jpg' }}) no-repeat center;background-size: 100%">
                                                <div class="banner-inner">
                                                    <div class="banner-content">
                                                        ...
                                                        <a class="primary-btn fix-gr-bg semi-large"
                                                            href="{{ $SmNewsPage->button_url }}">{{ $SmNewsPage->button_text }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </section>
                                            ...
                                            <div class="col-md-6">
                                                <div class="academic-item">
                                                    <div class="academic-img">
                                                        <img class="img-fluid" src="{{ assetPath($SmNewsPage->main_image) }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
