                ...
                <div class="row">
                    <div class="col-lg-12">
                        @if (isset($add_home_slider))
                            {{ html()->form('POST', route('home-slider-update'))->attributes([
                        ...
                        @else
                            @if (userPermission('home-slider-store'))
                                {{ html()->form('POST', route('home-slider-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                        ...
                        <div class="white-box">
                            ...
                            <div class="add-visitor">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <img class="previewImageSize {{ @$add_home_slider->image ? '' : 'd-none' }}"
                                            src="{{ @$add_home_slider->image ? assetPath($add_home_slider->image) : '' }}"
                                            alt="" id="homeSliderImageShow" height="100%" width="100%">
                                    </div>
                                </div>
                                <div class="row mt-20">
                                    <div class="col-lg-12">
