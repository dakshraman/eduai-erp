                ...
                <div class="row">
                    <div class="col-lg-12">
                        @if (isset($add_expert_teacher))
                            {{ html()->form('POST', route('expert-teacher-update'))->attributes([
                        ...
                        @else
                            @if (userPermission('expert-teacher-store'))
                                {{ html()->form('POST', route('expert-teacher-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                                    ...
                                    <div class="col-lg-12 mb-15" id="selectStaffsDiv">
                                        ...
                                        <select
                                            ...
                                            @foreach ($expertTeachers as $value)
                                                @if ($value->staff)
                                                    <option value="{{ $value->staff_id }}">{{ $value->staff->full_name }}
                                                    </option>
                                                @endif
                                            @endforeach
                                        </select>
                                    ...
                                    <tbody>
                                        @foreach ($expertTeachers as $key => $value)
                                            <tr e_id="{{ $value->id }}">
                                                ...
                                                <td><img src="{{ @$value->staff->staff_photo ? asset(@$value->staff->staff_photo) : assetPath('public/uploads/staff/staff.jpg') }}"
