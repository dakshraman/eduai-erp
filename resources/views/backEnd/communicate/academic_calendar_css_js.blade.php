@push('css')
    ...
    <link rel="stylesheet" href="{{ assetPath('public/backEnd/assets/vendors/css/customFullCalendar.css') }}"/>
    <style>
        .color-input {
            height: 50px;
...
@push('script')
    <script src="{{ assetPath('public/backEnd/') }}/full_calendar/js/index.global.min.js"></script>
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            @php
                $is_alumni = App\Support\GlobalVariable::isAlumni();
            @endphp
