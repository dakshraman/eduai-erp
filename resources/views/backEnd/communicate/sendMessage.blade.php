    ...
    <section class="admin-visitor-area up_admin_visitor">
        @if (userPermission('add-notice'))
            <div class="container-fluid p-0">
                {{ html()->form('POST', route('save-notice-data'))->attributes([
                                    ...
                                    <div class="col-lg-7">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input
                                                ...
                                                value="{{ isset($leave_type) ? $leave_type->type : old('notice_title') }}">
                                        ...
                                        <div class="primary_input mt-0">
                                            ...
                                            <textarea class="primary_input_field form-control" cols="0" rows="5" name="notice_message"
                                                id="article-ckeditor">{{old('notice_message')}}</textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label class="primary_input_label"
                                                    for="">@lang('communicate.message_to')  <span class="text-danger"> *</span></label>
                                                @php
                                                    $selectedRoles = old('role', $selected_roles ?? []);
                                                @endphp
