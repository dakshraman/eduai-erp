                                ...
                                <table id="table_id" class="table" cellspacing="0" width="100%">
                                    ...
                                    @foreach($routes as $route)
                                            ...
                                            <td class="col-6">
                                                <table>
                                                    ...
                                                    @foreach($vehicles as $vehicle)
                                                        ...
                                                        <span>
                                                            @php $vehicle = App\Models\SmVehicle::find($vehicle);
                                                            @endphp
                                                            {{$vehicle->vehicle_no}}
                                                        </span>
                                                                <div>
                                                                    ...
                                                                    @if($student_detail->route_list_id == $route->route->id && $student_detail->vechile_id == $vehicle->id)
                                                                        <a href="javascript:void(0)"
                                                                           class="primary-btn small fix-gr-bg">@lang('transport.assigned')</a>
                                                                    @endif
                                                                </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a class="primary-btn small fix-gr-bg"
                                                                       data-toggle="modal"
                                                                       data-target="#transportView{{$route->route->id}}{{$vehicle->id}}"
                                        ...
                                        <div class="modal fade admin-query"
                                             id="transportView{{$route->route->id}}{{$vehicle->id}}">
                                                            ...
                                                            <div class="single-meta">
                                                                <div class="row">
                                                                    <div class="col-lg-12 no-gutters">
                                                                        <div class="main-title">
                                                                            <h3 class="mb-0 text-center">@lang('common.route')
                                                                                : {{$route->route->title}}</h3>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div class="student-meta-box">
                                                                            ...
                                                                            @if (!empty($vehicle->driver_id))
                                                                                ...
                                                                                @php
                                                                                    $driver_info=App\Models\SmStaff::where('id','=',$vehicle->driver_id)->first();
                                                                                @endphp
                                                                                <div class="single-meta">
                                                                                    <div class="row">
                                                                                        <div class="col-lg-6 col-md-6">
