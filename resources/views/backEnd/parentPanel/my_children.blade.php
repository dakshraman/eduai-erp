                        ...
                        <div class="student-meta-box">
                            ...
                            @if (is_show('photo'))
                                <img class="student-meta-img img-100"
                                     src="{{ file_exists(@$student_detail->student_photo) ? assetPath($student_detail->student_photo) : assetPath('public/uploads/staff/demo/student.jpg') }}"
                                     alt="">
                            @endif
                                ...
                                @if(shiftEnable())
                                    <div class="single-meta">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="value">
                                                {{ @$student_detail->studentRecord->shift->shift_name }}
                                            </div>
                                        </div>
                                    </div>
                                @endif
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="white-box">
                                    ...
                                    <div class="d-flex">
                                        @if (is_show('fathers_photo'))
                                            <div class="mr-20 mt-20">
                                                <img class="student-meta-img img-100"
                                                     src="{{ file_exists(@$student_detail->parents->fathers_photo) ? assetPath($student_detail->parents->fathers_photo) : assetPath('public/uploads/staff/demo/father.png') }}"
                                                     alt="">
                                            </div>
                                        @endif
                                        <div class="w-100">
                                    ...
                                    <div class="d-flex">
                                        @if (is_show('mothers_photo'))
                                            <div class="mr-20 mt-20">
                                                <img class="student-meta-img img-100"
                                                     src="{{ file_exists(@$student_detail->parents->mothers_photo) ? assetPath($student_detail->parents->mothers_photo) : assetPath('public/uploads/staff/demo/mother.jpg') }}"
                                                     alt="">
                                            </div>
                                        @endif
                                        <div class="w-100">
                                    ...
                                    <div class="d-flex">
                                        @if (is_show('guardians_photo'))
                                            <div class="mr-20 mt-20">
                                                <img class="student-meta-img img-100"
                                                     src="{{ file_exists(@$student_detail->parents->guardians_photo) ? assetPath($student_detail->parents->guardians_photo) : assetPath('public/uploads/staff/demo/guardian.jpg') }}"
                                                     alt="">
                                            </div>
                                        @endif
                                        <div class="w-100">
                                                ...
                                                <table class="table school-table-style res_scrol" cellspacing="0"
                                                    ...
                                                    @foreach ($record->fees as $fees_assigned)
                                                        @if ($fees_assigned->record_id == $record->id)
                                                            ...
                                                            @endphp
                                                            @php
                                                                @$paid = App\Models\SmFeesAssign::discountSum(@$fees_assigned->student_id, @$fees_assigned->feesGroupMaster->feesTypes->id, 'amount', $fees_assigned->record_id);
                                                                @$total_grand_paid += @$paid;
                                                            @endphp
                                                            @php
                                                                @$fine = App\Models\SmFeesAssign::discountSum(@$fees_assigned->student_id, @$fees_assigned->feesGroupMaster->feesTypes->id, 'fine', $fees_assigned->record_id);
                                                                @$total_fine += @$fine;
                                                            @endphp
                                                            ...
                                                            @php
                                                                @$payments = App\Models\SmFeesAssign::feesPayment(@$fees_assigned->feesGroupMaster->feesTypes->id, @$fees_assigned->student_id, $fees_assigned->record_id);
                                                                $i = 0;
                                                            @endphp
                                                            @foreach ($payments as $payment)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right"><img
                                                                                src="{{ assetPath('public/backEnd/img/table-arrow.png') }}">
                                                                    </td>
                                                                    <td>
                                                                        @php
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="studentExam">
                                ...
                                @else
                                    @foreach ($student_detail->studentRecords->where('academic_id', getAcademicId()) as $record)
                                        @php
                                        ...
                                        @endif
                                        <div class="white-box no-search no-paginate no-table-info mb-2">
                                            @php $has_exam_result = false; @endphp
                                            @foreach($exam_terms as $exam)
                                                @php
                                                    $get_results = App\Models\SmStudent::getExamResult(@$exam->id, @$record);
                                                @endphp
                                                @if($get_results)
                                                    @php $has_exam_result = true; @endphp
                                                    <div class="main-title">
                                                    ...
                                                    @php
                                                        ...
                                                        $examSubjects = App\Models\SmExam::where([
                                                            ['exam_type_id', $exam->id],
                                                            ['section_id', $record->section_id],
                                                            ['class_id', $record->class_id]
                                                        ])->pluck('subject_id')->toArray();

                                                        $assign_subjects = App\Models\SmAssignSubject::where([
                                                            ['class_id', $record->class_id],
                                                            ['section_id', $record->section_id]
                                                        ])
                                                        ->whereIn('subject_id', $examSubjects)
                                                        ...
                                                        $optional_subject = (!is_null($optional_subject_setup) && !is_null($student_optional_subject)) ? 1 : 0;
                                                        $optional_gpa = 0;
                                                    @endphp
                                                        ...
                                                        <table id="table_id" class="display school-table"
                                                            ...
                                                            @foreach($get_results as $mark)
                                                                @php
                                                                    ...
                                                                    $subjectPercentage = subjectPercentageMark(@$mark->total_marks, $get_subject_marks);
                                                                    $gradeResult = markGpa($subjectPercentage);
                                                                    $mark_gpa_grade = @$mark->total_gpa_grade ?: ($gradeResult ? $gradeResult->grade_name : '');
                                                                    $mark_gpa_point = @$mark->total_gpa_point ?: ($gradeResult ? $gradeResult->gpa : 0);

                                                                    if((!is_null($optional_subject_setup)) && (!is_null($student_optional_subject))){
                                                                        if($mark->subject_id != @$student_optional_subject->subject_id){
                                                                            $temp_grade[]=$mark_gpa_grade;
                                                                        }
                                                                    }else{
                                                                        $temp_grade[]=$mark_gpa_grade;
                                                                    }
                                                                    $total_gpa_point += $mark_gpa_point;
                                                                    if(! is_null(@$student_optional_subject)){
                                                                        if(@$student_optional_subject->subject_id == $mark->subject->id && $mark_gpa_point < @$optional_subject_setup->gpa_above ){
                                                                            $total_gpa_point = $total_gpa_point - $mark_gpa_point;
                                                                        }
                                                                    }
                                                                    $temp_gpa[]=$mark_gpa_point;
                                                                        ...
                                                                        $subject_marks = App\Models\SmStudent::fullMarksBySubject($exam->id, $mark->subject_id);
                                                                        $schedule_by_subject = App\Models\SmStudent::scheduleBySubject($exam->id,
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <td>
                                                                            {{ number_format($mark_gpa_point, 2, '.', '') }}
                                                                        </td>
                                                                    @endif
                                                                </tr>
                                                            @endforeach
                                                                            ...
                                                                            if (in_array($failgpaname->grade_name, $temp_grade)) {
                                                                                ...
                                                                                if ($denominator != 0) {
                                                                                    ...
                                                                                    if ($result == 0 && $grand_total_marks != 0) {
                                                                                        ...
                                                                                        if ($gpa_point >= $maxgpa) {
                                                                                            $average_grade_max = \App\Models\SmMarksGrade::where('school_id', Auth::user()->school_id)
                                                                                                ->where('academic_id', getAcademicId())
                                                                                                ->where('from', '<=', $maxgpa)
                                                                                                ->where('up', '>=', $maxgpa)
                                                                                                ->first('grade_name');
                                                                                            ...
                                                                                            $average_grade = \App\Models\SmMarksGrade::where('school_id', Auth::user()->school_id)
                                                                                                ->where('academic_id', getAcademicId())
                                                ...
                                                @else
                                                    ...
                                                    <x-table>
                                                        <table class="table mb-5" cellspacing="0" width="100%">
                                                            <thead>
                                                            <tr>
                                                                <th>@lang('common.date')</th>
                                                                <th>@lang('exam.subject_full_marks')</th>
                                                            ...
                                                            <tbody>
                                                            <tr>
                                                                <td colspan="{{ @generalSetting()->result_type == 'mark' ? 4 : 5 }}"
                                                                    class="text-center">
                                                                    @lang('exam.result_not_publish_yet')
                                                                </td>
                                                            </tr>
                                                ...
                                                @endif
                                            @endforeach
                                            @if(!$has_exam_result && $exam_count > 0)
                                                ...
                                                <tr class="d-flex">
                                                    ...
                                                    <td class="col-3 d-flex align-items-center">
                                                        ...
                                                        <button class="primary-btn tr-bg text-uppercase bord-rad mr-1">
                                                            <a href="{{ assetPath($student_detail->document_file_1) }}"
                                            ...
                                            @if ($student_detail->document_file_2 != '')
                                                <tr class="d-flex">
                                                    ...
                                                    <td class="col-3 d-flex align-items-center">
                                                        {{-- @if (userPermission(17)) --}}
                                                        <button class="primary-btn tr-bg text-uppercase bord-rad mr-1">
                                                            <a href="{{ assetPath($student_detail->document_file_2) }}"
                                                               download>@lang('common.download')</a>
                                                            <span class="pl ti-download"></span>
                                                        </button>
                                                        {{-- @endif --}}
                                            ...
                                            @if ($student_detail->document_file_3 != '')
                                                <tr class="d-flex">
                                                    ...
                                                    <td class="col-3 d-flex align-items-center">
                                                        {{-- @if (userPermission(17)) --}}
                                                        <button class="primary-btn tr-bg text-uppercase bord-rad mr-1">
                                                            <a href="{{ assetPath($student_detail->document_file_3) }}"
                                                               download>@lang('common.download')</a>
                                                            <span class="pl ti-download"></span>
                                                        </button>
                                                        {{-- @endif --}}
                                            ...
                                            @if ($student_detail->document_file_4 != '')
                                                <tr class="d-flex">
                                                    ...
                                                    <td class="col-3 d-flex align-items-center">
                                                        {{-- @if (userPermission(17)) --}}
                                                        <button class="primary-btn tr-bg text-uppercase bord-rad mr-1">
                                                            <a href="{{ assetPath($student_detail->document_file_4) }}"
                                                               download>@lang('common.download')</a>
                                                            <span class="pl ti-download"></span>
                                                        </button>
                                                        {{-- @endif --}}
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                {{ html()->form('POST', route('upload_document'))->attributes([
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="studentTimeline">
                                <div class="white-box">
                                    ...
                                    <table id="" class="table simple-table table-responsive school-table"
                                        ...
                                        <thead class="d-block">
                                        <tr class="d-flex">
                                            <th class="@if(shiftEnable()) col-3 @else col-4 @endif">@lang('common.class')</th>
                                            <th class="@if(shiftEnable()) col-3 @else col-4 @endif">@lang('common.section')</th>
                                            @if(shiftEnable())
                                                <th class="col-3">@lang('common.shift')</th>
                                            @endif
                                            <th class="@if(shiftEnable()) col-3 @else col-4 @endif">@lang('student.id_number')</th>
                                        </tr>
                                        </thead>
                                        ...
                                        @foreach ($student_detail->studentRecords as $record)
                                            <tr class="d-flex">
                                                <td class="@if(shiftEnable()) col-3 @else col-4 @endif">{{ $record->class->class_name }}
                                                ...
                                                <td class="@if(shiftEnable()) col-3 @else col-4 @endif">{{ $record->section->section_name }}</td>
                                                @if(shiftEnable() && $record->shift)
                                                    <td class="col-3">{{ $record->shift->name }}</td>
                                                @endif
                                                <td class="@if(shiftEnable()) col-3 @else col-4 @endif">{{ $record->roll_no }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
