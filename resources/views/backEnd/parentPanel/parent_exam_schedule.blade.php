    ...
    <div class="container-fluid p-0">
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div>
                            {{ html()->form('POST', route('parent_exam_schedule_search'))->attributes([
                    ...
                    <table id="table_id" class="table" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>@if(shiftEnable()) @lang('admin.class_Sec_shift') @else @lang('common.class_Sec') @endif</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $exam_routine->class ? $exam_routine->class->class_name :'' }} {{ $exam_routine->section ? '('. $exam_routine->section->section_name .')':'' }} @if(shiftEnable()) {{ $exam_routine->shift ? '['. $exam_routine->shift->name .']':'' }} @endif</td>
