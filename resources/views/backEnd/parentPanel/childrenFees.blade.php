                                            ...
                                            @foreach ($record->fees as $fees_assigned)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($rest_amount = !0)
                                                            @php
                                                                $already_add = App\Models\SmBankPaymentSlip::where('student_id', $fees_assigned->student_id)
                                                                                ...
                                                                                <div class="pay">
                                                                                    <button
                                                                                            ...
                                                                                            @if(serviceCharge('RazorPay'))
                                                                                                data-toggle="tooltip"
                                                                                            data-title="{{ __('common.service charge for per transaction ') }} {{ serviceCharge('RazorPay') }}"
                                                                                            @endif
                                                                                    >
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (in_array($fees_discount->id, $applied_discount))
                                                            @php
                                                                $createdBy = App\Models\SmFeesAssign::createdBy($student_id, $fees_discount->id, $fees_discount->record_id);
                                                            @endphp
                                                            @if ($createdBy != '')
                                                                @php
