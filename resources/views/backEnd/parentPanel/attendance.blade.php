            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="student-meta-box">
                        ...
                        <img class="student-meta-img img-100" src="{{assetPath($student_detail->student_photo)}}" alt="">
                        <div class="white-box">
                            <div class="row">
            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div>
                            {{ html()->form('POST', route('parent_attendance_search'))->attributes([
                                ...
                                <li class="nav-item">
                                    <a class="nav-link @if($key== 0) active @endif " href="#tab{{$key}}" role="tab"
                                       data-toggle="tab">{{$record->class->class_name}}
                                        ({{$record->section->section_name}}) @if(shiftEnable() && $record->shift) ({{$record->shift->name}}) @endif</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-12 no-gutters d-flex flex-wrap align-items-center justify-content-between">
                                        <div class="lateday d-flex flex-wrap">
                                            ...
                                            <div class="mr-3">Holiday: <span class="text-dark">H</span></div>
                                            <div class="mr-3">Leave: <span class="text-muted">Le</span></div>
                                        </div>
