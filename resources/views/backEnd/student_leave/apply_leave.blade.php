                                    ...
                                    <table id="table_id" class="table" cellspacing="0" width="100%">
                                        ...
                                        @foreach($my_leaves as $my_leave)
                                            @php
                                                ...
                                                $approved_leaves = App\Models\SmLeaveRequest::approvedLeave($my_leave->id);
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if(isset($apply_leave))
                                {{ html()->form('PUT', route('student-leave-update', $apply_leave->id))->attributes([
                            ...
                            @else
                                @if(userPermission('student-leave-store'))
                                    {{ html()->form('POST', route('student-leave-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                    <div class="row no-gutters input-right-icon">
                                        ...
                                        <div class="col">
                                            <div class="primary_input">
                                                ...
                                                <input class="primary_input_field  primary_input_field date form-control form-control{{ $errors->has('apply_date') ? ' is-invalid' : '' }}"
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <select class="primary_select  form-control{{ $errors->has('leave_type') ? ' is-invalid' : '' }}"
                                                    name="leave_type">
                                                <option data-display="@lang('leave.leave_type') *"
                                                        value="">@lang('leave.leave_type') *
                                                </option>
                                        ...
                                        <div class="col">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('leave.leave_from')<span
                                                            class="text-danger"> *</span> </label>
                                                <input class="primary_input_field  primary_input_field date form-control form-control{{ $errors->has('leave_from') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('leave.leave_to')<span
                                                            class="text-danger"> *</span> </label>
                                                <input class="primary_input_field  primary_input_field date form-control form-control{{ $errors->has('leave_to') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <textarea class="primary_input_field form-control" cols="0" rows="4"
                                                          name="reason">{{isset($apply_leave)? $apply_leave->reason: old('reason')}}</textarea>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($apply_leave->approve_status == 'P')
                                                        <button class="primary-btn small bg-warning  text-white border-0 tr-bg">@lang('common.pending')</button>
                                                    @endif
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-40 d-flex justify-content-between">
                                                                ...
                                                                {{ html()->form('DELETE', route('apply-leave-delete', $apply_leave->id))->attribute('enctype', 'multipart/form-data')->open() }}
