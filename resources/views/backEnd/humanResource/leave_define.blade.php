            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($leave_define))
                            {{ html()->form('PUT', route('leave-define-update', $leave_define->id))->attributes([
                            ...
                            @else
                                @if (userPermission('leave-define-store'))
                                {{ html()->form('POST', route('leave-define-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                                            ...
                                            <select
                                                ...
                                                @else
                                                    @foreach ($roles as $value)
                                                        <option value="{{ $value->id }}" {{ old('member_type') == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            ...
                                            <select
                                                ...
                                                @foreach ($leave_types as $leave_type)
                                                    ...
                                                    <option value="{{ $leave_type?->id }}"
                                                        {{ old('leave_type', isset($leave_define) ? $leave_define?->type_id : '') == $leave_type?->id ? 'selected' : '' }}>
                                                        {{ $leave_type?->type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($leave_define) ? $leave_define->days : old('days') }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ html()->form('DELETE', route('leave-define-delete'))->attribute('enctype', 'multipart/form-data')->open() }}
    ...
    <div class="modal fade admin-query" id="addLeaveDayModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ html()->form('POST', route('leave-define-updateLeave'))->attribute('enctype', 'multipart/form-data')->open() }}
