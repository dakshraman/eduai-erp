            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('staff-attendance-search'))->attributes([
                ...
                <div class="row mt-40">
                    <div class="col-lg-12">
                        <div class="white-box">
                            ...
                            {{ html()->form('POST', route('staff-attendance-store'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                ])->open() }}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex radio-btn-flex">
                                                            ...
                                                            <div>
                                                                <input type="radio" name="attendance[{{ $staff->id }}]"
                                                                    id="attendanceLe{{ $staff->id }}" value="Le"
                                                                    class="common-radio attendance_type_staff"
                                                                    {{ (
                                                                        ($staff->DateWiseStaffAttendance?->attendance_type === 'Le')
                                                                        || (!empty($staff->is_on_leave))
                                                                    ) ? 'checked' : '' }}>
                                                                <label for="attendanceLe{{ $staff->id }}">@lang('hr.leave')</label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="primary_input">
                                                            <textarea class="primary_input_field note-field form-control note_{{ $staff->id }}" cols="0" rows="2"
                                                                name="note[{{ $staff->id }}]" id="">{{ $staff->DateWiseStaffAttendance?->notes 
                                                                ?? ($staff->leave_reason ?? '') }}</textarea>
