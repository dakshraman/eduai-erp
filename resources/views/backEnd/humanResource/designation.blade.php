        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        @if (isset($designation))
                        {{ html()->form('PUT', route('designation-update', $designation->id))->attributes([
                        ...
                        @else
                        @if (userPermission('designation-store'))
                        {{ html()->form('POST', route('designation-store'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}
                                ...
                                @if (moduleStatusCheck('Branch'))
                                    <div class="row">
                                        @include('branch::components.branch_select', [
                                            ...
                                            'mb' => 'mb-20',
                                            'branch_id' => isset($designation) ? $designation->branch_id : '',
                                        ])
                                    </div>
                                @endif
                                <div class="row">
                            ...
                            <x-table>
                                <table id="table_id" class="table" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            @if (moduleStatusCheck('Branch'))
                                                <td>{{ $designation?->branch?->branch_name ?? 'N/A' }}</td>
                                            @endif
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mt-40 d-flex justify-content-between">
                                                            <button type="button" class="primary-btn tr-bg"
                                                                ...
                                                                {{ html()->form('DELETE', route('designation-delete', $designation->id))->attribute('enctype', 'multipart/form-data')->open() }}
