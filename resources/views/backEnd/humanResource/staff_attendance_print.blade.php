        ...
        <table cellspacing="0" width="100%">
            <tr>
                ...
                <td style="text-aligh:center">
                    ...
                    <p style="font-size:14px !important; border-bottom:1px solid gray" align="left" class="text-white">
                        @lang('common.branch'): {{ $branch->branch_name}} </p>
                    @endif
                </td>
            </tr>
        </table>
        ...
        <table id="attendance" style="width: 100%; table-layout: fixed">
            ...
            @foreach($attendances as $staff_id => $records)
                @php
                    ...
                    $attendanceCounts = ['P' => 0, 'L' => 0, 'A' => 0, 'H' => 0, 'F' => 0, 'Le' => 0];
                ...
                @foreach($records as $record)
                    @php
                        $attendanceCounts[$record->attendence_type]++;
                ...
                <tr>
                    ...
                    @for ($i = 1; $i <= $days; $i++)
                        @php
                            ...
                            $attendance = $records->firstWhere('attendence_date', $date);
                        @endphp
                        ...
                        <td width="3%" class="{{ $i <= 18 ? 'all' : 'none' }}">
                            @if($attendance)
                                ...
                                @if($attendance->notes)
                                    <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="{{ $attendance->notes }}"></i>
                                @endif
