...
@section('mainContent')
    ...
    {{ html()->form('POST', route('savePayrollData'))->attributes([
                                ...
                                @if ($staffDetails->lms_balance && moduleStatusCheck('Lms') == true)
                                    <tr id="rowLms">
                                        ...
                                        <td width="30%">
                                            <div class="primary_input mt-10">
                                                <input
                                                    class="primary_input_field form-control" type="number" step="{{inputStep()}}"
                                ...
                                <tr class="d-block">
                                    <td width="100%" class="pr-30 d-block">
                                        <div class="primary_input mt-10">
                                            ...
                                            <input class="primary_input_field form-control" type="number" step="{{inputStep()}}"
                                                id="basicSalary" value="{{ decimal_only($staffDetails->basic_salary) }}"
                                ...
                                <tr class="d-block">
                                    <td width="100%" class="pr-30 d-block">
                                        <div class="primary_input mt-30">
                                            ...
                                            <input class="primary_input_field form-control" readonly type="number" step="{{inputStep()}}"
                                ...
                                <tr class="d-block">
                                    <td width="100%" class="pr-30 d-block">
                                        <div class="primary_input mt-30">
                                            ...
                                            <input class="primary_input_field form-control" type="number" readonly step="{{inputStep()}}"
                                    ...
                                    <td width="100%" class="pr-30 d-block">
                                        <div class="primary_input mt-30">
                                            ...
                                            <input class="primary_input_field form-control" type="number" readonly
                                                id="leave_deduction"
                                                value="{{ round(decimal_only(($staffDetails->basic_salary / 30) * $extra_days)) }}"
                                    ...
                                    <td width="100%" class="pr-30 d-block">
                                        <div class="primary_input mt-30">
                                            ...
                                            <input class="primary_input_field form-control" readonly type="number"
                                                id="gross_salary" value="{{decimal_only(0)}}">
                                    ...
                                    <td width="100%" class="pr-30 d-block">
                                        <div class="primary_input mt-30 mb-30">
                                            ...
                                            <input
                                                ...
                                                type="number" step="{{inputStep()}}" id="net_salary" name="net_salary">
