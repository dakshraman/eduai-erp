        ...
        <div class="container-fluid p-0">
            @if(userPermission('payroll-bulk-print-seacrh'))
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            {{ html()->form('POST', route('payroll-bulk-print-seacrh'))->attributes([
                            ...
                            <div class="row">
                                <div class="col-lg-4 mt-30-md">
                                    <select class="primary_select  form-control {{ $errors->has('role_id') ? ' is-invalid' : '' }}"
                                            name="role_id" id="role_id">
                                        <option data-display="@lang('hr.role') *" value="">@lang('common.select_role')
                                            *
                                        </option>
                            ...
                            {{ $errors->first('role_id') }}
                                ...
                                <div class="col-lg-4 mt-30-md">
                                    <select class="primary_select  form-control {{$errors->has('payroll_month') ? 'is-invalid' : ''}}"
                                            name="payroll_month" id="payroll_month">
                                        <option data-display="@lang('student.select_month') "
                                                value="">@lang('student.select_month') </option>
                        ...
                        {{ $errors->first('payroll_month') }}
                                ...
                                <div class="col-lg-4">
                                    <select class="primary_select  form-control {{$errors->has('payroll_year') ? 'is-invalid' : ''}}"
                                            name="payroll_year" id="payroll_year">
                                        <option data-display="@lang('hr.select_year') "
                                                value="">@lang('hr.select_year') </option>
                                        @php
                                            $year = date('Y');
                                            $ini = date('y');
                                            $limit = $ini + 30;
                                ...
                                <table id="table_id" class="table" cellspacing="0" width="100%">
                                    ...
                                    @foreach($staffs as $value)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $getPayrollDetails = App\Models\SmHrPayrollGenerate::getPayrollDetails($value->id, $payroll_month, $payroll_year);
                                                @endphp
                                                        ...
                                                        @if(!empty($getPayrollDetails))
                                                            @if($getPayrollDetails->payroll_status == 'G')
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="{{route('print-payslip', $getPayrollDetails->id)}}">@lang('common.print')</a>
                                                            @endif
                                                            @if($getPayrollDetails->payroll_status == 'P')
