        ...
        <div class="text-center mb-4">
            <div class="d-flex justify-content-center">
                ...
                @if(! is_null($setting_info->logo))
                        <img class="logo-img" src="{{ assetPath($setting_info->logo)}}" alt="{{$setting_info->school_name}}">
                    @else
                            <img class="logo-img" src="{{ assetPath('public/uploads/settings/logo.png')}}" alt="logo">
                    @endif
                </div>
                <div class="ml-30">
