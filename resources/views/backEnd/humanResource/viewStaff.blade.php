                    ...
                    <div class="white-box">
                        ...
                        <div class="student-meta-box">
                            ...
                            <img class="student-meta-img img-100"
                                 src="{{ file_exists(@$staffDetails->staff_photo) ? assetPath($staffDetails->staff_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
                                 alt="">
                            <div class="white-box">
                                ...
                                @if (moduleStatusCheck('Branch'))
                                    <div class="single-meta">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="value">
                                                @if (isset($staffDetails))
                                                    {{ !empty($staffDetails->branch) ? $staffDetails->branch->branch_name : '' }}
                                                @endif
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="value">
                                                <img height="100" width="100"
                                                     src="{{ assetPath('public/qr_codes/staff-'.$staffDetails->id.'-qrcode.png') }}"
                                                     alt="">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-9 staff-details">
                    <div class="white-box">
                        <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if (Session::get('staffDocuments') != 'active' && Session::get('staffTimeline') != 'active') active @endif"
                                   href="#studentProfile"
                        ...
                        <div class="tab-content mt-10">
                            <!-- Start Profile Tab -->
                            <div role="tabpanel"
                                 class="tab-pane fade @if (Session::get('staffDocuments') != 'active' && Session::get('staffTimeline') != 'active') show active @endif"
                                 id="studentProfile">
                                <div>
                                ...
                                <div>
                                    <table id="" class="table simple-table table-responsive school-table"
                                        ...
                                        <tr>
                                            ...
                                            <th width="15%">@lang('hr.net_salary')
                                                            ...
                                                            <a class="modalLink" data-modal-size="modal-lg"
                                                               ...
                                                               href="{{ route('view-payslip', $value->id) }}">
                                                                <button
                                                                    ...
                                                                    @lang('common.view_payslip')</button>
                                                            </a>
                                                        @endif
                                                    </td>
                                                </tr>
                            ...
                            <!-- Start Documents Tab -->
                            <div role="tabpanel"
                                 class="tab-pane fade {{ Session::get('staffDocuments') == 'active' ? 'show active' : '' }}"
                                 id="staffDocuments">
                                <div>
                            ...
                            {{-- Start Timeline Tab --}}
                            <div role="tabpanel"
                                 class="tab-pane fade {{ Session::get('staffTimeline') == 'active' ? 'show active' : '' }}"
                                 id="staffTimeline">
                                <div>
                                    <div class="text-right mb-20">
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 mt-30">
                                                        <div class="d-flex justify-content-between">
                                                            <button class="primary-btn tr-bg" type="button"
