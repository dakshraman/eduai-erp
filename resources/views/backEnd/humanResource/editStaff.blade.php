                                                    ...
                                                    <div class="form-section">
                                                        <div class="row">
                                                            ...
                                                            @if (in_array('staff_photo', $has_permission))
                                                                ...
                                                                src="{{ @$editData->staff_photo ? assetPath($editData->staff_photo) : '' }}"
                                                                ...
                                                                <div class="col-lg-6 col-xl-3 mb-20">
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="{{ decimal_only($editData->basic_salary) }}">
                                                                    ...
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <select class="primary_select  form-control"
                                                                            ...
                                                                            <option value="permanent"
                                                                                @if (isset($editData)) @if ($editData->contract_type == 'permanent')  selected @endif
                                                                                @endif
                                                                                >@lang('hr.permanent')
                                                                            </option>
