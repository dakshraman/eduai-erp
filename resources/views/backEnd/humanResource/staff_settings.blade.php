                                        ...
                                        @foreach ($staff_settings as $field)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="switch_toggle">
                                                        <input type="checkbox"
                                                            @if (in_array($field->field_name, ['mobile', 'phone_number'])) id='phone_number' data-phone_number="{{ $field->is_required }}" @endif
                                                            @if (in_array($field->field_name, ['email', 'email_address'])) id='email_address' data-email_address="{{ $field->is_required }}" @endif
                                                            data-id="{{ $field->id }}"
        ...
        $(document).ready(function() {
            $(".required_switch_btn").on("change", function() {
                ...
                if ($(this).is(":checked")) {
                    ...
                    if (filed_value == "phone_number" || filed_value == "mobile") {
                        var email = $('#email_address').data('email_address');
                        if (email == 0) {
                            $('#email_address').prop('checked', true);

                        }
                    } else if (filed_value == "email_address" || filed_value == "email") {
