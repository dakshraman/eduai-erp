            ...
            <div class="container-fluid p-0">
                <div class="white-box mt-40">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="{{ route('staff-attendance/print', [$role_id, $month, $year, $branch_id ?? null]) }}"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="lateday d-flex justify-content-center">
                                    ...
                                    <div class="mr-3">@lang('hr.leave'): <span class="text-primary">Le</span></div>
                                    <div class="mr-3">@lang('hr.half_day'): <span class="text-info">F</span></div>
                                    <div class="mr-3">@lang('hr.leave'): <span class="text-muted">Le</span></div>
                                </div>
                                        ...
                                        <table id="table_id1" style="margin-bottom:25px" class="table table-responsive" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($attendances as $staff_id => $values)
                                                    @php
                                                        $total_attendance = $values->where('attendence_type', '!=', 'Le')->count();
                                                        ...
                                                        $le = $values->where('attendence_type', 'Le')->count();
                                                    ...
                                                    <tr>
                                                        ...
                                                        @for ($i = 1; $i <= $days; $i++)
                                                            @php
                                                                ...
                                                                $attendance = $values->firstWhere('attendence_date', $date);
                                                                $attendanceType = optional($attendance)->attendence_type ?? '';
                                                            ...
                                                            <td width="3%" class="{{ $i <= 18 ? 'all' : 'none' }}">
                                                                @if($attendanceType)
                                                                    {{ $attendanceType }}
                                                                    @if($notes)
                                                                        <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{ $notes }}"></i>
                                                                    @endif
