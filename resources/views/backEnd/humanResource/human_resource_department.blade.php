        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        @if(isset($department))
                        {{ html()->form('PUT', route('department-update', $department->id))->attributes([
                        ...
                        @else
                         @if(userPermission("department-store"))
                         {{ html()->form('POST', route('department-store'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}                        
                                ...
                                @if (moduleStatusCheck('Branch'))
                                    <div class="row">
                                        @include('branch::components.branch_select', [
                                            ...
                                            'mb' => 'mb-20',
                                            'branch_id' => isset($department) ? $department->branch_id : '',
                                        ])
                                    </div>
                                @endif
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                type="text" name="name" autocomplete="off" value="{{isset($department)? $department->name: old('name')}}">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        ...
                                                        {{ html()->form('DELETE', route('department-delete', $department->id))->attribute('enctype', 'multipart/form-data')->open() }}
