    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        {{ html()->form('POST', route('fees-discount-assign-search'))->attributes([
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="fees_discount_id" id="fees_discount_id"
                                   value="{{ $fees_discount_id }}">
                            ...
                            @else
                                ...
                                <div class="col-lg-3 mt-30-md" id="select_section_div">
                                    ...
                                    <div class="pull-right loader loader_style" id="select_section_loader">
                                        <img class="loader_img_style" src="{{ assetPath('public/backEnd/img/demo_wait.gif') }}"
                                            alt="loader">
                                    </div>
                                ...
                                <div class="col-lg-3 mt-30-md">
                                    <select
                                            ...
                                            name="category">
                                        <option data-display="@lang('fees.select_category')"
                                                value="">@lang('fees.select_category')</option>
                                ...
                                <div class="col-lg-3 mt-30-md">
                                    <select
                                            ...
                                            name="group">
                                        <option data-display="@lang('fees.select_group')"
                                                value="">@lang('fees.select_group') </option>
            ...
            @if (!empty($students))
                {{ html()->form('POST', url('fees-discount-assign-store'))->class('form-horizontal')->open() }}
                <div class="row mt-40">
                    <div class="col-lg-12">
                        <div class="row mb-30">
                        ...
                        <input type="hidden" name="fees_discount_id" value="{{ $fees_discount_id }}"
                               id="fees_discount_id">
                        <div class="row">
                            <div class="col-lg-4">
                                <x-table>
                                    <table id="table_id_table" class="table" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            @if(moduleStatusCheck('Branch'))
                                                <td>{{ $fees_discount->branch?->branch_name }}</td>
                                            @endif
                                            <td>{{ $fees_discount->name }}</td>
                                            <td>{{ currency_format($fees_discount->amount) }}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </x-table>
                                            ...
                                            @foreach ($students as $student)
                                                <tr>
                                                    <td>
                                                        @php
                                                            if ($fees_discount->type == 'once') {
                                                                $checkPayment = \App\Models\SmFeesDiscount::CheckAppliedDiscount(
                                                                    $fees_discount_id,
                                                                    $student->id,
                                                                    $student->id,
                                                                );
                                                                ...
                                                                $checkPayment = \App\Models\SmFeesDiscount::CheckAppliedYearlyDiscount(
                                                                    $fees_discount_id,
                                                                    $student->id,
                                                                    $student->id,
                                                                );
                                                        ...
                                                        <input type="checkbox" id="student.{{ $student->id }}"
                                                               {{ @$show }} class="common-checkbox"
                                                               name="data[{{ $loop->index }}][checked]" value="1"
                                                                {{ in_array($student->student_id, $pre_assigned) ? 'checked' : '' }}
                                                                {{ in_array($student->student_id, $already_paid) ? 'disabled="disabled"' : '' }}>
                                                        <label for="student.{{ $student->id }}"></label>
                                                    </td>
                                                    @if (moduleStatusCheck('Branch'))
                                                        <input type="hidden" name="data[{{ $loop->index }}][branch_id]"
                                                               value="{{ @$student->branch_id }}">
                                                    @endif
                                                    <input type="hidden" name="data[{{ $loop->index }}][class_id]"
                                                           value="{{ @$student->class_id }}">
                                                    <input type="hidden"
                                                           name="data[{{ $loop->index }}][section_id]"
                                                           value="{{ @$student->section_id }}">
                                                    @if(shiftEnable())
                                                        <input type="hidden"
                                                               name="data[{{ $loop->index }}][shift_id]"
                                                               value="{{ @$student->shift_id }}">
                                                    @endif
                                                    <input type="hidden" name="data[{{ $loop->index }}][record_id]"
                                                           value="{{ @$student->id }}">
                                                    <input type="hidden"
                                                           name="data[{{ $loop->index }}][student_id]"
                                                           value="{{ @$student->studentDetail->forwardBalance->id ?? $student->student_id }}">
                                                    ...
                                                    <td>{{ $student->class != '' ? @$student->class->class_name : '' }}
                                                        ...
                                                        @if(shiftEnable())
                                                            {{ '[' . $student->shift != '' ? $student->shift->shift_name : '' . ']' }}
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @php
                                                            $check_discount_apply = DB::table(
                                                                ...
                                                                ->leftjoin(
                                                                    ...
                                                                    'sm_fees_types.id',
                                                                    '=',
                                                                    'sm_fees_assign_discounts.fees_type_id',
                                                                )
                                                                ->leftjoin(
                                                                    'sm_fees_groups',
                                                                    'sm_fees_groups.id',
                                                                    '=',
                                                                    'sm_fees_assign_discounts.fees_group_id',
                                                                )
                                                                ->select(
                                                                    'sm_fees_assign_discounts.*',
                                                                    'sm_fees_groups.name as fees_group_name',
                                                                    'sm_fees_types.name as fees_type_name',
                                                                )
                                                                ->first();
                                                            $group_ids = [];
                                                        @endphp
                                                        ...
                                                        @if ($fees_discount->type == 'once')
                                                            @if ($check_discount_apply == '')
                                                                <select
                                                                        class="primary_select w-100  form-control{{ $errors->has('fees_master_id') ? ' is-invalid' : '' }} select_fees_master"
                                                                        {{ @$show }}
                                                                        name="data[{{ $loop->index }}][fees_master_id]"
                                                                        id="fees_master{{ $student->id }}">
                                                                    <option data-display="@lang('fees.select_fees_type') *"
                                                                            value="">@lang('fees.select_fees_type') *
                                                                    </option>
                                                                    @foreach ($assigned_fees_groups[$student->id] as $key => $fees_group)
                                                                        ...
                                                                        <option value="" disabled>
                                                                            {{ $fees_group->name }} </option>
                                                                        @php
                                                                            $studentAssingFees_types = App\Models\SmFeesAssign::studentFeesTypeDiscount(
                                                                                $fees_group->group_id,
                                                                                $student->student_id,
                                                                                $fees_discount->amount,
                                                                                $student->id,
                                                                            );
                                                                        @endphp
                                                            ...
                                                            @else
                                                                <select
                                                                    ...
                                                                    <option
                                                                            value="{{ $check_discount_apply->fees_type_id }}"
                                                                            selected>
                                                                        {{ $check_discount_apply->fees_type_name }}
                                                                    </option>
                                                                    {{-- @endforeach --}}
                                                                </select>
                                                                @if ($errors->has('fees_master_id'))
                                                        ...
                                                        @else
                                                            ...
                                                            @if ($check_discount_apply == '')
                                                                <select
                                                                        ...
                                                                        {{ @$show }}
                                                                        id="fees_master{{ $student->id }}">
                                                                    <option data-display="@lang('fees.select_fees_group')"
                                                                            value="">@lang('fees.select_fees_group')</option>
                                                                    @foreach ($assigned_fees_groups[$student->id] as $key => $fees_group)
                                                                        @php
                                                                            if (
                                                                                in_array(
                                                            ...
                                                            @else
                                                                ...
                                                                <select
                                                                    ...
                                                                    <option
                                                                            value="{{ @$check_discount_apply->fees_group_id }}"
                                                                            checked>
