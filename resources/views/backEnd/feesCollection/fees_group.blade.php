            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($fees_group))
                                {{ html()->form('POST', route('fees_group_update'))->attributes([
                            ...
                            @else
                                @if (userPermission('fees_group_store'))
                                    {{ html()->form('POST', route('fees_group_store'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($fees_group) ? $fees_group->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($fees_group) ? $fees_group->name : old('name') }}">
                                                <input type="hidden" name="id"
                                                    value="{{ isset($fees_group) ? $fees_group->id : '' }}">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <textarea class="primary_input_field form-control" cols="0" rows="4" name="description">{{ isset($fees_group) ? $fees_group->description : old('description') }}</textarea>
                                    ...
                                    <table id="table_id" class="table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            @foreach ($fees_groups as $fees_group)
                                                <tr>
                                                    @if (moduleStatusCheck('Branch'))
                                                    <td>{{ @$fees_group->branch?->branch_name }}</td>
                                                    @endif
                                                            ...
                                                            $routeList = [
                                                                userPermission('fees_group_edit')
                                                                    ? '<a class="dropdown-item" href="' .
                                                                        route('fees_group_edit', [$fees_group->id]) .
                                                                        '">
                                                                ' .
                                                                        __('common.edit') .
                                                                        ' </a>'
                                                                ...
                                                                userPermission('fees_group_delete') &&
                                                                !@$fees_group->un_semester_label_id
                                                                    ? '<a class="dropdown-item deleteFeesGroupModal" data-toggle="modal" data-target="#deleteFeesGroupModal" href="#" data-id="' .
                                                                        $fees_group->id .
                                                                        '">' .
                                                                        __('common.delete') .
                                                                        '
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ html()->form('POST', route('fees_group_delete'))->attribute('enctype', 'multipart/form-data')->open() }}
