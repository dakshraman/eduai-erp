            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($fees_discount))
                                {{ html()->form('POST', route('fees_discount_update'))->attributes([
                            ...
                            @else
                                @if (userPermission('fees_discount_store'))
                                    {{ html()->form('POST', route('fees_discount_store'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($fees_discount) ? @$fees_discount->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($fees_discount) ? $fees_discount->name : old('name') }}">
                                                <input type="hidden" name="id"
                                                    value="{{ isset($fees_discount) ? $fees_discount->id : '' }}">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('fees.discount_code') <span
                                                        class="text-danger"> *</span></label>
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('code') ? ' is-invalid' : '' }}"
                                                    type="text" name="code" autocomplete="off"
                                                    value="{{ isset($fees_discount) ? $fees_discount->code : old('code') }}">
                                                @if ($errors->has('code'))
                                                    <span class="text-danger">
                                                        {{ $errors->first('code') }}
                                                    </span>
                                        ...
                                        <div class="row mt-40">
                                            <div class="col-lg-12 d-flex">
                                                ...
                                                <div class="radio-btn-flex ml-40">
                                                    <div class="mr-30">
                                                        <input type="radio" name="type" id="once" value="once"
                                                            class="common-radio relationButton"
                                                            {{ isset($fees_discount) ? ($fees_discount->type == 'once' ? 'checked' : '') : 'checked' }}>
                                                        <label for="once">@lang('fees.once')</label>
                                                    </div>
                                                    <div class="mr-30">
                                                        <input type="radio" name="type" id="year" value="year"
                                                            class="common-radio relationButton"
                                                            {{ isset($fees_discount) ? ($fees_discount->type == 'year' ? 'checked' : '') : '' }}>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($fees_discount) ? decimal_only($fees_discount->amount) : old('amount') }}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('common.description')
                                                    <span></span></label>
                                                <textarea class="primary_input_field form-control" cols="0" rows="4" name="description">{{ isset($fees_discount) ? $fees_discount->description : old('description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    @php
                                            ...
                                            @foreach ($fees_discounts as $fees_discount)
                                                <tr>
                                                    ...
                                                    <td data-toggle="tooltip" data-placement="top"
                                                        title="{{ $fees_discount->description }}">
                                                        {{ $fees_discount->name }}</td>
                                                        ...
                                                        <x-drop-down>
                                                            @if (userPermission('fees_discount_assign'))
                                                                <a class="dropdown-item"
                                                                    href="{{ route('fees_discount_assign', [$fees_discount->id]) }}">@lang('fees.assign')</a>
                                                            @endif
                                                            @if (userPermission('fees_discount_edit'))
                                                                <a class="dropdown-item"
                                                                    href="{{ route('fees_discount_edit', [$fees_discount->id]) }}">@lang('common.edit')</a>
                                                            @endif
                                                            @if (userPermission('fees_discount_delete'))
                                                                <a class="dropdown-item" data-toggle="modal"
                                                                    data-target="#deleteFeesDiscountModal{{ $fees_discount->id }}"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mt-40 d-flex justify-content-between">
                                            ...
                                            <a href="{{ route('fees_discount_delete', [$fees_discount->id]) }}"><button
