                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($fees_master) ? $fees_master->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                    <div class="row">
                                                    ...
                                                    @if (!in_array($fees_type->id, $already_assigned))
                                                        @if (isset($fees_master))
                                                            <option value="{{ $fees_type->id }}"
                                                                {{ old('fees_type', $fees_master->fees_type_id ?? '') == $fees_type->id ? 'selected' : '' }}>
                                                                {{ $fees_type->name }} ({{ $fees_type->fessGroup->name }})
                                                            </option>
                                                        @else
                                                            <option value="{{ $fees_type->id }}"
                                                                {{ old('fees_type') == $fees_type->id ? 'selected' : '' }}>
                                                                {{ $fees_type->name }} ({{ $fees_type->fessGroup->name }})
                                                            </option>
                                                        @endif
                                                    @endif
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    ...
                                                    <input oninput="numberCheckWithDot(this)"
                                                        ...
                                                        value="{{ isset($fees_master) ? decimal_only($fees_master->amount) : old('amount') }}">
                                                    ...
                                                    <td>
                                                        @foreach ($values as $fees_master)
                                                            ...
                                                            <div class="row row-gap-24 my-3">
                                                                @if (moduleStatusCheck('Branch'))
                                                                    <div class="col-sm-2 custom_fees_master">
                                                                        {{ $fees_master->branch != '' ? @$fees_master->branch->branch_name : '' }}
                                                                    </div>
                                                                @endif
                                                                <div class="col-sm-4 custom_fees_master">
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <div class="dropdown CRM_dropdown">
                                                                        ...
                                                                        <div
                                                                            class="dropdown-menu dropdown-menu-right mr-20">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                {{ html()->form('POST', url('fees-master-single-delete'))->attribute('enctype', 'multipart/form-data')->open() }}
                                                                                <input type="hidden" name="id"
                                                                                    id=""
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ html()->form('POST', route('fees-master-single-delete'))->attribute('enctype', 'multipart/form-data')->open() }}
...
<div class="modal-body">
    ...
    <div class="mt-40 d-flex justify-content-between">
        <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('common.cancel')</button>
        {{ html()->form('POST', route('fees-master-group-delete'))->attribute('enctype', 'multipart/form-data')->open() }}
