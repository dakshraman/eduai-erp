                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="name">
                                                    ...
                                                    @else
                                                        @if(shiftEnable())
                                                            {{ @$student->class->class_name . '(' . @$student->section->section_name . ')' . '[' . @$student->shift->shift_name . ']' }}
                                                        @else
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            @if (moduleStatusCheck('University'))
                                ...
                                <x-table>
                                    <table id="" class="table school-table-style-parent-fees" cellspacing="0"
                                           width="100%">
                                        <thead>
                                        <tr>
                                            <td class="text-right" colspan="14">
                                                <a class="primary-btn small fix-gr-bg modalLink"
                                                   data-modal-size="modal-lg" title="@lang('fees.add_fees')"
                                                   href="{{ route('university.un-total-fees-modal', [$student->id]) }}"
                                                   0>
                                                    <i class="ti-plus pr-2"></i> @lang('fees.add_fees')
                                                </a>

                                                <a href="" id="fees_groups_invoice_print_button"
                                                   class="primary-btn small fix-gr-bg" target="">
                                        ...
                                        <tr>
                                            ...
                                            <th class="nowrap">@lang('fees.amount')
                                            ...
                                            <th class="nowrap">@lang('fees.discount')
                                                ({{ @generalSetting()->currency_symbol }})
                                            </th>
                                            <th class="nowrap">@lang('fees.paid')
                                                ({{ @generalSetting()->currency_symbol }})
                                            </th>
                                        ...
                                        @foreach ($feesInstallments as $key => $feesInstallment)
                                            @php
                                                ...
                                                $total_balance +=
                                                    discountFeesAmount($feesInstallment->id) -
                                                    $feesInstallment->paid_amount;
                                            @endphp

                                            <tr>
                                                <td>
                                                    <input type="checkbox" id="fees_group.{{ $feesInstallment->id }}"
                                                           class="common-checkbox fees-groups-print" name="fees_group[]"
                                                           value="{{ $feesInstallment->id }}">
                                                    ...
                                                    @if ($feesInstallment->active_status == 1)
                                                        @if (moduleStatusCheck('University'))
                                                            <a href="#" data-toggle="tooltip"
                                                               ...
                                                               title="{{ 'Collected By: ' . @$feesInstallment->user->full_name }}">
                                                ...
                                                <td>
                                                    {{ currency_format($feesInstallment->paid_amount) }}

                                                </td>
                                                <td>{{ currency_format(discountFeesAmount($feesInstallment->id) - $feesInstallment->paid_amount) }}
                                                </td>
                                                <td>
                                          ...
                                          @endif --}}
                                            ...
                                            @foreach ($feesInstallment->payments as $payment)
                                                <tr>
                                                    ...
                                                    <td>{{ currency_format($payment->discount_amount) }}</td>
                                                    <td>{{ currency_format($payment->paid_amount) }}</td>
                                                    <td>{{ currency_format($payment->balance_amount) }} </td>
                                                    <td>
                                                        <div class="dropdown CRM_dropdown">
                                                            <button type="button" class="btn dropdown-toggle"
                                                                    data-toggle="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                @if (userPermission('university.editSubPaymentModal'))
                                                                    <a class="dropdown-item modalLink"
                                                                       ...
                                                                       href="{{ route('university.editSubPaymentModal', [$payment->id, $payment->paid_amount]) }}">
                                                                        @lang('common.edit')
                                                                    </a>
                                                                @endif
                                            ...
                                            @if (moduleStatusCheck('University'))
                                                <div class="modal fade admin-query"
                                                     id="editInstallment_{{ $feesInstallment->id }}">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                {{ html()->form('POST', route('university.feesInstallmentUpdate'))->attributes([
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="primary_input ">
                                                                            <input
                                                                                    ...
                                                                                    id="amount"
                                                                                    value="{{ $feesInstallment->amount }}"
                                                                                    readonly>
                                                                            <label class="primary_input_label"
                                                                                   for="">@lang('fees.amount') <span
                                                                            ...
                                                                            <div class="col">
                                                                                <div class="primary_input ">
                                                                                    <input
                                                                                            ...
                                                                                            name="due_date"
                                                                                            value="{{ date('m/d/Y', strtotime($feesInstallment->due_date)) }}"
                                                                                            autocomplete="off">
                                                                                    <label class="primary_input_label"
                                                                                           for="">@lang('fees.due_date')
                                    ...
                                    <table id="" class="table school-table-style-parent-fees" cellspacing="0"
                                        ...
                                        <tr>
                                            <td class="text-right" colspan="14">
                                                ...
                                                <a class="primary-btn small fix-gr-bg modalLink"
                                                   data-modal-size="modal-lg" title="@lang('fees.add_fees')"
                                                   href="{{ route('direct-fees-total-payment', [$student->id]) }}" 0>
                                                    <i class="ti-plus pr-2"></i> @lang('fees.add_fees')
                                                </a>
                                        ...
                                        @foreach ($feesInstallments as $key => $feesInstallment)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ currency_format(discount_fees($feesInstallment->amount, $feesInstallment->discount_amount) - ($feesInstallment->payments->sum('total_paid') + $feesInstallment->paid_amount)) }}
                                                </td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown CRM_dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a onclick="deletePayment({{ $payment->id }});"
                                                                   class="dropdown-item" href="#"
                                                                   data-toggle="modal">@lang('common.delete')</a>
                                            ...
                                            <div class="modal fade admin-query"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            {{ html()->form('POST', route('feesInstallmentUpdate'))->attributes([
                                                                    'class' => 'form-horizontal',
                                                                    'files' => true,
                                                                    'enctype' => 'multipart/form-data',
                                                                ])->open() }}
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="primary_input ">
                                                                <input
                                                                        ...
                                                                        value="{{ decimal_only($feesInstallment->amount) }}"
                                                                        readonly>
                                                                <label class="primary_input_label"
                                                                       for="">@lang('fees.amount') <span
                                                    ...
                                                    <div class="modal-body">
                                                        {{ html()->form('POST', route('directFees.deleteSubPayment'))->attributes([
                                                                'class' => 'form-horizontal',
                                                                'files' => true,
                                                                'enctype' => 'multipart/form-data',
                                                            ])->open() }}
                                                ...
                                                <table class="table school-table-style" cellspacing="0" width="100%">
                                                    ...
                                                    @foreach ($fees_assigneds as $fees_assigned)
                                                        @php
                                                            ...
                                                            $paid = \App\Models\SmFeesAssign::discountSum(
                                                            ...
                                                            $fine = \App\Models\SmFeesAssign::discountSum(
                                                                $fees_assigned->student_id,
                                                                $fees_assigned->feesGroupMaster->feesTypes->id,
                                                                'fine',
                                                                $fees_assigned->record_id,
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox"
                                                                       id="fees_group.{{ $fees_assigned->id }}"
                                                                       class="common-checkbox fees-groups-print"
                                                                       name="fees_group[]"
                                                            ...
                                                            <td>
                                                                @php
                                                                    $rest_amount =
                                                                        $fees_assigned->feesGroupMaster->amount - $total_paid;
                                                            ...
                                                            <td>{{ currency_format($fees_assigned->feesGroupMaster->amount) }}</td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                                        ...
                                                                        @if (userPermission('fees-generate-modal'))
                                                                            @if ($balance_amount != 0)
                                                                                ...
                                                                                <a class="dropdown-item modalLink"
                                                                                   ...
                                                                                   href="{{ route('fees-generate-modal', [$balance_amount, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id, $fees_assigned->fees_master_id, $fees_assigned->id, $fees_assigned->record_id]) }}">@lang('fees.add_fees')
                                                                                </a>
                                                                            @else
                                                        ...
                                                        @php
                                                            $payments = App\Models\SmFeesAssign::feesPayment(
                                                                $fees_assigned->feesGroupMaster->feesTypes->id,
                                                                $fees_assigned->student_id,
                                                                $fees_assigned->record_id,
                                                            );
                                                        ...
                                                        @foreach ($payments as $payment)
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td class="text-right">
                                                                    <img src="{{ assetPath('public/backEnd/img/table-arrow.png') }}">
                                                                </td>
                                                                <td>
                                                                    @php
                                                                ...
                                                                <td class="text-center">{{ currency_format($payment->discount_amount) }}</td>
                                                                <td>
        ...
        <div class="modal fade admin-query" id="deletePaymentModal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ html()->form('POST', route('university.deleteSubPayment'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}
