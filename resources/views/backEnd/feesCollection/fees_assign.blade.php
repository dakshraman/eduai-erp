        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        {{ html()->form('POST', route('fees-assign-search'))->attributes([
                        ...
                        <div class="row">
                            ...
                            @if (moduleStatusCheck('Branch'))
                                @include('branch::components.branch_select', [
                                    'grid_class' => 'col-lg-3',
                                    'mb' => 'mb-15',
                                    'branch_id' => isset($requestData) ? @$requestData['branch_id'] : '',
                                    'title' => 0
                                ])
                            @endif
                            ...
                            @else
                                @include('backEnd.shift.shift_class_section_include', [
                                    ...
                                    'selected' => [
                                        'shift_id' => @$requestData['shift'],
                                        'class_id' => @$requestData['class'],
                                        'section_id' => @$requestData['section'],
                                    ],
                                ])
...
class
            ...
            @if (isset($students))
                {{ html()->form('POST', url('btn-assign-fees-group'))->attributes([
                        'class' => 'form-horizontal',
                        'files' => true,
                        'enctype' => 'multipart/form-data',
                    ])->open() }}
            ...
            <tbody>
                @foreach ($fees_assign_groups as $fees_assign_group)
                    <tr>
                        ...
                        <td style="padding: 20px 10px 10px 17px !important;">{{ currency_format(@$fees_assign_group->amount) }}</td>
                    </tr>
                @endforeach
            </tbody>
            </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        @if (moduleStatusCheck('Branch'))
                        <input type="hidden" name="fees_assign_branch"
                            value="{{ isset($requestData) ? $requestData['branch_id'] : '' }}">
                        @endif
                        ...
                        @if(shiftEnable())
                        <input type="hidden" name="fees_assign_shift"
                            value="{{ isset($requestData) ? $requestData['shift'] : '' }}">
                        @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        <button type="button" class="primary-btn tr-bg" data-dismiss="modal">@lang('admin.cancel')</button>
                        {{ html()->form('POST', url('unssign-all-fees-group'))->attributes([
                                'class' => 'form-horizontal',
                                'files' => true,
                                'enctype' => 'multipart/form-data',
                            ])->open() }}
