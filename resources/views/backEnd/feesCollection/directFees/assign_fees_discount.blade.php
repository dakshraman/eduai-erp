...
@section('mainContent')
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            ...
            @if (!empty($students))
                {{ html()->form('POST', route('directFees.fees-discount-assign-store'))->class('form-horizontal')->open() }}
                <div class="row mt-40">
                    <div class="col-lg-12">
                        <div class="row mb-30">
