...
<head>
    ...
    <link rel="stylesheet" href="{{ assetPath('public/backEnd/css/report/bootstrap.min.css')}}">
        ...
        <div class="student_marks_table print">
            <table class="custom_table">
                        ...
                        <th colspan="2">
                            ...
                            <ul>
                                ...
                                @if(shiftEnable())
                                    <li>
                                        <p>
                                            @lang('common.shift'): {{@$student->shift->shift_name}}
                                        </p>
                                    </li>
                                    @endif
                                    </li>
                ...
                <tr>
                    <!-- first header  -->
                    @if($invoiceSettings->per_th==1 || $invoiceSettings->per_th==2 || $invoiceSettings->per_th==3)
                        <th class="text-left" style="text-align: left">@lang('fees.fees_details')</th>
                        <th class="text-right" style="text-align: right">@lang('accounts.amount') ({{generalSetting()->currency_symbol}})</th>
                    @endif
                    @if($invoiceSettings->per_th==2 || $invoiceSettings->per_th==3)
                        <!-- space  -->
                        ...
                        <tr>
                            ...
                            @if($invoiceSettings->per_th==1 || $invoiceSettings->per_th==2 || $invoiceSettings->per_th==3)
                                ...
                                <td class="border-top" style="text-align: right">
                                    ...
                                    @if ($feesInstallment->discount_amount>0)
                                        <br>
                                        {{currency_format($feesInstallment->discount_amount)}}
                                    @endif
                                    @if ($fine>0)
                                        <br>
                ...
                @else
                    @foreach($fees_assigneds as $fees_assigned)
                        ...
                        <tr>
                            @php
                                $assigned_main_fees=decimal_only((float)@$fees_assigned?->feesGroupMaster->amount);
                                $p_amount= $assigned_main_fees-$paid + $fine-$discount_amount;
                                //  $totalpayable+=decimal_only((float)@$fees_assigned?->feesGroupMaster->amount);
                            ...
                            @if($invoiceSettings->per_th==1 || $invoiceSettings->per_th==2 || $invoiceSettings->per_th==3)
                                ...
                                <td class="border-top" style="text-align: right">
                                    {{currency_format(@$assigned_main_fees)}}
                                    @if ($discount_amount>0)
                                        <br>
                ...
                <tr>
                    @if($invoiceSettings->per_th==1 || $invoiceSettings->per_th==2 || $invoiceSettings->per_th==3)
                        ...
                        <td style="text-align: right">
                            ...
                            <strong> {{ currency_format((float) $grand_total)}} </strong>
                        </td>
                    @endif
                ...
                <tr>
                    @if($invoiceSettings->per_th==1 || $invoiceSettings->per_th==2 || $invoiceSettings->per_th==3)
                        ...
                        <td style="text-align: right">
                            {{-- {{ currency_format((float) $unapplied_discount_amount)}}<br> --}}
                            <strong> {{ currency_format((float) $total_grand_paid)}} </strong>
                        </td>
                    @endif
                ...
                <tr>
                    @if($invoiceSettings->per_th==1 || $invoiceSettings->per_th==2 || $invoiceSettings->per_th==3)
                        ...
                        <td style="text-align: right">
                            {{-- {{ currency_format((float) $unapplied_discount_amount)}}<br> --}}
                            <strong> {{ currency_format((float) ($grand_total - $total_grand_paid - $total_discount))}} </strong>
                        </td>
                    @endif
            ...
            @if($invoiceSettings->per_th==1 || $invoiceSettings->per_th==2 || $invoiceSettings->per_th==3)
                <div class="footer_widget">
                    <ul class="copyies_text">
                        @if(!empty($invoiceSettings->footer_1) && $invoiceSettings->signature_p==1)
                            <li> {{$invoiceSettings->footer_1 !='' ? $invoiceSettings->footer_1 :''}}</li>
                        @endif
                        @if(!empty($invoiceSettings->footer_2) && $invoiceSettings->signature_c==1)
                            <li> {{$invoiceSettings->footer_2 !='' ? $invoiceSettings->footer_2 :''}}</li>
                        @endif
                        @if(!empty($invoiceSettings->footer_3) && $invoiceSettings->signature_o==1)
                            <li> {{$invoiceSettings->footer_3 !='' ? $invoiceSettings->footer_3 :''}}</li>
                        @endif
...
<script src="{{ assetPath('public/backEnd/js/fees_invoice/jquery-3.2.1.slim.min.js') }}"></script>
<script src="{{ assetPath('public/backEnd/js/fees_invoice/popper.min.js') }}"></script>
<script src="{{ assetPath('public/backEnd/js/fees_invoice/bootstrap.min.js') }}"></script>
</body>
</html>
