                                ...
                                <tr>
                                    <td align="center" class="m_img_mc_fix">
                                        <a href="" target="_blank">
                                            <img align="center" src="{{assetPath(generalSetting()->logo)}}" alt=""
                                                 width="" height="" border="0" style="width:px; max-width:px;">
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        @php
                                            $body = App\Models\SmsTemplate::emailTempleteToBody(getTempleteDetails('reject_bank_payment_student')->body,$data);
                                        @endphp
