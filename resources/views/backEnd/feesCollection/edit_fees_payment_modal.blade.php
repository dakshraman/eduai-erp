...
<div class="container-fluid">
    {{ html()->form('POST', route('fees-payment-update'))->attributes([
                        ...
                        <div class="primary_input">
                            ...
                            <div class="position-relative">
                                <input class="primary_input_field  primary_input_field date form-control form-control"
                                    id="startDate" type="text" name="date" value="{{ date('m/d/Y') }}" readonly
                ...
                <div class="col-lg-12" id="sibling_class_div">
                    <div class="primary_input">
                        <label class="primary_input_label" for="">@lang('accounts.amount') <span class="text-danger">
                                *</span> </label>
                        <input class="primary_input_field form-control" type="number" step="{{inputStep()}}" min="0"
                            name="amount" value="{{ decimal_only($fees_payment->amount) }}" id="amount">
