@php
    ...
    $email_template = App\Models\SmsTemplate::where('id',1)->first();
@endphp
                                ...
                                <tr>
                                    <td align="center" class="m_img_mc_fix">
                                        <a href="" target="_blank">
                                            <img align="center" src="{{assetPath(generalSetting()->logo)}}"
                                                 alt="{{assetPath(generalSetting()->school_name)}}" border="0"
