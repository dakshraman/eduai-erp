        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        {{ html()->form('POST', route('fees_statement_search'))->attributes([
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="student-meta-box">
                                    ...
                                    <img class="student-meta-img img-100" src="{{ assetPath($student->student_photo) }}"
                                         alt="">
                                    <div class="white-box">
                                        <div class="row">
                                ...
                                @foreach ($fees_assigneds as $fees_assigned)
                                    ...
                                    <tr class="text-nowrap">
                                        ...
                                        <td>
                                            ...
                                            @php
                                                ...
                                                $balance_amount = decimal_only($rest_amount + $fine );

                                            @endphp

                                            @if ($balance_amount == 0)
                                                <button
                                                        class="primary-btn small bg-success text-white border-0">@lang('reports.paid')</button>
                                            @elseif($paid != 0)
                                                <button
                                                        class="primary-btn small bg-warning text-white border-0">@lang('reports.partial')</button>
                                            @elseif($paid == 0)
                                                <button
                                                        class="primary-btn small bg-danger text-white border-0">@lang('reports.unpaid')</button>
                                            @endif
                                        </td>
                                    ...
                                    @foreach ($payments as $payment)
                                        <tr>
                                            ...
                                            <td class="nowrap">
                                                {{ $payment->payment_date != '' ? dateConvert($payment->payment_date) : '' }}</td>
