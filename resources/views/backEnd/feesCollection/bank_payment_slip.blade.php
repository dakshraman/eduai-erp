            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('bank-payment-slips'))->attributes([
                        ...
                        <input type="hidden" id="un_semester_label_id" name="un_semester_label_id"
                            value="{{ @$un_semester_label_id }}">
                        ...
                        @if (moduleStatusCheck('University'))
                            <div class="row">
                                ...
                                @includeIf(
                                    ...
                                    ['required' => ['USN', 'UF', 'UD', 'UA', 'US', 'USL'], 'hide' => ['USUB']]
                                )
                                <div class="col-lg-3 col-md-3 mt-15">
                                    <label for="">@lang('common.status')</label>
                                    @php
                                        $selectedStatus = old('approve_status', $approve_status ?? '');
                                    @endphp
                                    ...
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field  primary_input_field date form-control form-control{{ $errors->has('payment_date') ? ' is-invalid' : '' }} {{ isset($date) ? 'read-only-input' : '' }}"
                                                    id="startDate" type="text" name="payment_date" autocomplete="off"
                                                    value="{{ isset($date) ? $date : old('payment_date') }}">
                                        ...
                                        <button class="" type="button">
                                            <label class="m-0 p-0" for="startDate">
                                                <i style="position: relative; top: 15px;" class="ti-calendar"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ html()->form('POST', route('approve-fees-payment'))->attribute('enctype', 'multipart/form-data')->open() }}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{ html()->form('POST', route('reject-fees-payment'))->attribute('enctype', 'multipart/form-data')->open() }}
            ...
            $(document).ready(function() {
                $('.data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        @if (moduleStatusCheck('University'))
                            {
                                data: 'installment_assign.installment.title',
                                name: 'title'
                            },
                        @elseif (directFees()) {
                                data: 'installment_assign.installment.title',
