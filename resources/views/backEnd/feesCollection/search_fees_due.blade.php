                        ...
                        <div class="row">
                            ...
                            @if (moduleStatusCheck('University'))
                                ...
                                <div class="col-lg-3 mt-30">
                                    ...
                                    @php
                                        $selectedValue = old('fees_group', isset($fees_group_id) && isset($fees_group_master_id) 
                                            ? ($fees_group_master_id . '-' . $fees_group_id) 
                                            : '');
                                    @endphp
                                    ...
                                    <select
                                            ...
                                            name="fees_group">
                                        <option data-display="@lang('fees.fees_group')*"
                                                value="">@lang('fees.fees_group') *
                                        </option>
                                        ...
                                        @foreach ($fees_masters as $fees_master)
                                            ...
                                            @foreach ($fees_master->feesTypeIds as $feesTypeId)
                                                @php
                                                    $optionValue = $fees_master->fees_group_id . '-' . $feesTypeId->feesTypes->id;
                                                @endphp
                                                <option value="{{ $optionValue }}"
                                                        {{ $optionValue == $selectedValue ? 'selected' : '' }}>
                                                    {{ $feesTypeId->feesTypes->name }}
                                                </option>
                                            @endforeach
                                        @endforeach
                                    </select>
                            ...
                            @else
                                <div class="{{shiftEnable() ? 'col-lg-3' : 'col-lg-4'}} mt-30-md">
                                    ...
                                    <select
                                        ...
                                        @foreach ($fees_masters as $fees_master)
                                            ...
                                            @foreach ($fees_master->feesTypeIds as $feesTypeId)
                                                @php
                                                    $combinedValue = $fees_master->fees_group_id . '-' . $feesTypeId->feesTypes->id;
                                                    $selectedValue = old('fees_group', isset($fees_group_id) ? ($fees_master->fees_group_id . '-' . $fees_group_id) : '');
                                                @endphp
                                                <option
                                                        value="{{ $combinedValue }}"
                                                        {{ $combinedValue == $selectedValue ? 'selected' : '' }}>
                                                    {{ $feesTypeId->feesTypes->name }}
                                                </option>
                                            @endforeach
                                        @endforeach
                                ...
                                {{-- <div class="col-lg-4 mt-30-md">
                                    @php
                                        $selectedClass = old('class', $class_id ?? '');
                                    @endphp
                                    ...
                                    @if (moduleStatusCheck('University'))
                                        ...
                                        <table id="table_id" class="table " cellspacing="0" width="100%">
                                            ...
                                            @foreach ($fees_dues as $fees_due)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endphp
                                                        {{ currency_format($fees_due->amount) }}
                                                    </td>
                                                    <td>
                                                        @php
                                                            $totalDiscount += $fees_due->discount_amount;
                                                        @endphp
                                                        {{ currency_format($fees_due->discount_amount) }}
                                                    </td>
                                                    <td>
                                                        @php
                                                            $totalPaid += $fees_due->paid_amount;
                                                        @endphp
                                                        {{ currency_format($fees_due->paid_amount) }}
                                                    </td>
                                                    <td>
                                                        @php
                                                            $balance =
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ currency_format($totalDiscount) }}</td>
                                                <td>{{ currency_format($totalPaid) }}</td>
                                                <td>{{ currency_format($totalBalance) }}</td>
                                                <td></td>
                                            </tr>
                                            </tfoot>
                                        </table>
                                        ...
                                        <table id="table_id" class="table " cellspacing="0" width="100%">
                                            ...
                                            @foreach ($fees_dues as $fees_due)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            echo currency_format($fees_due->feesGroupMaster->amount);
                                                        @endphp
                                                    </td>
                                                    <td>
                                                        @php
                                                            $amount = App\Models\SmFeesAssign::discountSum(
                                                                $fees_due->student_id,
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            if ($discount_amount > 0) {
                                                                echo currency_format($discount_amount);
                                                            } else {
                                                                echo currency_format(0.0);
                                                            }
                                                        @endphp
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden"
                                                               ...
                                                               value="{{ currency_format($dues_amount) }}">
