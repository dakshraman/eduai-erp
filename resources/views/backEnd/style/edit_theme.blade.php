...
@section('mainContent')
    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            {{ html()->form('PUT', route('themes.update', $theme->id))->attributes([
                'class' => 'form-horizontal',
                'files' => true,
                'enctype' => 'multipart/form-data',
            ])->open() }}
            <input type="hidden" value="{{ $theme->id }}" name="theme_id">
            <input type="hidden" id="old_bg_image" value="{{ assetPath($theme->background_image) }}">
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <div class="row">
                        ...
                        <div class="row mt-15" id="themeImageDiv">
                            <div class="col-lg-12">
                                <img class="previewImageSize {{ @$theme->background_image ? '' : 'd-none' }}" src="{{ @$theme->background_image ? assetPath($theme->background_image) : '' }}" alt="" id="themeImageShow" height="100%" width="100%">
                            </div>
                        </div>
                        <div class="row">
