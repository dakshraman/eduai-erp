            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if(isset($visitor))
                            {{ html()->form('POST', route('background-settings-update'))->attributes([
                            ...
                            @else
                                ...
                                {{ html()->form('POST', route('background-settings-store'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                ])->open() }}
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src="{{assetPath($background_setting->image)}}" width="200px" height="100px">
                                                @else
