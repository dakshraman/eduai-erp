                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @else
                                @if (userPermission('holiday-store'))
                                    {{ html()->form('POST', url('holiday'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mb-20">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('system_settings.holiday_title')
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('common.description')
                                                    <span class="text-danger"> *</span> </label>
                                                <textarea class="primary_input_field form-control {{ $errors->has('details') ? ' is-invalid' : '' }}" cols="0"
                                                    rows="4" name="details">{{ isset($editData) ? $editData->details : '' }}</textarea>
                                                        ...
                                                        <td>
                                                            <x-drop-down>
                                                                ...
                                                                @if ($value->upload_image_file != '')
                                                                    <a class="dropdown-item"
                                                                        href="{{ url($value->upload_image_file) }}"
                                                                        download>
