            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($editData))
                            {{ html()->form('PUT', url('holiday/' . $editData->id))->attributes([
                            ...
                            @else
                                @if (userPermission('library-member-store'))
                                {{ html()->form('POST', route('library-member-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-4',
                                                'branch_id' => isset($editData) ? $editData->branch_id : old('branch_id'),
                                            ])
                                        </div>
                                    @endif
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mb-15">
                                            ...
                                            <select
                                                ...
                                                @foreach ($roles as $value)
                                                    ...
                                                    @else
                                                        <option value="{{ $value->id }}"
                                                            {{ old('member_type') == $value->id ? 'selected' : '' }}>
                                                            {{ $value->name }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                        ...
                                        <div class="forStudentWrapper col-lg-12">
                                            @if (moduleStatusCheck('University'))
                                                ...
                                                <div class="mt-30 mb-40" id="select_un_student_div">
                                                    {{ html()->select('student', ['' => __('common.select_student') . '*'])->attributes([
                                            ...
                                            @else
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 mb-15" id="select_section__member_div">
                                                        ...
                                                        <input type="hidden" id="is_alumni" value="{{ App\Support\GlobalVariable::isAlumni() }}">
                                                        <select
                                        ...
                                        <div class="forParentWrapper col-lg-12">
                                            <div class="row">
                                                ...
                                                @endif
                                                <div class="col-lg-12 mb-15 mt-3" id="select_parent_div">
                                                    <label class="primary_input_label" for="">
                                                        @lang('library.parent')
                                                        <span class="text-danger"> *</span>
                                                    </label>
                                        ...
                                        <div class="col-lg-12 mb-15 mt-10">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ isset($content_title) ? $leave_type->type : old('member_ud_id') }}">
    ...
    @push('script')
        <script>
            $(document).ready(function() {
                ...
                $(document).on('change','#select_section_parent',function(){
                   
                    let section_id = $(this).val();
                    let faculty_id = $("#select_faculty_parent").val();
                    let dept_id = $("#select_dept_parent").val();
                    let session_id = $("#select_session_parent").val();
                    let academic_id = $("#select_academic_parent").val();
                    let semester_id = $("#select_semester_parent").val();
                    let semester_label = $("#select_semester_label_parent").val();
                    let data = {
                            session_id:session_id,
                        ...
                        console.log(data);
                    $.ajax({
                        url:"{{ route('library-member-getParents') }}",
                        method:"get",
                        data: data,
                            ...
                            if(response.status == 'success') {
                                ...
                                {
                                    option = option + `<option value='${parents[i].id}'>${parents[i].name}</option>`
                                }   
                                $("#select_parent").html(option);
                                $("#select_parent").niceSelect('update');                           
                            }
                    });
                });
            });
