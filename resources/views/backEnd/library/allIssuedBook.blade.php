            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('search-issued-book'))->attributes([
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="filed_branch_id" name="branch_id" value="{{@$branch_id}}">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select class="primary_select form-control" name="book_id" id="book_id">
                                    <option data-display="@lang('library.select_Book_Name')" value="">
                                        @lang('common.select')
                                    </option>
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <div class="primary_input">
                                    ...
                                    <input class="primary_input_field" type="text" name="book_number"
                                        value="{{ isset($book_number) ? $book_number : old('book_number') }}">
                            ...
                            <div class="col-lg-4 mt-30-md">
                                ...
                                <select class="primary_select form-control" name="subject_id" id="subject_id">
                                    ...
                                    @foreach ($subjects as $key => $value)
                                        <option value="{{ $value->id }}"
                                            {{ (old('subject_id') ?? ($subject_id ?? '')) == $value->id ? 'selected' : '' }}>
                                            {{ $value->subject_name }}
                                        </option>
                                    @endforeach
                                </select>
       ...
       $('.data-table').DataTable({
                     ...
                     "ajax": $.fn.dataTable.pipeline( {
                       ...
                       columns: [
                            ...
                            {data: 'issue_status', orderable: false, searchable: true},
                        ],
