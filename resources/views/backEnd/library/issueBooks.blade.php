                    ...
                    <div class="student-meta-box mt-30">
                        ...
                        @if (@$memberDetails->member_type == 2)
                            <img class="student-meta-img img-100"
                                src="{{ file_exists(@$memberDetails->studentDetails->student_photo) ? assetPath($memberDetails->studentDetails->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
                                alt="">
                        @elseif(@$memberDetails->member_type == 3)
                            <img class="student-meta-img img-100"
                                src="{{ file_exists(@$staffDetails->guardians_photo) ? assetPath($staffDetails->guardians_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
                                alt="">
                        @else
                            <img class="student-meta-img img-100"
                                src="{{ file_exists(@$memberDetails->staffDetails->staff_photo) ? assetPath($memberDetails->staffDetails->staff_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }}"
                                alt="">
                        @endif
                        <div class="white-box">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="value">
                                        @if (isset($memberDetails))
                                            {{ $memberDetails->branch?->branch_name }}
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    @if (userPermission('issue-books'))
                        <div class="row mt-30">
                            <div class="col-lg-12">
                                ...
                                @if (isset($editData))
                                {{ html()->form('PUT', route('book-category-list-update', $editData->id))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                ])->open() }}                                
                                @else
                                {{ html()->form('POST', route('save-issue-book-data'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
