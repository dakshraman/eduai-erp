                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @else
                         ...
                         {{ html()->form('POST', route('book-category-list-store'))->attributes([
                            'class' => 'form-horizontal',
                            'files' => true,
                            'enctype' => 'multipart/form-data',
                        ])->open() }}                        
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mt-40 d-flex justify-content-between">
                                                ...
                                                {{ html()->form('DELETE', route('book-category-list-delete', $value->id))->attribute('enctype', 'multipart/form-data')->open() }}
