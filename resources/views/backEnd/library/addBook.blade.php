...
@section('mainContent')
    ...
    <section class="admin-visitor-area">
          <div class="container-fluid p-0">
            @if(isset($editData))
            {{ html()->form('POST', route('update-book-data', $editData->id))->attributes([
            ...
            @else
                ...
                {{ html()->form('POST', route('save-book-data'))->attributes([
                    'class' => 'form-horizontal',
                    'files' => true,
                    'enctype' => 'multipart/form-data',
                ])->open() }}                
                                ...
                                <div class="col-lg-3 mb-4">
                                    <div class="primary_input ">
                                        ...
                                        <input oninput="numberMinZeroCheck(this)"
                                            ...
                                            type="number" step="{{inputStep()}}" name="book_price" autocomplete="off"
                                            value="{{isset($editData)? decimal_only($editData->book_price) : old('book_price')}}">
