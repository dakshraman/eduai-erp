...
<script src="{{assetPath('public/backEnd/assets/js/metisMenu.js')}}"></script>

@if(userRtlLtl() ==1)
<script src="{{assetPath('public/backEnd/assets/js/bootstrap.rtl.min.js') }}"></script>
@else
<script src="{{assetPath('public/backEnd/assets/js/bootstrap.min.js') }}"></script>
@endif
...
<script type="text/javascript" src="{{assetPath('public/backEnd/vendors/js/moment.min.js')}}"></script>
...
<script type="text/javascript" src="{{assetPath('public/backEnd/js/jquery.validate.min.js')}}"></script>


<script src="{{assetPath('public/backEnd/js/main.js')}}?v=2"></script>
...
<script src="{{assetPath('modules/wallet/js/wallet.js')}}"></script>
<script>
...
<script src="{{assetPath('public/backEnd/')}}/js/search.js"></script>

{!! Toastr::message() !!}
<script src="{{ assetPath('public/chat/js/custom.js') }}"></script>
