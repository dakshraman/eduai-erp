            ...
            <div class="main-title">
                <h3 class="mb-15">@lang('exam.add_marks') |
                    <small>@lang('exam.exam'): {{$exam->title}}, @lang('common.class'):
                        ...
                        {{$section->section_name}} @if(shiftEnable() && @$shift) , @lang('common.shift'): {{$shift->name}} @endif , @lang('common.subject'): {{$subject->subject_name}}
                </h3>

                <input type="hidden" value="{{$exam->id}}" id="exam_import_id">
                <input type="hidden" value="{{$class->id}}" id="class_import_id">
                <input type="hidden" value="{{$section->id}}" id="section_import_id">
                <input type="hidden" value="{{$subject->id}}" id="subject_import_id">
