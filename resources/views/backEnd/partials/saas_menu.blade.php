...
Session::put('permission', App\Support\GlobalVariable::GlobarModuleLinks());
...
<nav id="sidebar">
    <div class="sidebar-header update_sidebar">
        <a href="{{url('/')}}">
            <img src="{{ file_exists(@generalSetting()->logo) ? assetPath(generalSetting()->logo) : assetPath('public/uploads/settings/logo.png') }}"
                 alt="logo">
        </a>
    ...
    <ul class="list-unstyled components">
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="subMenuEduAIInvoice">
                ...
                <li><a href="{{route('administrator/income-expense')}}">@lang('accounts.date_to')
                        /@lang('accounts.expense')</a></li>
                ...
                <li>
                    <a href="{{url('administrator/tabulation-sheet-report')}}">@lang('reports.tabulation_sheet_report')</a>
                </li>
