@push('css')
<link rel="stylesheet" href="{{ assetPath('public/backEnd/vendors/css/daterangepicker.css') }}" />
@endpush

@push('script')
<script src="{{assetPath('public/backEnd/')}}/vendors/js/daterangepicker.min.js"></script>
