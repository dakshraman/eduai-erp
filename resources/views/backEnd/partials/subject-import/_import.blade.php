    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="main-title">
                <h3 class="mb-15">@lang('academics.assign_subject_import') |
                    <small>@if(moduleStatusCheck('Branch') && @$branch) @lang('common.branch'):
                        {{$branch->branch_name}}, @endif @lang('common.class'):
                ...
                @endif
                @if(moduleStatusCheck('Branch')  && @$branch)
                    <input type="hidden" name="branch_id" value="{{$branch->id}}" id="branch_submit_id">
                @endif
            </div>
        </div>
    </div>
