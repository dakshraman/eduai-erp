...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            ...
            @endif
            <div class="row">
                @if (userPermission('subject_store') || isset($subject))
                <div class="col-lg-4 col-xl-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($subject))
                                {{ html()->form('POST', route('subject_update'))->attribute('class', 'form-horizontal')->attribute('files', true)->open() }}
                            @else
                                @if (userPermission('subject_store'))
                                    {{ html()->form('POST', route('subject_store'))->attribute('class', 'form-horizontal')->attribute('files', true)->open() }}
                                @endif
                            @endif
                            <div class="white-box">
                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($subject) ? $subject->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                    <div class="row">
                ...
                @endif
                <div class="@if (userPermission('subject_store') || isset($subject)) col-lg-8 col-xl-9 @else col-lg-12 @endif">
                    <div class="white-box">
                        <div class="row">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-item-center justify-content-start flex-wrap">
                                                            @if(userPermission('subject_edit'))
                                                                <a class="primary-btn small fix-gr-bg icon-only ml-10  l-h-30" href="{{ route('subject_edit', [@$subject->id]) }}">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                            @endif
                                                            @if(userPermission('subject_delete'))
