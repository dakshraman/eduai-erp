    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            <div class="row">
                ...
                @if (userPermission('assign_subject_import'))
                    <div class="offset-lg-6 col-lg-2 text-right col-md-6 mb-15">
                        @if (userPermission('assign_subject_import'))
                            <a href="{{ route('assign_subject_import') }}" class="primary-btn small fix-gr-bg">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="assign-subject" id="assign-subject">
                                        ...
                                        @if (moduleStatusCheck('Branch'))
                                        <input type="hidden" name="branch_id" id="main_branch_id" value="{{@$branch_id}}"> 
                                        @endif
                                        @if (moduleStatusCheck('University'))
