                        ...
                        <div class="col-lg-12">
                            @if (isset($phone_call_log))
                             @if (userPermission('phone-call-store'))
                                {{ html()->form('PUT', route('phone-call_update', @$phone_call_log->id))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
                             @endif
                            @else
                                @if (userPermission('phone-call-store'))
                                    {{ html()->form('POST', route('phone-call-store'))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
                                    ...
                                    <div class="row">
                                        @if (moduleStatusCheck('Branch'))
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($phone_call_log) ? $phone_call_log->branch_id : '',
                                            ])
                                        @endif
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"
                                                    for="">@lang('admin.call_duration')</label>
                                                <input
                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <x-table>
                                        <table id="table_id" class="table data-table custom-btn" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    @if(moduleStatusCheck('Branch'))
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-40 d-flex justify-content-between">
                            ...
                            {{ html()->form('DELETE', route('phone-call_delete'))->attribute('enctype', 'multipart/form-data')->open() }}
