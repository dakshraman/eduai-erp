...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            {{ html()->form('post', route('admission-query-search'))->acceptsFiles()->attributes(['class' => 'form-horizontal', 'id' => 'infix_form'])->open() }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label" for="">@lang('admin.date_from') <span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label" for="">@lang('admin.date_to') <span class="text-danger">*</span></label>
                                    <div class="primary_datepicker_input">
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="">
                                    ...
                                    <select name="source"
                                        ...
                                        @foreach ($sources as $source)
                                            <option value="{{ $source->id }}"
                                                {{ old('source', $source_id ?? '') == $source->id ? 'selected' : '' }}>
                                                {{ $source->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input">
                                    ...
                                    <select
                                        ...
                                        <option data-display="@lang('admin.select_status')" value="">
                                            @lang('admin.Status')
                                        </option>

                                        <option value="1"
                                            {{ old('status', $status_id ?? '') == '1' ? 'selected' : '' }}>
                                            @lang('admin.active')
                                        </option>

                                        <option value="2"
                                            {{ old('status', $status_id ?? '') == '2' ? 'selected' : '' }}>
                                            @lang('admin.inactive')
                                        </option>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($requestData))
                                @if(moduleStatusCheck('Branch'))
                                    <input type="hidden" name="branch_id" value="{{ $requestData['branch_id'] ?? '' }}">
                                @endif
                            ...
                            @endif
                            <x-table>
                                <table id="table_id" class="table custom-btn data-table" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {!! html()->form('POST', route('admission_query_delete'))->attribute('enctype', 'multipart/form-data')->open() !!}
    ...
    <div class="modal fade admin-query" id="addQuery">
        <div class="modal-dialog modal-dialog-centered large-modal">
            <div class="modal-content">
                ...
                {!! html()->form('POST', route('admission_query_store_a'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="primary_input">
                                                ...
                                                <input class="primary_input_field read-only-input form-control"
                                                    type="text"
                                                    name="assigned" id="assigned" value="{{old('assigned')}}">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <select class="primary_select " name="class" id="class">
                                                    ...
                                                    @foreach ($classes as $class)
                                                        <option value="{{ @$class->id }}" {{ old('class') == @$class->id ? 'selected' : '' }}>{{ @$class->class_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="primary_input">
                                                ...
                                                <input oninput="numberMinCheck(this)"
                                                    class="primary_input_field read-only-input form-control"
                                                    type="text" name="no_of_child" id="no_of_child" value="{{old('no_of_child')}}">
