            ...
            <div class="row">
                <div class="col-lg-4 col-xl-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($complaint))
                                {!! html()->form('put', url('complaint/' . @$complaint->id))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() !!}
                            @else
                                @if (userPermission('complaint_store'))
                                    {!! html()->form('POST', url('complaint'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() !!}
                                @endif
                            @endif
                            <div class="white-box">
                                    ...
                                    <div class="row">
                                        @if (moduleStatusCheck('Branch'))
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($complaint) ? $complaint->branch_id : '',
                                            ])
                                        @endif
                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"
                                                    for="">@lang('admin.date')<span class="text-danger"> *</span></label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-40 d-flex justify-content-between">
                            ...
                            {!! html()->form('POST', route('complaint_delete'))->attribute('enctype', 'multipart/form-data')->open() !!}
