...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            @endif
            <div class="row">
                @if (userPermission('postal-dispatch-store') || isset($postal_dispatch))
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($postal_dispatch))
                                {{ html()->form('PUT', route('postal-dispatch_update', @$postal_dispatch->id))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
                            @else
                                @if (userPermission('postal-dispatch-store'))
                                    {{ html()->form('POST', route('postal-dispatch-store'))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
                                @endif
                            @endif
                            <div class="white-box">
                                    ...
                                    <div class="row">
                                        @if (moduleStatusCheck('Branch'))
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($postal_dispatch) ? $postal_dispatch->branch_id : '',
                                            ])
                                        @endif
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input class="primary_input_field form-control{{ $errors->has('to_title') ? ' is-invalid' : '' }}"
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input class="primary_input_field form-control{{ $errors->has('address') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                @isset($postal_dispatch)
                                                    <textarea class="primary_input_field form-control{{ @$errors->has('note') ? ' is-invalid' : '' }}" cols="0"
                                                        rows="4" name="note"> {{ @$postal_dispatch->note }}</textarea>
                                                @else
                                                    <textarea class="primary_input_field form-control{{ @$errors->has('note') ? ' is-invalid' : '' }}" cols="0"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label class="primary_input_label" for="">@lang('admin.from_title') <span
                                                            class="text-danger"> *</span></label>
                                                    <input class="primary_input_field form-control{{ $errors->has('from_title') ? ' is-invalid' : '' }}"
                ...
                @endif
                    <div class=" @if (userPermission('postal-dispatch-store') || isset($postal_dispatch)) col-lg-9 @else col-lg-12 @endif">
                        <div class="white-box">
                            <div class="row">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-40 d-flex justify-content-between">
                            ...
                            {{ html()->form('POST', route('postal-dispatch_delete'))->attribute('enctype', 'multipart/form-data')->open() }}
