    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            <div class="row">
                ...
                @if (userPermission('postal-receive-store') || isset($postal_receive))
                <div class="col-lg-4 col-xl-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($postal_receive))
                                {{ html()->form('PUT', url('postal-receive/' . @$postal_receive->id))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
                            @else
                                @if (userPermission('postal-receive-store'))
                                    {{ html()->form('POST', route('postal-receive-store'))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
                                @endif
                            @endif
                            <div class="white-box">
                                    ...
                                    <div class="row">
                                        @if (moduleStatusCheck('Branch'))
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($postal_receive) ? $postal_receive->branch_id : '',
                                            ])
                                        @endif
                                    </div>
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="primary_input">
                                                ...
                                                <input class="primary_input_field form-control{{ $errors->has('from_title') ? ' is-invalid' : '' }}" type="text" name="from_title"
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input class="primary_input_field form-control{{ $errors->has('reference_no') ? ' is-invalid' : '' }}" type="text" name="reference_no"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('admin.address') <span
                                                        class="text-danger"> *</span></label>
                                                <input class="primary_input_field form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" type="text" name="address" autocomplete="off"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                @isset($postal_receive)
                                                    <textarea class="primary_input_field form-control" cols="0" rows="4" name="note"> {{ @$postal_receive->note }}</textarea>
                                                @else
                                                    <textarea class="primary_input_field form-control" cols="0" rows="4" name="note">{{ old('note') }}</textarea>
                                                    @endif
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label class="primary_input_label" for="">@lang('admin.to_title') <span
                                                            class="text-danger"> *</span></label>
                                                    <input class="primary_input_field form-control{{ $errors->has('to_title') ? ' is-invalid' : '' }}" type="text" name="to_title"
                ...
                @endif
                <div class="@if (userPermission('postal-receive-store') || isset($postal_receive)) col-lg-8 col-xl-9 @else col-lg-12 @endif">
                    <div class="white-box">
                        <div class="row">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-40 d-flex justify-content-between">
                            ...
                            {{ html()->form('POST', route('postal-receive_delete'))->attribute('enctype', 'multipart/form-data')->open() }}
