...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            {{ html()->form('POST', route('generate_id_card_bulk_search'))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            @if (moduleStatusCheck('Branch'))
                                @include('branch::components.branch_select', [
                                    'grid_class' => 'col-lg-4',
                                    'mb' => 'mb-15 mt-30-md',
                                    'branch_id' => isset($id_card) ? $id_card->branch_id : '',
                                ])
                            @endif
                                ...
                                <select class="primary_select" name="role" id="role_id">
                                    ...
                                    @foreach ($roles as $role)
                                        <option value="{{ @$role->id }}"
                                            ...
                                            {{ old('role') == $role->id ? 'selected' : (@$class_id == $role->id ? 'selected' : '') }}>
                                            {{ @$role->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-4 mt-30-md" id="id-card-div">
                                <label class="primary_input_label" for="">@lang('admin.id_card') <span
                                        class="text-danger"> *</span></label>
                                <select class="primary_select" id="id_card_list" name="id_card">
                                    <option data-display=" @lang('admin.select_id_card') *" value=""> @lang('admin.select_id_card') *
                                    </option>
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('admin.grid_gap') (px) <span
                                            class="text-danger"> *</span></label>
                                    <input class="primary_input_field" type="number" name="grid_gap" autocomplete="off"
                                        value="{{ old('grid_gap') }}">
                    ...
                    <div class="col-lg-12">
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="col-lg-1">
                                    <a href="javascript:;" id="genearte-id-card-print-button"
                                                ...
                                                <tr>
                                                    <th width="10%">
                                                        <input type="checkbox" id="checkAll"
                                                            class="common-checkbox generate-id-card-print-all"
                                                            name="checkAll" value="">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" id="student.{{ @$student->id }}"
                                                                class="common-checkbox generate-id-card-print"
...
@section('script')
    <script>
        $(document).ready(function() {
            $("#role_id, #branch_id").on("change", function() {
                var url = $("#url").val();
                var i = 0;
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data, function(i, item) {
                            if (item.length) {
                                $("#id_card_list").find("option").not(":first")
                                    .remove();
