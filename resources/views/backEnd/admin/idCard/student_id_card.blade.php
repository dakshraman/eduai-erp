    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            changeSignature = (status) => {
                const reuired_placeholder =
                    "{{ isset($id_card) ? ($id_card->signature != '' ? getFilePath3($id_card->signature) : trans('admin.signature') . ' *') : trans('admin.signature') . ' *' }}";
        ...
        $(document).on("click", "#deleteBackImg", function(event) {
            ...
            if (pageLayout == "horizontal") {
                ...
                $('.hr_bg').attr('style',
                    'line-height:1.02; background-image: url({{ assetPath('public/backEnd/id_card/img/horizontal_bg.png') }}); width: 86mm; height: 54mm; margin: auto; background-size: 100% 100%; background-position: center center; position: relative;'
                    );
            } else {

                $('.vr_bg').attr('style',
                    'line-height:1.02; background-image: url({{ assetPath('public/backEnd/id_card/img/vertical_bg.png') }}); width: 57.15mm; height: 88.9mm; margin: auto; background-size: 100% 100%; background-position: center center; position: relative; background-color: #fff; display: flex; flex-direction: column;'
                    );
            }
        });
        ...
        $(document).on("click", "#deleteLogoImg", function(event) {
            ...
            $("#old_logo").val(0);
            if (pageLayout == "horizontal") {
                $('.hLogo').css('background-image', 'url({{ assetPath('public/backEnd/img/logo.png') }})');
            } else {
                $('.vLogo').css('background-image', 'url({{ assetPath('public/backEnd/img/logo.png') }})');
            }
        });
        ...
        $(document).on("click", "#deleteSignImg", function(event) {
            ...
            if (pageLayout == "horizontal") {
                ...
                $('.hSign').css('background-image',
                    'url({{ assetPath('public/backEnd/id_card/img/Signature.png') }})');
            } else {
                console.log($('.vSign'));
