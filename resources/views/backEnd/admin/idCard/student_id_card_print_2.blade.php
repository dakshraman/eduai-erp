    			     ...
    			     <table cellpadding="0" cellspacing="0" border="0" width="156" height="241" align="center" style=" border: 1px solid var(--border_color); margin: 0px 0 0 0;" >
                        <tr style="border-right: 1px solid #ddd; border-left: 1px solid #ddd;  height: 0px; ">
                            <td colspan="3" style=" position: relative; text-align: center; background-color: #c738d8; border:1px solid #c738d8">
                               <!--  <center>
                                    <img src="{{assetPath('public/backEnd/img/student/id-card-bg.png')}}" style="width: 100%; height: auto; padding: 0px; margin: 0px" >
                                </center> -->
                        ...
                        <tr >
                            <td colspan="3" style="text-align: center;   border-right: 1px solid #ddd; border-left: 1px solid #ddd;">
                                <img src="{{ @$student->student_photo != "" ? asset(@$student->student_photo) : assetPath('public/backEnd/img/student/id-card-img.jpg') }}" alt="" style="width: 30%; margin-top: 5px;">
                            </td>
                        </tr>
                        ...
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd;">@lang('common.branch')</td>                            
                            <td style="text-align: right; margin-right: 40px !important; border-right: 1px solid #ddd">
                                {{ @$student->branch!=""?@$student->branch->branch_name:""}} </td>
                        </tr>
                        @endif
                        @if(shiftEnable())
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd;">@lang('common.shift')</td>                            
                            <td style="text-align: right; margin-right: 40px !important; border-right: 1px solid #ddd">
                                {{ @$student->shift!=""?@$student->shift->name:""}} </td>
                        </tr>
                        @endif
                        <tr >
                        ...
                        <tr >
                            ...
                            <td style=" border-right: 1px solid #ddd; text-align: right; padding-right: 20px;"><img src="{{assetPath($id_card->signature)}}" width="40%" style="margin-right: 20px !important;"></td>
                        </tr>
                        <tr >
                            <td colspan="3" style="text-align: center; padding-top: 20px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd; border-left: 1px solid #ddd;">
                                <img src="{{assetPath($id_card->logo)}}" width="50%"  height="40px"
