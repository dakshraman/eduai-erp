...
{{ html()->form('POST', route('admission_query_update'))->attributes([
        'class' => 'form-horizontal',
        'files' => true,
        'enctype' => 'multipart/form-data',
        'id' => 'admission-query-store',
    ])->open() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="primary_input">
                                ...
                                <input oninput="phoneCheck(this)" type="number"
                    ...
                    <div class="row">
                        @if (moduleStatusCheck('Branch'))
                            @include('branch::components.branch_select', [
                                'grid_class' => 'col-lg-4',
                                'mb' => '',
                                'branch_id' => isset($admission_query) ? $admission_query->branch_id : '',
                            ])
                        @endif
                        <div class="col-lg-4">
