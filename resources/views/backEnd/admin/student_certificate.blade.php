            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($certificate))
                                {{ html()->form('PUT', route('student-certificate-update', $certificate->id))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
                            @else
                                @if (userPermission('student-certificate'))
                                    {{ html()->form('POST', route('student-certificate-store'))->attribute('class', 'form-horizontal')->attribute('enctype', 'multipart/form-data')->attribute('files', true)->open() }}
                                @endif
                            @endif
                            <div class="white-box">
                                ...
                                <div class="add-visitor">
                                    ...
                                    @if (moduleStatusCheck('Branch'))
                                        <div class="row">
                                            @include('branch::components.branch_select', [
                                                ...
                                                'mb' => 'mb-15',
                                                'branch_id' => isset($certificate) ? $certificate->branch_id : '',
                                            ])
                                        </div>
                                    @endif
                                    <div class="row ">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field{{ $errors->has('header_left_text') ? ' is-invalid' : '' }}"
                                                    type="text" name="header_left_text" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->header_left_text : old('header_left_text') }}">
                                                        ...
                                                        <div class="col">
                                                            <div class="">
                                                                <input
                                                                    ...
                                                                    autocomplete="off"
                                                                    value="{{ isset($certificate) ? date('m/d/Y', strtotime($certificate->date)) : date('m/d/Y') }}">
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            ...
                                            <span class="text-primary">
                                                [name] [dob] [present_address] [guardian] [created_at] [admission_no]
                                                [roll_no] [gender] [admission_date] [category] [cast] [father_name]
                                                [mother_name] [religion] [email] [phone] @if (moduleStatusCheck('Lms'))
                                                    [course_name]
                                                @endif
                                                @if (moduleStatusCheck('University'))
                                                    [arabic_name] [faculty] [session] [department] [academic] [semester]
                                                    [semester_label] [graduation_date]
                                                @else
                                                    [class] [section]
                                                @endif
                                            </span>
                                            @if (moduleStatusCheck('Lms'))
                                                <code class="d-block">For Lms Certificate make take the [name] and
                                                    [course_name] variable</code>
                                            @endif
                                        </div>
                                        <div class="col-lg-6 mt-20">
                                            <div class="primary_input">
                                                <label for="font_size">@lang('admin.body_font') <span
                                                ...
                                                <select class="primary_select form-control" name="body_font_family" id="font-family">
                                                    ...
                                                    @php
                                                        $selectedFont = old('body_font_family') ?? ($certificate->body_font_family ?? '');
                                                    @endphp

                                                    <option value="Arial" {{ $selectedFont == 'Arial' ? 'selected' : '' }}>Arial</option>
                                                    <option value="Arial Black" {{ $selectedFont == 'Arial Black' ? 'selected' : '' }}>Arial Black</option>
                                                    <option value="Pinyon Script" {{ $selectedFont == 'Pinyon Script' ? 'selected' : '' }}>Pinyon Script</option>
                                                    <option value="Comic Sans MS" {{ $selectedFont == 'Comic Sans MS' ? 'selected' : '' }}>Comic Sans MS</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mt-20">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field{{ $errors->has('body_font_size') ? ' is-invalid' : '' }} body_font_size"
                                                    type="text" name="body_font_size" placeholder="Ex: 2em"
                                                    autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->body_font_size : old('body_font_size') }}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                @if ($errors->has('body_two'))
                                                    <span
                                                        class="error text-danger">{{ $errors->first('body_two') }}</span>
                                                @endif
                                            </div>
                                            <span class="text-primary">
                                                [name] [dob] [present_address] [guardian] [created_at] [admission_no]
                                                [roll_no] [gender] [admission_date] [category] [cast] [father_name]
                                                [mother_name] [religion] [email] [phone]
                                                @if (moduleStatusCheck('University'))
                                                    [arabic_name] [faculty] [session] [department] [academic] [semester]
                                                    [semester_label] [graduation_date]
                                                @else
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field{{ $errors->has('footer_left_text') ? ' is-invalid' : '' }}"
                                                    type="text" name="footer_left_text" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->footer_left_text : old('footer_left_text') }}">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field{{ $errors->has('footer_center_text') ? ' is-invalid' : '' }}"
                                                    type="text" name="footer_center_text" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->footer_center_text : old('footer_center_text') }}">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field{{ $errors->has('footer_right_text') ? ' is-invalid' : '' }}"
                                                    type="text" name="footer_right_text" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->footer_right_text : old('footer_right_text') }}">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12 mb-20">
                                            ...
                                            @php
                                                $selectedLayout = old('layout') ?? ($certificate->layout ?? '');
                                            @endphp
                                            ...
                                            <select
                                                ...
                                                name="layout"
                                                id="layout">
                                                <option data-display="{{ _trans('certificate.Page Layout') }} *" value="">
                                                    {{ _trans('certificate.Page Layout') }} *
                                                </option>
                                                <option value="1" {{ $selectedLayout == 1 ? 'selected' : '' }}>
                                                    {{ _trans('certificate.A4 (Portrait)') }}
                                                </option>
                                                <option value="2" {{ $selectedLayout == 2 ? 'selected' : '' }}>
                                                    {{ _trans('certificate.A4 (Landscape)') }}
                                                </option>
                                                <option value="3" {{ $selectedLayout == 3 ? 'selected' : '' }}>
                                                    {{ _trans('certificate.Custom') }}
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field{{ $errors->has('height') ? ' is-invalid' : '' }} certificate_height"
                                                    type="text" name="height" placeholder="@lang('admin.height')"
                                                    autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->height : old('height') }}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field{{ $errors->has('width') ? ' is-invalid' : '' }} certificate_width"
                                                    type="text" name="width" placeholder="@lang('admin.width')"
                                                    autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->width : old('width') }}">
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12 d-flex align-items-center">
                                            ...
                                            <div class="d-flex radio-btn-flex ml-40">
                                                <div class="mr-30">
                                                    <input type="radio" name="student_photo" id="relationFather"
                                                        value="1" class="common-radio relationButton"
                                                        {{ isset($certificate) ? ($certificate->student_photo == 1 ? 'checked' : '') : 'checked' }}>
                                                    <label for="relationFather">@lang('common.yes')</label>
                                                </div>
                                                <div class="mr-30">
                                                    <input type="radio" name="student_photo" id="relationMother"
                                                        value="0" class="common-radio relationButton"
                                                        {{ isset($certificate) ? ($certificate->student_photo == 0 ? 'checked' : '') : '' }}>
                                            ...
                                            <div class="primary_input">
                                                <div class="primary_file_uploader">
                                                    <input class="primary_input_field" type="text"
                                                        id="placeholderInput"
                                                        placeholder="{{ isset($certificate) ? ($certificate->file != '' ? getFilePath3($certificate->file) : trans('common.image') . ' *') : trans('common.image') . ' (1100 X 850)px *' }}"
                                                        readonly>
                                    ...
                                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            @foreach ($certificates as $certificate)
                                                <tr>
                                                    @if (moduleStatusCheck('Branch'))
                                                    <td>{{ @$certificate->branch?->branch_name }}</td>
                                                    @endif
                                                    <td><a class="text-color" data-toggle="modal"
                                                            data-target="#showCertificateModal{{ @$certificate->id }}"
                                                            href="#">{{ @$certificate->name }}</a></td>
                                                    <td>
                                                        @if (@$certificate->file)
                                                    ...
                                                    <td>
                                                        <button type="button"
                                                            class="primary-btn small fix-gr-bg text-nowrap">
                                                            {{ @$certificate->default_for }}
                                                        </button>
                                                    </td>
                                                    <td>
                                                        <x-drop-down>
                                                            @if(userPermission('student-certificate-view'))
                                                            ...
                                                            @if (userPermission('student-certificate-edit'))
                                                                <a class="dropdown-item"
                                                                    href="{{ route('student-certificate-edit', @$certificate->id) }}">@lang('common.edit')</a>
                                                            @endif
                                                            @if (userPermission('student-certificate-edit') && moduleStatusCheck('Lms'))
                                                                @if (@$certificate->default_for == null)
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('student-certificate-set-default', [@$certificate->id, 'course']) }}">
                                                                        {{ _trans('lms.Make Default(Course)') }}
                                                                    </a>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('student-certificate-set-default', [@$certificate->id, 'quiz']) }}">
                                                                        {{ _trans('lms.Make Default(Quiz)') }}
                                                                    </a>
                                                                @else
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('student-certificate-reset-default', @$certificate->id) }}">
                                                            ...
                                                            @if (userPermission('student-certificate-delete'))
                                                                <a class="dropdown-item" data-toggle="modal"
                                                                    data-target="#deleteSectionModal{{ @$certificate->id }}"
                                                ...
                                                <div class="modal fade admin-query"
                                                    id="deleteSectionModal{{ @$certificate->id }}">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    ...
                                                                    {{ html()->form('DELETE', route('student-certificate-delete', $certificate->id))->attribute('enctype', 'multipart/form-data')->open() }}
                                                                ...
                                                                <div class="mx-3 my-2 student-certificate">
                                                                    <div class="row justify-content-center">
                                                                        ...
                                                                        <div class="text-center certificate-position">
                                                                            <div>
                                                                                <div
                                                                                    class="row justify-content-lg-between mb-5">
                                                                                    <div class="col-md-5">
                                                                                        <p class="m-0">
