            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($certificate))
                                {{ html()->form('POST', route('student-certificate-update'))->attributes([
                            ...
                            @else
                                {{ html()->form('POST', route('student-certificate-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                                ...
                                <div class="add-visitor">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <select
                                                        ...
                                                        name="type" id="lmsCertificateType">
                                                        <option data-display="@lang('admin.certificate') @lang('admin.type')*"
                                                            value="">@lang('admin.certificate') @lang('common.select')*</option>
                                                        <option value="School"
                                                            {{ isset($certificate) ? ($certificate->type == 'School' ? 'selected' : '') : (old('type') == 'School' ? 'selected' : '') }}>
                                                            @lang('common.school')</option>
                                                        <option value="Lms"
                                                            {{ isset($certificate) ? ($certificate->type == 'Lms' ? 'selected' : '') : (old('type') == 'Lms' ? 'selected' : '') }}>
                                                            @lang('lms::lms.lms')</option>
                                                    </select>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <input class="primary_input_field " type="text" name="title"
                                                    autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->title : old('title') }}"
                                                    id="certificateTitle">
                                                <label class="primary_input_label" for="">@lang('admin.certificate_title') <span
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('background_height') ? ' is-invalid' : '' }}"
                                                    type="text" name="background_height" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->background_height : 144 }}"
                                                    id="bgHeight">
                                                <label class="primary_input_label" for="">@lang('admin.certificate_height') (mm)
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('background_width') ? ' is-invalid' : '' }}"
                                                    type="text" name="background_width" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->background_width : 165 }}"
                                                    id="bgwidth">
                                                <label class="primary_input_label" for="">@lang('admin.certificate_weight') (mm)
                                                    <span class="text-danger"> *</span></label>
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('padding_top') ? ' is-invalid' : '' }}"
                                                    type="text" name="padding_top" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->padding_top : old('padding_top', 5) }}"
                                                    id="paddingTop">
                                                <label class="primary_input_label" for="">@lang('admin.padding_top')
                                                    (mm)</label>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('padding_right') ? ' is-invalid' : '' }}"
                                                    type="text" name="padding_right" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->padding_right : old('padding_right', 5) }}"
                                                    id="paddingRight">
                                                <label class="primary_input_label" for="">@lang('admin.padding_right')
                                                    (mm)</label>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('padding_bottom') ? ' is-invalid' : '' }}"
                                                    type="text" name="padding_bottom" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->padding_bottom : old('padding_bottom', 5) }}"
                                                    id="paddingBottom">
                                                <label class="primary_input_label" for="">@lang('admin.padding_bottom')
                                                    (mm)</label>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ $errors->has('pading_left') ? ' is-invalid' : '' }}"
                                                    type="text" name="pading_left" autocomplete="off"
                                                    value="{{ isset($certificate) ? $certificate->pading_left : old('pading_left', 5) }}"
                                                    id="paddingLeft">
                                                <label class="primary_input_label" for="">@lang('admin.pading_left')
                                                    (mm)</label>
                                    ...
                                    <div class="d-flex mt-25">
                                        <div
                                            class="row flex-grow-1 d-flex justify-content-between input-right-icon no-gutters">
                                            <div class="col">
                                                <div class="primary_input">
                                                    <input
                                                        class="primary_input_field form-control{{ $errors->has('background_image') ? ' is-invalid' : '' }}"
                                                        type="text" id="certificateBackgroundImage"
                                                        placeholder="{{ isset($certificate) ? ($certificate->background_image != '' ? getFilePath3($certificate->background_image) : trans('admin.background_image')) : trans('admin.background_image') }}"
                                                        readonly>
                                            ...
                                            <div class="col-auto">
                                                <button class="primary-btn-small-input cust-margin" type="button">
                                                    <label class="primary-btn small fix-gr-bg"
                                                        for="certificateBackGroundImage">@lang('common.browse')</label>
                                                    <input type="file" class="d-none" name="background_image"
                                                        id="certificateBackGroundImage"
                                                        onchange="certificateBackground(this)"
                                                        value="{{ isset($certificate) ? ($certificate->background_image != '' ? getFilePath3($certificate->background_image) : '') : '' }}">
                                                </button>
                                            </div>
                                        </div>
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($roles as $role)
                                                        <option value="{{ $role->id }}"
                                                            {{ isset($certificate) && $certificate->role == $role->id ? 'selected' : '' }}>
                                                            {{ $role->name }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="primary_input mt-20">
                                                <label class="primary_input_label" for="">@lang('communicate.body')<span
                                                        class="text-danger"> *</span></label>
                                                ...
                                                @if ($errors->has('body'))
                                                    <span
                                                        class="error text-danger">{{ $errors->first('body') }}</strong></span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-40">
                                            ...
                                            <h4>
                                                ...
                                                <span class="text-primary">
                                                    @if (moduleStatusCheck('University'))
                                                        ...
                                                        [admission_no] [roll_no] [faculty] [session] [department] [academic]
                                                        [semester] [semester_label] [gender] [admission_date]
                                                        [category] [cast] [father_name] [mother_name] [religion] [email]
                                                        [phone]
                                                    @else
                                                        [name] [date_of_birth] [present_address] [guardian] [created_at]
                                        ...
                                        <div class="col-lg-12 parentVariable d-none">
                                            <h4>
                                                <strong>@lang('communicate.variables') :</strong>
                                                <span class="text-primary">
                                                    [parent_name] [parent_mobile] [parent_email] [parent_occupation]
                                                    [parent_address],
                                                    </br>
                                                    @lang('admin.use') [profile_image] @lang('admin.variable_for_showing_static_profile_image')
                                                </span>
                                        ...
                                        <div class="col-lg-12 staffVariable d-none">
                                            <h4>
                                                <strong>@lang('communicate.variables') :</strong>
                                                <span class="text-primary">
                                                    [staff_name] [dob] [present_address] [date_of_joining] [email] [mobile]
                                                    [qualification]
                                                    [experience],
                                                    </br>
                                                    @lang('admin.use') [profile_image] @lang('admin.variable_for_showing_static_profile_image')
                ...
                <div class="col-lg-5">
                    ...
                    <div class="sticky_card">
                        ...
                        <div class="mt-10">
                            <div class="certificate_box_wrapper" id='showCertificatePreview'
                                style="background-image: url('{{ isset($certificate) ? assetPath($certificate->background_image) : '' }}');">
...
@push('scripts')
    <script>
        ...
        function showbgHeight(bgHeightPass) {
            $(".certificate_box_wrapper").css({
                "height": bgHeightPass + "mm"
            });
        }

        function showbgwidth(bgWidthPass) {
            $(".certificate_box_wrapper").css({
                "width": bgWidthPass + "mm"
            });
        }

        function showPaddingTop(paddingTopPass) {
            $(".certificate_box_wrapper").css({
                "padding-top": paddingTopPass + "mm"
            });
        }

        function showPaddingRight(paddingRightPass) {
            $(".certificate_box_wrapper").css({
                "padding-right": paddingRightPass + "mm"
            });
        }

        function showPaddingLeft(paddingLeftPass) {
            $(".certificate_box_wrapper").css({
                "padding-left": paddingLeftPass + "mm"
            });
        }

        function showgPaddingBottom(paddingBottomPass) {
            $(".certificate_box_wrapper").css({
                "padding-bottom": paddingBottomPass + "mm"
            });
        }
        ...
        $('.summer_note').summernote({
            ...
            callbacks: {
                onChange: function(e) {
                    ...
                    string = string.replace("[profile_image]",
                        '<img src="http://localhost/lms/public/uploads/staff/demo/staff.jpg" height="165px" width="165px"> '
                        );
