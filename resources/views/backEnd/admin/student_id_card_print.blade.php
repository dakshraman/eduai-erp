				...
				<div class="student-details">
					<div class="student-meta-box">
						<div class="position-relative">
							<img class="w-100 img-fluid" src="{{assetPath('public/backEnd/img/student/id-card-bg.png')}}">
							<h3 class="" style="position:absolute; left: 20px; top: 45px; color: #fff">@lang('common.view_student_id_card')</h3>
						</div>
						<!-- <div class="text-center p-3">
							<img class="img-fluid" src="{{assetPath('public/backEnd/img/student/student-id-bg.png')}}">
						</div> -->

						<div class="p-3 radius-t-y-0 pb-4" style="border:1px solid #ddd">
							<div class="text-center mb-4">
								<img class="img-180" src="{{assetPath('public/backEnd/img/student/id-card-img.jpg')}}" alt="">
							</div>
                            ...
                            <div class="single-meta">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div style="clear:both"></div>
                                    <div style="float: right">
                                        <img class="img-fluid" src="{{assetPath($id_card->signature)}}">
                                    </div>
                                    <div style="clear:both"></div>
                                </div>
                            </div>
                            ...
                            <div class="bottom-part text-center mt-5">
                                <img class="img-fluid w-25" src="{{assetPath($id_card->logo)}}">
