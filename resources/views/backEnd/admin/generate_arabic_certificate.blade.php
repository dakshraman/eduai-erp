...
@foreach($students as $student)
    ...
    @php
        $body = App\Models\SmStudentCertificate::certificateBody($certificate->body, 2,$student->student->id,$certificate->id);
        
        $body_two = App\Models\SmStudentCertificate::certificateBody($certificate->body_two, 2,$student->student->id,$certificate->id);
        $graduate_date = null;
        if(moduleStatusCheck('Alumni') == true){
            $graduate_date = $student->alumni->graduation_date;
        }
        $certificateNumber = App\Models\SmStudentCertificate::certificateNumber($certificate->certificate_no,$student->studentDetail->admission_no, $graduate_date);
        ...
        <tr>
            ...
            <td style="width: 15%;text-align: center;">
                <div style=" margin-left: auto;">
                    <img src="{{ assetPath(generalSetting()->logo) }}" alt="" style="width: 100%;height: 100%;">
                </div>
            </td>
            <td style="font-size: 18px; font-weight: 700; text-align: center;width: 35%;text-transform: uppercase;">كلية
                المقاصد الجامعية
            </td>
        </tr>
        <tr>
