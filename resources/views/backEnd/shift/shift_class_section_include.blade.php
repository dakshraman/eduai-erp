        ...
        <div class="primary_input " id="common_select_academic_div">
            ...
            <select
                ...
                @foreach (academicYears() as $session)
                    ...
                    <option value="{{ $session->id }}"
                            {{ old($academic_year_name, $academic_year ?? getAcademicId()) == $session->id ? 'selected' : '' }}>
                ...
                @if (isset($classes))
                    @foreach ($classes as $class)
                        ...
                        <option value="{{ $class->id }}"
                                {{ old($class_name, $class_id ?? '') == $class->id ? 'selected' : '' }}>
                            {{ $class->class_name }}
                        </option>
                    @endforeach
                @endif
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('change', '.for-data-get-shift-class', function () {
                ...
                var academic_id = $("#common_select_academic").length ? $("#common_select_academic").val() : '';
