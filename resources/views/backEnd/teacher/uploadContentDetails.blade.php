    ...
    <div class="student-details">
                        ...
                        <div class="col-lg-5">
                            <div class="name">
                                @if(isset($ContentDetails))
                                    ...
                                    @endif
                                    @if ( moduleStatusCheck('Branch') && $ContentDetails->branch != "")
                                        <p>@lang('common.branch'): {{$ContentDetails->branch->branch_name}}</p>
                                    @endif
                                    ...
                                    @endif
                                    @if ($ContentDetails->shift != "")
                                        <p>@lang('common.shift') : {{ @$ContentDetails->shift?->name }}</p>
                                    @endif
                                @endif
                            </div>
                        </div>
        ...
        @endphp
            ...
            <div class="mt-40 d-flex justify-content-between">
                ...
                @endphp
                <a class="primary-btn tr-bg" download="{{$set_filename}}" href="{{assetPath($attached_file)}}"> <span class="pl ti-download"> @lang('common.download')</span></a>
