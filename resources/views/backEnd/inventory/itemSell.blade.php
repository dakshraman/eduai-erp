...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        ...
        {{ html()->form('POST', route('save-item-sell-data'))->attributes([
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-30">
                                    ...
                                    <select class="primary_select  form-control{{ $errors->has('income_head_id') ? ' is-invalid' : '' }}" name="income_head_id" id="income_head_id">
                                        ...
                                        <option value="{{$sell_head->id}}" {{ old('income_head_id') == $sell_head->id ? 'selected' : '' }}>{{$sell_head->head}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-12 mb-30">
                                    ...
                                    <select class="primary_select  form-control" name="payment_method" id="item_sell_payment_method_id">
                                        ...
                                        @foreach($paymentMethhods as $key=>$value)
                                            <option data-string="{{$value->method}}" value="{{$value->id}}" {{ old('payment_method') == $value->id ? 'selected' : '' }}>{{$value->method}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-12 mb-30 d-none" id="add_item_sell_bankAccount">
                                    <div class="primary_input">
                                        ...
                                        <option value="{{$value->id}}" {{ old('bank_id') == $value->id ? 'selected' : '' }}>{{$value->account_name}} ({{$value->bank_name}})</option>
                                        @endforeach
                                        @endif
                                        </select>
                                ...
                                <div class="col-lg-12 mb-30" id="selectStaffsDiv">
                                    ...
                                    <select class="primary_select  form-control{{ $errors->has('staff_id') ? ' is-invalid' : '' }}" name="staff_id" id="selectStaffs">
                                        ...
                                        <option value="{{$value->id}}" {{ old('staff_id', @$editData->staff_id) == $value->id ? 'selected' : '' }}>{{$value->full_name}}</option>
                                        @endforeach
                                        @else
                                ...
                                <div class="col-lg-12 mb-30">
                                    ...
                                    <div class="primary_input">
                                        ...
                                        type="text" name="reference_no" autocomplete="off" value="{{isset($editData)? $editData->reference_no : old('reference_no') }}">
             ...
             <div class="white-box">
                <div class="alert alert-danger" id="errorMessage2">
                 ...
                 <table class="table" id="productTable">
                    <thead>
                      <tr>
                          <th> @lang('inventory.product_name')  <span class="text-danger"> *</span></th>
                          <th> @lang('inventory.sell_price')  <span class="text-danger"> *</span></th>
                          <th> @lang('inventory.quantity')  <span class="text-danger"> *</span></th>
