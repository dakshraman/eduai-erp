       ...
       <div class="row">
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-lg-12">
                        @if(isset($editData))
                        {{ html()->form('PUT', route('item-store-update', $editData->id))->attributes([
                        ...
                        @else
                         @if(userPermission("item-store-store"))
                         {{ html()->form('POST', route('item-store-store'))->attributes([
                            'class' => 'form-horizontal',
                            'files' => true,
                            'enctype' => 'multipart/form-data',
                        ])->open() }}                        
                                ...
                                <div class="row">                                 
                                    ...
                                    <div class="col-lg-12 mb-15">
                                        <div class="primary_input">
                                            ...
                                            type="text" name="store_name" autocomplete="off" value="{{isset($editData)? $editData->store_name : old('store_name') }}">
                                     ...
                                     <div class="col-lg-12 mb-15">
                                        <div class="primary_input">
                                            ...
                                            type="text" name="store_no" autocomplete="off" value="{{isset($editData)? $editData->store_no : old('store_no') }}">
