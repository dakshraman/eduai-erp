                            ...
                            <div class="col-lg-4">
                                <div class="invoice-details-left">
                                    <div class="mb-20">
                                        ...
                                        <label>
                                            <img src="{{ assetPath($general_setting->logo)}}" alt="">
                                        </label>
                                        @else
                                        <label for="companyLogo" class="company-logo">
                                            <i class="ti-image"></i> 
                                            <img src="{{ assetPath('public/uploads/settings/logo.png')}}" alt="">
                                        </label>
                                ...
                                <table class="d-table table-responsive custom-table" cellspacing="0" width="100%">
                                    ...
                                    @foreach($editDataChildren as $value)
                                        <tr>
                                            ...
                                            <td>{{currency_format( (float) $value->sell_price)}}</td>
                                            <td>{{currency_format( (float) $value->sub_total)}}</td>
                                        </tr>
                                    ...
                                    @endif
                                        ...
                                        <tr>
                                            ...
                                            <td>{{currency_format( (float) $sub_totals)}}</td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            ...
                                            <td class="fw-600">
                                            {{(isset($viewData)) ? currency_format( (float) $viewData->total_paid) : ''}}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            ...
                                            <td class="fw-600">
                                            {{(isset($viewData)) ? currency_format( (float) $viewData->total_due) : ''}}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
