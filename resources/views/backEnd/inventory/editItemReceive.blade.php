...
@section('mainContent')
    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            @if (isset($editData))
            {{ html()->form('POST', route('update-edit-item-receive-data', $editData->id))->attributes([
                                ...
                                <table class="table" id="productTable">
                                                    ...
                                                    <td>
                                                        <div class="primary_input">
                                                            <input
                                                                ...
                                                                type="number" step="{{inputStep()}}" id="unit_price{{ $i }}"
                                                                name="unit_price[]" autocomplete="off"
                                                                value="{{ isset($editDataChildren) ? decimal_only($editDataValue->unit_price) : '' }}"
                                                    ...
                                                    <td>
                                                        <div class="primary_input">
                                                            <input
                                                                ...
                                                                type="number" name="total[]" step="{{inputStep()}}"
                                                                id="total{{ $i }}" autocomplete="off"
                                                                value="{{ isset($editDataChildren) ? decimal_only($editDataValue->sub_total) : '' }}">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>
                                                <input type="number" step="{{inputStep()}}" class="primary_input_field form-control"
                                                    id="subTotal" name="subTotal" placeholder="{{decimal_only(0)}}" readonly=""
                                                    value="{{ decimal_only($grand_total) }}" />

                                                <input type="hidden" class="form-control" id="subTotalValue"
                                                    name="subTotalValue" step="{{inputStep()}}"
                                                    value="{{ decimal_only($grand_total) }}" />
                            ...
                            > Full Paid
                             -->
                                    ...
                                    <div class="col-lg-4 mt-30-md">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <input class="primary_input_field" type="number" step="{{inputStep()}}" name="totalPaid"
                                                    id="totalPaid" onkeyup="paidAmount();" 
                                                    value="{{ isset($editData) ? decimal_only($editData->total_paid) : '' }}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <input class="primary_input_field" type="number" step="{{inputStep()}}"
                                                    value="{{ isset($editData) ? decimal_only($editData->total_due) : '' }}"
                                                    id="totalDue" readonly>
                                                <input type="hidden" id="totalDueValue" name="totalDueValue" step="{{inputStep()}}"
                                                    value="{{ isset($editData) ? decimal_only($editData->total_due) : '' }}">
                                                <label class="primary_input_label"
...
@push('script')
    <script>
        (function() {
            let rowIndex = $('#productTable tbody > tr[id^="row"]').length || 1;
            ...
            window.addRow = function() {
                ...
                const row = `
                    <tr id="row${rowIndex}">
                        ...
                        <td>
                            <div class="primary_input">
                                <input class="primary_input_field form-control" type="number" step="{{ inputStep() }}"
                                    id="unit_price${rowIndex}" name="unit_price[]" autocomplete="off">
                            </div>
                        </td>
                        <td>
                            <div class="primary_input">
                                <input class="primary_input_field form-control" type="text" id="quantity${rowIndex}"
                                    name="quantity[]" autocomplete="off">
                            </div>
                        </td>
                        <td>
                            <div class="primary_input">
                                <input class="primary_input_field form-control" type="number" step="{{ inputStep() }}"
                                    name="total[]" id="total${rowIndex}" autocomplete="off" value="{{ decimal_only(0) }}" readonly>
                            </div>
            ...
            $(document).on('click', '.delete-item-receive-row, #productTable button[type="button"]', function() {
