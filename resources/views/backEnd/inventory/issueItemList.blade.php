            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($editData))
                                {{ html()->form('PUT', route('holiday-update', $editData->id))->attributes([
                            ...
                            @else
                                @if (userPermission('save-item-issue-data'))
                                    {{ html()->form('POST', route('save-item-issue-data'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mb-15">
                                            <label class="primary_input_label" for="">@lang('common.role') <span
                                                        class="text-danger"> *</span> </label>
                                            <select
                                                    class="primary_select  form-control{{ $errors->has('role_id') ? ' is-invalid' : '' }}"
                                                    name="role_id" id="member_type">
                                                <option data-display=" @lang('inventory.user_type') *"
                                                        value="">@lang('inventory.user_type')
                                                    *
                                                </option>
                                        ...
                                        <div class="forStudentWrapper col-lg-12">
                                            <div class="row">
                                                @include('backEnd.common.search_criteria', [
                                                    ...
                                                    'selected' => [
                                                        'class_id' => old("class"),
                                                        'section_id' => old("student"),
                                                        'shift_id' => old("shift"),
                                                        'student_id' => old("student"),
                                                    ],
                                                ])
                                                {{-- <div class="col-lg-12 mb-15">
                                        ...
                                        <div class="col-lg-12 mb-15" id="selectStaffsDiv">
                                            <label class="primary_input_label" for="">@lang('inventory.issue_to')
                                                <span></span> </label>
                                            <select
                                                    class="primary_select  form-control{{ $errors->has('staff_id') ? ' is-invalid' : '' }}"
                                                    name="staff_id" id="selectStaffs">
                                                <option data-display="@lang('inventory.issue_to')"
                                                        value="">@lang('inventory.issue_to')
                                                </option>
                                    ...
                                    <div class="row mb-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('inventory.issue_date')
                                    ...
                                    <div class="row mb-15">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('inventory.due_date')
                                                    <span class="text-danger"> *</span> </label>
                                                <div class="primary_datepicker_input">
                                                    <div class="no-gutters input-right-icon">
                                                        <div class="col">
                                    ...
                                    <div class="row ">
                                        <div class="col-lg-12 mb-15">
                                            <label class="primary_input_label" for="">@lang('inventory.category') <span
                                                        class="text-danger"> *</span> </label>
                                            <select
                                        ...
                                        <div class="col-lg-12 mb-15">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('inventory.quantity')
                                                    <span class="text-danger"> *</span> </label>
                                                <input
                                        ...
                                        <div class="col-lg-12 mb-15">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('inventory.note')
                                                    <span></span> </label>
                                    ...
                                    <div class="row mt-40">
                                        <div class="col-lg-12 text-center">
                                            <button class="primary-btn fix-gr-bg submit issuedSubmit"
                                                    data-toggle="tooltip"
                                                    title="{{ $tooltip }}">
                                        ...
                                        @if (isset($issuedItems))
                                            @foreach ($issuedItems as $key => $value)
                                                <tr>
                                                    ...
                                                    @if ($value->role_id == 2)
                                                        @php
                                                            $getMemberDetail = App\Models\SmStudent::find($value->issue_to);
                                                        @endphp
                                                    @else
                                                        @php
                                                            $getMemberDetail = App\Models\SmBook::getMemberStaffsDetails($value->issue_to);
                                                        @endphp
                                                    @endif
