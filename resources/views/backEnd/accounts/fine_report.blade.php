        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        {{ html()->form('POST', route('fine-report-search'))->attributes([
                        ...
                        <div class="row">
                            ...
                            @else
                                <div class="{{shiftEnable() ? 'col-md-3' : 'col-md-6'}}">
                                    <input placeholder="" class="primary_input_field primary_input_field form-control"
                                        type="text" name="date_range" value="">
                                </div>
                            ...
                            <div class="col-lg-12">
                                <table id="table_id_al" class="table" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($fine_info as $fees_payment)
                                            @if ($fees_payment->fine > 0)
                                                <tr>
                                                    ...
                                                    <td>{{ $fees_payment->studentInfo != null ? $fees_payment->studentInfo->full_name : '' }}</td>
                                                    {{-- <td>
                                                        @if ($fees_payment->studentInfo != null && $fees_payment->studentInfo->class != null)
                                                            {{ $fees_payment->studentInfo->class->class_name }}
                                                        @endif
                                                    </td> --}}
                                                    <td>{{ $fees_payment->feesType != null ? $fees_payment->feesType->name : '' }}</td>
