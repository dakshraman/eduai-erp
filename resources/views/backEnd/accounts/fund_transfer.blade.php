            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('fund-transfer-store'))->attributes([
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <input
                                                ...
                                                type="number" name="amount" step="{{ inputStep() }}" autocomplete="off"
                                                value="{{ old('amount') }}">
                                        ...
                                        <div class="CustomPaymentMethod d-flex mb-2">
                                            <div class="primary_input custom-transfer-account  d-flex">
                                                ...
                                                <label style="margin-left: 10px; margin-top: 8px;"
                                                    ...
                                                    @php
                                                        $total =
                                                            $payment_method->IncomeAmount -
                                                            $payment_method->ExpenseAmount;
                                                    @endphp
                                                    @if ($payment_method->method != 'Bank')
                                                        ({{ currency_format($total) }})
                                                    @else
                                                        ({{ currency_format($bank_amount) }})
                                                    @endif
                                                </label>
                                            </div>
                                            @if ($payment_method->method == 'Bank')
                                                    ...
                                                    @foreach ($bank_accounts as $bank_account)
                                                        <div class="primary_input custom-transfer-account mb-10">
                                                            ...
                                                            <label
                                                                ...
                                                                ({{ currency_format($bank_account->current_balance) }})
                                                            </label>
                                                        </div>
                                                    @endforeach
                                                </div>
                                        ...
                                        <div class="CustomPaymentMethod d-flex mb-2">
                                            <div
                                                ...
                                                <input style="bottom: 5px" type="radio" name="to_payment_method"
                                                    ...
                                                    value="{{ $payment_method->id }}" class="common-radio toRelation">
                                                <label style="margin-left: 10px; margin-top: 8px;"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($transfers as $transfer)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ currency_format($transfer->amount) }}</td>
