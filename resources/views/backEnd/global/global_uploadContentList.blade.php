                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if (isset($editData))
                                {{ html()->form('POST', route('global-update-upload-content', @$editData->id))->attributes([
                            ...
                            @else
                                @if (userPermission(89))
                                    {{ html()->form('POST', route('global-save-upload-content'))->attributes([
                                            'class' => 'form-horizontal',
                                            'files' => true,
                                            'enctype' => 'multipart/form-data',
                                        ])->open() }}
                                        ...
                                        @if (isset($uploadContents))
                                            @foreach ($uploadContents as $key => $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (@$value->globalClasses != '' && $value->globalSections != '')
                                                            ...
                                                            ({{ @$value->globalClasses->class_name . '->' . @$value->globalSections->section_name }})
                                                        @endif
                                                        @if (@$value->classes != '' && $value->section == null)
                                                            @lang('study.all_students_of') ({{ @$value->classes->class_name . '->' }}
                                                    ...
                                                    <td>
                                                        ...
                                                        @php
                                                            $routeList = [
                                                                '<a data-modal-size="modal-lg" title="' .
                                                                __('study.view_content_details') .
                                                                '" class="dropdown-item modalLink" href="' .
                                                                route('global-upload-content-view', $value->id) .
                                                                '">' .
                                                                __('common.view') .
                                                                '</a>',
                                                                moduleStatusCheck('VideoWatch') == true
                                                                    ? '<a class="dropdown-item" href="' .
                                                                        url('videowatch/view-log/' . $value->id) .
                                                                        '">' .
                                                                        __('study.seen') .
                                                                        '</a>'
                                                                    : null,
                                                                ...
                                                                '<a class="dropdown-item" href="' .
                                                                route('global-upload-content-edit', $value->id) .
                                                                '">' .
                                                                __('common.edit') .
                                                                '</a>',

                                                                userPermission(91)
                                                                    ? '<a class="dropdown-item" data-toggle="modal" data-target="#deleteApplyLeaveModal' .
                                                                        $value->id .
                                                                        '" href="#">' .
                                                                        __('common.delete') .
                                                                        '</a>'
                                                ...
                                                <div class="modal fade admin-query"
                                                    id="deleteApplyLeaveModal{{ @$value->id }}">
