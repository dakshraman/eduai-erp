...
<style>
    ...
    <section class="bradcrumb_area" style="background-image:url('{{ assetPath($news->image) }}')">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="blog_details">
                                    <div class="blog_details_img"><img src="{{ assetPath($news->image) }}" alt="{{$news->news_title}}"></div>
