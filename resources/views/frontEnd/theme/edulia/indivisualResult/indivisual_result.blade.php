        ...
        <div class="marksheet_container" id="print_sheet">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 order-3 order-md-1 text-center text-md-start">
                    <img src="{{ file_exists(@$studentDetails->studentDetail->student_photo) ? $studentDetails->studentDetail->student_photo) : 'public/uploads/staff/demo/staff.jpg') }}"
                ...
                <div
                    ...
                    <img src="{{ generalSetting()->logo) }}" alt="{{ generalSetting()->school_name }}"
            ...
            <div class="row my-3 student_info_section">
                <div class="col-md-7 col-lg-8">
                    <ul>
                        <li><span class="student_info_type">@lang('edulia.students_name')</span><span
                                    class="info_separetor">:</span><b
                                    class="text-uppercase">{{ $student_detail->studentDetail->full_name }}</b></li>
                        <li><span class="student_info_type">@lang('edulia.fathers_name')</span><span
                                    class="info_separetor">:</span><b
                                    class="text-uppercase">{{ $student->parents->fathers_name }}</b></li>
                        <li><span class="student_info_type">@lang('edulia.mothers_name')</span><span
                                    class="info_separetor">:</span><b
                                    class="text-uppercase">{{ $student->parents->mothers_name }}</b>
                        </li>
                        <li><span class="student_info_type">@lang('edulia.students_id')</span><span
                                    class="info_separetor">:</span><b>{{ @$student_detail->student->admission_no }}</b>
                        </li>
                ...
                <div class="col-md-5 col-lg-4">
                    <ul>
                        ...
                        <li><span class="student_info_type">@lang('edulia.group')</span><span
                                    class="info_separetor">:</span><b
                        ...
                        <li><span class="student_info_type">@lang('edulia.publish_date')</span><span
                                    class="info_separetor">:</span><b>{{ dateConvert($exam_content?->publish_date) }}</b>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <table class="w-100 table-bordered marksheet_table">
                        ...
                        <tr>
                            ...
                            <td>
                                @if (@$generalsettingsResultType == 'mark')
                                    ...
                                    @php $total_total_full_mark+= subject100PercentMark(); @endphp
                                @else
                            ...
                            <td>
                                @if (@$generalsettingsResultType == 'mark')
                                    @php
                                        $single_mark = singleSubjectMark($data->student_record_id, $data->subject_id, $data->exam_type_id)[0] ?? 0;
                                        $total_total_obtained_mark+=$single_mark;
                                    @endphp
                                    {{ $single_mark }}
                                @else
                    ...
                    @php
                        ...
                        if (in_array($failgpaname->grade_name, $temp_grade)) {
                            ...
                            if ($final_result >= $maxGrade) {
                                $grade_details = \App\Models\SmResultStore::remarks($maxGrade);
                            } else {
                                $grade_details = \App\Models\SmResultStore::remarks($final_result);
                            }
                        }
                    @endphp
                    <tr class="total">
            ...
            <div class="row mt-3">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="table-responsive">
                        <table class="table-bordered w-100 final_result">
                            ...
                            <tr>
                                ...
                                <td width="5%">{{ @$grade_details ? $gpa : "0" }}</td>
                                <td width="15%">@lang('edulia.grade')</td>
                                <td width="5%">{{ @$grade_details->grade_name ?? "F" }}</td>
                    ...
                    <div class="remarks mt-3">
                        @if (@$grade_details && $grade_details->grade_name != "F")
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-sm-4 text-center">
                                <div class="soft_signature_area w-75">
                                    <img class="mb-2" src="{{ $exam_content->file) }}" width="100px"
                                         alt="">
                                </div>
