...
<head>
    ...
    <link rel="icon" href="{{assetPath('public/landing/img/favicon.png')}}">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{assetPath('public/landing/css/bootstrap.min.css')}}">
    <!-- animate CSS -->
    <link rel="stylesheet" href="{{assetPath('public/landing/css/animate.css')}}">
    <!-- themify CSS -->
    <link rel="stylesheet" href="{{assetPath('public/landing/css/themify-icons.css')}}">
    <link rel="stylesheet" href="{{assetPath('public/backEnd/')}}/vendors/css/font-awesome.min.css"/>
    <!-- font awesome CSS -->
    <link rel="stylesheet" href="{{assetPath('public/landing/css/magnific-popup.css')}}">
    <!-- style CSS -->
    <link rel="stylesheet" href="{{assetPath('public/landing/css/style.css')}}">
            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="{{url('/')}}">
                        <img src="{{assetPath('public/landing/img/logo.png')}}" alt="logo"> </a>
        ...
        <div class="row align-items-center">
            <div class="col-md-7 col-lg-7">
                <div class="video_section_img">
                    ...
                    <!-- <img src="{{assetPath('public/landing/img/vodeo_bg.png')}}" alt=""> -->
            ...
            <div class="col-md-5 col-lg-5">
                <div class="video_section_text">
                    ...
                    <img src="{{assetPath('public/landing/img/Line.png')}}" alt="">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="dashboard_img">
                    ...
                    <img src="{{assetPath('public/landing/img/dashboard_preview.png')}}" alt="">
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class="single_feature">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="footer_area_text">
                    ...
                    <img src="{{assetPath('public/landing/img/logo.png')}}" alt="">
...
<!-- jquery plugins here-->
<!-- jquery -->
<script src="{{assetPath('public/landing/js/jquery-1.12.1.min.js')}}"></script>
<!-- popper js -->
<script src="{{assetPath('public/landing/js/popper.min.js')}}"></script>
<!-- bootstrap js -->
<script src="{{assetPath('public/landing/js/bootstrap.min.js')}}"></script>
<!-- easing js -->
<script src="{{assetPath('public/landing/js/jquery.magnific-popup.js')}}"></script>
<!--  -->
<script src="{{assetPath('public/landing/js/jquery.easing.min.js')}}"></script>
<!-- custom js -->
<script src="{{assetPath('public/landing/js/custom.js')}}"></script>
