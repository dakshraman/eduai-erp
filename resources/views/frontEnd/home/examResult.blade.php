                    ...
                    <div class="col-lg-4 mt-30-md md_mb_20">
                        <div class="primary_input">
                            <label class="primary_input_label" for="">@lang('exam.admission_number')<span
                                        class="text-danger"> *</span></label>
                            <input class="primary_input_field form-control{{ $errors->has('admission_number') ? ' is-invalid' : '' }}"
                                   placeholder="@lang('exam.admission_number')*" type="text"
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="report-admit-img profile_100"
                                                             style="background-image: url({{ file_exists(@$studentDetails->studentDetail->student_photo) ? assetPath($studentDetails->studentDetail->student_photo) : assetPath('public/uploads/staff/demo/staff.jpg') }})">
                                                        </div>
                                                    </div>
                                                    {{-- Start  Result Table --}}
