...
@if(isset($per["Image Banner"]) and $homePage)
    <?php
    $css = "background: linear-gradient(0deg, rgba(124, 50, 255, 0.6), rgba(199, 56, 216, 0.6)), url(" . assetPath($homePage->image) . ") no-repeat center;    background-size: cover;";
    ?>
    <style type="text/css">
                        ...
                        <div class="row">
                            @foreach($news as $value)
                                <div class="col-lg-4 col-md-6">
                                    <div class="news-item">
                                        <div class="news-img">
                                            <img class="img-fluid w-100 news-image" src="{{assetPath($value->image)}}"
                                                 alt="">
                                        </div>
                                        <div class="news-text">
                                            <p class="date">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="academic-item">
                                        <div class="academic-img">
                                            <img class="img-fluid" src="{{assetPath($academic->image)}}" alt="">
                                        </div>
                                    ...
                                    <div class="events-item">
                                        <div class="card">
                                            <img class="card-img-top" class="img-fluid"
                                                 src="{{assetPath($event->uplad_image_file)}}" alt="">
                                            <div class="card-body">
                                                <h5 class="card-title">
                                                    {{$event->event_title}}
                                                </h5>
                                    ...
                                    <div class="thumb">
                                        @if(!empty($value->image))
                                            <img class="img-fluid rounded-circle testimonial-image"
                                                 src="{{assetPath($value->image)}}" alt="">
                                        @else
                                            <img class="img-fluid rounded-circle"
                                                 src="{{assetPath('public/uploads/sample.jpg')}}" alt="">
                                        @endif
                                    </div>
