...
@section('main_content')
    ...
    <section class="container box-1420">
        <div class="banner-area" style="background: linear-gradient(0deg, rgba(124, 50, 255, 0.6), rgba(199, 56, 216, 0.6)), url({{$category_id->category_image != ""? assetPath($category_id->category_image) : '../img/client/common-banner1.jpg'}}) no-repeat center;">
                    ...
                    <div class="row all_info">
                        ...
                        <div class="col-lg-4 col-md-6 all_courses">
                            <div class="academic-item">
                                ...
                                style="background:  
                                url({{$value->image != ""? assetPath($value->image) : '../img/client/common-banner1.jpg'}})
                                            no-repeat top;">
                                </div>
