...
@section('main_content')
    ...
    <section class="container box-1420">
        <div class="banner-area" style="background: linear-gradient( 0deg, rgba(124, 50, 255, 0.6), rgba(199, 56, 216, 0.6)), url({{assetPath($news->image)}}) no-repeat center;">
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <div class="news-img">
                        <img class="img-fluid news-image" src="{{assetPath($news->image)}}" alt="{{$news->news_title}}">
                    </div>
                    <p class="mt-2">
                        {!!$news->news_body!!}
                    </p>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100 news-image" src="{{assetPath($theNews->image)}}" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">
