...
@endpush
    ...
    <section class="container box-1420">
        <div class="banner-area" style="background: linear-gradient(0deg, rgba(124, 50, 255, 0.6), rgba(199, 56, 216, 0.6)), url({{$course->image != ""? assetPath($course->image) : '../img/client/common-banner1.jpg'}}) no-repeat center;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="academic-item">
                                ...
                                style="background:  
                                url({{$course->image != ""? assetPath($course->image) : '../img/client/common-banner1.jpg'}})
                                            no-repeat top;">
                                </div>
