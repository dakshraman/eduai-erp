                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="academic-item">
                                <div class="academic-img">
                                    <img class="img-fluid" src="{{assetPath($value->image)}}" alt="">
                                </div>
            ...
            <div class="single-info row mt-40 align-items-center">
                <div class="col-lg-6 col-md-12 text-center pr-lg-0 info-left">
                    <div class="info-thumb">
                        <img src="{{assetPath($about->main_image)}}" class="img-fluid" alt="">
                    </div>
                </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="thumb">
                                    @if(!empty($value->image))
                                        <img class="img-fluid rounded-circle testimonial-image" src="{{assetPath($value->image)}}" alt="">
                                    @else
                                        <img class="img-fluid rounded-circle testimonial-image" src="{{assetPath('public/uploads/sample.jpg')}}" alt="">
                                    @endif
                                </div>
