                ...
                <div class="col-lg-3">
                    ...
                    <div class="student-meta-box">
                        ...
                        @if(!empty($staffDetails->staff_photo))
                            <img class="student-meta-img img-100" src="{{assetPath($staffDetails->staff_photo)}}"
                                 alt="">
                        @else
                            <img class="student-meta-img img-100" src="{{assetPath('public/uploads/sample.jpg')}}"
                                 alt="">
                        @endif
                        <div class="white-box">
                                ...
                                <table id="" class="table simple-table table-responsive school-table"
                                            ...
                                            <tr>
                                                ...
                                                <td><?php $payment_mode = '';
                                                        if (!empty($value->payment_mode)) {
                                                            $payment_mode = App\Models\SmHrPayrollGenerate::getPaymentMode($value->payment_mode);
                                                        } else {
                                                            $payment_mode = '';
                                                        }
                                                        ?>
                                                ...
                                                <td>
                                                    @if($value->payroll_status == 'P')
                                                        <a class="modalLink" data-modal-size="modal-lg"
                                                           ...
                                                           href="{{route('view-payslip', $value->id)}}">
                                                            <button class="primary-btn small tr-bg"> View Payslip
                                                            </button>
                                                        </a>
                                                    @endif
                                                </td>
                                    ...
                                    @else
                                        <tr class="justify-content-center">
                                            <td colspan="7" class="justify-content-center text-center">No Payroll Data
                                            </td>
                                        </tr>
                                    @endif
                                    </tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="modalLink" data-modal-size="modal-md"
                                                               ...
                                                               href="{{route('view-leave-details', $value->id)}}">
                                                                <button class="primary-btn small tr-bg"> View</button>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            ...
                                            <tr class="d-flex">
                                                ...
                                                <td class="col-4">
                                                    <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                       href="{{route('download-staff-document',getFilePath3($value->file))}}">
                                                        Download
                                                        <span class="pl ti-download"></span>
                                                    </a>
                                                    <a class="primary-btn icon-only fix-gr-bg modalLink"
                                                       title="Delete Document" data-modal-size="modal-md"
                                                       href="{{route('delete-staff-document-view',$value->id)}}">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="container-fluid">
                                            {{ html()->form('POST', route('save_upload_document'))->attributes([
                                                    ...
                                                    <div class="row no-gutters input-right-icon mt-35">
                                                        ...
                                                        <div class="col-auto">
                                                            <button class="primary-btn-small-input" type="button">
                                                                ...
                                                                <input type="file" class="d-none" id="browseFile"
                                                                       name="staff_upload_document">
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="single-activity">
                                                ...
                                                <div class="sub-activity-box d-flex">
                                                    ...
                                                    <div class="close-activity">
                                                        ...
                                                        <a class="primary-btn icon-only fix-gr-bg modalLink"
                                                           title="Delete Timeline" data-modal-size="modal-md"
                                                           href="{{route('delete-staff-timeline-view',$timeline->id)}}">
                                                            <span class="ti-trash"></span>
                                                        </a>
                                                        @if($timeline->file != "")
                                                            <a href="{{route('download-staff-timeline-doc',getFilePath3($timeline->file))}}"
                                                               class="primary-btn tr-bg text-uppercase bord-rad">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    ...
                                    {{ html()->form('POST', route('staff_timeline_store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                        'name' => 'document_upload',
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mt-30">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="primary_input">
                                                        <input class="primary_input_field  primary_input_field date form-control form-control{{ $errors->has('date_of_birth') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col-lg-12 mt-30">
                                            <div class="row no-gutters input-right-icon mt-35">
                                                <div class="col">
                                                    <div class="primary_input">
                                                        <input class="primary_input_field" id="placeholderFileFourName"
                                                               type="text"
                                                ...
                                                <div class="col-auto">
                                                    <button class="primary-btn-small-input" type="button">
                                                        ...
                                                        <input type="file" class="d-none" id="document_file_4"
