...
if (isset($setting->copyright_text)) {
    ...
    generalSetting()->copyright_text = "Copyright © " . date('Y') . " All rights reserved | is made with by Codethemes";
}
...
<head>
    ...
    <link rel="icon" href="{{assetPath(generalSetting()->favicon)}}" type="image/png"/>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <p>Copyright © {{ date('Y') }} All rights reserved | This application is made with <span
                            class="ti-heart"></span> by Codethemes</p>
                </p>
            </div>
        </div>
    </div>
