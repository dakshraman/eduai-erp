                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if(isset($visitor))
                                {{ html()->form('POST', route('social-media-update'))->attributes([
                                    'class' => 'form-horizontal',
                                    'files' => true,
                                    'enctype' => 'multipart/form-data',
                                ])->open() }}
                            @else
                                @if(in_array(530, App\Support\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1)
                                    {{ html()->form('POST', route('social-media-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <input class="primary_input_field form-control{{ $errors->has('icon') ? ' is-invalid' : '' }}"
                                                       type="text" id="icon" name="icon" autocomplete="off"
                                                       value="{{isset($visitor)? $visitor->icon: old('icon')}}">
                                                <input type="hidden" name="id"
                                                       value="{{isset($visitor)? $visitor->id: ''}}">
                                                <label class="primary_input_label" for="">@lang('front_settings.icon')
                                                    (fa fa-facebook)<span class="text-danger"> *</span></label>
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <input class="primary_input_field form-control{{ $errors->has('url') ? ' is-invalid' : '' }}"
                                                       type="text" name="url" autocomplete="off"
                                                       value="{{isset($visitor)? $visitor->url: old('url')}}">
                                                <input type="hidden" name="id"
                                                       value="{{isset($visitor)? $visitor->id: ''}}">
                                                <label class="primary_input_label" for="">@lang('common.url')<span
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <select class="primary_select  form-control{{ $errors->has('status') ? ' is-invalid' : '' }}"
                                                    name="status">
